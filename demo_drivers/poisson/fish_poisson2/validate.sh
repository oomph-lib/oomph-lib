...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/fish_poisson_no_adapt.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/fish_poisson_adapt.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/fish_poisson_node_update.dat.gz   \
