...
public:
 ...
 PoissonProblem(PoissonEquations<2>::PoissonSourceFctPt source_fct_pt, double n_x, double n_y, double l_x, double l_y);
...
int main()
{
 ...
 PoissonProblem<QPoissonElement<2,3> > 
  problem(&TanhSolnForPoisson::source_function, n_x, n_y, l_x, l_y);
