...
class SingularPoissonSolutionElement : public virtual GeneralisedElement
{
 ...
 /// \short Set pointer to associated wrapped Poisson element which contains
...
class PoissonElementWithSingularity : public virtual BASIC_POISSON_ELEMENT
{
 ...
 /// \short Access function to pointer of vector of 
 ...
 /// \short Add pointer to associated SingularPoissonSolutionElement that 
