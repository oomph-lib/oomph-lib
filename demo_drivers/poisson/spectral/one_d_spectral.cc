...
//LIC// 
//LIC//====================================================================
//Driver for a simple 1D poisson problem using spectral elements
...
{ 
 ...
 cout << assign_eqn_numbers() << " Degrees of freedom " << std::endl;
...
void construct_and_solve_problem(const unsigned &i)
{
 ...
 OneDPoissonProblem<QSpectralPoissonElement<1,SPECTRAL_ORDER> > //Element type as template parameter
 ...
 //Output solution for this case (label output files with "i")
...
int main()
{
 construct_and_solve_problem<2>(0);
 construct_and_solve_problem<3>(1);
 construct_and_solve_problem<4>(2);
 construct_and_solve_problem<5>(3);
 construct_and_solve_problem<6>(4);
 construct_and_solve_problem<7>(5);
 construct_and_solve_problem<8>(6);
} // end of main
