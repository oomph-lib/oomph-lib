...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/1d_spectral.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/2d_spectral.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/3d_spectral.dat.gz   \
