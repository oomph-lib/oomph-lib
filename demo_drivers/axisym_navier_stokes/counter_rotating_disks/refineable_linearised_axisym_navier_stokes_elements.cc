...
//asd
             ...
             case 1:
              ...
              sum -= visc_ratio*(
               ...
               + ((1.0+Gamma[0]+(k*k))*interpolated_US/r))*testf_*W*hang_weight;
              ...
              sum -= 
               scaled_re*(r*interpolated_ur*interpolated_dUSdr
                          ...
                          + r*interpolated_durdz*interpolated_WS)*testf_*W*hang_weight;
             ...
             case 2:
              ...
              sum += visc_ratio*k*
               (Gamma[1]*interpolated_dVSdz - k*interpolated_WC/r)*testf_*W*hang_weight;
              ...
              sum -=
               scaled_re*(r*interpolated_ur*interpolated_dWCdr 
                          ...
                          + r*interpolated_duzdz*interpolated_WC)*testf_*W*hang_weight;
             ...
             case 3:
              ...
              sum -= visc_ratio*k*
               (Gamma[1]*interpolated_dVCdz + k*interpolated_WS/r)*testf_*W*hang_weight;
              ...
              sum -=
               scaled_re*(r*interpolated_ur*interpolated_dWSdr 
                          ...
                          + r*interpolated_duzdz*interpolated_WS)*testf_*W*hang_weight;
             ...
             case 4:
              ...
              sum -= visc_ratio*
               (k*Gamma[0]*interpolated_WS + r*interpolated_dVCdz)*dtestfdz*W*hang_weight;
              
              sum += visc_ratio*
               (Gamma[0]*interpolated_dVCdr
                + k*(2.0+Gamma[0])*interpolated_US/r
                - (1.0+(k*k)+(k*k*Gamma[0]))*interpolated_VC/r)*testf_*W*hang_weight;
              ...
              sum -= 
               scaled_re*(r*interpolated_ur*interpolated_dVCdr
                          ...
                          + r*interpolated_duthetadz*interpolated_WC)*testf_*W*hang_weight;
             ...
             case 5:
              ...
              sum += visc_ratio*
               (k*Gamma[0]*interpolated_WC - r*interpolated_dVSdz)*dtestfdz*W*hang_weight;
              
              sum += visc_ratio*
               (Gamma[0]*interpolated_dVSdr
                - k*(2.0+Gamma[0])*interpolated_UC/r
                - (1.0+(k*k)+(k*k*Gamma[0]))*interpolated_VS/r)*testf_*W*hang_weight;
              ...
              sum -= 
               scaled_re*(r*interpolated_ur*interpolated_dVSdr
                          ...
                          + r*interpolated_duthetadz*interpolated_WS)*testf_*W*hang_weight;
                        ...
                        switch(i2)
                         ...
                         case 0:
                          ...
                          jacobian(local_eqn,local_unknown)
                           -= visc_ratio*r*(1.0+Gamma[0])*dpsifdr*dtestfdr*W*hang_weight*hang_weight2;
                          
                          jacobian(local_eqn,local_unknown)
                           -= visc_ratio*r*dpsifdz*dtestfdz*W*hang_weight*hang_weight2;
                          
                          jacobian(local_eqn,local_unknown)
                           -= visc_ratio*(1.0+Gamma[0]+(k*k))*psif_*testf_*W*hang_weight*hang_weight2/r;
                          ...
                          jacobian(local_eqn,local_unknown) -=
                           scaled_re*r*(psif_*interpolated_durdr 
                                        ...
                                        + interpolated_uz*dpsifdz)*testf_*W*hang_weight*hang_weight2;
                         ...
                         case 1:
                          ...
                          // Convective term
                          jacobian(local_eqn,local_unknown) -=
                           scaled_re*k*interpolated_utheta*psif_*testf_*W*hang_weight*hang_weight2;
                         ...
                         case 2:
                          ...
                          // Stress tensor term
                          jacobian(local_eqn,local_unknown) -=
                           visc_ratio*Gamma[0]*r*dpsifdr*dtestfdz*W*hang_weight*hang_weight2;
                          
                          // Convective term
                          jacobian(local_eqn,local_unknown) -=
                           scaled_re*r*interpolated_durdz*psif_*testf_*W*hang_weight*hang_weight2;
                         ...
                         case 4:
                          ...
                          // Convective term
                          jacobian(local_eqn,local_unknown) +=
                           scaled_re*2*interpolated_utheta*psif_*testf_*W*hang_weight*hang_weight2;
                         ...
                         case 5:
                          ...
                          jacobian(local_eqn,local_unknown) += visc_ratio*(
                           (Gamma[0]*k*dpsifdr) - (k*(2.0+Gamma[0])*psif_/r))*testf_*W*hang_weight*hang_weight2;
                       ...
                       case 1:
                        ...
                        switch(i2)
                         ...
                         case 4:
                          ...
                          jacobian(local_eqn,local_unknown) -= visc_ratio*(
                           (Gamma[0]*k*dpsifdr)
                           - (k*(2.0+Gamma[0])*psif_/r))*testf_*W*hang_weight*hang_weight2;
                       ...
                       case 2:
                        ...
                        switch(i2)
                         ...
                         case 0:
                          ...
                          // Stress tensor term
                          jacobian(local_eqn,local_unknown) -= 
                           visc_ratio*r*Gamma[1]*dpsifdz*dtestfdr*W*hang_weight*hang_weight2;
                          
                          // Convective term
                          jacobian(local_eqn,local_unknown) -= 
                           scaled_re*r*psif_*interpolated_duzdr*testf_*W*hang_weight*hang_weight2;
                         ...
                         case 2:
                          ...
                          // Stress tensor terms
                          jacobian(local_eqn,local_unknown) -= 
                           visc_ratio*r*dpsifdr*dtestfdr*W*hang_weight*hang_weight2;
                          
                          jacobian(local_eqn,local_unknown) -= 
                           visc_ratio*r*(1.0+Gamma[1])*dpsifdz*dtestfdz*W*hang_weight*hang_weight2;
                          
                          jacobian(local_eqn,local_unknown) -=
                           visc_ratio*k*k*psif_*testf_*W*hang_weight*hang_weight2/r;
                         ...
                         case 5:
                          ...
                          // Stress tensor term
                          jacobian(local_eqn,local_unknown) +=
                           visc_ratio*Gamma[1]*k*dpsifdz*testf_*W*hang_weight*hang_weight2;
                        ...
                        switch(i2)
                         ...
                         case 0:
                          ...
                          jacobian(local_eqn,local_unknown) -=
                           scaled_re*(r*interpolated_duthetadr 
                                      + interpolated_utheta)*psif_*testf_*W*hang_weight*hang_weight2;
                         ...
                         case 1:
                          ...
                          jacobian(local_eqn,local_unknown) += visc_ratio*k*psif_*(
                           ((2.0+Gamma[0])*testf_/r) - (Gamma[0]*dtestfdr))*W*hang_weight*hang_weight2;
                         ...
                         case 2:
                          ...
                          // Convective term
                          jacobian(local_eqn,local_unknown) -= 
                           scaled_re*r*psif_*interpolated_duthetadz*testf_*W*hang_weight*hang_weight2;
                         ...
                         case 3:
                          ...
                          // Stress tensor term
                          jacobian(local_eqn,local_unknown) -= 
                           visc_ratio*k*Gamma[0]*psif_*dtestfdz*W*hang_weight*hang_weight2;
                         ...
                         case 4:
                          ...
                          // Stress tensor terms
                          jacobian(local_eqn,local_unknown) +=
                           visc_ratio*(Gamma[0]*psif_ - r*dpsifdr)*dtestfdr*W*hang_weight*hang_weight2;
                          ...
                          jacobian(local_eqn,local_unknown) +=
                           visc_ratio*(Gamma[0]*dpsifdr 
                                       - (1.0+(k*k)+(k*k*Gamma[0]))*psif_/r)*testf_*W*hang_weight*hang_weight2;
                          ...
                          jacobian(local_eqn,local_unknown) -= 
                           scaled_re*(r*interpolated_ur*dpsifdr
                                      ...
                                      + r*interpolated_uz*dpsifdz)*testf_*W*hang_weight*hang_weight2;
                       ...
                       case 5:
                        ...
                        switch(i2)
                         ...
                         case 0:
                          ...
                          // Stress tensor terms
                          jacobian(local_eqn,local_unknown) += visc_ratio*k*psif_*(
                           (Gamma[0]*dtestfdr) - ((2.0+Gamma[0])*testf_/r))*W*hang_weight*hang_weight2;
                       ...
                       case 0:
                        ...
                        switch(i2)
                         ...
                         case 0:
                          ...
                          jacobian(local_eqn,local_unknown) +=
                           psip[l2]*(testf_ + r*dtestfdr)*W*hang_weight*hang_weight2;
             ...
             case 0:
              ...
              residuals[local_eqn] += 
               (interpolated_UC + r*interpolated_dUCdr
                + k*interpolated_VS + r*interpolated_dWCdz)*testp_*W*hang_weight;
             ...
             case 1:
              ...
              residuals[local_eqn] += 
               (interpolated_US + r*interpolated_dUSdr
                - k*interpolated_VC + r*interpolated_dWSdz)*testp_*W*hang_weight;
                       ...
                       case 0:
                        ...
                        switch(i2)
                         ...
                         case 0:
                          ...
                          jacobian(local_eqn,local_unknown) +=
                           (psif_ + r*dpsifdr)*testp_*W*hang_weight*hang_weight2;
