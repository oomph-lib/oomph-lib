...
}; // End of RefineableLinearisedAxisymmetricNavierStokesEquations class def
...
public virtual RefineableQElement<2>
{
 ...
 void get_interpolated_values(const Vector<double> &s, Vector<double> &values)
 {
  ...
  // Determine size of values Vector: U^C, U^S, W^C, W^S, V^C, V^S, P^C, P^S
  ...
  for(unsigned i=0;i<2;i++)
   {
    values[(2*DIM)+i] = interpolated_p_linearised_axi_nst(s,i);
   }
 }
 ...
 Node* get_interpolating_node_at_local_coordinate(const Vector<double> &s,   
                                                  const int &n_value)
  {
   ...
   if(n_value==static_cast<int>(2*DIM) || n_value==static_cast<int>((2*DIM)+1))
    {
...
//==========================================================================
/// Face geometry of the RefineableLinearisedAxisymmetricQTaylorHoodElements
//==========================================================================
template<>
...
//===========================================================================
/// Face geometry of RefineableLinearisedAxisymmetricQCrouzeixRaviartElements
//===========================================================================
template<>
