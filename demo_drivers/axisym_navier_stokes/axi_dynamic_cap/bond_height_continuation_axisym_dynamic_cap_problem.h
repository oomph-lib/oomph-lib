...
#ifndef BOND_HEIGHT_CONTINUATION_AXISYM_DYNAMIC_CAP_PROBLEM_HEADER
#define BOND_HEIGHT_CONTINUATION_AXISYM_DYNAMIC_CAP_PROBLEM_HEADER
...
namespace oomph
{
  ...
  class BondHeightContinuationAxisymDynamicCapProblem : public MyEigenproblem
  {
  public:
    ...
    // Constructor
    BondHeightContinuationAxisymDynamicCapProblem(const double& contact_angle,
