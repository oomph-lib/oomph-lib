...
#ifndef CA_HEIGHT_CONTROL_SINGULAR_AXISYM_DYNAMIC_CAP_PROBLEM_HEADER
#define CA_HEIGHT_CONTROL_SINGULAR_AXISYM_DYNAMIC_CAP_PROBLEM_HEADER
...
namespace oomph
{
  ...
  class CaHeightControlSingularAxisymDynamicCapProblem : public MyEigenproblem
  {
  public:
    ...
    // Constructor
    CaHeightControlSingularAxisymDynamicCapProblem(const double& contact_angle,
  ...
  private:
    ...
    {
      oomph_info << "setup_pressure_contribution_elements" << endl;
    ...
    {
      oomph_info << "create_pressure_contribution_2_elements" << endl;
