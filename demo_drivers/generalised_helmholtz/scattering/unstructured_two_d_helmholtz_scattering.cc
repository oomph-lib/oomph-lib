...
namespace GlobalParameters
{
 ...
 double K_squared=(Omega/C)*(Omega/C);
...
{ 
 ...
 for(unsigned e=0;e<nn_element;e++)
  {
   GeneralisedHelmholtzPowerElement<ELEMENT> *el_pt = 
    dynamic_cast<GeneralisedHelmholtzPowerElement<ELEMENT>*>(
 ...
 for(unsigned e=0;e<n_element;e++)
  {
   ...
   GeneralisedHelmholtzPowerElement<ELEMENT>* power_element_pt = new 
    GeneralisedHelmholtzPowerElement<ELEMENT>(bulk_elem_pt,face_index);
