...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/1d_cont_adv.dat.gz \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/1d_disc_adv.dat.gz \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/2d_disc_adv.dat.gz \
