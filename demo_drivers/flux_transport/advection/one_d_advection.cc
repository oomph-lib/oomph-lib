      ...
      if (finite_element_pt(e) == bulk_element_pt)
      {
        ...
        switch (face_index)
        {
          ...
          case 1:
            ...
            // Otherwise complain
          default:
            throw OomphLibError("Coordinate is not on any face",
...
public:
  ...
  DGProblem(const unsigned& n_element)
  {
    ...
    Problem::mesh_pt() =
      new OneDimMesh<ELEMENT>(n_element, this->time_stepper_pt());
