...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/clamped_shell.dat.gz \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/pinned_shell.dat.gz \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/pinned_periodic.dat.gz \
