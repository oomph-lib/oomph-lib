  ...
  public:
    ...
    inline Vector<double> interpolated_u_shell(const Vector<double>& s) const
    {
      ...
      x_dir = interpolated_u[0] * t(0, 0) + interpolated_u[1] * t(1, 0) +
              interpolated_u[2] * unit_n[0];
      y_dir = interpolated_u[0] * t(0, 1) + interpolated_u[1] * t(1, 1) +
              interpolated_u[2] * unit_n[1];
      z_dir = interpolated_u[0] * t(0, 2) + interpolated_u[1] * t(1, 2) +
