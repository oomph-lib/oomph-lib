...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/shell_with_arclength_cont_results.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/shell.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/unstructured_curved_shell.dat.gz \
    unstructured_curved_shell.dat 0.125 1.0e-14 >>validation.log
fi
