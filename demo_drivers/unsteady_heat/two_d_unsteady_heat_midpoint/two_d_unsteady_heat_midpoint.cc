...
public:
 ...
 /// Constructor
 UnsteadyHeatProblem(UnsteadyHeatEquationsBase::UnsteadyHeatSourceFctPt
...
int main(int argc, const char* argv[])
{
 ...
 if(to_lower(std::string(argv[1])) == "bdf2")
  ...
  {
   std::string err = "Command line argument " + to_string(argv[1])
    + " not recognised.";
 ...
 // Build problem
 UnsteadyHeatProblem<QMidpointSafeUnsteadyHeatElement<2,4> >
  problem(&ExactSolnForUnsteadyHeat::get_source, ts_pt);
