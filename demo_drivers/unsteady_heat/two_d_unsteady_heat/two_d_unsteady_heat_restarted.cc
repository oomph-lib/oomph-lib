...
// LIC//
// LIC//====================================================================
// Driver for 2D unsteady heat problem with optional restart from disk
  ...
  Source_fct_pt(source_fct_pt)
{
  ...
  cout << "Recording trace of the solution at: " << Control_node_pt->x(0) << " "
                                                ...
                                                ofstream &trace_file)
{
  ...
  some_file.open(filename);
  mesh_pt()->output_fct(
    some_file, npts, time_pt()->time(), ExactSolnForUnsteadyHeat::get_exact_u);
  some_file.close();
  ...
  trace_file << time_pt()->time() << " " << Control_node_pt->value(0) << " "
             << u_exact << " " << error << " " << norm << std::endl;
...
//=======start_of_main====================================================
/// \short Driver code for unsteady heat equation with option for
...
int main(int argc, char *argv[])
{
  ...
  UnsteadyHeatProblem<QUnsteadyHeatElement<2, 4>> problem(
    &ExactSolnForUnsteadyHeat::get_source);
