  ...
  Source_fct_pt(source_fct_pt)
{
  ...
  cout << " Building a " << n_x << " x " << n_y << " mesh." << std::endl;
...
void PoissonProblem<ELEMENT>::run_it(DocInfo& doc_info)
{
  ...
  for (unsigned i = 0; i < n_assemble; i++)
  {
    ...
    cout << "    ======================================================= "
         << std::endl;
    cout << "    Time for " << i
         << "th jac/residual computation [sec]: " << total_time << std::endl;
    cout << "    ======================================================= "
         << std::endl;
  }
...
int main(int argc, char* argv[])
{
  ...
  //-----------------------------------------------
  {
    ...
    PoissonProblem<QPoissonElement<2, 3>> problem(
      &TanhSolnForPoisson::source_function, n_refine);
  ...
  //-----------------------------------------------------------------
  {
    ...
    // QPoissonElement family. Pass pointer to source function
    // and number of refinements required
    PoissonProblem<ELEMENT> problem(&TanhSolnForPoisson::source_function,
                                    n_refine);
    ...
    cout << "Total time for assignment of shape functions and derivatives from "
         << std::endl
         << "the first element: " << total_time << " sec" << std::endl;
    cout << "================================================================= "
         << std::endl;
    cout << std::endl;
