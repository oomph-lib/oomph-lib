...
{ 
 ...
 //----------------------------
 {
  ...
  // Do output
  snprintf(filename, sizeof(filename), "%s/soln%i.cpp_style.dat",doc_info.directory().c_str(),
          doc_info.number());
 ...
 //--------------------------
 {
  ...
  // Do output
  snprintf(filename, sizeof(filename), "%s/soln%i.c_style.dat",doc_info.directory().c_str(),
          doc_info.number());
