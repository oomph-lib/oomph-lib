...
$OOMPH_ROOT_DIR/scripts/fpdiff.py RESLT/soln0.cpp_style.dat RESLT/soln0.c_style.dat\
    >> validation.log
$OOMPH_ROOT_DIR/scripts/fpdiff.py RESLT/soln1.cpp_style.dat RESLT/soln1.c_style.dat\
    >> validation.log
fi
