...
#else
#$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/matrix1.dat.gz   \
#    matrix1.dat.sorted >> validation.log
#$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/matrix2.dat.gz   \
#    matrix2.dat.sorted >> validation.log
#$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/matrix3.dat.gz   \
#    matrix3.dat.sorted >> validation.log
#$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/matrix4.dat.gz   \
