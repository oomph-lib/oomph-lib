...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/results.dat.gz  results.dat 0.1 1.0e-8 >> validation.log
fi
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/results2.dat.gz  results2.dat 0.1 1.0e-8 >> validation.log
fi
