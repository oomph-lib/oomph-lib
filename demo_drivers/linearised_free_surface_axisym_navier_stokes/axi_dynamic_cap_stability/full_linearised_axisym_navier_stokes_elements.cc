...
namespace oomph
{
  ...
  Vector<double> FullLinearisedAxisymmetricNavierStokesEquations::Gamma(2, 1.0);

  // "Magic" number to indicate pressure is not stored at node
  int FullLinearisedAxisymmetricNavierStokesEquations::
    Pressure_not_stored_at_node = -100;

  // Physical constants default to zero
  double FullLinearisedAxisymmetricNavierStokesEquations::
  ...
  Vector<double> FullLinearisedAxisymmetricNavierStokesEquations::
  ...
  //=======================================================================
  void FullLinearisedAxisymmetricNavierStokesEquations::output_veloc(
  ...
  /// Specified number of plot points in each coordinate direction.
  //=======================================================================
  void FullLinearisedAxisymmetricNavierStokesEquations::output(
    std::ostream& outfile, const unsigned& nplot)
  {
    const bool has_base_output = true;
    ...
    for (unsigned iplot = 0; iplot < n_plot_points; iplot++)
    {
      ...
      {
        outfile << interpolated_nodal_position_perturbation_lin_axi_nst(s, i)
                << " ";
      }
      ...
      if (has_base_output)
      {
        ...
        get_base_flow_u(s, base_flow_u);
        for (unsigned i = 0; i < 3; i++)
        {
          outfile << base_flow_u[i] << " ";
        }
        double base_flow_p = 0.0;
        get_base_flow_p(s, base_flow_p);
        outfile << base_flow_p << " ";

        DenseMatrix<double> base_flow_duds(3, 2, 0.0);
        DenseMatrix<double> base_flow_dudx(3, 2, 0.0);
        get_base_flow_duds(s, base_flow_duds);
        get_base_flow_dudx(s, base_flow_dudx);
        for (unsigned i = 0; i < 2; i++)
        {
          for (unsigned j = 0; j < 2; j++)
          {
            outfile << base_flow_duds(i, j) << " ";
          }
        }
        for (unsigned i = 0; i < 2; i++)
        {
          for (unsigned j = 0; j < 2; j++)
          {
            outfile << base_flow_dudx(i, j) << " ";
          }
        }

        Vector<double> base_flow_dudt(3, 0.0);
        get_base_flow_dudt(s, base_flow_dudt);
        for (unsigned i = 0; i < 3; i++)
        {
  ...
  //=======================================================================
  void FullLinearisedAxisymmetricNavierStokesEquations::strain_rate(
  ...
  /// ratio.
  //==============================================================
  void FullLinearisedAxisymmetricNavierStokesEquations::dkin_energy_dt(
    double& dkin_en_dt, double& kin_en) const
  {
    ...
    for (unsigned ipt = 0; ipt < n_intpt; ipt++)
    {
      ...
      const double dJdt =
        interpolated_d_dxds_dt(0, 0) * interpolated_dxds(1, 1) +
      ...
      dkin_en_dt +=
        2.0 * veloc_multiplied_by_time_deriv * interpolated_r * J * w;
  ...
  //=======================================================================
  void FullLinearisedAxisymmetricNavierStokesEquations::
      ...
      unsigned flag)
  {
    ...
    for (unsigned ipt = 0; ipt < n_intpt; ipt++)
    {
      ...
      const double Jbar = dshape_and_dtest_eulerian_at_knot_lin_axi_nst(
      ...
      if (!ALE_is_disabled)
      {
        ...
        for (unsigned l = 0; l < n_node; l++)
        {
          ...
          for (unsigned i = 0; i < 4; i++)
          {
            ...
            // w.r.t. time
            dxhat_dt[i] +=
              this->dnodal_position_perturbation_dt_lin_axi_nst(l, i) * psif(l);
          }
        }
      }
      ...
      for (unsigned l = 0; l < n_node; l++)
      {
        ...
        if (local_eqn >= 0)
        {
          ...
          residuals[local_eqn] -= scaled_re * interpolated_RC * base_flow_ur *
                                  base_flow_durdr * testf_ * Jbar * w;
          residuals[local_eqn] += scaled_re_st * interpolated_RC *
                                  mesh_velocity[0] * base_flow_durdr * testf_ *
                                  Jbar * w;
          ...
          residuals[local_eqn] -= scaled_re * interpolated_RC * base_flow_uz *
                                  base_flow_durdz * testf_ * Jbar * w;
          residuals[local_eqn] += scaled_re_st * interpolated_RC *
                                  mesh_velocity[1] * base_flow_durdz * testf_ *
                                  Jbar * w;
          residuals[local_eqn] +=
          ...
          residuals[local_eqn] -= visc_ratio * (1.0 + Gamma[0]) * r *
          ...
          residuals[local_eqn] -= visc_ratio * (1.0 + Gamma[0]) *
                                  interpolated_RC * base_flow_durdr * dtestfdr *
                                  Jbar * w;
          residuals[local_eqn] += k * visc_ratio * Gamma[0] *
          ...
          residuals[local_eqn] -= visc_ratio * k * base_flow_utheta * dtestfdr *
                                  interpolated_RS * Jbar * w / r;
          residuals[local_eqn] -= visc_ratio * k * base_flow_utheta * dtestfdz *
                                  interpolated_ZS * Jbar * w / r;
          residuals[local_eqn] -=
          ...
          residuals[local_eqn] -= visc_ratio * Gamma[0] * r *
                                  interpolated_dWdRC * dtestfdz * Jbar * w;
          residuals[local_eqn] +=
            visc_ratio * Gamma[0] * r * base_flow_duzdr * JhatC * dtestfdz * w;
          residuals[local_eqn] -= visc_ratio * Gamma[0] * interpolated_RC *
                                  base_flow_duzdr * dtestfdz * Jbar * w;
          residuals[local_eqn] -=
          ...
          residuals[local_eqn] -= visc_ratio * (1.0 + Gamma[0]) * k *
          ...
          residuals[local_eqn] += visc_ratio * (1.0 + Gamma[0]) * base_flow_ur *
                                  interpolated_RC * testf_ * Jbar * w / (r * r);
          residuals[local_eqn] -=
            ...
            for (unsigned l2 = 0; l2 < n_node; l2++)
            {
              ...
              if (local_unknown >= 0)
              {
                ...
                jacobian(local_eqn, local_unknown) -=
                  ...
                  node_pt(l2)->time_stepper_pt()->weight(1, 0) * testf_ * Jbar *
                  w;
                jacobian(local_eqn, local_unknown) -=
                  scaled_re * r * base_flow_ur * group_B[l2] * testf_ * w;
                jacobian(local_eqn, local_unknown) += scaled_re_st * r *
                                                      mesh_velocity[0] *
                                                      group_B[l2] * testf_ * w;
                jacobian(local_eqn, local_unknown) -= scaled_re * r * psif[l2] *
                                                      base_flow_durdr * testf_ *
                                                      Jbar * w;
                jacobian(local_eqn, local_unknown) -=
                ...
                jacobian(local_eqn, local_unknown) += scaled_re_st * r *
                                                      ...
                                                      group_A[l2] * testf_ * w;
                jacobian(local_eqn, local_unknown) -=
                  visc_ratio * (1.0 + Gamma[0]) * r * group_B[l2] * dtestfdr *
                  w;
                jacobian(local_eqn, local_unknown) -=
                ...
                jacobian(local_eqn, local_unknown) -=
                  visc_ratio * (1.0 + Gamma[0]) * psif[l2] * testf_ * Jbar * w /
                  r;
              }
              ...
              {
                jacobian(local_eqn, local_unknown) -=
                  k * scaled_re * base_flow_utheta * psif[l2] * testf_ * Jbar *
                  w;
              }
              ...
              if (local_unknown >= 0)
              {
                ...
                jacobian(local_eqn, local_unknown) -=
                  visc_ratio * (1.0 + Gamma[0]) * k * psif[l2] * testf_ * Jbar *
                  w / r;
              }

              // Perturbation to radial nodal coord (cosine part) R_k^C
              local_unknown =
                nodal_local_eqn(l2, this->xhat_index_lin_axi_nst(l2, 0));
              if (local_unknown >= 0)
              {
                jacobian(local_eqn, local_unknown) -=
                ...
                jacobian(local_eqn, local_unknown) +=
                  ...
                  Jbar * w / r;
                jacobian(local_eqn, local_unknown) += visc_ratio * Gamma[0] *
                                                      r * base_flow_duzdr *
                                                      group_F(l, l2) * w;
                jacobian(local_eqn, local_unknown) +=
                  visc_ratio * Gamma[0] * r * base_flow_duzdr * group_B[l2] *
                  dtestfdz * w;
                jacobian(local_eqn, local_unknown) -=
                  visc_ratio * Gamma[0] * psif[l2] * base_flow_duzdr *
                  dtestfdz * Jbar * w;
                jacobian(local_eqn, local_unknown) +=
              ...
              local_unknown =
                nodal_local_eqn(l2, this->xhat_index_lin_axi_nst(l2, 1));
              if (local_unknown >= 0)
              {
                jacobian(local_eqn, local_unknown) +=
                ...
                jacobian(local_eqn, local_unknown) -=
                  ...
                  Jbar * w / r;
                jacobian(local_eqn, local_unknown) +=
                  visc_ratio * k * psif[l2] * base_flow_utheta * testf_ * Jbar *
                  w / (r * r);
                jacobian(local_eqn, local_unknown) +=
                  visc_ratio * (1.0 + Gamma[0]) * k * base_flow_duthetadr *
                  psif[l2] * testf_ * Jbar * w / r;
                jacobian(local_eqn, local_unknown) -=
                  k * visc_ratio * base_flow_utheta * testf_ * group_B[l2] * w /
                  r;
              }

              // Perturbation to axial nodal coord (cosine part) Z_k^C
              local_unknown =
                nodal_local_eqn(l2, this->xhat_index_lin_axi_nst(l2, 2));
              if (local_unknown >= 0)
              {
                jacobian(local_eqn, local_unknown) -=
                ...
                jacobian(local_eqn, local_unknown) -=
                  ...
                  group_F(l, l2) * w;
                jacobian(local_eqn, local_unknown) -=
                  visc_ratio * (1.0 + Gamma[0]) * r * group_C[l2] * dtestfdr *
                  w;
                jacobian(local_eqn, local_unknown) +=
                  visc_ratio * (1.0 + Gamma[0]) * r * base_flow_durdr *
                ...
                jacobian(local_eqn, local_unknown) +=
                  visc_ratio * Gamma[0] * r * base_flow_duzdr * group_A[l2] *
                  dtestfdz * w;
                jacobian(local_eqn, local_unknown) +=
              ...
              local_unknown =
                nodal_local_eqn(l2, this->xhat_index_lin_axi_nst(l2, 3));
              if (local_unknown >= 0)
              {
                jacobian(local_eqn, local_unknown) +=
                ...
                jacobian(local_eqn, local_unknown) +=
                  ...
                  psif[l2] * testf_ * Jbar * w / r;
                jacobian(local_eqn, local_unknown) -=
                  k * visc_ratio * base_flow_utheta * testf_ * group_A[l2] * w /
                  r;
              }
        ...
        if (local_eqn >= 0)
        {
          ...
          residuals[local_eqn] -= visc_ratio * (1.0 + Gamma[0]) *
                                  interpolated_RS * base_flow_durdr * dtestfdr *
                                  Jbar * w;
          residuals[local_eqn] -= k * visc_ratio * Gamma[0] *
                                  base_flow_duthetadr * dtestfdr *
          ...
          residuals[local_eqn] += visc_ratio * k * base_flow_utheta * dtestfdr *
                                  interpolated_RC * Jbar * w / r;
          residuals[local_eqn] += visc_ratio * k * base_flow_utheta * dtestfdz *
                                  interpolated_ZC * Jbar * w / r;
          residuals[local_eqn] +=
          ...
          residuals[local_eqn] -= visc_ratio * Gamma[0] * interpolated_RS *
                                  base_flow_duzdr * dtestfdz * Jbar * w;
          residuals[local_eqn] -=
          ...
          residuals[local_eqn] += visc_ratio * (1.0 + Gamma[0]) * base_flow_ur *
                                  interpolated_RS * testf_ * Jbar * w / (r * r);
          residuals[local_eqn] -=
            ...
            for (unsigned l2 = 0; l2 < n_node; l2++)
            {
              ...
              if (local_unknown >= 0)
              {
                ...
                jacobian(local_eqn, local_unknown) +=
                  ...
                  Jbar * w / r;
                jacobian(local_eqn, local_unknown) +=
                  visc_ratio * Gamma[0] * r * base_flow_duzdr * dtestfdz *
                  group_A[l2] * w;
                jacobian(local_eqn, local_unknown) -=
                  visc_ratio * Gamma[0] * r * group_D[l2] * dtestfdz * w;
                jacobian(local_eqn, local_unknown) +=
        ...
        if (local_eqn >= 0)
        {
          ...
          residuals[local_eqn] -= scaled_re * interpolated_RC * base_flow_ur *
                                  base_flow_duzdr * testf_ * Jbar * w;
          residuals[local_eqn] += scaled_re_st * interpolated_RC *
                                  mesh_velocity[0] * base_flow_duzdr * testf_ *
                                  Jbar * w;
          residuals[local_eqn] -= k * scaled_re * base_flow_utheta *
          ...
          residuals[local_eqn] -= scaled_re * interpolated_RC * base_flow_uz *
                                  base_flow_duzdz * testf_ * Jbar * w;
          residuals[local_eqn] += scaled_re_st * interpolated_RC *
                                  mesh_velocity[1] * base_flow_duzdz * testf_ *
                                  Jbar * w;
          residuals[local_eqn] +=
          ...
          residuals[local_eqn] -= visc_ratio * Gamma[1] * r *
                                  interpolated_dUdZC * dtestfdr * Jbar * w;
          residuals[local_eqn] +=
            visc_ratio * Gamma[1] * r * base_flow_durdz * JhatC * dtestfdr * w;
          residuals[local_eqn] -= visc_ratio * Gamma[1] * interpolated_RC *
                                  base_flow_durdz * dtestfdr * Jbar * w;
          residuals[local_eqn] -=
          ...
          residuals[local_eqn] += visc_ratio * k * k * base_flow_duzdz *
                                  interpolated_ZC * testf_ * Jbar * w / r;
          residuals[local_eqn] += k * visc_ratio * Gamma[1] *
          ...
          residuals[local_eqn] -= visc_ratio * (1.0 + Gamma[1]) * r *
                                  base_flow_duzdz * dtestfdZC * Jbar * w;
          residuals[local_eqn] -= visc_ratio * (1.0 + Gamma[1]) * r *
                                  interpolated_dWdZC * dtestfdz * Jbar * w;
          residuals[local_eqn] += visc_ratio * (1.0 + Gamma[1]) * r *
                                  base_flow_duzdz * JhatC * dtestfdz * w;
          residuals[local_eqn] -= visc_ratio * (1.0 + Gamma[1]) *
                                  interpolated_RC * base_flow_duzdz * dtestfdz *
                                  Jbar * w;
          residuals[local_eqn] -=
            ...
            for (unsigned l2 = 0; l2 < n_node; l2++)
            {
              ...
              if (local_unknown >= 0)
              {
                ...
                jacobian(local_eqn, local_unknown) -=
                  visc_ratio * k * k * psif[l2] * testf_ * Jbar * w / r;
                jacobian(local_eqn, local_unknown) -=
                  visc_ratio * (1.0 + Gamma[1]) * r * group_A[l2] * dtestfdz *
                  w;
              }
              ...
              if (local_unknown >= 0)
              {
                ...
                jacobian(local_eqn, local_unknown) +=
                  visc_ratio * Gamma[1] * r * base_flow_durdz * group_B[l2] *
                  dtestfdr * w;
                jacobian(local_eqn, local_unknown) -=
                  visc_ratio * Gamma[1] * psif[l2] * base_flow_durdz *
                  dtestfdr * Jbar * w;
                jacobian(local_eqn, local_unknown) +=
                ...
                jacobian(local_eqn, local_unknown) +=
                  ...
                  group_F(l, l2) * w;
                jacobian(local_eqn, local_unknown) +=
                  visc_ratio * (1.0 + Gamma[1]) * r * group_D[l2] * dtestfdz *
                  w;
                jacobian(local_eqn, local_unknown) +=
                  visc_ratio * (1.0 + Gamma[1]) * r * base_flow_duzdz *
              ...
              if (local_unknown >= 0)
              {
                ...
                jacobian(local_eqn, local_unknown) -= visc_ratio * Gamma[1] *
                                                      r * base_flow_durdz *
                                                      group_F(l, l2) * w;
                jacobian(local_eqn, local_unknown) +=
                  visc_ratio * Gamma[1] * r * base_flow_durdz * group_A[l2] *
                  dtestfdr * w;
                jacobian(local_eqn, local_unknown) +=
        ...
        if (local_eqn >= 0)
        {
          ...
          residuals[local_eqn] -= visc_ratio * Gamma[1] * interpolated_RS *
                                  base_flow_durdz * dtestfdr * Jbar * w;
          residuals[local_eqn] -=
          ...
          residuals[local_eqn] -= visc_ratio * (1.0 + Gamma[1]) *
                                  interpolated_RS * base_flow_duzdz * dtestfdz *
                                  Jbar * w;
          residuals[local_eqn] -=
        ...
        if (local_eqn >= 0)
        {
          ...
          residuals[local_eqn] += k * visc_ratio * Gamma[0] * base_flow_durdr *
                                  interpolated_RS * dtestfdr * Jbar * w;
          residuals[local_eqn] += k * visc_ratio * Gamma[0] * base_flow_durdz *
                                  interpolated_ZS * dtestfdr * Jbar * w;
          residuals[local_eqn] +=
          ...
          residuals[local_eqn] -= visc_ratio * (1.0 + Gamma[0]) * k * k *
                                  interpolated_VC * testf_ * Jbar * w / r;
          residuals[local_eqn] += visc_ratio * (1.0 + Gamma[0]) * k * k *
                                  base_flow_duthetadr * interpolated_RC *
                                  testf_ * Jbar * w / r;
          ...
          residuals[local_eqn] += k * visc_ratio * Gamma[0] * base_flow_duzdr *
                                  interpolated_RS * dtestfdz * Jbar * w;
          residuals[local_eqn] += k * visc_ratio * Gamma[0] * base_flow_duzdz *
                                  interpolated_ZS * dtestfdz * Jbar * w;
          residuals[local_eqn] -=
          ...
          residuals[local_eqn] += k * visc_ratio * (1.0 + Gamma[0]) *
          ...
          if (flag)
          {
            ...
            for (unsigned l2 = 0; l2 < n_node; l2++)
            {
              ...
              if (local_unknown >= 0)
              {
                ...
                jacobian(local_eqn, local_unknown) -=
                  visc_ratio * (1.0 + Gamma[0]) * k * k * psif[l2] * testf_ *
                  Jbar * w / r;
                jacobian(local_eqn, local_unknown) -=
                  visc_ratio * r * group_A[l2] * dtestfdz * w;
                jacobian(local_eqn, local_unknown) +=
              ...
              if (local_unknown >= 0)
              {
                jacobian(local_eqn, local_unknown) -= scaled_re_st * psif[l2] *
                                                      base_flow_duthetadt *
                                                      testf_ * Jbar * w;
                jacobian(local_eqn, local_unknown) +=
                  scaled_re_st * r * psif[l2] *
                ...
                jacobian(local_eqn, local_unknown) -= visc_ratio * psif[l2] *
                                                      ...
                                                      dtestfdz * Jbar * w;
                jacobian(local_eqn, local_unknown) +=
                  visc_ratio * base_flow_utheta * psif[l2] * testf_ * Jbar * w /
                  (r * r);
                jacobian(local_eqn, local_unknown) -= scaled_re_st * r *
                                                      base_flow_duthetadt *
                                                      testf_ * group_B[l2] * w;
              ...
              if (local_unknown >= 0)
              {
                jacobian(local_eqn, local_unknown) +=
                  ...
                  psif[l2] * testf_ * Jbar * w;
                jacobian(local_eqn, local_unknown) +=
                  k * visc_ratio * Gamma[0] * base_flow_durdr * psif[l2] *
                  dtestfdr * Jbar * w;
                jacobian(local_eqn, local_unknown) -=
                ...
                jacobian(local_eqn, local_unknown) -=
                  ...
                  testf_ * Jbar * w / (r * r);
                jacobian(local_eqn, local_unknown) +=
                  k * visc_ratio * Gamma[0] * base_flow_duzdr * psif[l2] *
                  dtestfdz * Jbar * w;
                jacobian(local_eqn, local_unknown) -=
                  visc_ratio * k * base_flow_durdr * psif[l2] * testf_ * Jbar *
                  w / r;
                jacobian(local_eqn, local_unknown) -=
              ...
              if (local_unknown >= 0)
              {
                jacobian(local_eqn, local_unknown) +=
                  ...
                  psif[l2] * testf_ * Jbar * w;
                jacobian(local_eqn, local_unknown) +=
                  k * visc_ratio * Gamma[0] * base_flow_durdz * psif[l2] *
                  dtestfdr * Jbar * w;
                jacobian(local_eqn, local_unknown) -=
                ...
                jacobian(local_eqn, local_unknown) +=
                  ...
                  psif[l2] * Jbar * w / r;
                jacobian(local_eqn, local_unknown) +=
                  k * visc_ratio * Gamma[0] * base_flow_duzdz * psif[l2] *
                  dtestfdz * Jbar * w;
                jacobian(local_eqn, local_unknown) -=
                  visc_ratio * k * base_flow_durdz * psif[l2] * testf_ * Jbar *
                  w / r;
                jacobian(local_eqn, local_unknown) -=
        ...
        if (local_eqn >= 0)
        {
          ...
          residuals[local_eqn] -= k * visc_ratio * Gamma[0] * base_flow_durdr *
                                  interpolated_RC * dtestfdr * Jbar * w;
          residuals[local_eqn] -= k * visc_ratio * Gamma[0] * base_flow_durdz *
                                  interpolated_ZC * dtestfdr * Jbar * w;
          residuals[local_eqn] +=
          ...
          residuals[local_eqn] -= k * visc_ratio * Gamma[0] * base_flow_duzdr *
                                  interpolated_RC * dtestfdz * Jbar * w;
          residuals[local_eqn] -= k * visc_ratio * Gamma[0] * base_flow_duzdz *
                                  interpolated_ZC * dtestfdz * Jbar * w;
          residuals[local_eqn] -=
