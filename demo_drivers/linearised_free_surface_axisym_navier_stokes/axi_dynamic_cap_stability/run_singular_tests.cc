...
//     compare_matrices(expected_jacobian, actual_jacobian, 1.2e-5);
//   BOOST_TEST(jacobians_are_equal);
//   output_matrices(actual_jacobian, "actual_jacobian.dat");
//   save_dofs_types(problem_pt, "dofs.txt");
//   problem_pt->steady_newton_solve();
//   problem_pt->doc_solution();
//   BOOST_TEST(abs(problem_pt->get_height_drop() + 0.29795664727577137) <
//   1e-6);
// }
...
//   problem_pt->doc_solution();
//   BOOST_TEST(abs(problem_pt->get_height_drop() + 0.29795664727577137) <
//   1e-6); Global_Physical_Parameters::Equilibrium_contact_angle =
...
//    linear_problem_pt->solve_and_document_n_most_unstable_eigensolutions(2);
//  printf("%16.11g \n", eigenvalue[0].real());
...
//    linear_regular_problem_pt->solve_n_most_unstable_eigensolutions(2);
//
//  // Actual solution
//  shared_ptr<SINGULAR_PROBLEM> problem_pt = createSingularProblem();
//  Slip_Parameters::wall_velocity = 0.0;
...
//    linear_problem_pt->solve_n_most_unstable_eigensolutions(2);
//
//  // Compare
