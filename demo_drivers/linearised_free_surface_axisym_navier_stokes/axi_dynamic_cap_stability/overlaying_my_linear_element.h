...
namespace oomph
{
  ...
  class OverlayingMyLinearElement : public virtual Hijacked<MyLinearElement>
  {
  private:
    BASE_ELEMENT* Base_element_pt;

  public:
    OverlayingMyLinearElement() : MyLinearElement() {}
  ...
  template<class BASE_ELEMENT>
  class FaceGeometry<OverlayingMyLinearElement<BASE_ELEMENT>>
    : public TElement<1, 3>
  {
  public:
