...
public:
  ...
  RefineableAdvectionDiffusionProblem(
    GeneralisedAdvectionDiffusionEquations<
      2>::GeneralisedAdvectionDiffusionWindFctPt wind_fct_pt,
    GeneralisedAdvectionDiffusionEquations<
      2>::GeneralisedAdvectionDiffusionWindFctPt swim_fct_pt,
    GeneralisedAdvectionDiffusionEquations<
      2>::GeneralisedAdvectionDiffusionDiffFctPt diff_fct_pt);
...
//========================================================================
template<class ELEMENT>
RefineableAdvectionDiffusionProblem<ELEMENT>::
  RefineableAdvectionDiffusionProblem(
    GeneralisedAdvectionDiffusionEquations<
      2>::GeneralisedAdvectionDiffusionWindFctPt wind_fct_pt,
    GeneralisedAdvectionDiffusionEquations<
    ...
    GeneralisedAdvectionDiffusionEquations<
      2>::GeneralisedAdvectionDiffusionDiffFctPt diff_fct_pt) :
  Diff_fct_pt(diff_fct_pt), Wind_fct_pt(wind_fct_pt), Swim_fct_pt(swim_fct_pt)
{
...
void RefineableAdvectionDiffusionProblem<ELEMENT>::doc_solution()
{
  ...
  some_file.open(filename);
  mesh_pt()->output_fct(
    some_file, npts, RachelsAdvectionDiffusion::get_exact_u);
  some_file.close();
  ...
  mesh_pt()->compute_error(
    some_file, RachelsAdvectionDiffusion::get_exact_u, error, norm);
  some_file.close();
...
int main()
{
  ...
  RefineableAdvectionDiffusionProblem<
    RefineableQGeneralisedAdvectionDiffusionElement<2, 3>>
    problem(&RachelsAdvectionDiffusion::wind_function,
