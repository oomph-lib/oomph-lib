 ...
 for(unsigned e=0;e<n_element;e++)
  {
   ...
   // Swimming component
   el_pt->conserved_wind_fct_pt() =  &TanhSolnForAdvectionDiffusion::swimming;
   
   // Diffusivity
  //el_pt->diff_fct_pt() =  &TanhSolnForAdvectionDiffusion::diff_function;
...
int main()
{
 ...
 TwoMeshFluxAdvectionDiffusionProblem<RefineableQGeneralisedAdvectionDiffusionElement<2,
  3> > problem(&TanhSolnForAdvectionDiffusion::source_function,
			   ...
			   //&TanhSolnForAdvectionDiffusion::diff_function);
