...
namespace GlobalParameters
{
                   ...
                   Vector<double> &u)
  {
    ...
    {
      t0 = 0.25 * S0 / Beta0 *
             (r * r - 1.0 * Radius_innermost * Radius_innermost) +
           U0;
    }
    else
    {
      ...
      MapleGenVar9 =
        -2.0 * log(Radius_inner) * S0 * Radius_innermost * Radius_innermost +
        2.0 * log(Radius_outer) * S0 * Radius_innermost * Radius_innermost +
        4.0 * log(Radius_inner) * Sigma * Theta_0 * Theta_0 * Theta_0 *
          Theta_0 * Radius_inner -
        8.0 * log(Radius_inner) * Sigma * Theta_0 * Theta_0 * Theta_0 *
          Theta_0 * Radius_innermost +
        4.0 * log(Radius_inner) * Sigma * U0 * U0 * U0 * U0 * Radius_inner -
        8.0 * log(Radius_inner) * Sigma * U0 * U0 * U0 * U0 * Radius_innermost -
        4.0 * log(Radius_outer) * Sigma * Theta_0 * Theta_0 * Theta_0 *
          Theta_0 * Radius_inner +
        8.0 * log(Radius_outer) * Sigma * Theta_0 * Theta_0 * Theta_0 *
          Theta_0 * Radius_innermost -
        4.0 * log(Radius_outer) * Sigma * U0 * U0 * U0 * U0 * Radius_inner +
        8.0 * log(Radius_outer) * Sigma * U0 * U0 * U0 * U0 * Radius_innermost +
        2.0 * log(Radius_inner) * S0 * Radius_inner * Radius_innermost -
        2.0 * log(Radius_outer) * S0 * Radius_inner * Radius_innermost -
        2.0 * S1 * Radius_inner * Radius_inner * log(Radius_inner);
      MapleGenVar8 =
        MapleGenVar9 +
        2.0 * log(Radius_outer) * S1 * Radius_inner * Radius_inner +
        16.0 * log(Radius_inner) * Sigma * Theta_0 * Theta_0 * Theta_0 * U0 *
          Radius_inner -
        32.0 * log(Radius_inner) * Sigma * Theta_0 * Theta_0 * Theta_0 * U0 *
          Radius_innermost +
        24.0 * log(Radius_inner) * Sigma * Theta_0 * Theta_0 * U0 * U0 *
          Radius_inner -
        48.0 * log(Radius_inner) * Sigma * Theta_0 * Theta_0 * U0 * U0 *
          Radius_innermost +
        16.0 * log(Radius_inner) * Sigma * Theta_0 * U0 * U0 * U0 *
          Radius_inner -
        32.0 * log(Radius_inner) * Sigma * Theta_0 * U0 * U0 * U0 *
          Radius_innermost -
        16.0 * log(Radius_outer) * Sigma * Theta_0 * Theta_0 * Theta_0 * U0 *
          Radius_inner +
        32.0 * log(Radius_outer) * Sigma * Theta_0 * Theta_0 * Theta_0 * U0 *
          Radius_innermost -
        24.0 * log(Radius_outer) * Sigma * Theta_0 * Theta_0 * U0 * U0 *
          Radius_inner +
        48.0 * log(Radius_outer) * Sigma * Theta_0 * Theta_0 * U0 * U0 *
          Radius_innermost -
        16.0 * log(Radius_outer) * Sigma * Theta_0 * U0 * U0 * U0 *
          Radius_inner +
        32.0 * log(Radius_outer) * Sigma * Theta_0 * U0 * U0 * U0 *
          Radius_innermost;
      MapleGenVar9 = log(r);
      ...
      MapleGenVar6 =
        -Beta1 * pow(2.0, 0.75) *
          pow((2.0 * Sigma * Theta_0 * Theta_0 * Theta_0 * Theta_0 +
               8.0 * Sigma * Theta_0 * Theta_0 * Theta_0 * U0 +
               12.0 * Sigma * Theta_0 * Theta_0 * U0 * U0 +
               8.0 * Sigma * Theta_0 * U0 * U0 * U0 +
               2.0 * Sigma * U0 * U0 * U0 * U0 + S0 * Radius_innermost) /
                Sigma,
              0.25) *
          log(Radius_outer) / 2.0 -
        log(Radius_inner) * S1 * Radius_outer * Radius_outer / 4.0;
      MapleGenVar7 = MapleGenVar6 +
                     log(Radius_outer) * S1 * Radius_inner * Radius_inner / 4.0;
      ...
      MapleGenVar16 =
        ...
        2.0 * pow(2.0, 0.75) *
          pow((2.0 * Sigma * Theta_0 * Theta_0 * Theta_0 * Theta_0 +
              ...
              0.25) *
          Beta1 +
        S1 * Radius_outer * Radius_outer - 4.0 * Theta_0 * Beta1 -
        16.0 * log(Radius_inner) * Sigma * Theta_0 * Theta_0 * Theta_0 * U0 *
          Radius_inner +
        32.0 * log(Radius_inner) * Sigma * Theta_0 * Theta_0 * Theta_0 * U0 *
          Radius_innermost -
        ...
        48.0 * log(Radius_inner) * Sigma * Theta_0 * Theta_0 * U0 * U0 *
          Radius_innermost;
      MapleGenVar14 = MapleGenVar16 -
                      16.0 * log(Radius_inner) * Sigma * Theta_0 * U0 * U0 *
                        U0 * Radius_inner +
                      32.0 * log(Radius_inner) * Sigma * Theta_0 * U0 * U0 *
                        U0 * Radius_innermost +
                      16.0 * log(Radius_outer) * Sigma * Theta_0 * Theta_0 *
                        Theta_0 * U0 * Radius_inner -
                      32.0 * log(Radius_outer) * Sigma * Theta_0 * Theta_0 *
                        Theta_0 * U0 * Radius_innermost +
                      24.0 * log(Radius_outer) * Sigma * Theta_0 * Theta_0 *
                        U0 * U0 * Radius_inner -
                      48.0 * log(Radius_outer) * Sigma * Theta_0 * Theta_0 *
                        U0 * U0 * Radius_innermost +
                      16.0 * log(Radius_outer) * Sigma * Theta_0 * U0 * U0 *
                        U0 * Radius_inner -
                      32.0 * log(Radius_outer) * Sigma * Theta_0 * U0 * U0 *
                        U0 * Radius_innermost;
...
StefanBoltzmannProblem<ELEMENT>::StefanBoltzmannProblem()
{
  // Open trace file
  Trace_file.open(
    (GlobalParameters::Directory + std::string("/trace.dat")).c_str());
  ...
  boundary_id = 2;
  inner_boundary_line_pt[0] = new TriangleMeshCurviLine(inner_circle_pt,
                                                        s_start,
                                                        s_end,
                                                        n_inner, // hierher
                                                        boundary_id);
  ...
  // Build "bulk" mesh
  Bulk_mesh_pt =
    new TriangleMesh<ELEMENT>(triangle_mesh_parameters, time_stepper_pt());
  ...
  bc_set.insert(4);
  bc_set.insert(5);
  for (std::set<unsigned>::iterator it = bc_set.begin(); it != bc_set.end();
       it++)
  {
    unsigned b = (*it);
  ...
  ofstream some_file;
  some_file.open(
    (GlobalParameters::Directory + std::string("/populated_bins.dat")).c_str());
  StefanBoltzmannHelper::doc_bins(some_file);
  some_file.close();

  // Doc the sample points used to assess visibility
  some_file.open(
    (GlobalParameters::Directory + std::string("/sample_points.dat")).c_str());
...
void StefanBoltzmannProblem<ELEMENT>::doc_solution(DocInfo &doc_info)
{
  ...
  //------------------------------------------------------------
  sprintf(filename,
          "%s/stefan_boltzmann_radiation%i.dat",
          doc_info.directory().c_str(),
          doc_info.number());
  some_file.open(filename);
  ...
  if (output_rays)
  {
    ...
    {
      sprintf(filename,
              "%s/stefan_boltzmann_rays%i_intpt%i.dat",
              doc_info.directory().c_str(),
              doc_info.number(),
              count);
      some_file.open(filename);
