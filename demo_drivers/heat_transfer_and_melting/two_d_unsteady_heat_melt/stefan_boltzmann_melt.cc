...
namespace GlobalParameters
{
  ...
  void get_source(const double& time, const Vector<double>& x, double& source)
  {
    ...
    if (r < 0.5 * (Radius_inner + Radius_innermost))
    {
      ...
      t0 =
        Beta0 *
          (2.0 * V0 + V0_hat * (1.0 + cos(2.0 * 0.3141592653589793E1 * t))) -
        Alpha0 *
          ((Radius_innermost -
            R_hat * (t - sin(2.0 * 0.3141592653589793E1 * t) /
                           0.3141592653589793E1 / 2.0)) *
             R_hat * (1.0 - cos(2.0 * 0.3141592653589793E1 * t)) *
             (V0 + V0_hat * (1.0 + cos(2.0 * 0.3141592653589793E1 * t)) / 2.0) -
           (r * r - pow(Radius_innermost -
                          R_hat * (t - sin(2.0 * 0.3141592653589793E1 * t) /
                                         0.3141592653589793E1 / 2.0),
                        2.0)) *
             V0_hat * sin(2.0 * 0.3141592653589793E1 * t) *
             0.3141592653589793E1 / 2.0);
    }
    else
    {
      ...
      MapleGenVar8 =
        -Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * V0_hat * t * t *
          Radius_inner / 2.0 +
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * V0_hat * t * t *
          Radius_outer / 2.0 +
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          R_hat * R_hat * V0 * t * Radius_inner -
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          R_hat * R_hat * V0 * t * Radius_outer +
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          R_hat * R_hat * V0_hat * t * Radius_inner / 2.0 -
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          R_hat * R_hat * V0_hat * t * Radius_outer / 2.0 -
        Beta0 * pow(sin(2.0 * 0.3141592653589793E1 * t), 2.0) * R_hat * R_hat *
          V0 * Radius_inner / 4.0 +
        Beta0 * pow(sin(2.0 * 0.3141592653589793E1 * t), 2.0) * R_hat * R_hat *
          V0 * Radius_outer / 4.0 -
        Beta0 * pow(sin(2.0 * 0.3141592653589793E1 * t), 2.0) * R_hat * R_hat *
          V0_hat * Radius_inner / 8.0 +
        Beta0 * pow(sin(2.0 * 0.3141592653589793E1 * t), 2.0) * R_hat * R_hat *
          V0_hat * Radius_outer / 8.0 -
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * V0 *
          Radius_inner * Radius_innermost * Radius_innermost +
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * V0 *
          Radius_outer * Radius_innermost * Radius_innermost;
      MapleGenVar9 =
        MapleGenVar8 -
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * V0_hat *
          Radius_inner * Radius_innermost * Radius_innermost / 2.0 +
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * V0_hat *
          Radius_outer * Radius_innermost * Radius_innermost / 2.0 -
        0.3141592653589793E1 * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * t *
          Radius_inner +
        0.3141592653589793E1 * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * t *
          Radius_outer +
        sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * Radius_inner /
          2.0 -
        sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * Radius_outer /
          2.0;
      MapleGenVar7 =
        MapleGenVar9 +
        0.3141592653589793E1 * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * Radius_inner *
          Radius_innermost -
        0.3141592653589793E1 * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * Radius_outer *
          Radius_innermost +
        0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat * t *
          Radius_inner -
        0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat * t *
          Radius_outer +
        Beta1 * 0.3141592653589793E1 * 0.3141592653589793E1 * Radius_inner *
          pow((Beta0 *
                 (Radius_innermost -
                  R_hat * (t - sin(2.0 * 0.3141592653589793E1 * t) /
                                 0.3141592653589793E1 / 2.0)) *
                 (V0 +
                  V0_hat * (1.0 + cos(2.0 * 0.3141592653589793E1 * t)) / 2.0) +
               R_hat * (1.0 - cos(2.0 * 0.3141592653589793E1 * t))) /
                  Sigma +
                pow(Theta_0 + U0, 4.0),
              0.25) -
        Beta1 * 0.3141592653589793E1 * 0.3141592653589793E1 * Radius_inner *
          Theta_0 -
        sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 * R_hat *
          R_hat * Radius_inner / 2.0;
      MapleGenVar9 =
        sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 * R_hat *
          R_hat * Radius_outer / 2.0 -
        0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * Radius_inner *
          Radius_innermost +
        0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * Radius_outer *
          Radius_innermost +
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * V0_hat * t *
          Radius_inner / 2.0 -
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * V0_hat * t *
          Radius_outer / 2.0 +
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * V0_hat * t *
          Radius_inner * Radius_innermost;
      MapleGenVar8 =
        MapleGenVar9 -
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * V0_hat * t *
          Radius_outer * Radius_innermost -
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * V0_hat * Radius_inner *
          Radius_innermost / 2.0 +
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * V0_hat * Radius_outer *
          Radius_innermost / 2.0 +
        MapleGenVar7 -
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat *
          V0 * t * t * Radius_inner +
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat *
          V0 * t * t * Radius_outer -
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat *
      ...
      MapleGenVar9 =
        MapleGenVar8 +
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat *
          V0_hat * t * t * Radius_outer / 2.0 -
        Beta0 * pow(sin(2.0 * 0.3141592653589793E1 * t), 2.0) *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * V0_hat *
          Radius_inner / 8.0 +
        Beta0 * pow(sin(2.0 * 0.3141592653589793E1 * t), 2.0) *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * V0_hat *
          Radius_outer / 8.0 -
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * V0_hat * Radius_inner *
          Radius_innermost * Radius_innermost / 2.0 +
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * V0_hat * Radius_outer *
          Radius_innermost * Radius_innermost / 2.0 +
        2.0 * Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * V0 *
          t * Radius_inner * Radius_innermost;
      MapleGenVar6 =
        MapleGenVar9 -
        2.0 * Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * V0 *
          t * Radius_outer * Radius_innermost +
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * V0_hat *
          t * Radius_inner * Radius_innermost -
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * V0_hat *
          t * Radius_outer * Radius_innermost -
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          R_hat * V0 * Radius_inner * Radius_innermost +
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          R_hat * V0 * Radius_outer * Radius_innermost -
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          R_hat * V0_hat * Radius_inner * Radius_innermost / 2.0 +
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          R_hat * V0_hat * Radius_outer * Radius_innermost / 2.0;
      MapleGenVar7 = 1 / (0.3141592653589793E1 * 0.3141592653589793E1) /
                     Radius_inner / Beta1;
        ...
        (pow(
          (Beta0 *
           ...
           R_hat * (1.0 - cos(2.0 * 0.3141592653589793E1 * t))) /
            ...
            pow(Theta_0 + U0, 4.0),
          0.75)) *
        (-Beta0 * R_hat * (1.0 - cos(2.0 * 0.3141592653589793E1 * t)) *
           (V0 + V0_hat * (1.0 + cos(2.0 * 0.3141592653589793E1 * t)) / 2.0) -
         Beta0 *
           (Radius_innermost -
            R_hat * (t - sin(2.0 * 0.3141592653589793E1 * t) /
                           0.3141592653589793E1 / 2.0)) *
           V0_hat * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 +
         2.0 * R_hat * sin(2.0 * 0.3141592653589793E1 * t) *
           0.3141592653589793E1) /
        Sigma / 4.0;
      MapleGenVar14 =
        pow(cos(2.0 * 0.3141592653589793E1 * t), 2.0) * 0.3141592653589793E1 *
          0.3141592653589793E1 * R_hat * R_hat * Radius_inner -
        pow(sin(2.0 * 0.3141592653589793E1 * t), 2.0) * 0.3141592653589793E1 *
          0.3141592653589793E1 * R_hat * R_hat * Radius_inner -
        pow(cos(2.0 * 0.3141592653589793E1 * t), 2.0) * 0.3141592653589793E1 *
          0.3141592653589793E1 * R_hat * R_hat * Radius_outer +
        pow(sin(2.0 * 0.3141592653589793E1 * t), 2.0) * 0.3141592653589793E1 *
          0.3141592653589793E1 * R_hat * R_hat * Radius_outer +
        0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat *
          Radius_inner -
        0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat *
          Radius_outer;
      MapleGenVar13 =
        MapleGenVar14 -
        2.0 * Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          0.3141592653589793E1 * sin(2.0 * 0.3141592653589793E1 * t) * R_hat *
          V0_hat * t * Radius_inner * Radius_innermost +
        2.0 * Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          0.3141592653589793E1 * sin(2.0 * 0.3141592653589793E1 * t) * R_hat *
          V0_hat * t * Radius_outer * Radius_innermost +
        Beta1 * 0.3141592653589793E1 * 0.3141592653589793E1 * Radius_inner /
          pow((Beta0 *
                 (Radius_innermost -
                  R_hat * (t - sin(2.0 * 0.3141592653589793E1 * t) /
          ...
          (-Beta0 * R_hat * (1.0 - cos(2.0 * 0.3141592653589793E1 * t)) *
           ...
           2.0 * R_hat * sin(2.0 * 0.3141592653589793E1 * t) *
             0.3141592653589793E1) /
          Sigma / 4.0 -
        2.0 * Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat *
          R_hat * V0 * t * Radius_inner +
        2.0 * Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat *
          R_hat * V0 * t * Radius_outer -
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat *
          V0_hat * t * Radius_inner;
      MapleGenVar12 =
        MapleGenVar13 +
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat *
          V0_hat * t * Radius_outer +
        Beta0 * pow(sin(2.0 * 0.3141592653589793E1 * t), 3.0) *
          0.3141592653589793E1 * R_hat * R_hat * V0_hat * Radius_inner / 4.0 -
        Beta0 * pow(sin(2.0 * 0.3141592653589793E1 * t), 3.0) *
          0.3141592653589793E1 * R_hat * R_hat * V0_hat * Radius_outer / 4.0 +
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          0.3141592653589793E1 * sin(2.0 * 0.3141592653589793E1 * t) * V0_hat *
          Radius_inner * Radius_innermost * Radius_innermost -
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          0.3141592653589793E1 * sin(2.0 * 0.3141592653589793E1 * t) * V0_hat *
          Radius_outer * Radius_innermost * Radius_innermost +
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          0.3141592653589793E1 * sin(2.0 * 0.3141592653589793E1 * t) * R_hat *
          R_hat * V0_hat * t * t * Radius_inner -
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          0.3141592653589793E1 * sin(2.0 * 0.3141592653589793E1 * t) * R_hat *
          R_hat * V0_hat * t * t * Radius_outer +
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          R_hat * R_hat * V0 * Radius_inner +
        2.0 * Beta0 * cos(2.0 * 0.3141592653589793E1 * t) *
          0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat * V0 * t *
          Radius_inner -
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          R_hat * R_hat * V0 * Radius_outer -
        2.0 * Beta0 * cos(2.0 * 0.3141592653589793E1 * t) *
          0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat * V0 * t *
          Radius_outer +
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
      ...
      MapleGenVar14 =
        MapleGenVar12 -
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          R_hat * R_hat * V0_hat * Radius_outer / 2.0 -
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * V0 *
          Radius_inner * cos(2.0 * 0.3141592653589793E1 * t) *
          0.3141592653589793E1 +
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * V0 *
          Radius_outer * cos(2.0 * 0.3141592653589793E1 * t) *
          0.3141592653589793E1 +
        Beta0 * pow(cos(2.0 * 0.3141592653589793E1 * t), 2.0) *
          0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat * V0_hat *
          t * Radius_inner -
        Beta0 * pow(sin(2.0 * 0.3141592653589793E1 * t), 2.0) *
          0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * R_hat * V0_hat *
          t * Radius_inner;
      MapleGenVar13 = MapleGenVar14 -
                      Beta0 * pow(cos(2.0 * 0.3141592653589793E1 * t), 2.0) *
                        0.3141592653589793E1 * 0.3141592653589793E1 * R_hat *
                        R_hat * V0_hat * t * Radius_outer +
                      Beta0 * pow(sin(2.0 * 0.3141592653589793E1 * t), 2.0) *
                        0.3141592653589793E1 * 0.3141592653589793E1 * R_hat *
                        R_hat * V0_hat * t * Radius_outer -
                      Beta0 * pow(cos(2.0 * 0.3141592653589793E1 * t), 2.0) *
                        0.3141592653589793E1 * 0.3141592653589793E1 * R_hat *
                        V0_hat * Radius_inner * Radius_innermost +
                      Beta0 * pow(sin(2.0 * 0.3141592653589793E1 * t), 2.0) *
                        0.3141592653589793E1 * 0.3141592653589793E1 * R_hat *
                        V0_hat * Radius_inner * Radius_innermost +
                      Beta0 * pow(cos(2.0 * 0.3141592653589793E1 * t), 2.0) *
                        0.3141592653589793E1 * 0.3141592653589793E1 * R_hat *
                        V0_hat * Radius_outer * Radius_innermost -
                      Beta0 * pow(sin(2.0 * 0.3141592653589793E1 * t), 2.0) *
                        0.3141592653589793E1 * 0.3141592653589793E1 * R_hat *
                        V0_hat * Radius_outer * Radius_innermost -
                      Beta0 * sin(2.0 * 0.3141592653589793E1 * t) *
                        pow(cos(2.0 * 0.3141592653589793E1 * t), 2.0) * R_hat *
                        R_hat * V0_hat * Radius_inner * 0.3141592653589793E1 /
                        2.0;
      MapleGenVar11 =
        MapleGenVar13 +
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) *
          pow(cos(2.0 * 0.3141592653589793E1 * t), 2.0) * R_hat * R_hat *
          V0_hat * Radius_outer * 0.3141592653589793E1 / 2.0 +
        2.0 * Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * V0 *
          Radius_inner * Radius_innermost -
        2.0 * Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * V0 *
          Radius_outer * Radius_innermost +
        ...
        Beta0 * 0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * V0_hat *
          Radius_outer * Radius_innermost -
        2.0 * Beta0 * cos(2.0 * 0.3141592653589793E1 * t) *
          0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * V0 *
          Radius_inner * Radius_innermost +
        2.0 * Beta0 * cos(2.0 * 0.3141592653589793E1 * t) *
          0.3141592653589793E1 * 0.3141592653589793E1 * R_hat * V0 *
          Radius_outer * Radius_innermost -
        2.0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * Radius_inner +
        2.0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          0.3141592653589793E1 * sin(2.0 * 0.3141592653589793E1 * t) * R_hat *
          R_hat * t * Radius_inner +
        2.0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          cos(2.0 * 0.3141592653589793E1 * t) * R_hat * R_hat * Radius_outer -
        2.0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          0.3141592653589793E1 * sin(2.0 * 0.3141592653589793E1 * t) * R_hat *
          R_hat * t * Radius_outer -
        2.0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
          0.3141592653589793E1 * sin(2.0 * 0.3141592653589793E1 * t) * R_hat *
          Radius_inner * Radius_innermost +
        2.0 * 0.3141592653589793E1 * 0.3141592653589793E1 *
                   ...
                   Vector<double>& u)
  {
    ...
    else
    {
      ...
      MapleGenVar7 =
        ...
        Beta0 * sin(2.0 * 0.3141592653589793E1 * t) * 0.3141592653589793E1 *
          R_hat * V0_hat * Radius_outer * Radius_innermost / 2.0;
      MapleGenVar8 = 1 / (0.3141592653589793E1 * 0.3141592653589793E1) /
                     Radius_inner / Beta1;
      MapleGenVar6 = MapleGenVar7 * MapleGenVar8;
      MapleGenVar7 =
        -pow(
  ...
  double incoming_sb_inside(const double& t)
  {
    ...
    t0 =
      Sigma *
      ((Beta0 *
          (Radius_innermost - R_hat * (t - sin(2.0 * 0.3141592653589793E1 * t) /
                                             0.3141592653589793E1 / 2.0)) *
          (V0 + V0_hat * (1.0 + cos(2.0 * 0.3141592653589793E1 * t)) / 2.0) +
        R_hat * (1.0 - cos(2.0 * 0.3141592653589793E1 * t))) /
         Sigma +
...
public:
  ...
  void create_melt_elements()
  {
    ...
    oomph_info << "Pinning vertical   displacement at " << x_min_node_pt->x(0)
               << " " << x_min_node_pt->x(1) << std::endl;
    x_min_node_pt->pin_position(1);
    oomph_info << "Pinning vertical   displacement at " << x_max_node_pt->x(0)
               << " " << x_max_node_pt->x(1) << std::endl;
    x_max_node_pt->pin_position(1);
    oomph_info << "Pinning horizontal displacement at " << y_max_node_pt->x(0)
...
StefanBoltzmannProblem<ELEMENT>::StefanBoltzmannProblem()
{
  ...
  unsigned n_inner =
    unsigned(GlobalParameters::Radius_inner /
             GlobalParameters::Radius_innermost * double(n_innermost));
  unsigned n_outer = 20;
  ...
  boundary_id = 2;
  inner_boundary_line_pt[0] = new TriangleMeshCurviLine(
  ...
  boundary_id = 3;
  inner_boundary_line_pt[1] = new TriangleMeshCurviLine(
    inner_circle_pt, s_start, s_end, n_inner, boundary_id);
  ...
  internal_closed_curve_pt.push_back(
    new TriangleMeshClosedCurve(inner_boundary_line_pt, hole_coords));
  ...
  boundary_id = 4;
  central_boundary_line_pt[0] = new TriangleMeshCurviLine(
    central_circle_pt, s_start, s_end, n_innermost, boundary_id);

  // The intrinsic coordinates for the beginning and end of the curve
  s_start = MathematicalConstants::Pi;
  s_end = 2.0 * MathematicalConstants::Pi;
  boundary_id = 5;
  central_boundary_line_pt[1] = new TriangleMeshCurviLine(
    central_circle_pt, s_start, s_end, n_innermost, boundary_id);
  ...
  outer_annulus_region_coord[1] =
    0.5 * (GlobalParameters::Radius_inner + GlobalParameters::Radius_outer);
  triangle_mesh_parameters.add_region_coordinates(1,
                                                  outer_annulus_region_coord);
  ...
  for (unsigned e = 0; e < nel; e++)
  {
    ...
    el_pt->constitutive_law_pt() = GlobalParameters::Constitutive_law_pt;
...
void StefanBoltzmannProblem<ELEMENT>::doc_solution()
{
  ...
  // Output rays
  sprintf(filename,
          "%s/stefan_boltzmann_rays_left%i.dat",
          Doc_info.directory().c_str(),
          Doc_info.number());
  some_file.open(filename);
  Leftmost_outer_el_pt->output_stefan_boltzmann_radiation_rays(
    some_file, Ipt_leftmost_outer);
  some_file.close();

  // Output rays
  sprintf(filename,
          "%s/stefan_boltzmann_rays_right%i.dat",
          Doc_info.directory().c_str(),
          Doc_info.number());
  some_file.open(filename);
  Rightmost_inner_el_pt->output_stefan_boltzmann_radiation_rays(
    some_file, Ipt_rightmost_inner);
  some_file.close();
  ...
  //--------------------------------------
  sprintf(
    filename, "%s/flux%i.dat", Doc_info.directory().c_str(), Doc_info.number());
  some_file.open(filename);
    ...
    GlobalParameters::incoming_sb_inside(time_pt()->time());
  {
    ...
    for (unsigned e = 0; e < nel; e++)
    {
      ...
      for (unsigned ipt = 0; ipt < nintpt; ipt++)
      {
        ...
        double my_rate =
          el_pt->incoming_stefan_boltzmann_radiation(ipt, x, unit_normal);
  ...
  double melt_exact = GlobalParameters::melt_flux(time_pt()->time());
  {
    ...
    oomph_info << "Average melt rate: " << av_melt << " ; exact: " << melt_exact
               << " ; abs difference: " << fabs(melt_exact - av_melt);
    if (std::max(melt_exact, av_melt) != 0)
    {
      oomph_info << " ; rel difference: "
                 << fabs(melt_exact - av_melt) /
                      double(std::max(melt_exact, av_melt)) * 100.0
                 << " % ";
    }
    oomph_info << std::endl;
  }
  ...
  for (unsigned e = 0; e < nel; e++)
  {
    ...
    for (unsigned j = 0; j < nnod; j++)
    {
      ...
      if (!done[nod_pt])
      {
        ...
        count++;
        av_radius +=
          sqrt(nod_pt->x(0) * nod_pt->x(0) + nod_pt->x(1) * nod_pt->x(1));
      }
    }
  }
  av_radius /= double(count);

  Trace_file << time_pt()->time() << " " << av_radius << " "
             << GlobalParameters::radius(time_pt()->time()) << " "
             << av_inc_outer << " " << inc_outer_exact << " " << av_inc_inner
             << " " << inc_inner_exact << " " << av_melt << " " << melt_exact
             << " ";
  ...
  Bulk_mesh_pt->output_fct(
    some_file, npts, time_pt()->time(), GlobalParameters::get_exact_u);
  some_file.close();
  ...
  Bulk_mesh_pt->compute_error(
    some_file, GlobalParameters::get_exact_u, time_pt()->time(), error, norm);
  some_file.close();
...
int main(int argc, char** argv)
{
  ...
  StefanBoltzmannProblem<ProjectableUnsteadyHeatElement<
