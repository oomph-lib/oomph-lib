...
namespace oomph
{
  ...
  public:
    ...
    /// \short Generalised output function to include stefan boltzmann
    /// information: temperature, total incoming flux, incoming s.b. flux,
    /// outgoing s.b. flux, outer unit normal. Note that total incoming flux is
