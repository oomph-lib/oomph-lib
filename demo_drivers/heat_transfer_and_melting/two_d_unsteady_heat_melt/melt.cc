...
public:
  ...
  void actions_before_adapt()
  {
    ...
    Backed_up_surface_melt_mesh_pt =
      new BackupMeshForProjection<TElement<1, 3>>(Surface_melt_mesh_pt,
                                                  Melt_boundary_id);
  ...
  void actions_after_adapt()
  {
    ...
    Backed_up_surface_melt_mesh_pt->project_onto_new_mesh(Surface_melt_mesh_pt);
  ...
  void create_flux_elements()
  {
    ...
    for (unsigned e = 0; e < n_element; e++)
    {
      ...
      SurfaceMeltElement<ELEMENT>* flux_element_pt =
        new SurfaceMeltElement<ELEMENT>(bulk_elem_pt, face_index);
...
UnsteadyHeatMeltProblem<ELEMENT>::UnsteadyHeatMeltProblem()
{
  ...
  boundary_polyline_pt[3] =
    new TriangleMeshPolyLine(bound_coords, Melt_boundary_id);
...
int main(int argc, char* argv[])
{
  ...
  // Build problem
  UnsteadyHeatMeltProblem<ProjectableUnsteadyHeatElement<
