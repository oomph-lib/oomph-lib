...
namespace oomph
{
  ...
  public:
    ...
    virtual inline unsigned u_index_biharmonic() const
    {
...
namespace oomph
{
                                          ...
                                          const unsigned& flag)
  {
    ...
    for (unsigned ipt = 0; ipt < n_intpt; ipt++)
    {
      ...
      // Call the derivatives of the shape and test functions for normal
      // direction
        ...
        for (unsigned k = 0; k < n_position_type; k++)
        {
          ...
          if (local_eqn >= 0)
          {
            ...
            residuals[local_eqn] +=
              ...
              interpolated_d2udxi(0, 1) * d2psidxi(l, k, 0) * W +
              interpolated_d2udxi(0, 0) * d2psidxi(l, k, 1) * W;
                ...
                for (unsigned k2 = 0; k2 < n_position_type; k2++)
                {
                  ...
                  if (local_unknown >= 0)
                  {
                    ...
                    jacobian(local_eqn, local_unknown) +=
                      ...
                      2.0 * d2psidxi(l2, k2, 1) * d2psidxi(l, k, 0) * W;
                  }
                }
              }
            } // End of flag
  ...
  Source_fct_pt(source_fct_pt)
{
  ...
  Problem::mesh_pt() =
    new SimpleRectangularTriMesh<ELEMENT>(Physical_Variables::n_x,
                                          Physical_Variables::n_y,
                                          Physical_Variables::l_x,
                                          Physical_Variables::l_y);
...
//========================================================================
template<class ELEMENT, unsigned DIM, unsigned NNODE_1D>
void MyBiharmonicBellProblem<ELEMENT, DIM, NNODE_1D>::
...
//========================================================================
template<class ELEMENT, unsigned DIM, unsigned NNODE_1D>
void MyBiharmonicBellProblem<ELEMENT, DIM, NNODE_1D>::doc_solution(
  DocInfo& doc_info)
{
  ofstream some_file;
  char filename[100];
...
int main()
{
  ...
  MyBiharmonicBellProblem<BiharmonicBellElement<2, 2>,
                          2,
