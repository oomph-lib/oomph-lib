...
if test "$2" = "no_fpdiff"; then
  ...
  # Compare results
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/linear_elasticity_simple_prec_results.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  # Compare results
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/multi_poisson_simple_prec_results.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  # Compare results
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/multi_poisson_two_plus_three_prec_results.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  # Compare results
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/multi_poisson_two_plus_three_upper_triangular_prec_results.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  # Compare results
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/multi_poisson_two_plus_three_upper_triangular_with_sub_prec_results.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/DenseLU_results.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/results_Pe200.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/SuperLU_solve_error.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  #Compare number of iterations against reference data and append
  $OOMPH_ROOT_DIR/scripts/compare_file_length_with_tolerance.bash GMRES_convergence.dat \
    ../validata/GMRES_convergence.dat $threshold_for_number_of_iterations \
    >>validation.log

  #Compare number of iterations against reference data and append
  $OOMPH_ROOT_DIR/scripts/compare_file_length_with_tolerance.bash GMRES_la_solve_convergence.dat \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/GMRES_solve_error.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/BiCGStab_solve_error.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  #Compare number of iterations against reference data and append
  $OOMPH_ROOT_DIR/scripts/compare_file_length_with_tolerance.bash CG_convergence.dat \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/results_Pe0.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/CG_solve_error.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  #Compare number of iterations against reference data and append
  $OOMPH_ROOT_DIR/scripts/compare_file_length_with_tolerance.bash GS_convergence.dat \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/GS_solve_error.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  #Compare number of iterations against reference data and append
  $OOMPH_ROOT_DIR/scripts/compare_file_length_with_tolerance.bash DampedJacobi_convergence.dat \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/DampedJacobi_solve_error.dat.gz \
...
if [ -f ../HypreSolver_test ]; then
  ...
  if test "$2" = "no_fpdiff"; then
    ...
    echo "Solver/preconditioner combination 0" >>validation.log
    $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/Hypre_result.dat.gz \
      RESLT/soln0.dat >>validation.log
    echo "Solver/preconditioner combination 1" >>validation.log
    $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/Hypre_result.dat.gz \
      RESLT/soln1.dat >>validation.log
    ...
    $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/Hypre_conv.dat.gz \
      RESLT/conv.dat >>validation.log
  fi
