...
void OneDPoissonProblem<ELEMENT>::doc_solution(DocInfo& doc)
{
  ...
  sprintf(filename, "%s/soln%i.dat", doc.directory().c_str(), doc.number());
  ...
  sprintf(
    filename, "%s/exact_soln%i.dat", doc.directory().c_str(), doc.number());
  some_file.open(filename);
...
int main(int argc, char** argv)
{
  ...
  // PROBLEM BASED SOLVE
  {
    oomph_info << "////////////////////////////////////////////////////////////"
                  "///////////"
               << std::endl;
    oomph_info << "TESTING: DenseLU problem based solve" << std::endl;
    oomph_info << "////////////////////////////////////////////////////////////"
                  "///////////"
               << std::endl
               << std::endl;
  ...
  // PROBLEM BASED SOLVE
  {
    oomph_info << "////////////////////////////////////////////////////////////"
                  "///////////"
               << std::endl;
    oomph_info << "TESTING: FD_LU problem based solve" << std::endl;
    oomph_info << "////////////////////////////////////////////////////////////"
                  "///////////"
               << std::endl
               << std::endl;
  ...
  // MATRIX BASED SOLVE / CRDoubleMatrix (global)
  {
    ...
    OneDPoissonProblem<QPoissonElement<1, 4>> problem(
      n_element, FishSolnOneDPoisson::source_function);
    unsigned ndof = problem.ndof();
    LinearAlgebraDistribution global_dist(
      problem.communicator_pt(), ndof, false);
  ...
  // PROBLEM BASED SOLVE
  {
    oomph_info << "////////////////////////////////////////////////////////////"
                  "///////////"
               << std::endl;
    oomph_info << "TESTING: SuperLU problem based solve" << std::endl;
    oomph_info << "////////////////////////////////////////////////////////////"
                  "///////////"
               << std::endl
               << std::endl;
