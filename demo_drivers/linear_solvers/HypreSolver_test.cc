...
int main(int argc, char** argv)
{
  ...
  PoissonProblem<RefineableQPoissonElement<2, 2>> problem(
  ...
  for (unsigned s = 0; s <= 3; s++)
  {
    ...
    switch (s)
    {
      ...
      case 3:
        ...
        break;
      default:
        cout << "Error selecting solver" << endl;
    }
    ...
    for (unsigned p = 0; p < tests; p++)
    {
      ...
      switch (p)
      {
        case 0:
          ...
          break;
        case 1:
          hypre_linear_solver_pt->internal_preconditioner() =
            HypreSolver::BoomerAMG;
          break;
        case 2:
          hypre_linear_solver_pt->internal_preconditioner() =
            HypreSolver::Euclid;
        ...
        case 3:
          hypre_linear_solver_pt->internal_preconditioner() =
            HypreSolver::ParaSails;
          break;
        default:
          cout << "Error selecting preconditioner" << endl;
      }
