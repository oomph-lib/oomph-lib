...
namespace oomph
{
  ...
  double HomogenisedLinearElasticityEquationsBase::Default_lambda_sq_value =
    1.0;
      ...
      Vector<double>& residuals, DenseMatrix<double>& jacobian, unsigned flag)
  {
    ...
    {
      throw OomphLibError("HomogenisedLinearElasticity is not yet implemented "
            ...
            for (unsigned b = 0; b < DIM; b++)
            {
              for (unsigned c = 0; c < 3; c++)
              {
                for (unsigned d = 0; d < DIM; d++)
                {
                  ...
                  residuals[local_eqn] += (*E_pt)(a, b, c, d) *
                    ...
                    for (unsigned b = 0; b < DIM; b++)
                    {
                      for (unsigned d = 0; d < DIM; d++)
                      {
                        ...
                        jacobian(local_eqn, local_unknown) +=
                          (*E_pt)(a, b, c2, d) * dpsidx(l2, d) * dpsidx(l, b) *
                          W;
                      }
                    }
      ...
      for (unsigned a = 0; a < 3; a++)
      {
        ...
        for (unsigned b = 0; b < 3; b++)
        {
          for (unsigned c = 0; c < 3; c++)
          {
            ...
            {
              // Add the stress terms to the residuals
              H(a, b) += (*E_pt)(a, b, c, d) * interpolated_dudx(c, d) * W;
            }
          }
          // Add the additional term
