...
/// \short Boolean to indicate if we're using a fixed point iteration for
/// the strain rate that forms the basis for the invariant
bool Use_fixed_point_for_strain_rate;

/// \short Boolean to indicate whether we use Aitken extrapolation
/// during the fixed point iterations
bool Use_aitken_extrapolation;


public:
/// \short Constructor initialise error and set default for number of
...
MyTaylorHoodElement()
{
  ...
  for (unsigned val = 0; val < fp_n_val; val++)
  {
    ...
    {
      Fixed_point_iteration_guess_for_strain_rate[val][ipt].resize(
        el_dim, el_dim, 0.0);
    }
  }
...
/// \short Enable use of fixed point iteration (sets
...
/// \short Enable use of Aitken extrapolation
  ...
  const unsigned& ipt, DenseMatrix<double>& strainrate) const
{
  for (unsigned i = 0; i < el_dim; i++)
  {
    ...
    {
      strainrate(i, j) =
        Fixed_point_iteration_guess_for_strain_rate[Aitken_index - 1][ipt](i,
                                                                           j);
    }
  }
}
...
/// \short Update latest guess (obtained via fixed point iteration)
                              ...
                              DenseMatrix<double>& strainrate) const
{
  ...
  if ((strainrate.ncol() != 2) || (strainrate.nrow() != 2))
  {
    ...
    error_message << "The strain rate has incorrect dimensions "
                  << strainrate.ncol() << " x " << strainrate.nrow() << " Not 2"
                  << std::endl;
    ...
    case 4:
    {
      ...
      for (unsigned i = 0; i < el_dim; i++)
      {
        for (unsigned j = 0; j < el_dim; j++)
        {
          ...
          MapleGenVar2 = -1.0;
          MapleGenVar7 =
            dt * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_2 * u_minus_four -
            dt * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_2 *
              u_minus_three -
            dt * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_3 *
              u_minus_three +
            dt * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_3 * u_minus_two +
            dt * dt * dt * dt_minus_1 * dt_minus_2 * dt_minus_2 * u_minus_four -
            dt * dt * dt * dt_minus_1 * dt_minus_2 * dt_minus_2 *
              u_minus_three -
            2.0 * dt * dt * dt * dt_minus_1 * dt_minus_2 * dt_minus_3 *
              u_minus_three +
            2.0 * dt * dt * dt * dt_minus_1 * dt_minus_2 * dt_minus_3 *
              u_minus_two -
            dt * dt * dt * dt_minus_1 * dt_minus_3 * dt_minus_3 *
              u_minus_three +
            dt * dt * dt * dt_minus_1 * dt_minus_3 * dt_minus_3 * u_minus_two;
          MapleGenVar6 =
            -dt * dt * dt * dt_minus_2 * dt_minus_2 * dt_minus_3 * u_minus_one +
            dt * dt * dt * dt_minus_2 * dt_minus_2 * dt_minus_3 * u_minus_two -
            dt * dt * dt * dt_minus_2 * dt_minus_3 * dt_minus_3 * u_minus_one +
            dt * dt * dt * dt_minus_2 * dt_minus_3 * dt_minus_3 * u_minus_two +
            2.0 * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_1 * dt_minus_2 *
              u_minus_four -
            2.0 * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_1 * dt_minus_2 *
              u_minus_three -
            2.0 * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_1 * dt_minus_3 *
              u_minus_three +
            2.0 * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_1 * dt_minus_3 *
              u_minus_two +
            3.0 * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_2 * dt_minus_2 *
              u_minus_four -
            3.0 * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_2 * dt_minus_2 *
              u_minus_three +
            MapleGenVar7;
          MapleGenVar7 = -6.0 * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_3 * u_minus_three +
                         6.0 * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_3 * u_minus_two -
                         3.0 * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_3 *
                           dt_minus_3 * u_minus_three +
                         3.0 * dt * dt * dt_minus_1 * dt_minus_1 * dt_minus_3 *
                           dt_minus_3 * u_minus_two +
                         dt * dt * dt_minus_1 * dt_minus_2 * dt_minus_2 *
                           dt_minus_2 * u_minus_four -
                         dt * dt * dt_minus_1 * dt_minus_2 * dt_minus_2 *
                           dt_minus_2 * u_minus_three -
                         3.0 * dt * dt * dt_minus_1 * dt_minus_2 * dt_minus_2 *
                           dt_minus_3 * u_minus_one -
                         3.0 * dt * dt * dt_minus_1 * dt_minus_2 * dt_minus_2 *
                           dt_minus_3 * u_minus_three +
                         6.0 * dt * dt * dt_minus_1 * dt_minus_2 * dt_minus_2 *
                           dt_minus_3 * u_minus_two -
                         3.0 * dt * dt * dt_minus_1 * dt_minus_2 * dt_minus_3 *
                           dt_minus_3 * u_minus_one;
          MapleGenVar5 = -3.0 * dt * dt * dt_minus_1 * dt_minus_2 * dt_minus_3 *
                           dt_minus_3 * u_minus_three +
                         6.0 * dt * dt * dt_minus_1 * dt_minus_2 * dt_minus_3 *
                           dt_minus_3 * u_minus_two -
                         dt * dt * dt_minus_1 * dt_minus_3 * dt_minus_3 *
                           dt_minus_3 * u_minus_three +
                         dt * dt * dt_minus_1 * dt_minus_3 * dt_minus_3 *
                           dt_minus_3 * u_minus_two -
                         2.0 * dt * dt * dt_minus_2 * dt_minus_2 * dt_minus_2 *
                           dt_minus_3 * u_minus_one +
                         2.0 * dt * dt * dt_minus_2 * dt_minus_2 * dt_minus_2 *
                           dt_minus_3 * u_minus_two -
                         3.0 * dt * dt * dt_minus_2 * dt_minus_2 * dt_minus_3 *
                           dt_minus_3 * u_minus_one +
                         3.0 * dt * dt * dt_minus_2 * dt_minus_2 * dt_minus_3 *
                           dt_minus_3 * u_minus_two -
                         dt * dt * dt_minus_2 * dt_minus_3 * dt_minus_3 *
                           dt_minus_3 * u_minus_one +
                         dt * dt * dt_minus_2 * dt_minus_3 * dt_minus_3 *
                           dt_minus_3 * u_minus_two +
                         MapleGenVar6 + MapleGenVar7;
          MapleGenVar7 = dt * dt_minus_1 * dt_minus_1 * dt_minus_1 *
                           dt_minus_1 * dt_minus_2 * u_minus_four -
                         dt * dt_minus_1 * dt_minus_1 * dt_minus_1 *
                           dt_minus_1 * dt_minus_2 * u_minus_three -
                         dt * dt_minus_1 * dt_minus_1 * dt_minus_1 *
                           dt_minus_1 * dt_minus_3 * u_minus_three +
                         dt * dt_minus_1 * dt_minus_1 * dt_minus_1 *
                           dt_minus_1 * dt_minus_3 * u_minus_two +
                         2.0 * dt * dt_minus_1 * dt_minus_1 * dt_minus_1 *
                           dt_minus_2 * dt_minus_2 * u_minus_four -
                         2.0 * dt * dt_minus_1 * dt_minus_1 * dt_minus_1 *
                           dt_minus_2 * dt_minus_2 * u_minus_three -
                         4.0 * dt * dt_minus_1 * dt_minus_1 * dt_minus_1 *
                           dt_minus_2 * dt_minus_3 * u_minus_three +
                         4.0 * dt * dt_minus_1 * dt_minus_1 * dt_minus_1 *
                           dt_minus_2 * dt_minus_3 * u_minus_two -
                         2.0 * dt * dt_minus_1 * dt_minus_1 * dt_minus_1 *
                           dt_minus_3 * dt_minus_3 * u_minus_three +
                         2.0 * dt * dt_minus_1 * dt_minus_1 * dt_minus_1 *
                           dt_minus_3 * dt_minus_3 * u_minus_two;
          MapleGenVar6 = dt * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_2 * dt_minus_2 * u_minus_four -
                         dt * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_2 * dt_minus_2 * u_minus_three -
                         3.0 * dt * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_2 * dt_minus_3 * u_minus_one -
                         3.0 * dt * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_2 * dt_minus_3 * u_minus_three +
                         6.0 * dt * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_2 * dt_minus_3 * u_minus_two -
                         3.0 * dt * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_3 * dt_minus_3 * u_minus_one -
                         3.0 * dt * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_3 * dt_minus_3 * u_minus_three +
                         6.0 * dt * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_3 * dt_minus_3 * u_minus_two -
                         dt * dt_minus_1 * dt_minus_1 * dt_minus_3 *
                           dt_minus_3 * dt_minus_3 * u_minus_three +
                         dt * dt_minus_1 * dt_minus_1 * dt_minus_3 *
                           dt_minus_3 * dt_minus_3 * u_minus_two +
                         MapleGenVar7;
          MapleGenVar7 = -4.0 * dt * dt_minus_1 * dt_minus_2 * dt_minus_2 *
                           dt_minus_2 * dt_minus_3 * u_minus_one +
                         4.0 * dt * dt_minus_1 * dt_minus_2 * dt_minus_2 *
                           dt_minus_2 * dt_minus_3 * u_minus_two -
                         6.0 * dt * dt_minus_1 * dt_minus_2 * dt_minus_2 *
                           dt_minus_3 * dt_minus_3 * u_minus_one +
                         6.0 * dt * dt_minus_1 * dt_minus_2 * dt_minus_2 *
                           dt_minus_3 * dt_minus_3 * u_minus_two -
                         2.0 * dt * dt_minus_1 * dt_minus_2 * dt_minus_3 *
                           dt_minus_3 * dt_minus_3 * u_minus_one +
                         2.0 * dt * dt_minus_1 * dt_minus_2 * dt_minus_3 *
                           dt_minus_3 * dt_minus_3 * u_minus_two -
                         dt * dt_minus_2 * dt_minus_2 * dt_minus_2 *
                           dt_minus_2 * dt_minus_3 * u_minus_one +
                         dt * dt_minus_2 * dt_minus_2 * dt_minus_2 *
                           dt_minus_2 * dt_minus_3 * u_minus_two -
                         2.0 * dt * dt_minus_2 * dt_minus_2 * dt_minus_2 *
                           dt_minus_3 * dt_minus_3 * u_minus_one +
                         2.0 * dt * dt_minus_2 * dt_minus_2 * dt_minus_2 *
                           dt_minus_3 * dt_minus_3 * u_minus_two -
                         dt * dt_minus_2 * dt_minus_2 * dt_minus_3 *
                           dt_minus_3 * dt_minus_3 * u_minus_one;
          MapleGenVar4 = dt * dt_minus_2 * dt_minus_2 * dt_minus_3 *
                           dt_minus_3 * dt_minus_3 * u_minus_two -
                         dt_minus_1 * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_2 * dt_minus_3 * u_minus_one -
                         dt_minus_1 * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_3 * dt_minus_3 * u_minus_one -
                         2.0 * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_2 * dt_minus_2 * dt_minus_3 * u_minus_one -
                         3.0 * dt_minus_1 * dt_minus_1 * dt_minus_2 *
                           dt_minus_2 * dt_minus_3 * dt_minus_3 * u_minus_one -
                         dt_minus_1 * dt_minus_1 * dt_minus_2 * dt_minus_3 *
                           dt_minus_3 * dt_minus_3 * u_minus_one -
                         dt_minus_1 * dt_minus_2 * dt_minus_2 * dt_minus_2 *
                           dt_minus_2 * dt_minus_3 * u_minus_one -
                         2.0 * dt_minus_1 * dt_minus_2 * dt_minus_2 *
                           dt_minus_2 * dt_minus_3 * dt_minus_3 * u_minus_one -
                         dt_minus_1 * dt_minus_2 * dt_minus_2 * dt_minus_3 *
                           dt_minus_3 * dt_minus_3 * u_minus_one +
          ...
          MapleGenVar2 = 1 / dt_minus_2 / dt_minus_3 /
                         (dt_minus_1 * dt_minus_1 * dt_minus_2 +
                          dt_minus_1 * dt_minus_1 * dt_minus_3 +
                          2.0 * dt_minus_1 * dt_minus_2 * dt_minus_2 +
                          3.0 * dt_minus_1 * dt_minus_2 * dt_minus_3 +
                          dt_minus_1 * dt_minus_3 * dt_minus_3 +
                          dt_minus_2 * dt_minus_2 * dt_minus_2 +
                          2.0 * dt_minus_2 * dt_minus_2 * dt_minus_3 +
                          dt_minus_2 * dt_minus_3 * dt_minus_3);
...
void output(std::ostream& outfile, const unsigned& nplot)
{
  ...
  for (unsigned iplot = 0; iplot < num_plot_points; iplot++)
  {
    ...
    double viscosity =
      this->Constitutive_eqn_pt->viscosity(second_invariant_strain_extrapol);
...
void get_Z2_flux(const Vector<double>& s, Vector<double>& flux)
{
  ...
  // get viscosity
  double viscosity =
    this->Constitutive_eqn_pt->viscosity(second_invariant_strain);
  ...
  for (unsigned i = 0; i < el_dim; i++)
  {
    ...
    // hierher: This does the right thing but triangle can't handle the
    // refinement properly. Mesh seems ok though. MH will investigate triangle
    // mesh adaptation separately.
                                          ...
                                          double& error_norm_squared)
{
  ...
  for (unsigned ipt = 0; ipt < n_intpt; ipt++)
  {
    ...
    // Assemble norms
    norm_squared += invariant * invariant * W;
    extrapolated_norm_squared +=
      extrapolated_invariant * extrapolated_invariant * W;
    error_norm_squared += (extrapolated_invariant - invariant) *
                                   ...
                                   double& error_norm_squared)
{
  ...
  for (unsigned ipt = 0; ipt < n_intpt; ipt++)
  {
    ...
    // Assemble norms
    norm_squared += viscosity * viscosity * W;
    extrapolated_norm_squared +=
      extrapolated_viscosity * extrapolated_viscosity * W;
    error_norm_squared += (extrapolated_viscosity - viscosity) *
                                     ...
                                     double& error_norm_squared)
{
  ...
  for (unsigned ipt = 0; ipt < n_intpt; ipt++)
  {
    ...
    latest_fixed_point_iteration_guess_for_strain_rate(ipt,
                                                       latest_guess_strainrate);
    ...
    error_norm_squared += (latest_guess_invariant - invariant) *
