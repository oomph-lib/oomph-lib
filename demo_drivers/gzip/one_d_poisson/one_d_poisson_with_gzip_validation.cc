...
public:
  ...
  /// Doc the solution
  void doc_solution(const std::string& output_file);
...
//========================================================================
template<class ELEMENT>
void OneDPoissonProblem<ELEMENT>::doc_solution(const std::string& output_file)
{
  // Number of plot points
  unsigned n_plot_point = 5;

  // Output solution with specified number of plot points per element
  std::ofstream solution_file(output_file, std::ios_base::app);
  mesh_pt()->output(solution_file, n_plot_point);
  solution_file.close();
} // end of doc
...
int main()
{
  ...
  // Run fpdiff and append results to log_file
  int test_status = fpdiff(output_file, reference_data, log_file);
