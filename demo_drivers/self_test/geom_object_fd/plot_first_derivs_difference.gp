...
#
# It is used for the first derivative. The corresponding section of the code 
...
stats "build/RESLT/first_derivs_difference.dat" nooutput
n = STATS_columns
...
plot for [i=0:(n-3)/2] \
    "build/RESLT/first_derivs_difference.dat" \
