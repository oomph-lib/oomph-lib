...
public:
 ...
 FSIRingProblem(const unsigned &nelement_wall,
                ...
                const double& pcos_duration, const unsigned& i_case);
...
void FSIRingProblem::doc_solution(const unsigned& i,
  DocInfo& doc_info, ofstream& trace_file, const unsigned& i_case)
{ 
 ...
 for (unsigned i_case=0;i_case<5;i_case++)
  {
   ...
   //Set up the problem
   FSIRingProblem problem(nelem,eps_ampl,pcos_initial,pcos_duration,i_case);
