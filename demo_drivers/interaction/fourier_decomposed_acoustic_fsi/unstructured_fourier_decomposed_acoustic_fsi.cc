...
//======================================================================
template<class ELASTICITY_ELEMENT, class HELMHOLTZ_ELEMENT>
CoatedSphereProblem<ELASTICITY_ELEMENT,
                    HELMHOLTZ_ELEMENT>::CoatedSphereProblem()
{
  // Solid mesh
  //-----------
  {
  ...
  //---------------
  {
    ...
    // Build the mesh
    Helmholtz_mesh_pt =
      new RefineableTriangleMesh<HELMHOLTZ_ELEMENT>(triangle_mesh_parameters);

#else

    // Build the mesh
    Helmholtz_mesh_pt =
      new TriangleMesh<HELMHOLTZ_ELEMENT>(triangle_mesh_parameters);
...
//========================================================================
template<class ELASTICITY_ELEMENT, class HELMHOLTZ_ELEMENT>
void CoatedSphereProblem<ELASTICITY_ELEMENT,
...
template<class ELASTICITY_ELEMENT, class HELMHOLTZ_ELEMENT>
void CoatedSphereProblem<ELASTICITY_ELEMENT,
                         HELMHOLTZ_ELEMENT>::create_helmholtz_DtN_elements()
{
  // Outer boundary:
  ...
  DocInfo& doc_info)
{
  ...
  oomph_info << "Solid wavenumber : Omega_sq = "
             << Global_Parameters::Omega_sq[1] << std::endl
             << std::endl;
  ...
  Trace_file << Global_Parameters::Q << " " << Global_Parameters::K_squared
             ...
             << Global_Parameters::Omega_sq[1].real() << " " << power << " "
             << std::endl;
