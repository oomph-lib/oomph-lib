...
public:
 ...
 WallMesh(const double& r_min, const double& r_max, const double& lz,
  ...
  : RefineableSimpleCubicMesh<ELEMENT>(nx,ny,nz,1.0,1.0,lz,time_stepper_pt)
  {
   // move the nodes
...
namespace Global_Parameters
{
 ...
 /// Uniform pressure on the normal to the wall
 double P = 2.0e-4;
...
public:
 ...
 /// Actions after Newton step empty
 ...
 /// Bulk fluid mesh
 Mesh* fluid_mesh_pt() { return Fluid_mesh_pt; }
 ...
 /// Do some manual refinement of fluid and solid meshes
 void manual_refine();
...
PseudoElasticCollapsibleChannelProblem()
{
 ...
 Fluid_mesh_pt =  new FluidMesh<FLUID_ELEMENT>
  (Wall_pt,xi_lo,frac_mid,xi_hi,Global_Parameters::N,
 ...
 Solid_mesh_pt = new WallMesh<SOLID_ELEMENT>
  (1.0,1.0+Global_Parameters::W,Global_Parameters::L,
   2,2,unsigned(1.5*double(Global_Parameters::N)),Wall_time_stepper_pt);
...
{ 
 ...
 // hierher shouldn't matter
 //Lagrange_multiplier_mesh_pt->assign_initial_values_impulsive();
...
create_fsi_traction_elements()
{
 // boundary 4 is the is the fsi boundary
 unsigned b=4;
 ...
 for(unsigned e=0;e<n_element;e++)
  {
   ...
   RefineableFSISolidTractionElement<SOLID_ELEMENT,3>* el_pt=
    new RefineableFSISolidTractionElement<SOLID_ELEMENT,3>(bulk_elem_pt,face_index);
 ...
 for(unsigned e=0;e<n_element;e++)
  {
   ...
   RefineableSolidTractionElement<SOLID_ELEMENT>* el_pt = 
    new RefineableSolidTractionElement<SOLID_ELEMENT>(bulk_elem_pt,face_index);   
 ...
 for(unsigned e=0;e<n_element;e++)
  {
   ...
   // Create new element
   RefineableImposeDisplacementByLagrangeMultiplierElement<FLUID_ELEMENT>* el_pt =
...
//===========================================================================
/// \short actions before adapt
/// + remove face-elements from problem
/// .... NOTE: there's no actions_before_adapt for Turek, so why here?
//===========================================================================
template<class FLUID_ELEMENT, class SOLID_ELEMENT>
void PseudoElasticCollapsibleChannelProblem<FLUID_ELEMENT,SOLID_ELEMENT>
...
//===========================================================================
/// \short actions before distribute
/// + make bulk solid elements adjacent to fluid halo
/// + remove face-elements from problem
//===========================================================================
template<class FLUID_ELEMENT, class SOLID_ELEMENT>
void PseudoElasticCollapsibleChannelProblem<FLUID_ELEMENT,SOLID_ELEMENT>
...
//===========================================================================
/// \short actions_after_distribute
...
//========================================================================
/// Do some manual refinemnent of fluid and solid meshes
//========================================================================
template<class FLUID_ELEMENT, class SOLID_ELEMENT>
void PseudoElasticCollapsibleChannelProblem<FLUID_ELEMENT,SOLID_ELEMENT>::
manual_refine()
{ 
 ...
 // Vector of vectors containing numbers of elements that are to be
 // refined
 Vector<Vector<unsigned> > elements_to_be_refined(this->nsub_mesh());


// Fluid mesh comes first
elements_to_be_refined[0].resize(1);
elements_to_be_refined[0][0]=8;

// Solid mesh comes next
elements_to_be_refined[1].resize(2);
elements_to_be_refined[1][0]=8;
elements_to_be_refined[1][1]=13;

// Refine
this->refine_selected_elements(elements_to_be_refined);
...
//  // Increment re to target
//  double target_re = Global_Parameters::Re;
//  Global_Parameters::Re=target_re/8.0;
//  while (Global_Parameters::Re<target_re)
//   {
//    Global_Parameters::Re*=2.0;
...
//   {
//    Global_Parameters::Pcos-=4.0e-5;
//    this->steady_newton_solve();
//    this->doc_parameters();
//    output_parameters(this,outfile_steady);
//    this->doc_solution(doc_info);
//    doc_info.number()++;
//   }

//  // zero Pcos
//  oomph_info << "Switching off pcos\n";
//  Global_Parameters::Pcos=0;
//  this->steady_newton_solve();
//  this->doc_parameters();
//  this->doc_solution(doc_info);
//  doc_info.number()++;
...
//  oomph_info << "Problem is being distributed (DRIVER)" << std::endl;
//  bool report_stats=true;
//  problem.distribute(report_stats);
//  oomph_info << "Problem has been distributed (DRIVER)" << std::endl;
// #endif

 // TEST: refine uniformly after distribute...
