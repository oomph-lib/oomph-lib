...
namespace oomph
{
  ...
  public:
    ...
    /// \short Return the number of DOF types associated with this element.
...
namespace Global_Parameters
{
  ...
  /// \short Fluid structure interaction parameter: Ratio of stresses used
...
public:
  ...
  /// \short Actions before Newton solve:
  ...
  void doc_parameters()
  {
    ...
    oomph_info << "T                    : " << Global_Parameters::T
               << std::endl;
    oomph_info << "t                    : " << time_pt()->time() << std::endl;
    oomph_info << "tip x                : " << tip_node_pt()->x(0) << std::endl;
    oomph_info << "tip y                : " << tip_node_pt()->x(1) << std::endl;
    oomph_info << "=================================================\n\n";
  }
  ...
  const unsigned& mesh_multiplier)
{
  ...
  FSI_functions::setup_fluid_load_info_for_solid_elements<ELEMENT, 2>(
    this, 4, Bulk_mesh_pt, Wall_mesh_pt, face);
...
//==========================================================================
template<class ELEMENT>
void FSIChannelWithLeafletProblem<
...
int main(int argc, char** argv)
{
  ...
  unsigned nstep =
    unsigned(double(n_period) * Global_Parameters::T / Global_Parameters::Dt);
