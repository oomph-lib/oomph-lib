...
namespace Global_Parameters
{
 ...
 double Re=10.0; // hierher increase to 50 say 

 /// Default FSI parameter
 double Q=0.0;

 /// Increment in FSI parameter
 double Q_increment=1.0e-2;
 ...
 // hierher keep for solid then kill
 ...
 for(unsigned i=0;i<n_element;i++)
  {
   ...
   //Set the body force // hierher keep for solid then kill
...
/// Create non-FSI traction elements / hierher keep for solid then kill
//=======================================================================
template<class FLUID_ELEMENT,class SOLID_ELEMENT>
void UnstructuredFSIProblem<FLUID_ELEMENT,SOLID_ELEMENT>::
create_non_fsi_traction_elements()
...
int main(int argc, char **argv)
{
 ...
 double p_increment=0.0e-1; // 1.0e-2; // hierher keep for solid kill later
 ...
 for (unsigned istep=0;istep<nstep;istep++)
  {
   ...
   Global_Parameters::Gravity+=g_increment;// hierher only for solid -- kill later.
