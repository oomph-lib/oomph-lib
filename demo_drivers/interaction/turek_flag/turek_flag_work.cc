 ...
 
{
 ...
 /// vertices merge smoothly with the cylinder.
...
//  PVDEquationsBase<2>::
//   unpin_all_pressure_dofs(solid_mesh_pt()->element_pt());
...
int main(int argc, char* argv[])
{
 ...
 std::cout << "WARNING: REDUCING TIMESTEP BY 10 TO EXPERIMENT" << std::endl;
 nstep=10000;
 dt*=0.1;
