...
namespace TanhSolnForPoisson
{
  ...
  void get_source(const Vector<double>& x, double& source)
  {
    ...
    {
      source =
        2.0 * tanh(-1.0 + Alpha * (Beta * (x[0] - X_shift) - x[1])) *
          (1.0 -
           pow(tanh(-1.0 + Alpha * (Beta * (x[0] - X_shift) - x[1])), 2.0)) *
...
int main(int argc, char* argv[])
{
  ...
  //----------------
  {
    ...
    // Set up the problem
    PoissonProblem<TPoissonElement<2, 2>> problem(
  ...
  //-------------------
  {
    ...
    // Set up the problem
    PoissonProblem<TPoissonElement<2, 3>> problem(
      &TanhSolnForPoisson::get_source,
      node_file_name,
      element_file_name,
      poly_file_name);
  ...
  //---------------
  {
    ...
    // Set up the problem
    PoissonProblem<TPoissonElement<2, 4>> problem(
      &TanhSolnForPoisson::get_source,
      node_file_name,
      element_file_name,
      poly_file_name);
