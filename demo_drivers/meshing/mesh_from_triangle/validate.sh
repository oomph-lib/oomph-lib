...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/box_poisson_results.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/box_poisson_adapt_results.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/box_navier_stokes_results.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/box_navier_stokes_adapt_results.dat.gz   \
