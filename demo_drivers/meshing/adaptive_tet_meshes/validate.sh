...
if [ ! -f planar_facet_bounded_mesh_from_gmsh ]; then
    ...
    echo " " >> validation.log
    cat validation.log >> $OOMPH_ROOT_DIRlidation.log
    exit
fi
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/gmsh_curved_results.dat.gz \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/tetgen_planar_results.dat.gz \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/gmsh_planar_results.dat.gz \
