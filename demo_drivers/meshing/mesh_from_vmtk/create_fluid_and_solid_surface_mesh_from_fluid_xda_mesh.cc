 ...
 const bool& do_multi_boundary_ids=true)
{
 ...
 //-------------------------------------------------------------------
 ofstream fluid_output_stream(fluid_surface_file.c_str(),ios::out);
 ...
 ofstream solid_output_stream(solid_surface_file.c_str(),ios::out);
...
int main()
{
 ...
 cout << "Please enter the file name without the file extension '.xda': ";
 cin >> input_filename;
