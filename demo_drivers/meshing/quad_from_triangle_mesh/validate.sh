...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/adaptive_moving_block_navier_stokes_results.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/unstructured_two_d_solid_results0.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/unstructured_two_d_solid_results1.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/unstructured_two_d_solid_results2.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/adaptive_unstructured_two_d_solid_results0.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/adaptive_unstructured_two_d_solid_results1.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/adaptive_unstructured_two_d_solid_results2.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/unstructured_adaptive_scattering_results0.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/unstructured_adaptive_scattering_results1.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/unstructured_adaptive_scattering_results2.dat.gz   \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/unstructured_adaptive_scattering_results3.dat.gz   \
