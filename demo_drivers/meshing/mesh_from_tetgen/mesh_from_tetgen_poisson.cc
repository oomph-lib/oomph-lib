  ...
  Source_fct_pt(source_fct_pt)
{
  ...
  // Create mesh
  Problem::mesh_pt() =
    new TetgenMesh<ELEMENT>(node_file_name, element_file_name, face_file_name);
...
int main(int argc, char* argv[])
{
  ...
  if (argc != 4)
  {
    ...
    error_message += "filename.node then filename.ele then filename.face\n";
  ...
  //------------------------------------
  {
    PoissonProblem<TPoissonElement<3, 2>> problem(
  ...
  //---------------------------------------
  {
    PoissonProblem<TPoissonElement<3, 3>> problem(
      &TanhSolnForPoisson::get_source,
      node_file_name,
      element_file_name,
      face_file_name);
