...
template<class ELEMENT>
RefineableActivatorInhibitorProblem<
  ELEMENT>::RefineableActivatorInhibitorProblem() :
  Dt(0.1)
{
...
int main()
{
  ...
  RefineableActivatorInhibitorProblem<
    ProjectableAdvectionDiffusionReactionElement<
      TAdvectionDiffusionReactionElement<2, 2, 3>>>
    problem;
