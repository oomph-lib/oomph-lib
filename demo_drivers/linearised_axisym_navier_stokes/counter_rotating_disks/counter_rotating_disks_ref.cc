                                                  ...
                                                  const bool &output_soln)
{
  ...
  if (output_soln)
  {
    ...
    sprintf(filename,
            "%s/base_soln_k%i_Re%4.2f_soln%i.dat",
            doc_info.directory().c_str(),
            GlobalPhysicalVariables::k,
            GlobalPhysicalVariables::Re_current,
            doc_info.number());
...
public:
  ...
  void create_trace_file(DocInfo &doc_info)
  {
    ...
    char filename[256];
    sprintf(filename,
            "%s/perturbed_trace_k%i_Re%4.2f.dat",
            doc_info.directory().c_str(),
            GlobalPhysicalVariables::k,
            GlobalPhysicalVariables::Re_current);
    Trace_file.open(filename);
  ...
  DocInfo &doc_info, const bool &output_soln)
{
  ...
  if (output_soln)
  {
    ...
    // Open solution output file
    sprintf(filename,
            "%s/perturbed_soln_k%i_Re%4.2f_soln%i.dat",
            doc_info.directory().c_str(),
            GlobalPhysicalVariables::k,
            GlobalPhysicalVariables::Re_current,
            doc_info.number());
...
public:
  ...
  void create_trace_files(DocInfo &doc_info)
  {
    ...
    char filename[256];
    sprintf(filename,
            "%s/power_method_trace_k%i_Re%4.2f.dat",
            doc_info.directory().c_str(),
            GlobalPhysicalVariables::k,
            GlobalPhysicalVariables::Re_current);
...
int main(int argc, char *argv[])
{
  ...
  // ---------------------------------------------------
  {
    ...
    for (unsigned param = 0; param < n_param_steps; param++)
    {
      ...
      cout << "\n====================================================" << endl;
      cout << "Beginning parameter run " << param + 1 << " of " << n_param_steps
           << ": Re = " << GlobalPhysicalVariables::Re_current << endl;
      cout << "====================================================" << endl;
      ...
      // recomputed when we changed the problem parameters (Reynolds number
      // etc.)
      ...
      const unsigned n_power_method_iterations =
        problem.perform_power_method(dt,
                                     doc_info,
