...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/results_spine_single_layer.dat.gz  \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/results_elastic_single_layer.dat.gz  \
