  ...
  Lx(lx), Ly(ly)
{
  ...
  unsigned long interface_element_pt_range = Surface_mesh_pt->nelement();
...
class ElasticSimpleCubicMesh : public SimpleCubicMesh<ELEMENT>, public SolidMesh
{
  // Public functions
public:
...
int main(int argc, char *argv[])
{
...

  {
    ...
    InterfaceProblem<SpineElement<QCrouzeixRaviartElement<3>>, BDF<2>> problem(
      nx, ny, nz, lx, ly, h);
...

  {
    ...
    ElasticInterfaceProblem<
      PseudoSolidNodeUpdateElement<QCrouzeixRaviartElement<3>,
