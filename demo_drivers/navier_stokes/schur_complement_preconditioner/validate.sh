...
grep 'Number of iterations to convergence:' OUTPUT_two_d_fp | awk '{print $NF}' >iter_two_d.dat
...
mkdir RESLT
../three_d_fp bla >OUTPUT_three_d_fp 2>&1
echo "done"
echo " " >>validation.log
...
grep 'Number of iterations to convergence' OUTPUT_three_d_fp | awk '{print $NF}' >iter_three_d.dat
