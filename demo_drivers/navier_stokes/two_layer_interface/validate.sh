...
../../../../bin/fpdiff.py ../validata/results_spine_two_layer_interface.dat.gz results_spine_two_layer_interface.dat >> validation.log
fi
...
../../../../bin/fpdiff.py ../validata/results_elastic_two_layer_interface.dat.gz results_elastic_two_layer_interface.dat >> validation.log
fi
