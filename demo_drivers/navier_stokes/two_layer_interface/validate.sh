...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/results_spine_two_layer_interface.dat.gz results_spine_two_layer_interface.dat 0.1 2.0e-11 >> validation.log
fi
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/results_elastic_two_layer_interface.dat.gz results_elastic_two_layer_interface.dat 0.1 3.0e-9 >> validation.log
fi
