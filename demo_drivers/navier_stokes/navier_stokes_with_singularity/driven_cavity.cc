...
namespace Global_Parameters
{
  ...
  double blend(const Vector<double> &x, const Vector<double> &x_c)
  {
    ...
    {
      result =
        0.5 * (1.0 + cos(MathematicalConstants::Pi * (r - R_blend_inner) /
  ...
  double pressure_couette(const Vector<double> &x)
  {
    ...
    // Pressure
    double press =
      Global_Physical_Variables::Re * (A_couette * A_couette * r * r / 2.0 +
  ...
  Vector<double> velocity_singularity1(const Vector<double> &x)
  {
    ...
    u[0] =
      -(0.5 * Pi * theta * sin(theta) + theta * cos(theta) -
        0.25 * Pi * Pi * sin(theta)) *
        sin(theta) / (-1.0 + 0.25 * Pi * Pi) -
      1.0 *
        (-theta * sin(theta) + 0.5 * Pi * theta * cos(theta) +
         0.5 * Pi * sin(theta) - 0.25 * Pi * Pi * cos(theta) + cos(theta)) *
        cos(theta) / (-1.0 + 0.25 * Pi * Pi);
  ...
  Vector<Vector<double>> grad_velocity_singularity1(const Vector<double> &coord)
  {
    ...
    grad_u[0][0] =
      pow(x, 2) *
        (0.5 * Pi * x * atan2(y, x) / sqrt(pow(x, 2) + pow(y, 2)) -
         0.25 * pow(Pi, 2) * x / sqrt(pow(x, 2) + pow(y, 2)) +
         1.0 * x / sqrt(pow(x, 2) + pow(y, 2)) -
         1.0 * y * atan2(y, x) / sqrt(pow(x, 2) + pow(y, 2)) +
         0.5 * Pi * y / sqrt(pow(x, 2) + pow(y, 2))) /
        ((-1 + 0.25 * pow(Pi, 2)) * pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L)) -
      x * y *
        (-x * atan2(y, x) / sqrt(pow(x, 2) + pow(y, 2)) -
         0.5 * Pi * y * atan2(y, x) / sqrt(pow(x, 2) + pow(y, 2)) +
         0.25 * pow(Pi, 2) * y / sqrt(pow(x, 2) + pow(y, 2))) /
        ((-1 + 0.25 * pow(Pi, 2)) * pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L)) -
      x *
        (-0.5 * Pi * pow(x, 2) * atan2(y, x) /
           pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) -
         1.0 * pow(x, 2) / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) +
         0.25 * pow(Pi, 2) * pow(x, 2) /
           pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) +
         1.0 * x * y * atan2(y, x) / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) -
         1.0 * Pi * x * y / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) +
         1.0 * pow(y, 2) / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) +
         0.5 * Pi * atan2(y, x) / sqrt(pow(x, 2) + pow(y, 2)) -
         0.25 * pow(Pi, 2) / sqrt(pow(x, 2) + pow(y, 2)) +
         1.0 / sqrt(pow(x, 2) + pow(y, 2))) /
        ((-1 + 0.25 * pow(Pi, 2)) * sqrt(pow(x, 2) + pow(y, 2))) +
      y *
        (pow(x, 2) * atan2(y, x) / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) +
         0.5 * Pi * x * y * atan2(y, x) /
           pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) -
         0.25 * pow(Pi, 2) * x * y / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) +
         x * y / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) +
         0.5 * Pi * pow(y, 2) / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) -
         atan2(y, x) / sqrt(pow(x, 2) + pow(y, 2))) /
        ((-1 + 0.25 * pow(Pi, 2)) * sqrt(pow(x, 2) + pow(y, 2))) -
      (0.5 * Pi * x * atan2(y, x) / sqrt(pow(x, 2) + pow(y, 2)) -
       0.25 * pow(Pi, 2) * x / sqrt(pow(x, 2) + pow(y, 2)) +
       1.0 * x / sqrt(pow(x, 2) + pow(y, 2)) -
    ...
    grad_u[0][1] =
      x * y *
        ...
        ((-1 + 0.25 * pow(Pi, 2)) * pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L)) -
      x *
        (0.5 * Pi * pow(x, 2) / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) -
         0.5 * Pi * x * y * atan2(y, x) /
           pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) -
         2.0 * x * y / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) +
         0.25 * pow(Pi, 2) * x * y / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) +
         1.0 * pow(y, 2) * atan2(y, x) /
           pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) -
         0.5 * Pi * pow(y, 2) / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) -
         1.0 * atan2(y, x) / sqrt(pow(x, 2) + pow(y, 2)) +
         0.5 * Pi / sqrt(pow(x, 2) + pow(y, 2))) /
        ((-1 + 0.25 * pow(Pi, 2)) * sqrt(pow(x, 2) + pow(y, 2))) -
      pow(y, 2) *
        (-x * atan2(y, x) / sqrt(pow(x, 2) + pow(y, 2)) -
         0.5 * Pi * y * atan2(y, x) / sqrt(pow(x, 2) + pow(y, 2)) +
        ...
        ((-1 + 0.25 * pow(Pi, 2)) * pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L)) +
      y *
        (-pow(x, 2) / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) +
         x * y * atan2(y, x) / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) -
         0.5 * Pi * x * y / pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) +
         0.5 * Pi * pow(y, 2) * atan2(y, x) /
           pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) -
         0.25 * pow(Pi, 2) * pow(y, 2) /
           pow(pow(x, 2) + pow(y, 2), 3.0L / 2.0L) -
         0.5 * Pi * atan2(y, x) / sqrt(pow(x, 2) + pow(y, 2)) +
         0.25 * pow(Pi, 2) / sqrt(pow(x, 2) + pow(y, 2))) /
        ((-1 + 0.25 * pow(Pi, 2)) * sqrt(pow(x, 2) + pow(y, 2))) +
  ...
  Vector<Vector<double>> grad_velocity_singularity2(const Vector<double> &coord)
  {
    ...
    grad_u[0][0] =
      -y * (-x + 1) *
        (-0.5 * Pi * y * atan2(y, -x + 1) / sqrt(pow(y, 2) + pow(-x + 1, 2)) +
         0.25 * pow(Pi, 2) * y / sqrt(pow(y, 2) + pow(-x + 1, 2)) -
         (-x + 1) * atan2(y, -x + 1) / sqrt(pow(y, 2) + pow(-x + 1, 2))) /
        ((-1 + 0.25 * pow(Pi, 2)) *
         pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L)) -
      y *
        (-0.5 * Pi * pow(y, 2) / pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) -
         0.5 * Pi * y * (-x + 1) * atan2(y, -x + 1) /
           pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) -
         y * (-x + 1) / pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) +
         0.25 * pow(Pi, 2) * y * (-x + 1) /
           pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) -
         pow(-x + 1, 2) * atan2(y, -x + 1) /
           pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) +
         atan2(y, -x + 1) / sqrt(pow(y, 2) + pow(-x + 1, 2))) /
        ((-1 + 0.25 * pow(Pi, 2)) * sqrt(pow(y, 2) + pow(-x + 1, 2))) +
      pow(-x + 1, 2) *
        (-1.0 * y * atan2(y, -x + 1) / sqrt(pow(y, 2) + pow(-x + 1, 2)) +
         0.5 * Pi * y / sqrt(pow(y, 2) + pow(-x + 1, 2)) +
         0.5 * Pi * (-x + 1) * atan2(y, -x + 1) /
           sqrt(pow(y, 2) + pow(-x + 1, 2)) -
         0.25 * pow(Pi, 2) * (-x + 1) / sqrt(pow(y, 2) + pow(-x + 1, 2)) +
         1.0 * (-x + 1) / sqrt(pow(y, 2) + pow(-x + 1, 2))) /
        ((-1 + 0.25 * pow(Pi, 2)) *
         pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L)) +
      (-x + 1) *
        (-1.0 * pow(y, 2) / pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) -
         1.0 * y * (-x + 1) * atan2(y, -x + 1) /
           pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) +
         1.0 * Pi * y * (-x + 1) /
           pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) +
         0.5 * Pi * pow(-x + 1, 2) * atan2(y, -x + 1) /
           pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) -
         0.25 * pow(Pi, 2) * pow(-x + 1, 2) /
           pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) +
         1.0 * pow(-x + 1, 2) / pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) -
         0.5 * Pi * atan2(y, -x + 1) / sqrt(pow(y, 2) + pow(-x + 1, 2)) -
         1.0 / sqrt(pow(y, 2) + pow(-x + 1, 2)) +
         0.25 * pow(Pi, 2) / sqrt(pow(y, 2) + pow(-x + 1, 2))) /
        ((-1 + 0.25 * pow(Pi, 2)) * sqrt(pow(y, 2) + pow(-x + 1, 2))) -
      (-1.0 * y * atan2(y, -x + 1) / sqrt(pow(y, 2) + pow(-x + 1, 2)) +
       0.5 * Pi * y / sqrt(pow(y, 2) + pow(-x + 1, 2)) +
       0.5 * Pi * (-x + 1) * atan2(y, -x + 1) /
    ...
    grad_u[0][1] =
      ...
      y *
        (0.5 * Pi * pow(y, 2) * atan2(y, -x + 1) /
         ...
         0.5 * Pi * y * (-x + 1) /
           pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) -
         pow(-x + 1, 2) / pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) -
         0.5 * Pi * atan2(y, -x + 1) / sqrt(pow(y, 2) + pow(-x + 1, 2)) +
         0.25 * pow(Pi, 2) / sqrt(pow(y, 2) + pow(-x + 1, 2))) /
        ((-1 + 0.25 * pow(Pi, 2)) * sqrt(pow(y, 2) + pow(-x + 1, 2))) +
      (-x + 1) *
        (1.0 * pow(y, 2) * atan2(y, -x + 1) /
           pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) -
         0.5 * Pi * pow(y, 2) / pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) -
         0.5 * Pi * y * (-x + 1) * atan2(y, -x + 1) /
           pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) -
         2.0 * y * (-x + 1) / pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) +
         0.25 * pow(Pi, 2) * y * (-x + 1) /
           pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) +
         0.5 * Pi * pow(-x + 1, 2) /
           pow(pow(y, 2) + pow(-x + 1, 2), 3.0L / 2.0L) -
         1.0 * atan2(y, -x + 1) / sqrt(pow(y, 2) + pow(-x + 1, 2)) +
         0.5 * Pi / sqrt(pow(y, 2) + pow(-x + 1, 2))) /
        ((-1 + 0.25 * pow(Pi, 2)) * sqrt(pow(y, 2) + pow(-x + 1, 2))) -
      (-0.5 * Pi * y * atan2(y, -x + 1) / sqrt(pow(y, 2) + pow(-x + 1, 2)) +
       0.25 * pow(Pi, 2) * y / sqrt(pow(y, 2) + pow(-x + 1, 2)) -
       (-x + 1) * atan2(y, -x + 1) / sqrt(pow(y, 2) + pow(-x + 1, 2))) /
  ...
  double pressure_singularity1(const Vector<double> &x)
  {
    ...
    double p = -(-0.25 * Pi * Pi * Pi * sin(theta) + 1.0 * Pi * sin(theta) -
                 0.5 * Pi * Pi * cos(theta) + 2.0 * cos(theta)) /
               (r * (-0.0625 * Pi * Pi * Pi * Pi - 1.0 + 0.5 * Pi * Pi));
  ...
  double pressure_singularity2(const Vector<double> &x)
  {
    ...
    double p = -(-1.0 * Pi * sin(theta) + 0.25 * Pi * Pi * Pi * sin(theta) -
                 2.0 * cos(theta) + 0.5 * Pi * Pi * cos(theta)) /
               (r * (-0.0625 * Pi * Pi * Pi * Pi - 1.0 + 0.5 * Pi * Pi));
  ...
  Vector<double> grad_pressure_singularity1(const Vector<double> &coord)
  {
    ...
    grad_p[0] =
      -x *
        (-0.5 * Pi * Pi * x / sqrt(x * x + y * y) +
         2.0 * x / sqrt(x * x + y * y) -
         0.25 * Pi * Pi * Pi * y / sqrt(x * x + y * y) +
         1.0 * Pi * y / sqrt(x * x + y * y)) /
        ((x * x + y * y) * sqrt(x * x + y * y) *
         (-0.0625 * Pi * Pi * Pi * Pi - 1.0 + 0.5 * Pi * Pi)) +
      (-2.0 * x * x / (x * x + y * y) * sqrt(x * x + y * y) +
       0.5 * Pi * Pi * x * x / (x * x + y * y) * sqrt(x * x + y * y) -
       1.0 * Pi * x * y / (x * x + y * y) * sqrt(x * x + y * y) +
       0.25 * Pi * Pi * Pi * x * y / (x * x + y * y) * sqrt(x * x + y * y) -
       0.5 * Pi * Pi / sqrt(x * x + y * y) + 2.0 / sqrt(x * x + y * y)) /
        (sqrt(x * x + y * y) *
         (-0.0625 * Pi * Pi * Pi * Pi - 1.0 + 0.5 * Pi * Pi));
    ...
    grad_p[1] =
      -y *
        ...
        ((x * x + y * y) * sqrt(x * x + y * y) *
         (-0.0625 * Pi * Pi * Pi * Pi - 1.0 + 0.5 * Pi * Pi)) +
      (-2.0 * x * y / (x * x + y * y) * sqrt(x * x + y * y) +
       0.5 * Pi * Pi * x * y / (x * x + y * y) * sqrt(x * x + y * y) -
       1.0 * Pi * y * y / (x * x + y * y) * sqrt(x * x + y * y) +
       0.25 * Pi * Pi * Pi * y * y / (x * x + y * y) * sqrt(x * x + y * y) -
       0.25 * Pi * Pi * Pi / sqrt(x * x + y * y) +
       1.0 * Pi / sqrt(x * x + y * y)) /
        (sqrt(x * x + y * y) *
         (-0.0625 * Pi * Pi * Pi * Pi - 1.0 + 0.5 * Pi * Pi));
  ...
  void analytic_solution1(const Vector<double> &x, Vector<double> &solution)
  {
    ...
    {
      solution[2] =
        -(-0.25 * Pi * Pi * Pi * sin(theta) + 1.0 * Pi * sin(theta) -
          0.5 * Pi * Pi * cos(theta) + 2.0 * cos(theta)) /
        (r * (-0.0625 * Pi * Pi * Pi * Pi - 1.0 + 0.5 * Pi * Pi));
    }
  }
  ...
  void analytic_solution2(const Vector<double> &x, Vector<double> &solution)
  {
    ...
    {
      solution[2] =
        -(-1.0 * Pi * sin(theta) + 0.25 * Pi * Pi * Pi * sin(theta) -
          2.0 * cos(theta) + 0.5 * Pi * Pi * cos(theta)) /
        (r * (-0.0625 * Pi * Pi * Pi * Pi - 1.0 + 0.5 * Pi * Pi));
    }
  }
  ...
  // Vector<Vector<double> > blended_grad_velocity_singularity1(const
  // Vector<double>& coord) Vector<Vector<double> >
  // blended_grad_velocity_singularity2(const Vector<double>& coord) double
  // blended_pressure_singularity1(const Vector<double>& x) double
  // blended_pressure_singularity2(const Vector<double>& x)
...
public:
  ...
  void setup_line_plot_points()
  {
    ...
    for (unsigned i = 0; i < n_phi; i++)
    {
      ...
      double phi =
        0.5 * MathematicalConstants::Pi * double(i) / double(n_phi - 1);
      ...
      for (unsigned j = 0; j < npt; j++)
      {
        ...
        if (geom_object_pt == 0)
        {
          oomph_info << "Point : " << zeta[0] << " " << zeta[1] << " "
                     << " not found in setup of line plots" << std::endl;
        }
...
//----------------------
  ...
  if (CommandLineArgs::command_line_flag_has_been_set("--blend"))
  {
    ...
    // Set the pointer to the gradient of the first velocity singularity
    // function for this element, defined in Global_parameters namespace
    Singular_navier_stokes_solution1_element_pt
  ...
  Singular_navier_stokes_solution_mesh_pt->add_element_pt(
    Singular_navier_stokes_solution1_element_pt);
  ...
  for (unsigned e = 0; e < n_element; e++)
  {
    ...
    el_pt->add_c_equation_element_pt(
      Singular_navier_stokes_solution1_element_pt);
...
void RectangularDrivenCavityProblem<ELEMENT>::doc_solution(DocInfo &doc_info)
{
  ...
  //-----------------------------
  sprintf(filename,
          "%s/perturbation_soln_two_term%i.dat",
          doc_info.directory().c_str(),
          doc_info.number());
  PerturbationSolution::N_terms_for_plot = 2;
  some_file.open(filename);
  Navier_stokes_mesh_pt->output_fct(
    some_file, npts, PerturbationSolution::perturbation_soln_for_plot);
  some_file.close();

  // Output perturbation solution
  //-----------------------------
  sprintf(filename,
          "%s/perturbation_soln_one_term%i.dat",
          doc_info.directory().c_str(),
          doc_info.number());
  some_file.open(filename);
  ...
  //--------------------------------------------------
  sprintf(filename,
          "%s/first_order_perturbation%i.dat",
          doc_info.directory().c_str(),
          doc_info.number());
  some_file.open(filename);
  Navier_stokes_mesh_pt->output_fct(
    some_file, npts, PerturbationSolution::first_order_perturbation_for_plot);
  some_file.close();

  // Output second-order perturbation solution (Stokes)
  //--------------------------------------------------
  sprintf(filename,
          "%s/second_order_perturbation%i.dat",
          doc_info.directory().c_str(),
          doc_info.number());
  some_file.open(filename);
  Navier_stokes_mesh_pt->output_fct(
    some_file, npts, PerturbationSolution::second_order_perturbation_for_plot);
  some_file.close();
  ...
  some_file.open(filename);
  sprintf(filename,
          "%s/second_order_perturbation_line_plot%i.dat",
          doc_info.directory().c_str(),
          doc_info.number());
  ...
  for (unsigned i = 0; i < nphi; i++)
  {
    ...
    for (unsigned j = 0; j < nr; j++)
    {
      ...
      some_file << x[0] << " " << x[1] << " " << sqrt(x[0] * x[0] + x[1] * x[1])
                << " " << u[0] << " " << u[1] << " " << p << " " << std::endl;

      PerturbationSolution::second_order_perturbation_for_plot(x, soln);
      some_file2 << x[0] << " " << x[1] << " "
                 << sqrt(x[0] * x[0] + x[1] * x[1]) << " " << soln[0] << " "
                 << soln[1] << " " << soln[2] << " " << std::endl;
    }
  }
  some_file.close();
  some_file2.close();
  ...
  //----------------------
  sprintf(filename,
          "%s/exact_couette_soln%i.dat",
          doc_info.directory().c_str(),
          doc_info.number());
  some_file.open(filename);
  Navier_stokes_mesh_pt->output_fct(
    some_file, npts, Global_Parameters::exact_couette);
  some_file.close();
  ...
  //  cout << "norm  (without pressure): " << sqrt(norm) << std::endl <<
  //  std::endl;
  ...
  double norm = 0.0;
  sprintf(filename,
          "%s/couette_error_with_pressure%i.dat",
          doc_info.directory().c_str(),
          doc_info.number());
  some_file.open(filename);
...
int main(int argc, char **argv)
{
  ...
  CommandLineArgs::specify_command_line_flag(
    "--element_multiplier", &Global_Parameters::Element_multiplier);
  ...
  // Check singularities and their gradients
  {
    ...
    for (unsigned i = 0; i < nplot; i++)
    {
      ...
      for (unsigned j = 0; j < nplot; j++)
      {
        ...
        // grad_u=Global_Parameters::grad_velocity_singularity1(x);

        // Vector<double> u=Global_Parameters::velocity_singularity2(x);
        // Vector<Vector<double> >
        // grad_u=Global_Parameters::grad_velocity_singularity2(x);

        Vector<double> u =
          Global_Parameters::blended_velocity_pseudo_singularity_for_couette(x);
        Vector<Vector<double>> grad_u = Global_Parameters::
          blended_grad_velocity_pseudo_singularity_for_couette(x);

        some_file << x[0] << " " << x[1] << " " << u[0] << " " << u[1] << " "
                  << grad_u[0][0] << " " << grad_u[0][1] << " " << grad_u[1][0]
                  << " " << grad_u[1][1] << " " << std::endl;
      }
    }
    some_file.close();
