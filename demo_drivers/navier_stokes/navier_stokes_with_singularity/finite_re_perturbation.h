...
namespace PerturbationSolution
{
                                        ...
                                        double& p_0)
  {
    ...
    // phi component
    u_0[1] = ((-4 * phi * cos(phi) + Pi * (-2 * phi + Pi) * sin(phi))) /
             (-4 + pow(Pi, 2));
                                      ...
                                      double& p_1)
  {
    ...
    u_1[0] = (r * (-2 * pow(Pi, 2) * (8 + pow(Pi, 2)) +
                   2 *
                     (8 * pow(phi, 2) * (-4 + pow(Pi, 2)) -
                      8 * phi * Pi * (2 + pow(Pi, 2)) +
                      pow(Pi, 2) * (8 + pow(Pi, 2))) *
                     cos(2 * phi) +
                   (32 * phi - 72 * Pi - 64 * pow(phi, 2) * Pi +
                    24 * phi * pow(Pi, 2) + 6 * pow(Pi, 3) + pow(Pi, 5)) *
                     sin(2 * phi))) /
             (32. * pow(-4 + pow(Pi, 2), 2));

    // phi component
    u_1[1] = (r * (Pi * (24 - 14 * pow(Pi, 2) - pow(Pi, 4) +
                         4 * phi * Pi * (8 + pow(Pi, 2))) +
                   (-64 * pow(phi, 2) * Pi + 8 * phi * (12 + pow(Pi, 2)) +
                    Pi * (-24 + 14 * pow(Pi, 2) + pow(Pi, 4))) *
                     cos(2 * phi) -
                   2 *
                     (24 + 10 * pow(Pi, 2) + pow(Pi, 4) +
                      8 * pow(phi, 2) * (-4 + pow(Pi, 2)) -
                      8 * phi * Pi * (6 + pow(Pi, 2))) *
                     sin(2 * phi))) /
             (32. * pow(-4 + pow(Pi, 2), 2));
                                       ...
                                       double& p_2)
  {
    ...
    u_2[0] =
      (pow(r, 2) *
       (2 *
          (-3952 + 3672 * pow(Pi, 2) - 51 * pow(Pi, 4) - 21 * pow(Pi, 6) +
           192 * pow(phi, 3) * Pi * (4 + pow(Pi, 2)) +
           72 * phi * Pi * (2 + pow(Pi, 2)) * (-8 + 3 * pow(Pi, 2)) +
           144 * pow(phi, 2) * (20 + 5 * pow(Pi, 2) - 2 * pow(Pi, 4))) *
          cos(phi) +
        2 *
          (3952 - 3672 * pow(Pi, 2) + 51 * pow(Pi, 4) + 21 * pow(Pi, 6) +
           288 * pow(phi, 3) * Pi * (-12 + pow(Pi, 2)) -
           432 * pow(phi, 2) * (-12 + 5 * pow(Pi, 2) + pow(Pi, 4)) +
           24 * phi * Pi * (276 + 85 * pow(Pi, 2) + 9 * pow(Pi, 4))) *
          cos(3 * phi) +
        (-768 * pow(phi, 3) * (4 + pow(Pi, 2)) +
         144 * pow(phi, 2) * Pi * (20 + 13 * pow(Pi, 2)) -
         36 * phi * (-32 + 32 * pow(Pi, 2) + 42 * pow(Pi, 4) + pow(Pi, 6)) +
         Pi * (-3648 + 2576 * pow(Pi, 2) + 564 * pow(Pi, 4) + 9 * pow(Pi, 6))) *
          sin(phi) +
        (3072 * Pi + 1152 * pow(phi, 3) * (4 - 3 * pow(Pi, 2)) +
         432 * pow(phi, 2) * Pi * (36 + 5 * pow(Pi, 2)) -
         pow(Pi, 3) * (2560 + 252 * pow(Pi, 2) + 27 * pow(Pi, 4)) +
         12 * phi *
           (-1024 + 72 * pow(Pi, 2) + 54 * pow(Pi, 4) + 3 * pow(Pi, 6))) *
          sin(3 * phi))) /
    ...
    u_2[1] =
      (pow(r, 2) *
       ((-768 * pow(phi, 3) * (4 + pow(Pi, 2)) +
         144 * pow(phi, 2) * Pi * (-12 + 5 * pow(Pi, 2)) -
         36 * phi * (-224 - 16 * pow(Pi, 2) + 10 * pow(Pi, 4) + pow(Pi, 6)) +
         Pi * (2112 + 1424 * pow(Pi, 2) + 132 * pow(Pi, 4) + 9 * pow(Pi, 6))) *
          cos(phi) +
        (-384 * pow(phi, 3) * (-4 + 3 * pow(Pi, 2)) +
         48 * pow(phi, 2) * Pi * (156 + 11 * pow(Pi, 2)) -
         Pi * (2112 + 1424 * pow(Pi, 2) + 132 * pow(Pi, 4) + 9 * pow(Pi, 6)) +
         4 * phi *
           (-1856 + 3 * pow(Pi, 2) * (6 + pow(Pi, 2)) * (28 + pow(Pi, 2)))) *
          cos(3 * phi) +
        2 *
          (-80 - 3960 * pow(Pi, 2) + 231 * pow(Pi, 4) + 39 * pow(Pi, 6) -
           192 * pow(phi, 3) * Pi * (4 + pow(Pi, 2)) +
           144 * pow(phi, 2) * (12 + 3 * pow(Pi, 2) + 2 * pow(Pi, 4)) -
           72 * phi * Pi * (-40 + 8 * pow(Pi, 2) + 3 * pow(Pi, 4))) *
          sin(phi) -
        2 *
          (80 - 888 * pow(Pi, 2) + 85 * pow(Pi, 4) + 9 * pow(Pi, 6) +
           96 * pow(phi, 3) * Pi * (-12 + pow(Pi, 2)) +
           8 * phi * Pi * (588 + 107 * pow(Pi, 2) + 9 * pow(Pi, 4)) -
           48 * pow(phi, 2) * (-52 + 3 * pow(Pi, 2) * (9 + pow(Pi, 2)))) *
          sin(3 * phi))) /
      (1536. * pow(-4 + pow(Pi, 2), 3));

    // second order pressure term
    p_2 =
      (r *
       (-((9632 - 6264 * pow(Pi, 2) + 552 * pow(Pi, 4) + 33 * pow(Pi, 6) +
           144 * phi * Pi * (28 - 13 * pow(Pi, 2)) +
           192 * pow(phi, 3) * Pi * (4 + pow(Pi, 2)) -
           288 * pow(phi, 2) * (20 + pow(Pi, 2))) *
          cos(phi)) +
        9 *
          (-352 + 80 * pow(Pi, 2) + 22 * pow(Pi, 4) + pow(Pi, 6) +
           32 * pow(phi, 2) * (4 - 3 * pow(Pi, 2)) +
           16 * phi * Pi * (36 + pow(Pi, 2))) *
          cos(3 * phi) +
        (384 * pow(phi, 3) * (4 + pow(Pi, 2)) -
         144 * pow(phi, 2) * Pi * (-20 + 3 * pow(Pi, 2) + pow(Pi, 4)) +
         36 * phi * (-256 - 72 * pow(Pi, 2) + 10 * pow(Pi, 4) + pow(Pi, 6)) +
         Pi * (7152 - 124 * pow(Pi, 2) + 24 * pow(Pi, 4) + 9 * pow(Pi, 6))) *
          sin(phi) -
        36 *
          (96 * phi - 48 * (-2 + pow(phi, 2)) * Pi - 56 * phi * pow(Pi, 2) +
           4 * (4 + pow(phi, 2)) * pow(Pi, 3) - 4 * phi * pow(Pi, 4) +
           pow(Pi, 5)) *
          sin(3 * phi))) /
      (576. * pow(-4 + pow(Pi, 2), 3));
  }
