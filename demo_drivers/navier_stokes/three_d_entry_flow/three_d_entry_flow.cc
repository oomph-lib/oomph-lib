  ...
  Doc_info(doc_info)
{
  ...
  Problem::mesh_pt() = new RefineableQuarterTubeMesh<ELEMENT>(
...
int main(int argc, char* argv[])
{
  ...
  //------------------------
  {
    ...
    // Build problem
    EntryFlowProblem<RefineableQTaylorHoodElement<3>> problem(
  ...
  //-----------------------------
  {
    ...
    // Build problem
    EntryFlowProblem<RefineableQCrouzeixRaviartElement<3>> problem(
      doc_info, min_error_target, max_error_target);
