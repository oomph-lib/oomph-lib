#ifndef SINGULAR_ZERO_STRESS_SECTOR_PROBLEM_HEADER
#define SINGULAR_ZERO_STRESS_SECTOR_PROBLEM_HEADER
...
/// Local headers
#include "zero_stress_sector_problem.h"
...
namespace oomph
{
  ...
  class SingularZeroStressSectorProblem
    : public ZeroStressSectorProblem<ELEMENT>
  {
  private:
  ...
  public:
    ...
    // Constructor
    SingularZeroStressSectorProblem()
      : ZeroStressSectorProblem<ELEMENT>(), Contact_line_node_pt(0)
    {
      // Re-assign doc info pointer
      this->doc_info_pt()->set_directory("RESLT_internal_zero");
    ...
    void setup()
    {
      ...
      ZeroStressSectorProblem<ELEMENT>::setup();
    ...
    void doc_solution()
    {
      ...
      ZeroStressSectorProblem<ELEMENT>::doc_solution();
    }
  ...
  template<class ELEMENT>
  void SingularZeroStressSectorProblem<
  ...
  template<class ELEMENT>
  void SingularZeroStressSectorProblem<ELEMENT>::find_corner_bulk_element(
  ...
  template<class ELEMENT>
  void SingularZeroStressSectorProblem<ELEMENT>::find_corner_bulk_node(
    const unsigned& boundary_1_id,
    const unsigned& boundary_2_id,
    unsigned& element_index,
    unsigned& node_index)
  ...
  template<class ELEMENT>
  void SingularZeroStressSectorProblem<ELEMENT>::setup_mesh_interaction()
  {
  ...
  template<class ELEMENT>
  void SingularZeroStressSectorProblem<ELEMENT>::
