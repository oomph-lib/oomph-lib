#ifndef DECOMPOSED_INTEGRAL_ELEMENTS_HEADER
#define DECOMPOSED_INTEGRAL_ELEMENTS_HEADER

namespace oomph
{
  template<class ELEMENT>
  class DecomposedIntegralElements : public virtual FaceElement,
  ...
  public:
    DecomposedIntegralElements(FiniteElement* const& element_pt,
      ...
      const unsigned& flag)
    {
      ...
      if (local_eqn >= 0)
      {
        ...
        for (unsigned ipt = 0; ipt < n_intpt; ipt++)
        {
          ...
          double dot = 0.0;
          dot += interpolated_RC * unit_normal[0];
          dot += interpolated_ZC * unit_normal[1];

          residuals[local_eqn] += dot * J * W;
        }
      }
    }
