...
namespace oomph
{
  ...
  public:
                                          ...
                                          DenseMatrix<double>& jacobian)
    {
      ...
      fill_in_contribution_to_residuals_nst_slip(residuals, jacobian, 1);
                               ...
                               const unsigned& nplot) const
    {
      ...
      for (unsigned iplot = 0; iplot < num_plot_points; iplot++)
      {
        ...
        else
        {
          ...
          error_stream << "Navier-Stokes Elements only store "
    ...
    std::string scalar_name_paraview(const unsigned& i) const
    {
      ...
      {
        std::stringstream error_stream;
        error_stream << "Fluid Slip Navier-Stokes Elements only store "
                     << 2 * (n_dim + 1) << " fields " << std::endl;
        throw OomphLibError(
    ...
    {
      return node_pt(n)->value(this->u_index_nst(n, i));
    }
          ...
          if (local_eqn >= 0)
          {
            ...
            if (slip[i] > 0)
            {
              ...
              if (flag)
              {
                ...
                {
                  local_unknown =
                    this->nodal_local_eqn(l2, this->u_index_nst(l2, i));
