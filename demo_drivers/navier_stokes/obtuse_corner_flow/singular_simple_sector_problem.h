#ifndef SINGULAR_SIMPLE_SECTOR_PROBLEM_HEADER
#define SINGULAR_SIMPLE_SECTOR_PROBLEM_HEADER
...
/// Local headers
#include "simple_sector_problem.h"
...
namespace oomph
{
  ...
  class SingularSimpleSectorProblem : public SimpleSectorProblem<ELEMENT>
  {
  private:
  ...
  public:
    ...
    // Constructor
    SingularSimpleSectorProblem()
      : SimpleSectorProblem<ELEMENT>(), Contact_line_node_pt(0)
    {
      // Re-assign doc info pointer
      this->doc_info_pt()->set_directory("RESLT_internal");
    ...
    void setup()
    {
      ...
      SimpleSectorProblem<ELEMENT>::setup();
    ...
    void doc_solution()
    {
      ...
      SimpleSectorProblem<ELEMENT>::doc_solution();
    }
  ...
  template<class ELEMENT>
  void SingularSimpleSectorProblem<
  ...
  template<class ELEMENT>
  void SingularSimpleSectorProblem<ELEMENT>::find_corner_bulk_element(
  ...
  template<class ELEMENT>
  void SingularSimpleSectorProblem<ELEMENT>::find_corner_bulk_node(
    const unsigned& boundary_1_id,
    const unsigned& boundary_2_id,
    unsigned& element_index,
    unsigned& node_index)
  ...
  template<class ELEMENT>
  void SingularSimpleSectorProblem<ELEMENT>::setup_mesh_interaction()
  {
  ...
  template<class ELEMENT>
  void SingularSimpleSectorProblem<ELEMENT>::
