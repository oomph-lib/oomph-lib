#ifndef SPRITTLES_SIMPLE_SECTOR_PROBLEM_HEADER
#define SPRITTLES_SIMPLE_SECTOR_PROBLEM_HEADER
...
namespace oomph
{
  ...
  class SprittlesSimpleSectorProblem : public SimpleSectorProblem<ELEMENT>
  {
  private:
  ...
  template<class ELEMENT>
  void SprittlesSimpleSectorProblem<ELEMENT>::create_traction_eigen_elements()
  {
  ...
  template<class ELEMENT>
  void SprittlesSimpleSectorProblem<
  ...
  template<class ELEMENT>
  void SprittlesSimpleSectorProblem<ELEMENT>::find_corner_bulk_element(
  ...
  template<class ELEMENT>
  void SprittlesSimpleSectorProblem<ELEMENT>::find_corner_bulk_node(
    const unsigned& boundary_1_id,
    const unsigned& boundary_2_id,
    unsigned& element_index,
    unsigned& node_index)
  ...
  template<class ELEMENT>
  void SprittlesSimpleSectorProblem<ELEMENT>::
