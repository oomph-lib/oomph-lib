#ifndef SIMPLE_SECTOR_PROBLEM_HEADER
#define SIMPLE_SECTOR_PROBLEM_HEADER
...
namespace oomph
{
  ...
  class SimpleSectorProblem : public Problem
  {
  private:
    /// Private variables
  ...
  public:
    ...
    // Constructor
    SimpleSectorProblem() : Z2_error_estimator_pt(new Z2ErrorEstimator)
    {
      // Create and add the timestepper
      add_time_stepper_pt(new BDF<2>);

      // Assign doc info pointer
      Doc_info.set_directory("RESLT_simple");
      Doc_info.number() = 0;
  ...
  template<class ELEMENT>
  void SimpleSectorProblem<ELEMENT>::add_bulk_mesh()
  {
  ...
  template<class ELEMENT>
  void SimpleSectorProblem<ELEMENT>::create_no_penetration1_elements()
  {
  ...
  template<class ELEMENT>
  void SimpleSectorProblem<ELEMENT>::create_no_penetration2_elements()
  {
  ...
  template<class ELEMENT>
  void SimpleSectorProblem<ELEMENT>::find_corner_bulk_node(
  ...
  template<class ELEMENT>
  void SimpleSectorProblem<ELEMENT>::doc_solution()
  {
