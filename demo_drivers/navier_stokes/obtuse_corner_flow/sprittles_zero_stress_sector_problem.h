#ifndef SPRITTLES_ZERO_STRESS_SECTOR_PROBLEM_HEADER
#define SPRITTLES_ZERO_STRESS_SECTOR_PROBLEM_HEADER
...
namespace oomph
{
  ...
  class SprittlesZeroStressSectorProblem
  ...
  public:
    ...
    // Constructor
    SprittlesZeroStressSectorProblem()
      : ZeroStressSectorProblem<ELEMENT>(), Contact_line_node_pt(0)
    {
      // Re-assign doc info pointer
      this->doc_info_pt()->set_directory("RESLT_boundary_zero");
  ...
  template<class ELEMENT>
  void SprittlesZeroStressSectorProblem<
  ...
  template<class ELEMENT>
  void SprittlesZeroStressSectorProblem<ELEMENT>::find_corner_bulk_element(
  ...
  template<class ELEMENT>
  void SprittlesZeroStressSectorProblem<ELEMENT>::find_corner_bulk_node(
    const unsigned& boundary_1_id,
    const unsigned& boundary_2_id,
    unsigned& element_index,
    unsigned& node_index)
  ...
  template<class ELEMENT>
  void SprittlesZeroStressSectorProblem<ELEMENT>::
