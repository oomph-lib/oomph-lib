...
#include "singular_zero_stress_sector_problem.h"
...
int main(int argc, char** argv)
{
  ...
  oomph_info << "internal_forcing_zero" << std::endl;

  // Create problem
  SingularZeroStressSectorProblem<SingularNavierStokesElement<MyElement>>
    problem;
  problem.setup();
