...
namespace oomph
{
  ...
  class SingularSectorProblem : public Problem
  {
  private:
    /// Private variables
  ...
  public:
      ...
      : Contact_line_node_pt(0), Z2_error_estimator_pt(new Z2ErrorEstimator)
    {
      ...
      Doc_info.set_directory("RESLT_fix");
      Doc_info.number() = 0;
  ...
  template<class ELEMENT>
  void SingularSectorProblem<ELEMENT>::add_bulk_mesh(
  ...
  template<class ELEMENT>
  void SingularSectorProblem<ELEMENT>::create_slip_elements()
  {
  ...
  template<class ELEMENT>
  void SingularSectorProblem<ELEMENT>::create_no_penetration_elements(
  ...
  template<class ELEMENT>
  void SingularSectorProblem<ELEMENT>::set_contact_line_node_pt()
  {
  ...
  template<class ELEMENT>
  void SingularSectorProblem<ELEMENT>::compute_error_estimate(double& max_err,
                                                              double& min_err)
  {
    // Get error estimator
  ...
  template<class ELEMENT>
  void SingularSectorProblem<ELEMENT>::create_far_field_elements()
  {
  ...
  template<class ELEMENT>
  void SingularSectorProblem<ELEMENT>::pin_far_field_elements()
  {
    const unsigned n_el = Far_field_mesh_pt->nelement();
    for (unsigned i_el = 0; i_el < n_el; i_el++)
    {
  ...
  template<class ELEMENT>
  void SingularSectorProblem<ELEMENT>::doc_solution()
  {
