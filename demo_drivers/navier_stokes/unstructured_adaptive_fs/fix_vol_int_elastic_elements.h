...
/// a pointer to the (pressure) freedom that must be traded for the volume
/// constraint.
//=========================================================================
class ElasticVolumeConstraintElement : public GeneralisedElement
 {
  private:
 ...
 ///Constructor
 ElasticVolumeConstraintElement()
  {
 ...
 void fill_in_generic_contribution_to_residuals_vol_const(
  Vector<double> &residuals)
  {
   //If the external pressure has been set,
   //Add the required volume from the constraint equation
   //ADDITION BECAUSE it's the volume of the air (not the fluid).
 ...
 void fill_in_contribution_to_residuals( Vector<double> &residuals)
  {
   this->fill_in_generic_contribution_to_residuals_vol_const(residuals);
  }
 ...
 /// constraint
  void fill_in_contribution_to_jacobian_and_mass_matrix(
    ...
    {
     //No contribution to jacobian or mass matrix
     this->fill_in_generic_contribution_to_residuals_vol_const(residuals);
    }
...
public ElasticLineFluidInterfaceElement<ELEMENT>
{
 ...
 FluidInterfaceEdgeElement* make_edge_element(const int &face_index)
  {
   throw OomphLibError("This function is not implemented",
                       "make_edge_element()",
                       OOMPH_EXCEPTION_LOCATION);
  }
};
