...
class MyCanyonMesh : public SimpleCubicMesh<ELEMENT>, public SpineMesh
{
public:
  ...
  virtual void spine_node_update(SpineNode* spine_node_pt)
  {
    ...
    double norm = sqrt((Xsim - origin_pt[0]) * (Xsim - origin_pt[0]) +
  ...
  double init_spine_height(SpineNode* spine_node_pt)
  {
    ...
    double daxis = sqrt(
      (this->Xsim - spine_node_pt->x(0)) * (this->Xsim - spine_node_pt->x(0)) +
      (this->Zsim - spine_node_pt->x(2)) * (this->Zsim - spine_node_pt->x(2)));
