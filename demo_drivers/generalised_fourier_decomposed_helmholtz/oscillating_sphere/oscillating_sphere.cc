...
//LIC// 
//LIC//====================================================================
//Driver for generalised Fourier-decomposed  Helmholtz problem 
...
#include "generalised_fourier_decomposed_helmholtz.h"
...
namespace ProblemParameters
{
 ...
 {
  // Generate the coefficients of the wavenumber
  double c(0.0);
  c_function(x,c);
  double alpha(0.0);
  alpha_function(x,alpha);
  double c_squared = c*c;
  double alpha_squared = alpha*alpha;
  double omega_squared = Omega*Omega;
  double cao_expr1 = (omega_squared/c_squared) - alpha_squared;
...
public:
 ...
 void fill_in_contribution_to_residuals(Vector<double> &residuals)
  {
   ...
   ELEMENT::fill_in_generic_residual_contribution_generalised_fourier_decomposed_helmholtz(
 ...
 void fill_in_contribution_to_jacobian(Vector<double> &residuals,
                                   DenseMatrix<double> &jacobian)
  {
   ...
   ELEMENT::fill_in_generic_residual_contribution_generalised_fourier_decomposed_helmholtz(residuals,
                                                            jacobian,1);
   ...
   for(unsigned l=0;l<n_node;l++)
    {
     ...
     local_eqn_real = 
      ...
      (l,this->u_index_generalised_fourier_decomposed_helmholtz().real());
     ...
     local_eqn_imag = 
      this->nodal_local_eqn
      (l,this->u_index_generalised_fourier_decomposed_helmholtz().imag());
...
//=====================================================================
template<class ELEMENT> 
class GeneralisedFourierDecomposedHelmholtzProblem : public Problem
{
   ...
   for(unsigned e=0;e<n_element;e++)
    {
     ...
     GeneralisedFourierDecomposedHelmholtzPowerMonitorElement<ELEMENT>* 
      flux_element_pt = new 
      GeneralisedFourierDecomposedHelmholtzPowerMonitorElement<ELEMENT>
 ...
 for(unsigned i=0;i<n_element;i++)
  {
   ...
   GeneralisedFourierDecomposedHelmholtzEquations *el_pt = dynamic_cast<
   ...
   if (!el_pt==0)
    {
     ...
     el_pt->omega_pt()=&ProblemParameters::Omega;
     
     //Set the soundspeed function pointer
     el_pt->c_fct_pt()=&ProblemParameters::c_function;
     
     //Set the absorption factor pointer
     el_pt->alpha_fct_pt()=&ProblemParameters::alpha_function;
     
     // Set pointer to Fourier wave number
     el_pt->generalised_fourier_wavenumber_pt()=&ProblemParameters::N_fourier;
    }
  }
...
/// Constructor for Generalised Fourier-decomposed Helmholtz problem
//========================================================================
template<class ELEMENT>
GeneralisedFourierDecomposedHelmholtzProblem<ELEMENT>::
GeneralisedFourierDecomposedHelmholtzProblem()
{ 
 // Open trace file
...
{ 
 ...
 for(unsigned e=0;e<nn_element;e++)
  {
   GeneralisedFourierDecomposedHelmholtzPowerMonitorElement<ELEMENT> *el_pt = 
    dynamic_cast<GeneralisedFourierDecomposedHelmholtzPowerMonitorElement
 ...
 for(unsigned e=0;e<n_element;e++)
  {
   ...
   GeneralisedFourierDecomposedHelmholtzFluxElement<ELEMENT>* 
    flux_element_pt = new 
    GeneralisedFourierDecomposedHelmholtzFluxElement<ELEMENT>
    (bulk_elem_pt,face_index);
...
//============================================================================
template<class ELEMENT>
void GeneralisedFourierDecomposedHelmholtzProblem<ELEMENT>::create_pml_meshes()
{
...
//===== start_of_main=====================================================
/// Driver code for Generalised Fourier decomposed Helmholtz problem
//========================================================================
int main(int argc, char **argv)
{
 ...
 // TGeneralisedFourierDecomposedHelmholtzElement family,
 ...
 // TGeneralisedFourierDecomposedHelmholtzElement family. 
 GeneralisedFourierDecomposedHelmholtzProblem
  <TGeneralisedFourierDecomposedHelmholtzElement<3> > 
  problem;
