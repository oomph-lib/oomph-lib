...
if test "$2" = "no_fpdiff"; then
 ...
 $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/circular_disk_results.dat.gz   \
...
if test "$2" = "no_fpdiff"; then
 ...
 $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/displacement_based_circular_disk_results.dat.gz   \
...
if test "$2" = "no_fpdiff"; then
 ...
 $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/axisym_results.dat.gz   \
...
if test "$2" = "no_fpdiff"; then
 ...
 $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/displacement_based_axisym_results.dat.gz   \
