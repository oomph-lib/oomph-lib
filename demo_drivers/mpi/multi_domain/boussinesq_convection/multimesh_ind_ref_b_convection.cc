...
int main(int argc, char **argv)
{
 ...
 RefineableConvectionProblem<MyRefineableNavierStokesElement<2>,
  MyRefineableAdvectionDiffusionElement<2> > problem;
 ...
 // Follow the same procedure as in refineable_b_convection (for a single mesh)
 // but allow each mesh to refine independently
