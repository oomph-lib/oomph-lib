...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/turek_flag_load_balance_external_results.dat.gz  \
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/turek_flag_external_results.dat.gz  \
