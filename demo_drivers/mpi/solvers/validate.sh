...
# Receive the oomph-lib root directory as the first argument
OOMPH_ROOT_DIR=$1
...
if [ -f ../two_d_multi_poisson ]; then
    ...
    if test "$3" = "no_fpdiff"; then
        ...
        # Compare results
        $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/multi_poisson_two_plus_three_upper_triangular_with_two_sub_prec_results.dat.gz \
    ...
    if test "$3" = "no_fpdiff"; then
        ...
        # Compare results
        $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/multi_poisson_two_plus_three_upper_triangular_with_replace_prec_results.dat.gz \
    ...
    if test "$3" = "no_fpdiff"; then
        ...
        # Compare results
        $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/multi_poisson_coarse_two_plus_two_plus_one_prec_results.dat.gz \
    ...
    if test "$3" = "no_fpdiff"; then
        ...
        # Compare results
        $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/multi_poisson_one_plus_four_with_two_coarse_results.dat.gz \
    ...
    if test "$3" = "no_fpdiff"; then
        ...
        # Compare results
        $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/multi_poisson_upper_triangular_prec_results.dat.gz \
...
if [ -f ../TrilinosSolver_test ]; then
    ...
    if test "$3" = "no_fpdiff"; then
        ...
        $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/Trilinos_result.dat.gz \
        ...
        $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/Trilinos_conv.dat.gz \
