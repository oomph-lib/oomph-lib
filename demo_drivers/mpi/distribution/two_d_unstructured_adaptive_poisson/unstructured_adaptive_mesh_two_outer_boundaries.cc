  ...
  Source_fct_pt(source_fct_pt)
{
  ...
  boundaryp12->connect_initial_vertex_to_polyline(boundaryp1,
                                                  vertex_to_connect);
  ...
  vertex_to_connect = 1;
  boundaryp14->connect_initial_vertex_to_polyline(boundaryp1,
                                                  vertex_to_connect);
  ...
  vertex_to_connect = 1;
  boundaryp15->connect_initial_vertex_to_polyline(boundaryp7,
                                                  vertex_to_connect);

  vertex_to_connect = 1;
  boundaryp15->connect_final_vertex_to_polyline(boundaryp5, vertex_to_connect);
  ...
  vertex_to_connect = 1;
  boundaryp16->connect_initial_vertex_to_polyline(boundaryp6,
                                                  vertex_to_connect);

  vertex_to_connect = 1;
  boundaryp16->connect_final_vertex_to_polyline(boundaryp5, vertex_to_connect);
...
int main(int argc, char* argv[])
{
  ...
  //---------------------------------------
  {
    ...
    // Set up the problem
    PoissonProblem<ProjectablePoissonElement<TPoissonElement<2, 2>>> problem(
