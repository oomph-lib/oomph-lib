...
../unstructured_adaptive_mesh_two_outer_boundaries $validation_flag > OUTPUT_unstructured_adaptive_mesh_two_outer_boundaries
echo "done"
echo " " >> validation.log
...
../unstructured_adaptive_mesh_two_outer_boundaries_crossed $validation_flag > OUTPUT_unstructured_adaptive_mesh_two_outer_boundaries_crossed
echo "done"
echo " " >> validation.log
...
../../../../../bin/fpdiff.py ../validata/trace_two_d_parallel_unstructured_adaptive_poisson_np2_square_results.dat.gz  \
         TRACE_two_d_parallel_unstructured_adaptive_poisson_np2_square_results.dat >> validation.log
fi
...
../../../../../bin/fpdiff.py ../validata/trace_two_d_parallel_unstructured_adaptive_poisson_np3_square_results.dat.gz  \
         TRACE_two_d_parallel_unstructured_adaptive_poisson_np3_square_results.dat >> validation.log
fi
...
../../../../../bin/fpdiff.py ../validata/trace_two_d_parallel_unstructured_adaptive_poisson_np4_square_results.dat.gz  \
         TRACE_two_d_parallel_unstructured_adaptive_poisson_np4_square_results.dat >> validation.log
fi
