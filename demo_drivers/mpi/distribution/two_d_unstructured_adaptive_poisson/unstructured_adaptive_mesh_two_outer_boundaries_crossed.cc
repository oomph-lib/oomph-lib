  ...
  Source_fct_pt(source_fct_pt)
{
  ...
  vertex_to_connect = 2;
  boundaryp14->connect_initial_vertex_to_polyline(boundaryp10,
                                                  vertex_to_connect);
  ...
  vertex_to_connect = 1;
  boundaryp19->connect_initial_vertex_to_polyline(boundaryp5,
                                                  vertex_to_connect);

  boundaryp19->connect_final_vertex_to_polyline(boundaryp7, vertex_to_connect);
  ...
  vertex_to_connect = 1;
  boundaryp20->connect_initial_vertex_to_polyline(boundaryp11,
                                                  vertex_to_connect);

  boundaryp20->connect_final_vertex_to_polyline(boundaryp13, vertex_to_connect);
  ...
  vertex_to_connect = 1;
  boundaryp21->connect_initial_vertex_to_polyline(boundaryp12,
                                                  vertex_to_connect);

  boundaryp21->connect_final_vertex_to_polyline(boundaryp20, vertex_to_connect);
  ...
  // -----------------------------------------------------------------------
  triangle_mesh_parameters.internal_closed_curve_pt() = internal_boundaries_pt;
  // -----------------------------------------------------------------------
