  ...
  void actions_after_adapt()
  {
    ...
    for (unsigned e = 0; e < n_element; e++)
    {
      ...
      if (mesh_pt()->finite_element_pt(e)->node_pt(0)->x(0) == 0.0 &&
          mesh_pt()->finite_element_pt(e)->node_pt(0)->x(1) ==
            0.0) // 2d problem
      {
...
RefineableDrivenCavityProblem<ELEMENT>::RefineableDrivenCavityProblem()
{
  ...
  my_mesh_pt->spatial_error_estimator_pt() = new DummyErrorEstimator(
    my_mesh_pt, elements_to_refine, central_node_number);
