...
private:
  ...
  /// \short Actions before distribute: Wipe the mesh of prescribed flux
  /// elements (simply call actions_before_adapt() which does the same thing)
...
//========================================================================
template<class ELEMENT>
void RefineableTwoMeshFluxPoissonProblem<ELEMENT>::doc_solution(
  DocInfo &doc_info)
{
  // Doc refinement levels in bulk mesh
  unsigned min_refinement_level;
  ...
  sprintf(filename,
          "%s/soln_with_halo%i_on_proc%i.dat",
...
//=======================================================================
template<class ELEMENT>
void RefineableTwoMeshFluxPoissonProblem<ELEMENT>::create_flux_elements(
...
//=======================================================================
template<class ELEMENT>
void RefineableTwoMeshFluxPoissonProblem<ELEMENT>::delete_flux_elements(
  Mesh *const &surface_mesh_pt)
{
...
int main(int argc, char *argv[])
{
  ...
  char filename[100];
  sprintf(
    filename, "RESLT/OUTPUT.%i", MPI_Helpers::communicator_pt()->my_rank());
  ...
  RefineableTwoMeshFluxPoissonProblem<RefineableQPoissonElement<2, 3>> problem(
  ...
  for (unsigned istep = 0; istep < nstep; istep++)
  {
    ...
    cout << "\n\nSolving for TanhSolnForPoisson::Alpha="
         << TanhSolnForPoisson::Alpha << std::endl
         << std::endl;
