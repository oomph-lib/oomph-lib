...
//=========================================================================
template<class ELEMENT>
class RefineableElasticCubicMesh :
  ...
  for (unsigned i = 0; i < 2; i++)
  {
    ...
    //-------------------------------------------
    {
...
#ifdef REFINE
      {
        ...
        CantileverProblem<RefineableQPVDElement<3, 3>> problem(incompress,
                                                               use_fd);
      ...
      {
        // Set up the problem with pure displacement based elements
        CantileverProblem<QPVDElement<3, 3>> problem(incompress, use_fd);
      ...
      {
        // Set up the problem with discontinous pressure/displacement
        CantileverProblem<QPVDElementWithPressure<3>> problem(incompress,
                                                              use_fd);
