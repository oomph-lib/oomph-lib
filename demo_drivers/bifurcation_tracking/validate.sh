...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/fold.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/pitch.dat.gz pitch.dat >>validation.log
fi
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/hopf.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/adaptive_pitch.dat.gz adaptive_pitch.dat \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/adaptive_hopf.dat.gz adaptive_hopf.dat \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/periodic_orbit.dat.gz periodic_orbit.dat \
