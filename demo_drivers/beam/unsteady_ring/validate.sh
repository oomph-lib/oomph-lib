...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/lin_unsteady_results.dat.gz \
...
if test "$2" = "no_fpdiff"; then
  ...
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/unsteady_results.dat.gz \
   unsteady_results.dat >> validation.log
  $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/restarted_unsteady_results.dat.gz \
