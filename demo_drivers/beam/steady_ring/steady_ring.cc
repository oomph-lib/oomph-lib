                                               ...
                                               ofstream& trace_file)
{
  ...
  trace_file << Global_Physical_Variables::Pext_data_pt->value(0) /
...
void ElasticRingProblem<ELEMENT>::parameter_study(DocInfo& doc_info)
{
  ...
  Global_Physical_Variables::Pext_data_pt->set_value(0,
                                                     p_buckl - pext_increment);
...
int main()
{
  ...
  //----------------------------------------------------------------------------
  {
    ...
    // Set up the problem
    ElasticRingProblem<HermiteBeamElement> problem(
      n_element, displ_control, load_data_already_exists);
