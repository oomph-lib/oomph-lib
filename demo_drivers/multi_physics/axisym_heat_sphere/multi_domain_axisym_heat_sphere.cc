...
public:
  ...
  void actions_after_adapt()
  {
    ...
    Multi_domain_functions::setup_multi_domain_interactions<NST_ELEMENT,
                                                            AD_ELEMENT>(
                                ...
                                const double& length)
{
  ...
  // Build meshes
  Nst_mesh_pt = new RefineableHalfRectangleWithHoleMesh<NST_ELEMENT>(
    cylinder_pt, radius, length, 49.0, 2, 49.0, 2, 1.0, 2);
  Adv_diff_mesh_pt = new RefineableHalfRectangleWithHoleMesh<AD_ELEMENT>(
    cylinder_pt, radius, length, 49.0, 2, 49.0, 2, 1.0, 2);
