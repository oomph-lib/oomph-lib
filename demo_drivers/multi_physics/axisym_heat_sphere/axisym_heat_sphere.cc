...
public:
 ...
 AdaptiveHalfRectangleWithHoleMesh<ELEMENT>* mesh_pt() 
  {
   return dynamic_cast<AdaptiveHalfRectangleWithHoleMesh<ELEMENT>*>
    (Problem::mesh_pt());
  }
...
{ 
 ...
 // Build mesh
 Problem::mesh_pt()=
  new AdaptiveHalfRectangleWithHoleMesh<ELEMENT>(cylinder_pt,radius,length,
                                                 49.0,2,49.0,2,1.0,2);
