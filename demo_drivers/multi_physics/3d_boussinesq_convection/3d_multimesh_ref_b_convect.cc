...
public:
  ...
  /// \short Switch to the iterative linear solve
...
//========================================================================
template<class NST_ELEMENT, class AD_ELEMENT>
RefineableConvectionProblem<NST_ELEMENT,
                            AD_ELEMENT>::RefineableConvectionProblem()
{
...
//========================================================================
template<class NST_ELEMENT, class AD_ELEMENT>
void RefineableConvectionProblem<NST_ELEMENT,
                                 AD_ELEMENT>::actions_before_newton_solve()
{
...
int main(int argc, char** argv)
{
  ...
  RefineableConvectionProblem<
    ...
    RefineableQAdvectionDiffusionElementWithExternalElement<3>>
    problem;
