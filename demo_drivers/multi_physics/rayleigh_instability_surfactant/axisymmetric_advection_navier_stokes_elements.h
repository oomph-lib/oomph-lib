...
namespace oomph
{
  ...
  public:
    ...
    {
      AxisymmetricNavierStokesEquations::scalar_value_paraview(
        file_out, i, nplot);
      AxisymAdvectionDiffusionEquations::scalar_value_paraview(
        file_out, i, nplot);
    }
    ...
    inline unsigned u_index_axi_adv_diff() const
    {
      return 3;
    }
    ...
    void fill_in_contribution_to_residuals(Vector<double>& residuals)
    {
      ...
      AxisymAdvectionDiffusionEquations::fill_in_contribution_to_residuals(
        residuals);
    }
                                          ...
                                          DenseMatrix<double>& jacobian)
    {
      ...
      AxisymAdvectionDiffusionEquations::fill_in_contribution_to_jacobian(
        residuals, jacobian);
  ...
  template<>
  class FaceGeometry<
    FaceGeometry<AxisymmetricQAdvectionCrouzeixRaviartElement>> :
