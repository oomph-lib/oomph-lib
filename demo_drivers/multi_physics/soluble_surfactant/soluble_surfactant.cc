...
namespace oomph
{
  ...
  public:
    ...
    void output(std::ostream& outfile, const unsigned& n_plot)
    {
      ...
      for (unsigned l = 0; l < n_plot; l++)
      {
        ...
        outfile << interpolated_T(s) << " " << interpolated_C(s) << std::endl;
      }
      outfile << std::endl;
    }
  };
  ...
  template<class ELEMENT>
  double SpineLineMarangoniSurfactantFluidInterfaceElement<
...
namespace Global_Physical_Variables
{
  ...
  /// \short The ratio of bulk diffusion to surface diffusion
  double DD_s = 1000.0;
