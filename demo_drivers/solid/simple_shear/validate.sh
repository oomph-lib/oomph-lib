...
if test "$2" = "no_fpdiff"; then
    ...
    $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/res.dat.gz \
        res.dat 0.1 2.0e-10 >>validation.log
    $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/res_pres.dat.gz \
        res_pres.dat 0.1 3.5e-10 >>validation.log
    $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/res_cont_pres.dat.gz \
...
if test "$2" = "no_fpdiff"; then
    ...
    $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/res_ref.dat.gz \
        res_ref.dat 0.1 4.0e-10 >>validation.log
    $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/res_pres_ref.dat.gz \
        res_pres_ref.dat 0.1 4.0e-10 >>validation.log
    $OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/res_cont_pres_ref.dat.gz \
