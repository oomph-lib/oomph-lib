...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/static_disk_compression_results0.dat.gz \
    static_disk_compression_results0.dat  >> validation.log

$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/static_disk_compression_results1.dat.gz \
    static_disk_compression_results1.dat  >> validation.log

$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/static_disk_compression_results2.dat.gz \
    static_disk_compression_results2.dat  >> validation.log

$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/static_disk_compression_results3.dat.gz \
    static_disk_compression_results3.dat  >> validation.log

$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/static_disk_compression_results4.dat.gz \
    static_disk_compression_results4.dat  >> validation.log

$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/static_disk_compression_results5.dat.gz \
