...
public:
  ...
  ElasticRefineableCollapsibleChannelMesh<ELEMENT>(
    ...
    CollapsibleChannelMesh<ELEMENT>(nup,
                                    ...
                                    wall_pt,
                                    time_stepper_pt),
    RefineableCollapsibleChannelMesh<ELEMENT>(nup,
                                              ncollapsible,
                                              ndown,
                                              ny,
                                              lup,
  ...
  const double &period)
{
  ...
  // Build mesh
  Bulk_mesh_pt =
    new ElasticRefineableCollapsibleChannelMesh<ELEMENT>(nup,
                                                         ncollapsible,
                                                         ndown,
                                                         ny,
                                                         lup,
  ...
  // Use new nodal positions to define undeformed configuration
...
//=======================================================================
template<class ELEMENT>
void CollapsibleChannelProblem<ELEMENT>::create_lagrange_multiplier_elements()
{
  ...
  for (unsigned i = 0; i < n_element; i++)
  {
    ...
    // specify which bulk boundary it's attached to
    el_pt->set_boundary_shape_geom_object_pt(Wall_pt, b);
...
//=======================================================================
template<class ELEMENT>
void CollapsibleChannelProblem<ELEMENT>::delete_lagrange_multiplier_elements()
{
  // How many surface elements are in the surface mesh
