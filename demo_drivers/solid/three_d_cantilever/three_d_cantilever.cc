...
//   solid_mesh_pt())->spatial_error_estimator_pt()=new Z2ErrorEstimator;
  ...
  //Now create the mesh 
 solid_mesh_pt() = new RefineableElasticQuarterTubeMesh<ELEMENT>
 ...
 solid_mesh_pt()->max_permitted_error()=0.05;
 solid_mesh_pt()->min_permitted_error()=0.005;
 ...
 //Now create the mesh 
 solid_mesh_pt() = new ElasticQuarterTubeMesh<ELEMENT>
  (wall_pt,xi_lo,frac_mid,xi_hi,nlayer);
...
void CantileverProblem<ELEMENT>::run_it(const unsigned& i_case)
{
 ...
 solid_mesh_pt()->output_boundaries("boundaries.dat");
