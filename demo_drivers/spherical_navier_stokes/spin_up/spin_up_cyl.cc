                                               ...
                                               const string& output_dir)
{
  ...
  for (unsigned istep = 0; istep < nstep; istep++)
  {
    ...
    trace_file << this->time() << " " << nod_pt->x(0) << " " << nod_pt->x(1)
               << " " << nod_pt->value(2) << " " << nod2_pt->x(0) << " "
               << nod2_pt->x(1) << " " << nod2_pt->value(2) << " "
...
int main()
{
  ...
  // Doing QTaylorHoodElements
  {
    ...
    SphericalSpinUpProblem<RefineableAxisymmetricQTaylorHoodElement> problem;
