...
{
  //======================================================================
  // QIntegralElement<DIM,NNODE_1D> elements are linear/quadrilateral/
  // brick-shaped Integral elements with NNODE_1D nodal points along each
  // element edge. Inherits from QElement and IntegralEquations
  // Isoparametric interpolation for the integrand function.
  //======================================================================
  ...
  public:
    ...
    // Call integral equations output
