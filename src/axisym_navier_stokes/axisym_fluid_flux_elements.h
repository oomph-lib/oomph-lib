...
namespace oomph
{
  ...
  class AxisymmetricFluidFluxElement
  ...
  public:
    ...
    AxisymmetricFluidFluxElement(FiniteElement* const& element_pt,
  ...
  /// AxisymmetricFluidFluxElement equations
  //=====================================================================
  template<class ELEMENT>
  void AxisymmetricFluidFluxElement<ELEMENT>::
    fill_in_contribution_to_residuals_axisymmetric_nst_flux(
      Vector<double>& residuals, DenseMatrix<double>& jacobian, unsigned flag)
  {
