...
//quite rightly, it shouts.
 /*void operator=(const RefineableGeneralisedAxisymAdvectionDiffusionEquations&) 
  {
 ...
 void further_build()
  {
   ...
   this->Conserved_wind_fct_pt = cast_father_element_pt->
 ...
 public virtual RefineableQElement<2>
{
 ...
 /// Broken assignment operator
 /*void operator=(const RefineableQGeneralisedAxisymAdvectionDiffusionElement<
                NNODE_1D>&) 
  {
   BrokenCopy::broken_assign(
    "RefineableQuadGeneralisedAxisymAdvectionDiffusionElement");
 ...
 {return 
    QGeneralisedAxisymAdvectionDiffusionElement<NNODE_1D>::nvertex_node();}

 /// \short Pointer to the j-th vertex node in the element
 Node* vertex_node_pt(const unsigned& j) const
  {return 
    QGeneralisedAxisymAdvectionDiffusionElement<NNODE_1D>::vertex_node_pt(j);}
...
//=======================================================================
template<unsigned NNODE_1D>
class FaceGeometry<RefineableQGeneralisedAxisymAdvectionDiffusionElement<
NNODE_1D> >: 
