...
//==============================================================
/// FaceGeometry of the FaceGeometry of the 2D RefineableQLinearElasticityElement 
//==============================================================
template<unsigned NNODE_1D>
...
//==============================================================
/// FaceGeometry of the FaceGeometry of the 3D RefineableQLinearElasticityElement
//==============================================================
template<unsigned NNODE_1D>
...
//===========================================================================
template<unsigned DIM>
class RefineableLinearElasticityEquationsWithPressure : 
...
public:
 ...
 /// \short Constructor:
 RefineableLinearElasticityEquationsWithPressure() :
  ...
  if (flux.size()!=num_entries)
   {
    ...
    error_message << "The flux vector has the wrong number of entries, " 
                  ...
                  << num_entries << std::endl;
    throw OomphLibError(error_message.str(),
                        "RefineableLinearElasticityEquationsWithPressure::get_Z2_flux()",
                        OOMPH_EXCEPTION_LOCATION);
   }
#endif
...
/// Number of continuously interpolated values: 0 (pure solid problem)
 ...
 void further_build()
  {
   RefineableLinearElasticityEquationsWithPressure<DIM>* cast_father_element_pt
    = dynamic_cast<RefineableLinearElasticityEquationsWithPressure<DIM>*>
    (this->father_element_pt());
...
//===========================================================================
template<unsigned DIM>
class RefineableQLinearElasticityElementWithPressure : 
public virtual QLinearElasticityElementWithPressure<DIM>,
public virtual RefineableLinearElasticityEquationsWithPressure<DIM>,
public virtual RefineableSolidQElement<DIM>
{
  public:
 
 /// \short Constructor: 
 RefineableQLinearElasticityElementWithPressure() :
  QLinearElasticityElementWithPressure<DIM>(),
  RefineableElement(),
  RefineableSolidElement(),
  RefineableLinearElasticityEquationsWithPressure<DIM>(),
 ...
 /// \short Number of vertex nodes in the element
 unsigned nvertex_node() const
  {return QLinearElasticityElementWithPressure<DIM>::nvertex_node();}

 /// \short Pointer to the j-th vertex node in the element
 Node* vertex_node_pt(const unsigned& j) const
  {return QLinearElasticityElementWithPressure<DIM>::vertex_node_pt(j);}
...
//======================================================================
///FaceGeometry of the 2D RefineableQLinearElasticityElementWithPressure
//=======================================================================
template<>
class FaceGeometry<RefineableQLinearElasticityElementWithPressure<2> >:
...
//===========================================================================
///FaceGeometry of the FaceGeometry of the 2D RefineableQLinearElasticityElementWithPressure
//============================================================================ 
template<>
class FaceGeometry<FaceGeometry<RefineableQLinearElasticityElementWithPressure<2> > >:
public virtual PointElement
{
  public:
 //Make sure that we call the constructor of the SolidQElement
...
//===================================================================
template<>
 inline void RefineableQLinearElasticityElementWithPressure<2>::
 ...
 for (unsigned ison=0;ison<4;ison++)
  {
   ...
   centre_solid_p[ison] = 
    dynamic_cast<RefineableQLinearElasticityElementWithPressure<2>*>
...
//=============================================================
template<>
inline void RefineableQLinearElasticityElementWithPressure<2>::further_build()
{
 RefineableLinearElasticityEquationsWithPressure<2>::further_build();
 ...
 // South west son
   ...
   RefineableQLinearElasticityElementWithPressure<2>* cast_father_element_pt=
    dynamic_cast<RefineableQLinearElasticityElementWithPressure<2>*>(father_el_pt);
...
//===============================================================
template<>
inline void RefineableQLinearElasticityElementWithPressure<3>::
rebuild_from_sons(Mesh* &mesh_pt) 
{
...
//=================================================================
template<>
inline void RefineableQLinearElasticityElementWithPressure<3>::further_build()

 {
  RefineableLinearElasticityEquationsWithPressure<3>::further_build();
  ...
  using namespace OcTreeNames;
   ...
   // Pressure value in father element
   RefineableQLinearElasticityElementWithPressure<3>* cast_father_element_pt=
    dynamic_cast<RefineableQLinearElasticityElementWithPressure<3>*>(father_el_pt);
...
//=========================================================================
///FaceGeometry of the 3D RefineableQLinearElasticityElementWithPressure
//========================================================================
template<>
class FaceGeometry<RefineableQLinearElasticityElementWithPressure<3> >:
...
//========================================================================
///FaceGeometry of the FaceGeometry of the 3D RefineableQLinearElasticityElementWithPressure
//========================================================================== 
template<>
class FaceGeometry<FaceGeometry<RefineableQLinearElasticityElementWithPressure<3> > >:
public virtual SolidQElement<1,3>
{
  public:
 //Make sure that we call the constructor of the SolidQElement
...
//===========================================================================
template<unsigned DIM>
class RefineableQLinearElasticityElementWithContinuousPressure : 
public virtual QLinearElasticityElementWithContinuousPressure<DIM>, 
public virtual RefineableLinearElasticityEquationsWithPressure<DIM>,
public virtual RefineableSolidQElement<DIM>
{
 ...
 /// \short Constructor:
 RefineableQLinearElasticityElementWithContinuousPressure() :
  QLinearElasticityElementWithContinuousPressure<DIM>(),
  RefineableElement(),
  RefineableSolidElement(),
  RefineableLinearElasticityEquationsWithPressure<DIM>(), 
  RefineableSolidQElement<DIM>() {}
 ...
 void  pin_elemental_redundant_nodal_solid_pressures()
  {
   ...
   unsigned Nsolid_pres = this->nsolid_pres();
...
/// \short Number of vertex nodes in the element
 unsigned nvertex_node() const
  {return QLinearElasticityElementWithContinuousPressure<DIM>::nvertex_node();}

 /// \short Pointer to the j-th vertex node in the element
 Node* vertex_node_pt(const unsigned& j) const
  {
   return QLinearElasticityElementWithContinuousPressure<DIM>::vertex_node_pt(j);
  }
...
//=========================================================================
///FaceGeometry of the 2D RefineableQLinearElasticityElementWithContinuousPressure elements
//=========================================================================
template<>
class FaceGeometry<RefineableQLinearElasticityElementWithContinuousPressure<2> >:
 public virtual SolidQElement<1,3>
{
  public:
 //Make sure that we call the constructor of the SolidQElement
...
class FaceGeometry<FaceGeometry<
 RefineableQLinearElasticityElementWithContinuousPressure<2> > >:
 public virtual PointElement
{
  public:
 //Make sure that we call the constructor of the SolidQElement
...
//=========================================================================
///FaceGeometry of the 3D RefineableQLinearElasticityElementWithContinuousPressure
//=========================================================================
template<>
class FaceGeometry<RefineableQLinearElasticityElementWithContinuousPressure<3> >:
 public virtual SolidQElement<2,3>
{
  public:
 //Make sure that we call the constructor of the SolidQElement
...
///RefineableQLinearElasticityElementWithContinuousPressue
//=========================================================================
template<>
class FaceGeometry<FaceGeometry<
 RefineableQLinearElasticityElementWithContinuousPressure<3> > >:
public virtual SolidQElement<1,3>
{
  public:
 //Make sure that we call the constructor of the SolidQElement
