...
namespace oomph
{
  ...
  TimeStepper* time_stepper_pt) : Thickness_fct_pt(thickness_fct_pt)
 {
  ...
  // Highest boundary ID
  unsigned highest_fluid_bound_id=*std::max_element(all_bnd.begin(),
                                                    all_bnd.end());
    ...
    for(unsigned e=0;e<nel;e++)
     {
      ...
      for (unsigned j=0;j<3;j++)
       {
          ...
          if (only_on_fsi)
           {
            ...
            if (nlayer==1)
             {
              Node* new_nod_pt = 
               new_el_pt[j][0]->construct_boundary_node(j_local+18,
                                                        time_stepper_pt); 
              connected_node_pt[new_node_pt].push_back(new_nod_pt);
              Node_pt.push_back(new_nod_pt);
             }
            ...
            for (unsigned ilayer=1;ilayer<nlayer;ilayer++)
             {
              ...
              // Create new nodes
              Node* new_nod_pt=
               new_el_pt[j][ilayer]->construct_node(j_local+9,
                                                    time_stepper_pt);
              connected_node_pt[new_node_pt].push_back(new_nod_pt);
              Node_pt.push_back(new_nod_pt);
              ...
              if (ilayer!=(nlayer-1))
               {
                Node* new_nod_pt=
                 new_el_pt[j][ilayer]->construct_node(j_local+18,
                                                      time_stepper_pt);
                connected_node_pt[new_node_pt].push_back(new_nod_pt);
                Node_pt.push_back(new_nod_pt);
               }
              else
               {
                Node* new_nod_pt=
                 new_el_pt[j][ilayer]->
                 construct_boundary_node(j_local+18,
                                         time_stepper_pt);
                connected_node_pt[new_node_pt].push_back(new_nod_pt);
                Node_pt.push_back(new_nod_pt);
               }
          ...
          else
           {
            ...
            Node* new_nod_pt=
             new_el_pt[j][0]->construct_boundary_node(j_local+9,
                                                      time_stepper_pt);
            connected_node_pt[new_node_pt].push_back(new_nod_pt);
            Node_pt.push_back(new_nod_pt);
            ...
            for (unsigned ilayer=1;ilayer<nlayer;ilayer++)
             {
              ...
              Node* new_nod_pt=
               new_el_pt[j][ilayer]->construct_boundary_node(j_local+9,
                                                             time_stepper_pt);
              connected_node_pt[new_node_pt].push_back(new_nod_pt);
              Node_pt.push_back(new_nod_pt);
              new_nod_pt=
               new_el_pt[j][ilayer]->construct_boundary_node(j_local+18,
                                                             time_stepper_pt);
              connected_node_pt[new_node_pt].push_back(new_nod_pt);
              Node_pt.push_back(new_nod_pt);
             }
            ...
            for (unsigned ilayer=1;ilayer<nlayer;ilayer++)
             {
              ...
              Node* new_nod_pt=
               new_el_pt[j][ilayer]->
               construct_boundary_node(j_local+9,
                                       time_stepper_pt);
              connected_node_pt[new_node_pt].push_back(new_nod_pt);
              Node_pt.push_back(new_nod_pt);
              new_nod_pt=
        ...
        if (existing_node_pt==0)
         {
          ...
          set_intersection((*bnd1_pt).begin(),(*bnd1_pt).end(),
                           (*bnd2_pt).begin(),(*bnd2_pt).end(),
                           inserter(bnd, bnd.begin())); 
          bool only_on_fsi=true;
          for (std::set<unsigned>::iterator it=bnd.begin();
               it!=bnd.end();it++)
           {
            if (!is_on_fsi_boundary[(*it)]) only_on_fsi=false;
            add_boundary_node((*it),new_node_pt);
        ...
        switch(j)
         {
         case 0: other_node=5; jj=11; break;
         case 1: other_node=3; jj=7;  break;
         case 2: other_node=4; jj=9; break;
         }
      ...
      if (nlayer==1)
       {
        Node* new_nod_pt = 
         new_el_pt[2][0]->construct_boundary_node(j_local+18,time_stepper_pt); 
        connected_node_pt[new_node_pt].push_back(new_nod_pt);
        Node_pt.push_back(new_nod_pt);
       }
      else
      ...
      for (unsigned ilayer=1;ilayer<nlayer;ilayer++)
       {
        ...
        if (ilayer!=(nlayer-1))
         {
          Node* new_nod_pt=
           new_el_pt[2][ilayer]->construct_node(j_local+18,
                                                time_stepper_pt);
          connected_node_pt[new_node_pt].push_back(new_nod_pt);
          Node_pt.push_back(new_nod_pt);
         }
        ...
        for (unsigned j=0;j<9;j++)
         {
                ...
                if (face_index!=0)
                 {
                  ...
                  if (k%2==1)
                   {
                    Boundary_element_pt[(*it)].
                     push_back(new_el_pt[j_stack][ilayer]);
          ...
          if (j==4) 
           {
            Boundary_element_pt[Outer_boundary_id].
             push_back(new_el_pt[j_stack][nlayer-1]);
            int face_index=3;
