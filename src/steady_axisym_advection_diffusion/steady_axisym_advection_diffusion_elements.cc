...
namespace oomph
{
      ...
      for (unsigned l = 0; l < n_node; l++)
      {
        ...
        if (local_eqn >= 0)
        {
          ...
          for (unsigned k = 0; k < 2; k++)
          {
            ...
            residuals[local_eqn] -=
              r * interpolated_dudx[k] *
              (scaled_peclet * wind[k] * test(l) + dtestdx(l, k)) * W;
          }
              ...
              if (local_unknown >= 0)
              {
                ...
                for (unsigned i = 0; i < 2; i++)
                {
                  ...
                  jacobian(local_eqn, local_unknown) -=
                    r * dpsidx(l2, i) *
                    (scaled_peclet * wind[i] * test(l) + dtestdx(l, i)) * W;
                }
              }
            }
          }
  ...
  const unsigned
    QSteadyAxisymAdvectionDiffusionElement<NNODE_1D>::Initial_Nvalue = 1;
