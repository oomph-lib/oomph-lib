...
namespace oomph
{
  ...
  template<unsigned DIM>
  int
    SpaceTimeNavierStokesMixedOrderEquations<DIM>::Pressure_not_stored_at_node =
      -100;

  /// Navier-Stokes equations static data
  template<unsigned DIM>
  double SpaceTimeNavierStokesMixedOrderEquations<
  ...
  template<unsigned DIM>
  Vector<double> SpaceTimeNavierStokesMixedOrderEquations<
  ...
  //======================================================================
  template<unsigned DIM>
  void SpaceTimeNavierStokesMixedOrderEquations<DIM>::compute_norm(
    Vector<double>& norm)
  {
  ...
  //=======================================================================
  template<unsigned DIM>
  void SpaceTimeNavierStokesMixedOrderEquations<DIM>::output_fct(
    std::ostream& outfile,
  ...
  //==============================================================
  template<unsigned DIM>
  void SpaceTimeNavierStokesMixedOrderEquations<DIM>::output_veloc(
    std::ostream& outfile, const unsigned& n_plot, const unsigned& t)
  {
  ...
  //==============================================================
  template<unsigned DIM>
  void SpaceTimeNavierStokesMixedOrderEquations<DIM>::output(
  ...
  //==============================================================
  template<unsigned DIM>
  void SpaceTimeNavierStokesMixedOrderEquations<DIM>::full_output(
    std::ostream& outfile, const unsigned& n_plot)
  {
    // Vector of local coordinates
    Vector<double> s(DIM + 1, 0.0);
  ...
  //==============================================================
  template<unsigned DIM>
  void SpaceTimeNavierStokesMixedOrderEquations<DIM>::output_vorticity(
    std::ostream& outfile, const unsigned& n_plot)
  {
    // Vector of local coordinates
    Vector<double> s(DIM + 1, 0.0);
  ...
  //==============================================================
  template<unsigned DIM>
  void SpaceTimeNavierStokesMixedOrderEquations<DIM>::get_traction(
  ...
  //==============================================================
  template<unsigned DIM>
  double SpaceTimeNavierStokesMixedOrderEquations<DIM>::dissipation(
  ...
  //==============================================================
  template<unsigned DIM>
  void SpaceTimeNavierStokesMixedOrderEquations<DIM>::strain_rate(
  ...
  //==============================================================
  template<>
  void SpaceTimeNavierStokesMixedOrderEquations<2>::get_vorticity(
  ...
  template<>
  void SpaceTimeNavierStokesMixedOrderEquations<2>::get_vorticity(
    const Vector<double>& s, double& vorticity) const
  {
  ...
  //==============================================================
  template<unsigned DIM>
  double SpaceTimeNavierStokesMixedOrderEquations<DIM>::pressure_integral()
    const
  {
    // Initialise
    double press_int = 0;
                                              ...
                                              const unsigned& flag)
  {
    ...
    // Get the scaled Womersley number differentiated w.r.t. the Womersley
    // number
  ...
  //======================================================================
  template<unsigned DIM>
  void SpaceTimeNavierStokesMixedOrderEquations<
  ...
  //=========================================================================
  template<unsigned DIM>
  void QTaylorHoodMixedOrderSpaceTimeElement<DIM>::identify_load_data(
  ...
  //=========================================================================
  template<unsigned DIM>
  void QTaylorHoodMixedOrderSpaceTimeElement<DIM>::identify_pressure_data(
