...
#ifndef OOMPH_GENERAL_PURPOSE_SPACETIME_SUBSIDIARY_BLOCK_PRECONDITIONER_HEADER
#define OOMPH_GENERAL_PURPOSE_SPACETIME_SUBSIDIARY_BLOCK_PRECONDITIONER_HEADER
