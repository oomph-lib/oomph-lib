...
namespace oomph
{
  ...
  //============================================================================
  template <unsigned SPATIAL_DIM, unsigned NNODE_1D>
  void BlockPrecRefineableQUnsteadyHeatMixedOrderSpaceTimeElement<SPATIAL_DIM,NNODE_1D>::
  get_dof_numbers_for_unknowns(std::list<std::pair<unsigned long,unsigned> >&
                               dof_lookup_list) const
  {
    // Number of nodes
  ...
  template class BlockPrecRefineableQUnsteadyHeatMixedOrderSpaceTimeElement<2,2>;
  template class BlockPrecRefineableQUnsteadyHeatMixedOrderSpaceTimeElement<2,3>;
  template class BlockPrecRefineableQUnsteadyHeatMixedOrderSpaceTimeElement<2,4>;
