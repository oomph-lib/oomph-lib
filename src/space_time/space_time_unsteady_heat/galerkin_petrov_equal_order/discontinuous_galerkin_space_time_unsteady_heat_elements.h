...
#define OOMPH_DISCONTINUOUS_GALERKIN_SPACE_TIME_UNSTEADY_HEAT_ELEMENTS_HEADER
...
namespace oomph
{
  ...
  public:
    ...
    SpaceTimeUnsteadyHeatEquations(
      const SpaceTimeUnsteadyHeatEquations& dummy) = delete;
                                       ...
                                       DShape& dtestdx) const
  {
    ...
    OneDimDiscontinuousGalerkin::shape<NNODE_1D>(s[2], test_values[2]);
    OneDimDiscontinuousGalerkin::dshape<NNODE_1D>(s[2], dtest_values[2]);
