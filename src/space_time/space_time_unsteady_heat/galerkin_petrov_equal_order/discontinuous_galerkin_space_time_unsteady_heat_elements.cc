...
namespace oomph
{
  ...
  double SpaceTimeUnsteadyHeatEquations<SPATIAL_DIM>::Default_alpha_parameter=1.0;

  /// Default value for Beta parameter (thermal conductivity)
  template<unsigned SPATIAL_DIM>
  double SpaceTimeUnsteadyHeatEquations<SPATIAL_DIM>::Default_beta_parameter=1.0;

  //======================================================================
  // Set the data for the number of variables at each node
  //======================================================================
  template<unsigned SPATIAL_DIM, unsigned NNODE_1D>
  const unsigned QUnsteadyHeatSpaceTimeElement<SPATIAL_DIM,NNODE_1D>::Initial_Nvalue=1;
  ...
  //======================================================================
  template <unsigned SPATIAL_DIM>
  void SpaceTimeUnsteadyHeatEquations<SPATIAL_DIM>::output(std::ostream& outfile,
  ...
  //======================================================================
  template <unsigned SPATIAL_DIM>
  void SpaceTimeUnsteadyHeatEquations<SPATIAL_DIM>::output(FILE* file_pt,
      const unsigned& nplot)
  {
    // Vector of local coordinates
    Vector<double> s(SPATIAL_DIM+1,0.0);
