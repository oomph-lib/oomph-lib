...
/// \short du/dt at local node n. 
 ...
 /// \short Disable ALE -- empty overload to suppress warning. 
 ...
 inline double interpolated_u_spherical_adv_diff(const Vector<double> &s) const
  {
...
//======================================================================
/// \short QSphericalAdvectionDiffusionElement elements are 
...
class QSphericalAdvectionDiffusionElement : public virtual QElement<2,NNODE_1D>,
...
public:
 ...
 QSphericalAdvectionDiffusionElement() : QElement<2,NNODE_1D>(), 
 SphericalAdvectionDiffusionEquations()
  { }
...
public:
 ...
 SphericalAdvectionDiffusionFluxElement()
  {
   throw OomphLibError(
    "Don't call empty constructor for SphericalAdvectionDiffusionFluxElement",
 ...
 inline void fill_in_contribution_to_jacobian(Vector<double> &residuals,
  ...
  {
   //Call the generic routine with the flag set to 1
   fill_in_generic_residual_contribution_spherical_adv_diff_flux(residuals,
                                                       jacobian,
                                                       1);
  }
...
} //End SphericalAdvectionDiffusionFluxElement class
