...
public virtual RefineableQElement<2>
{
 ...
 Node* vertex_node_pt(const unsigned& j) const
  {
   return GeneralisedNewtonianAxisymmetricQTaylorHoodElement::vertex_node_pt(j);
  }
...
class FaceGeometry<
RefineableGeneralisedNewtonianAxisymmetricQTaylorHoodElement>: 
public virtual FaceGeometry<GeneralisedNewtonianAxisymmetricQTaylorHoodElement>
{
  public:
