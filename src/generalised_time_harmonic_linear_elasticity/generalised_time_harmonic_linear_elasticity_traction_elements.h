...
/// traction elements
//=======================================================================
namespace GeneralisedTimeHarmonicLinearElasticityTractionElementHelper
 {
...
public virtual FaceGeometry<ELEMENT>, 
 ...
 GeneralisedTimeHarmonicLinearElasticityTractionElement(FiniteElement* const &element_pt, 
 ...
 FaceGeometry<ELEMENT>(), FaceElement()
  { 
   ...
   // Zero traction
   Traction_fct_pt=
    &GeneralisedTimeHarmonicLinearElasticityTractionElementHelper::Zero_traction_fct;
...
//=====================================================================
template<class ELEMENT>
void GeneralisedTimeHarmonicLinearElasticityTractionElement<ELEMENT>::traction(
...
/// GeneralisedTimeHarmonicLinearElasticityTractionElement equations
//=====================================================================
template<class ELEMENT>
 void GeneralisedTimeHarmonicLinearElasticityTractionElement<ELEMENT>::
 fill_in_contribution_to_residuals_time_harmonic_linear_elasticity_traction(
  Vector<double> &residuals)
 {
  ...
  if(n_position_type != 1)
   {
    throw OomphLibError(
     "GeneralisedTimeHarmonicLinearElasticity is not yet implemented for more than one position type",
     OOMPH_CURRENT_FUNCTION,
     OOMPH_EXCEPTION_LOCATION);
   }
#endif
  ...
  for(unsigned ipt=0;ipt<n_intpt;ipt++)
   {
    ...
    switch(n_dim)
     ...
     default:
      throw 
       OomphLibError(
        "Wrong dimension in GeneralisedTimeHarmonicLinearElasticityTractionElement",
        "GeneralisedTimeHarmonicLinearElasticityTractionElement::fill_in_contribution_to_residuals()",
        OOMPH_EXCEPTION_LOCATION);
     }
