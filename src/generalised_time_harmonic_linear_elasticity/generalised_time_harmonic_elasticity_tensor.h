...
class GeneralisedTimeHarmonicElasticityTensor
 {
  ...
  ///Empty Constructor
  GeneralisedTimeHarmonicElasticityTensor() {}

 public:

  ///Empty virtual Destructor 
  virtual ~GeneralisedTimeHarmonicElasticityTensor() {}
...
public GeneralisedTimeHarmonicElasticityTensor
  {
  ...
  /// equations).
  GeneralisedTimeHarmonicIsotropicElasticityTensor(const double &nu,
                                        const double &E) : 
   GeneralisedTimeHarmonicElasticityTensor(), Nu(nu)
   {
