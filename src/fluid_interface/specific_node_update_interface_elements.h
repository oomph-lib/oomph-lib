...
//======================================================================
/// \short Number of additional nodal values policy class. This is used
/// to allow additional values to be added to the nodes from our
/// new equations. This is a way of saving storage and will
/// only be filled in by "expert users". Again, this is only
/// required if you wish to use the generic template classes below.
/// If you overload from a specific class you can always do what you
/// want!
//=====================================================================
template<class ELEMENT>
 class FluidInterfaceAdditionalValues
 {
  ...
  //required. Default is zero
  inline unsigned nadditional_values(const unsigned &n) {return 0;}
 };
...
/// be combined with a given surface equations class to provide
/// a concrete implementation of any surface element.
//======================================================================
 template<class EQUATION_CLASS, class ELEMENT>
  ...
  public virtual EQUATION_CLASS 
  {
   ...
   Hijacked<SpineElement<FaceGeometry<ELEMENT> > >(), 
    EQUATION_CLASS()
     {
      ...
      const unsigned n_u_index = this->U_index_interface.size();
     ...
     const int &face_index)
    {
     ...
     //our policy class
     BoundingElementType<SpineUpdateFluidInterfaceElement<EQUATION_CLASS,ELEMENT> > *face_el_pt =
      new BoundingElementType<SpineUpdateFluidInterfaceElement<EQUATION_CLASS,ELEMENT> >;
...
template<class ELEMENT>
 ...
 public SpineUpdateFluidInterfaceElement<LineFluidInterfaceElement,
 ELEMENT>
{
public:
 ...
 SpineLineFluidInterfaceElement(
  ...
  const int &face_index) : 
  SpineUpdateFluidInterfaceElement<LineFluidInterfaceElement,ELEMENT>(element_pt,face_index) {}
};


//Define the BoundingElement type associated with the 1D surface element
template<class ELEMENT>
 class BoundingElementType<SpineUpdateFluidInterfaceElement<LineFluidInterfaceElement,ELEMENT> >:
 public SpinePointFluidInterfaceBoundingElement<ELEMENT>
 {
   public:
  
  BoundingElementType<SpineUpdateFluidInterfaceElement<LineFluidInterfaceElement,ELEMENT> >() :
...
//Specialise Spine update case to concrete axisymmetric case
 ...
 public SpineUpdateFluidInterfaceElement<AxisymmetricFluidInterfaceElement,
 ELEMENT>
{
public:
 ...
 SpineAxisymmetricFluidInterfaceElement(
  FiniteElement* const &element_pt, 
  const int &face_index) : 
  SpineUpdateFluidInterfaceElement<AxisymmetricFluidInterfaceElement,ELEMENT>(element_pt,face_index) {}
};

//Define the bounding element associated with the axisymmetric fluid interface element 
template<class ELEMENT>
 class BoundingElementType<SpineUpdateFluidInterfaceElement<AxisymmetricFluidInterfaceElement,ELEMENT> >:
 public SpinePointFluidInterfaceBoundingElement<ELEMENT>
 {
   public:
  
  BoundingElementType<SpineUpdateFluidInterfaceElement<AxisymmetricFluidInterfaceElement,ELEMENT> >() :
  SpinePointFluidInterfaceBoundingElement<ELEMENT>() { }
 };
...
//Specialise Spine update case to concrete 2D case 
 ...
 public SpineUpdateFluidInterfaceElement<SurfaceFluidInterfaceElement,
 ELEMENT>
{
public:
 ...
 SpineSurfaceFluidInterfaceElement(
  FiniteElement* const &element_pt, 
  const int &face_index) : 
  SpineUpdateFluidInterfaceElement<SurfaceFluidInterfaceElement,ELEMENT>(element_pt,face_index) {}
};

//Define the bounding element type for the 2D surface 
template<class ELEMENT>
 class BoundingElementType<SpineUpdateFluidInterfaceElement<SurfaceFluidInterfaceElement,ELEMENT> >:
 public SpineLineFluidInterfaceBoundingElement<ELEMENT>
 {
   public:
  
  BoundingElementType<SpineUpdateFluidInterfaceElement<SurfaceFluidInterfaceElement,ELEMENT> >() :
 ...
 public virtual Hijacked<FaceGeometry<ELEMENT> >, 
  ...
  /// on construction of this element.
   ...
   ElasticUpdateFluidInterfaceElement(FiniteElement* const &element_pt, 
                                       const int &face_index,
                                      const unsigned &id=0) : 
   FaceGeometry<ELEMENT>(), EQUATION_CLASS()
   {
     ...
     const int &face_index)
    {
     ...
     BoundingElementType<ElasticUpdateFluidInterfaceElement<EQUATION_CLASS,ELEMENT> > *face_el_pt =
      new BoundingElementType<ElasticUpdateFluidInterfaceElement<EQUATION_CLASS,ELEMENT> >;
...
template<class ELEMENT>
 ...
 public ElasticUpdateFluidInterfaceElement<LineFluidInterfaceElement,
 ELEMENT>
{
public:
 ...
 ElasticUpdateFluidInterfaceElement<LineFluidInterfaceElement,ELEMENT>(element_pt,face_index,id) {}
};

///Define the BoundingElement type associated with the 1D surface element
template<class ELEMENT>
 class BoundingElementType<ElasticUpdateFluidInterfaceElement<LineFluidInterfaceElement,ELEMENT> >:
 public ElasticPointFluidInterfaceBoundingElement<ELEMENT>
 {
   public:
  
  BoundingElementType<ElasticUpdateFluidInterfaceElement<LineFluidInterfaceElement,ELEMENT> >() :
...
template<class ELEMENT>
 ...
 public ElasticUpdateFluidInterfaceElement<AxisymmetricFluidInterfaceElement,
 ELEMENT>
{
public:
 ...
 ElasticAxisymmetricFluidInterfaceElement(
  FiniteElement* const &element_pt, 
  const int &face_index, const unsigned &id=0) : 
 ElasticUpdateFluidInterfaceElement<AxisymmetricFluidInterfaceElement,ELEMENT>(element_pt,face_index,id) {}
};

//Define the bounding element associated with the axsymmetric elastic fluid interface element
template<class ELEMENT>
 class BoundingElementType<ElasticUpdateFluidInterfaceElement<AxisymmetricFluidInterfaceElement,ELEMENT> >:
 public ElasticPointFluidInterfaceBoundingElement<ELEMENT>
 {
   public:
  
  BoundingElementType<ElasticUpdateFluidInterfaceElement<AxisymmetricFluidInterfaceElement,ELEMENT> >() :
  ElasticPointFluidInterfaceBoundingElement<ELEMENT>() { }
 };
...
template<class ELEMENT>
 ...
 public ElasticUpdateFluidInterfaceElement<SurfaceFluidInterfaceElement,
 ELEMENT>
{
public:
 ...
 ElasticSurfaceFluidInterfaceElement(
  FiniteElement* const &element_pt, 
  const int &face_index, const unsigned &id=0) : 
 ElasticUpdateFluidInterfaceElement<SurfaceFluidInterfaceElement,ELEMENT>(element_pt,face_index,id) {}
};


//Define the bounding element associated with the 2D surface elements
template<class ELEMENT>
 class BoundingElementType<ElasticUpdateFluidInterfaceElement<SurfaceFluidInterfaceElement,ELEMENT> >:
 public ElasticLineFluidInterfaceBoundingElement<ELEMENT>
 {
   public:
  
  BoundingElementType<ElasticUpdateFluidInterfaceElement<SurfaceFluidInterfaceElement,ELEMENT> >() :
