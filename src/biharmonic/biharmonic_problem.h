...
//=============================================================================
template<unsigned DIM> class BiharmonicPlateProblem : public Problem
{
...
protected:
 ...
 void impose_surface_load(const BiharmonicSourceFctPt source_fct_pt)
  {
 ...
 void impose_clamped_edge(const unsigned& b, DirichletBCFctPt u_fn = 0,
 ...
 void impose_simply_supported_edge(const unsigned& b,DirichletBCFctPt u_fn = 0,
 ...
 void impose_free_edge(const unsigned &b, 
