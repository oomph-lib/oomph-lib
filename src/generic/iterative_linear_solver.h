...
namespace oomph
{
  ...
  protected:
    ...
    /// \short indicates whether the preconditioner should be setup before
    /// solve. Default = true;
  ...
  public:
    /// Constructor
    CG() :
      Iterations(0), Matrix_pt(0), Resolving(false), Matrix_can_be_deleted(true)
    {
    }
  ...
  public:
    /// Constructor
    GS() :
      Matrix_pt(0), Iterations(0), Resolving(false), Matrix_can_be_deleted(true)
    {
    }
