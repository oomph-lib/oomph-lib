...
namespace oomph
{
    ...
    /// mesh generator gmsh.
    //======================================================================
    class GmshBrickScaffoldMesh : public virtual Mesh
    {
    public:
        /// Empty constructor
        GmshBrickScaffoldMesh() = default;

        /// Constructor: Pass the filename of the hexahedral file
        GmshBrickScaffoldMesh(const std::string& file_name, bool verbose);

        /// Empty destructor
        ~GmshBrickScaffoldMesh() {}
