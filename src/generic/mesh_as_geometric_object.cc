...
namespace MeshAsGeomObject_Helper
{
 ...
 unsigned Default_sample_point_container_version=UseCGALSamplePointContainer;
#else
 ...
 void create_sample_point_container_parameters(Mesh* mesh_pt,
                                               ...
                                               sample_point_container_parameters_pt)
 {
  switch (Default_sample_point_container_version) 
   ...
   case UseRefineableBinArray:
    sample_point_container_parameters_pt=new RefineableBinArrayParameters(mesh_pt);
    
    break;
    
   case UseNonRefineableBinArray:
    sample_point_container_parameters_pt=new NonRefineableBinArrayParameters(mesh_pt);
   ...
   case UseCGALSamplePointContainer:
    sample_point_container_parameters_pt=new CGALSamplePointContainerParameters(mesh_pt);
