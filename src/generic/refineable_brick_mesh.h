...
//=======================================================================
template <class ELEMENT>
class PRefineableBrickMesh : public virtual TreeBasedPRefineableMesh<ELEMENT>, 
 public virtual BrickMeshBase
{
...
public:
 ...
 /// Broken copy constructor
 PRefineableBrickMesh(const PRefineableBrickMesh& dummy) 
  { 
   BrokenCopy::broken_copy("PRefineableBrickMesh");
  } 
 
 /// Broken assignment operator
 void operator=(const PRefineableBrickMesh&) 
  {
   BrokenCopy::broken_assign("PRefineableBrickMesh");
  }

 /// Destructor:
 virtual ~PRefineableBrickMesh() {}
