...
#define CFARGT14S(S, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE) \
  ...
  S(T2, 2) \
  S(T3, 3) \
  S(T4, 4) S(T5, 5) S(T6, 6) S(T7, 7) S(T8, 8) S(T9, 9) S(TA, 10) S(TB, 11) \
...
#define CFARGT27S(S, \
  ...
  S(T3, 3) \
  S(T4, 4) S(T5, 5) S(T6, 6) S(T7, 7) S(T8, 8) S(T9, 9) S(TA, 10) S(TB, 11) \
    S(TC, 12) S(TD, 13) S(TE, 14) S(TF, 15) S(TG, 16) S(TH, 17) S(TI, 18) \
      S(TJ, 19) S(TK, 20) S(TL, 21) S(TM, 22) S(TN, 23) S(TO, 24) S(TP, 25) \
        S(TQ, 26) S(TR, 27)
...
#define CFARGT14FS( \
  ...
  F(T2, 2, 1) \
  F(T3, 3, 1) \
  F(T4, 4, 1) F(T5, 5, 1) F(T6, 6, 1) F(T7, 7, 1) F(T8, 8, 1) F(T9, 9, 1) \
    F(TA, 10, 1) F(TB, 11, 1) F(TC, 12, 1) F(TD, 13, 1) F(TE, 14, 1) \
...
#define CFARGT27FS(F, \
  ...
  F(T4, 4, 1) F(T5, 5, 1) F(T6, 6, 1) F(T7, 7, 1) F(T8, 8, 1) F(T9, 9, 1) \
    F(TA, 10, 1) F(TB, 11, 1) F(TC, 12, 1) F(TD, 13, 1) F(TE, 14, 1) \
      F(TF, 15, 1) F(TG, 16, 1) F(TH, 17, 1) F(TI, 18, 1) F(TJ, 19, 1) \
        F(TK, 20, 1) F(TL, 21, 1) F(TM, 22, 1) F(TN, 23, 1) \
          F(TO, 24, 1) F(TP, 25, 1) F(TQ, 26, 1) F(TR, 27, 1) M CFARGT27S(S, \
                                                                          T1, \
                                                                          T2, \
                                                                          T3, \
                                                                          T4, \
...
#define CFARGT20(F, \
  ...
  F(T4, 4, 1) F(T5, 5, 1) F(T6, 6, 1) F(T7, 7, 1) F(T8, 8, 1) F(T9, 9, 1) \
    F(TA, 10, 1) F(TB, 11, 1) F(TC, 12, 1) F(TD, 13, 1) F(TE, 14, 1) \
      F(TF, 15, 1) F(TG, 16, 1) F(TH, 17, 1) F(TI, 18, 1) F(TJ, 19, 1) \
        F(TK, 20, 1) S(T1, 1) S(T2, 2) S(T3, 3) S(T4, 4) S(T5, 5) S(T6, 6) \
...
#define CFARGTA14(F, \
  ...
  F(T2, A2, 2, 1) \
  F(T3, A3, 3, 1) \
  F(T4, A4, 4, 1) F(T5, A5, 5, 1) F(T6, A6, 6, 1) F(T7, A7, 7, 1) \
    F(T8, A8, 8, 1) F(T9, A9, 9, 1) F(TA, AA, 10, 1) F(TB, AB, 11, 1) \
      F(TC, AC, 12, 1) F(TD, AD, 13, 1) F(TE, AE, 14, 1) S(T1, 1) S(T2, 2) \
...
#define CFARGTA20(F, \
  ...
  F(T4, A4, 4, 1) F(T5, A5, 5, 1) F(T6, A6, 6, 1) F(T7, A7, 7, 1) \
    F(T8, A8, 8, 1) F(T9, A9, 9, 1) F(TA, AA, 10, 1) F(TB, AB, 11, 1) \
      F(TC, AC, 12, 1) F(TD, AD, 13, 1) F(TE, AE, 14, 1) F(TF, AF, 15, 1) \
        F(TG, AG, 16, 1) F(TH, AH, 17, 1) F(TI, AI, 18, 1) F(TJ, AJ, 19, 1) \
          F(TK, AK, 20, 1) S(T1, 1) S(T2, 2) S(T3, 3) S(T4, 4) S(T5, 5) \
            S(T6, 6) S(T7, 7) S(T8, 8) S(T9, 9) S(TA, 10) S(TB, 11) S(TC, 12) \
              S(TD, 13) S(TE, 14) S(TF, 15) S(TG, 16) S(TH, 17) S(TI, 18) \
                S(TJ, 19) S(TK, 20)
#define CFARGTA27(F, \
                  S, \
                  T1, \
  ...
  F(T4, A4, 4, 1) F(T5, A5, 5, 1) F(T6, A6, 6, 1) F(T7, A7, 7, 1) \
    F(T8, A8, 8, 1) F(T9, A9, 9, 1) F(TA, AA, 10, 1) F(TB, AB, 11, 1) \
      F(TC, AC, 12, 1) F(TD, AD, 13, 1) F(TE, AE, 14, 1) F(TF, AF, 15, 1) \
        F(TG, AG, 16, 1) F(TH, AH, 17, 1) F(TI, AI, 18, 1) F(TJ, AJ, 19, 1) \
          F(TK, AK, 20, 1) F(TL, AL, 21, 1) F(TM, AM, 22, 1) F(TN, AN, 23, 1) \
            F(TO, AO, 24, 1) F(TP, AP, 25, 1) F(TQ, AQ, 26, 1) \
              F(TR, AR, 27, 1) S(T1, 1) S(T2, 2) S(T3, 3) S(T4, 4) S(T5, 5) \
                S(T6, 6) S(T7, 7) S(T8, 8) S(T9, 9) S(TA, 10) S(TB, 11) \
                  S(TC, 12) S(TD, 13) S(TE, 14) S(TF, 15) S(TG, 16) S(TH, 17) \
                    S(TI, 18) S(TJ, 19) S(TK, 20) S(TL, 21) S(TM, 22) \
...
#define CFARGT14( \
  ...
  S(T1, 1) \
  F(T2, 2, 1) \
  S(T2, 2) F(T3, 3, 1) S(T3, 3) F(T4, 4, 1) S(T4, 4) F(T5, 5, 1) S(T5, 5) \
    F(T6, 6, 1) S(T6, 6) F(T7, 7, 1) S(T7, 7) F(T8, 8, 1) S(T8, 8) F(T9, 9, 1) \
      S(T9, 9) F(TA, 10, 1) S(TA, 10) F(TB, 11, 1) S(TB, 11) F(TC, 12, 1) \
...
#define CFARGT27(F, \
  ...
  S(T2, 2) F(T3, 3, 1) S(T3, 3) F(T4, 4, 1) S(T4, 4) F(T5, 5, 1) S(T5, 5) \
    F(T6, 6, 1) S(T6, 6) F(T7, 7, 1) S(T7, 7) F(T8, 8, 1) S(T8, 8) F(T9, 9, 1) \
      S(T9, 9) F(TA, 10, 1) S(TA, 10) F(TB, 11, 1) S(TB, 11) F(TC, 12, 1) \
        S(TC, 12) F(TD, 13, 1) S(TD, 13) F(TE, 14, 1) S(TE, 14) F(TF, 15, 1) \
          S(TF, 15) F(TG, 16, 1) S(TG, 16) F(TH, 17, 1) S(TH, 17) F(TI, 18, 1) \
...
#define CFARGTA14(F, \
  ...
  S(T1, 1) \
  F(T2, A2, 2, 1) \
  S(T2, 2) F(T3, A3, 3, 1) S(T3, 3) F(T4, A4, 4, 1) S(T4, 4) F(T5, A5, 5, 1) \
    S(T5, 5) F(T6, A6, 6, 1) S(T6, 6) F(T7, A7, 7, 1) S(T7, 7) F(T8, A8, 8, 1) \
      S(T8, 8) F(T9, A9, 9, 1) S(T9, 9) F(TA, AA, 10, 1) S(TA, 10) \
        F(TB, AB, 11, 1) S(TB, 11) F(TC, AC, 12, 1) S(TC, 12) F(TD, AD, 13, 1) \
...
#define CFARGTA20(F, \
  ...
  S(T2, 2) F(T3, A3, 3, 1) S(T3, 3) F(T4, A4, 4, 1) S(T4, 4) F(T5, A5, 5, 1) \
    S(T5, 5) F(T6, A6, 6, 1) S(T6, 6) F(T7, A7, 7, 1) S(T7, 7) F(T8, A8, 8, 1) \
      S(T8, 8) F(T9, A9, 9, 1) S(T9, 9) F(TA, AA, 10, 1) S(TA, 10) \
        F(TB, AB, 11, 1) S(TB, 11) F(TC, AC, 12, 1) S(TC, 12) F(TD, AD, 13, 1) \
          S(TD, 13) F(TE, AE, 14, 1) S(TE, 14) F(TF, AF, 15, 1) S(TF, 15) \
            F(TG, AG, 16, 1) S(TG, 16) F(TH, AH, 17, 1) S(TH, 17) \
              F(TI, AI, 18, 1) S(TI, 18) F(TJ, AJ, 19, 1) S(TJ, 19) \
                F(TK, AK, 20, 1) S(TK, 20)
#define CFARGTA27(F, \
                  S, \
                  T1, \
                  T2, \
      ...
      S(T8, 8) F(T9, A9, 9, 1) S(T9, 9) F(TA, AA, 10, 1) S(TA, 10) \
        F(TB, AB, 11, 1) S(TB, 11) F(TC, AC, 12, 1) S(TC, 12) F(TD, AD, 13, 1) \
          S(TD, 13) F(TE, AE, 14, 1) S(TE, 14) F(TF, AF, 15, 1) S(TF, 15) \
            F(TG, AG, 16, 1) S(TG, 16) F(TH, AH, 17, 1) S(TH, 17) \
              F(TI, AI, 18, 1) S(TI, 18) F(TJ, AJ, 19, 1) S(TJ, 19) \
                F(TK, AK, 20, 1) S(TK, 20) F(TL, AL, 21, 1) S(TL, 21) \
                  F(TM, AM, 22, 1) S(TM, 22) F(TN, AN, 23, 1) S(TN, 23) \
                    F(TO, AO, 24, 1) S(TO, 24) F(TP, AP, 25, 1) S(TP, 25) \
...
#define CCALLSFSUB14(UN, \
  ...
  { \
    ...
    VVCF(T2, A2, B2) \
    VVCF(T3, A3, B3) \
    VVCF(T4, A4, B4) VVCF(T5, A5, B5) VVCF(T6, A6, B6) VVCF(T7, A7, B7) \
      VVCF(T8, A8, B8) VVCF(T9, A9, B9) VVCF(TA, AA, B10) VVCF(TB, AB, B11) \
    ...
    WCF(T2, A2, 2) \
    WCF(T3, A3, 3) \
    WCF(T4, A4, 4) WCF(T5, A5, 5) WCF(T6, A6, 6) WCF(T7, A7, 7) WCF(T8, A8, 8) \
...
#define CCALLSFSUB27(UN, \
  ...
  { \
    ...
    VVCF(T2, A2, B2) \
    VVCF(T3, A3, B3) \
    VVCF(T4, A4, B4) VVCF(T5, A5, B5) VVCF(T6, A6, B6) VVCF(T7, A7, B7) VVCF( \
      T8, A8, B8) VVCF(T9, A9, B9) VVCF(TA, AA, B10) VVCF(TB, AB, B11) \
      VVCF(TC, AC, B12) VVCF(TD, AD, B13) VVCF(TE, AE, B14) VVCF(TF, AF, B15) \
        VVCF(TG, AG, B16) VVCF(TH, AH, B17) VVCF(TI, AI, B18) \
          VVCF(TJ, AJ, B19) VVCF(TK, AK, B20) VVCF(TL, AL, B21) \
            VVCF(TM, AM, B22) VVCF(TN, AN, B23) VVCF(TO, AO, B24) \
              VVCF(TP, AP, B25) VVCF(TQ, AQ, B26) VVCF(TR, AR, B27) \
                                ...
                                ACF(LN, TJ, AJ, 19) ACF(LN, TK, AK, 20) \
                                  ACF(LN, TL, AL, 21) ACF(LN, TM, AM, 22) \
                                    ACF(LN, TN, AN, 23) ACF(LN, TO, AO, 24) \
                                      ACF(LN, TP, AP, 25) ACF(LN, TQ, AQ, 26) \
