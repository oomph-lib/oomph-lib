...
*/
    ...
    #if (_MSC_VER < \
         1300) /* versions earlier than V7.0 do not have 'long long' */
...
#include <string.h> /* strlen, memset, memcpy, memchr.                     */
  ...
  #ifdef apollo
    #define __CF__APOLLO67 /* __STDCPP__ is in Apollo 6.8 (i.e. ANSI) and \
                              onwards */
  #endif
#endif
     ...
     */
      ...
      #define f2cFortran /* Lynx:      Only support f2c at the moment. \
                            VAXUltrix: f77 behaves like f2c. \
                              ...
                              f77 with vcc works, missing link magic for f77 \
                            I/O.*/
    #endif
...
/* "extname" changed to "appendus" below (CFITSIO) */
  ...
  #define orig_fcallsc(UN, LN) CFC_(UN, LN)
    ...
    defined(AbsoftProFortran)
      ...
      #define CFC_(UN, LN) UN /* Uppercase FORTRAN symbols.     */
    #endif
    #define orig_fcallsc(UN, LN) \
      CFC_(UN, LN) /* CRAY insists on arg.'s here.   */
    ...
    #define CF_SAME_NAMESPACE
      ...
      /* BUT we usually use UN for C macro to FORTRAN routines, so use LN
       * here,*/
...
#define FORTRAN_FUNCTION(UN, LN) CFC_(UN, LN)
  ...
  /* CRAY's double==float but CRAY says pointers to doubles and floats are
   * diff.*/
  #define VOIDP \
...
#define F2CLOGICALV(A, I) \
  ...
  #define F2CLOGICAL(L) ((L) < 0 ? (L) : 0)
    ...
    #define F2CLOGICAL(L) \
      _ltob(&(L)) /* Strangely _ltob() expects a pointer. \
                   */
  #else
...
#define CFARGT14S(S, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE) \
  ...
  S(T3, 3) \
  S(T4, 4) \
  S(T5, 5) S(T6, 6) S(T7, 7) S(T8, 8) S(T9, 9) S(TA, 10) S(TB, 11) S(TC, 12) \
    S(TD, 13) S(TE, 14)
#define CFARGT27S(S, \
                  T1, \
                  T2, \
...
#define CFARGT14FS( \
  ...
  F(T3, 3, 1) \
  F(T4, 4, 1) \
  F(T5, 5, 1) F(T6, 6, 1) F(T7, 7, 1) F(T8, 8, 1) F(T9, 9, 1) F(TA, 10, 1) \
    F(TB, 11, 1) F(TC, 12, 1) F(TD, 13, 1) F(TE, 14, 1) \
...
#define CFARGT27FS(F, \
  ...
  F(T4, 4, 1) \
  F(T5, 5, 1) F(T6, 6, 1) F(T7, 7, 1) F(T8, 8, 1) F(T9, 9, 1) F(TA, 10, 1) \
    F(TB, 11, 1) F(TC, 12, 1) F(TD, 13, 1) F(TE, 14, 1) F(TF, 15, 1) \
      F(TG, 16, 1) F(TH, 17, 1) F(TI, 18, 1) F(TJ, 19, 1) F(TK, 20, 1) \
        F(TL, 21, 1) F(TM, 22, 1) F(TN, 23, 1) F(TO, 24, 1) F(TP, 25, 1) \
          F(TQ, 26, 1) F(TR, 27, 1) M CFARGT27S(S, \
                                                T1, \
                                                T2, \
                                                T3, \
                                                T4, \
  ...
  */
  ...
  #define CFARGTA14(F, \
    ...
    F(T3, A3, 3, 1) \
    F(T4, A4, 4, 1) \
    F(T5, A5, 5, 1) F(T6, A6, 6, 1) F(T7, A7, 7, 1) F(T8, A8, 8, 1) \
      F(T9, A9, 9, 1) F(TA, AA, 10, 1) F(TB, AB, 11, 1) F(TC, AC, 12, 1) \
        ...
        F(T9, A9, 9, 1) F(TA, AA, 10, 1) F(TB, AB, 11, 1) F(TC, AC, 12, 1) \
          F(TD, AD, 13, 1) F(TE, AE, 14, 1) F(TF, AF, 15, 1) F(TG, AG, 16, 1) \
            F(TH, AH, 17, 1) F(TI, AI, 18, 1) F(TJ, AJ, 19, 1) \
              F(TK, AK, 20, 1) S(T1, 1) S(T2, 2) S(T3, 3) S(T4, 4) S(T5, 5) \
                S(T6, 6) S(T7, 7) S(T8, 8) S(T9, 9) S(TA, 10) S(TB, 11) \
                  S(TC, 12) S(TD, 13) S(TE, 14) S(TF, 15) S(TG, 16) S(TH, 17) \
    ...
    #define CFARGTA27(F, \
      ...
      F(T5, A5, 5, 1) F(T6, A6, 6, 1) F(T7, A7, 7, 1) F(T8, A8, 8, 1) \
        F(T9, A9, 9, 1) F(TA, AA, 10, 1) F(TB, AB, 11, 1) F(TC, AC, 12, 1) \
          F(TD, AD, 13, 1) F(TE, AE, 14, 1) F(TF, AF, 15, 1) F(TG, AG, 16, 1) \
            F(TH, AH, 17, 1) F(TI, AI, 18, 1) F(TJ, AJ, 19, 1) \
              F(TK, AK, 20, 1) F(TL, AL, 21, 1) F(TM, AM, 22, 1) \
                F(TN, AN, 23, 1) F(TO, AO, 24, 1) F(TP, AP, 25, 1) \
                  F(TQ, AQ, 26, 1) F(TR, AR, 27, 1) S(T1, 1) S(T2, 2) S(T3, 3) \
  ...
  #define CFARGT14( \
    ...
    F(T2, 2, 1) \
    S(T2, 2) \
    F(T3, 3, 1) S(T3, 3) F(T4, 4, 1) S(T4, 4) F(T5, 5, 1) S(T5, 5) F(T6, 6, 1) \
      S(T6, 6) F(T7, 7, 1) S(T7, 7) F(T8, 8, 1) S(T8, 8) F(T9, 9, 1) S(T9, 9) \
        F(TA, 10, 1) S(TA, 10) F(TB, 11, 1) S(TB, 11) F(TC, 12, 1) S(TC, 12) \
  ...
  #define CFARGT27(F, \
    ...
    F(T3, 3, 1) S(T3, 3) F(T4, 4, 1) S(T4, 4) F(T5, 5, 1) S(T5, 5) F(T6, 6, 1) \
      S(T6, 6) F(T7, 7, 1) S(T7, 7) F(T8, 8, 1) S(T8, 8) F(T9, 9, 1) S(T9, 9) \
        F(TA, 10, 1) S(TA, 10) F(TB, 11, 1) S(TB, 11) F(TC, 12, 1) S(TC, 12) \
          F(TD, 13, 1) S(TD, 13) F(TE, 14, 1) S(TE, 14) F(TF, 15, 1) S(TF, 15) \
            F(TG, 16, 1) S(TG, 16) F(TH, 17, 1) S(TH, 17) F(TI, 18, 1) \
              S(TI, 18) F(TJ, 19, 1) S(TJ, 19) F(TK, 20, 1) S(TK, 20) \
                F(TL, 21, 1) S(TL, 21) F(TM, 22, 1) S(TM, 22) F(TN, 23, 1) \
                  S(TN, 23) F(TO, 24, 1) S(TO, 24) F(TP, 25, 1) S(TP, 25) \
  ...
  #define CFARGTA14(F, \
    ...
    F(T2, A2, 2, 1) \
    S(T2, 2) \
    F(T3, A3, 3, 1) S(T3, 3) F(T4, A4, 4, 1) S(T4, 4) F(T5, A5, 5, 1) S(T5, 5) \
      F(T6, A6, 6, 1) S(T6, 6) F(T7, A7, 7, 1) S(T7, 7) F(T8, A8, 8, 1) \
        S(T8, 8) F(T9, A9, 9, 1) S(T9, 9) F(TA, AA, 10, 1) S(TA, 10) \
          F(TB, AB, 11, 1) S(TB, 11) F(TC, AC, 12, 1) S(TC, 12) \
    ...
    #define CFARGTA20(F, \
      ...
      F(T2, A2, 2, 1) \
      S(T2, 2) \
      F(T3, A3, 3, 1) S(T3, 3) F(T4, A4, 4, 1) S(T4, 4) F(T5, A5, 5, 1) \
        S(T5, 5) F(T6, A6, 6, 1) S(T6, 6) F(T7, A7, 7, 1) S(T7, 7) \
          F(T8, A8, 8, 1) S(T8, 8) F(T9, A9, 9, 1) S(T9, 9) F(TA, AA, 10, 1) \
            S(TA, 10) F(TB, AB, 11, 1) S(TB, 11) F(TC, AC, 12, 1) S(TC, 12) \
              F(TD, AD, 13, 1) S(TD, 13) F(TE, AE, 14, 1) S(TE, 14) \
                    ...
                    F(TJ, AJ, 19, 1) S(TJ, 19) F(TK, AK, 20, 1) S(TK, 20) \
                      F(TL, AL, 21, 1) S(TL, 21) F(TM, AM, 22, 1) S(TM, 22) \
                        F(TN, AN, 23, 1) S(TN, 23) F(TO, AO, 24, 1) S(TO, 24) \
                          F(TP, AP, 25, 1) S(TP, 25) F(TQ, AQ, 26, 1) \
                            S(TQ, 26) F(TR, AR, 27, 1) S(TR, 27)
  #endif
#endif
...
#define CCALLSFSUB13(UN, \
  ...
  #define CCALLSFSUB14(UN, \
    ...
    { \
      ...
      VVCF(T3, A3, B3) \
      VVCF(T4, A4, B4) \
      VVCF(T5, A5, B5) VVCF(T6, A6, B6) VVCF(T7, A7, B7) VVCF(T8, A8, B8) \
        VVCF(T9, A9, B9) VVCF(TA, AA, B10) VVCF(TB, AB, B11) VVCF(TC, AC, B12) \
      ...
      WCF(T3, A3, 3) \
      WCF(T4, A4, 4) \
      WCF(T5, A5, 5) WCF(T6, A6, 6) WCF(T7, A7, 7) WCF(T8, A8, 8) \
        WCF(T9, A9, 9) WCF(TA, AA, 10) WCF(TB, AB, 11) WCF(TC, AC, 12) \
          WCF(TD, AD, 13) WCF(TE, AE, 14) \
    } while (0)
#endif
  ...
  #define CCALLSFSUB19(UN, \
    ...
    #define CCALLSFSUB20(UN, \
      ...
      { \
        ...
        VVCF(T4, A4, B4) \
        VVCF(T5, A5, B5) VVCF(T6, A6, B6) VVCF(T7, A7, B7) VVCF(T8, A8, B8) \
          VVCF(T9, A9, B9) VVCF(TA, AA, B10) VVCF(TB, AB, B11) \
            VVCF(TC, AC, B12) VVCF(TD, AD, B13) VVCF(TE, AE, B14) \
              VVCF(TF, AF, B15) VVCF(TG, AG, B16) VVCF(TH, AH, B17) \
                VVCF(TI, AI, B18) VVCF(TJ, AJ, B19) VVCF(TK, AK, B20) \
                            ...
                            ACF(LN, TD, AD, 13) ACF(LN, TE, AE, 14) \
                              ACF(LN, TF, AF, 15) ACF(LN, TG, AG, 16) \
                                ACF(LN, TH, AH, 17) ACF(LN, TI, AI, 18) \
                                  ACF(LN, TJ, AJ, 19) ACF(LN, TK, AK, 20) \
                                    CFC_( \
      ...
      { \
        ...
        VVCF(T5, A5, B5) VVCF(T6, A6, B6) VVCF(T7, A7, B7) VVCF(T8, A8, B8) \
          VVCF(T9, A9, B9) VVCF(TA, AA, B10) VVCF(TB, AB, B11) VVCF( \
            TC, AC, B12) VVCF(TD, AD, B13) VVCF(TE, AE, B14) VVCF(TF, AF, B15) \
            VVCF(TG, AG, B16) VVCF(TH, AH, B17) VVCF(TI, AI, B18) \
              VVCF(TJ, AJ, B19) VVCF(TK, AK, B20) VVCF(TL, AL, B21) \
                VVCF(TM, AM, B22) VVCF(TN, AN, B23) VVCF(TO, AO, B24) VVCF( \
                  TP, AP, B25) VVCF(TQ, AQ, B26) VVCF(TR, AR, B27) \
                  CPPPROTOCLSFSUB27(UN, \
                                    LN, \
                                    T1, \
                                    T2, \
                                    T3, \
                                    ...
                                    TP, \
                                    TQ, \
                                    TR) ACF(LN, T1, A1, 1) ACF(LN, T2, A2, 2) \
                    ACF(LN, T3, A3, 3) ACF(LN, T4, A4, 4) ACF(LN, T5, A5, 5) \
                      ACF(LN, T6, A6, 6) ACF(LN, T7, A7, 7) ACF(LN, T8, A8, 8) \
                        ACF(LN, T9, A9, 9) ACF(LN, TA, AA, 10) \
                          ACF(LN, TB, AB, 11) ACF(LN, TC, AC, 12) \
                            ACF(LN, TD, AD, 13) ACF(LN, TE, AE, 14) \
                              ACF(LN, TF, AF, 15) ACF(LN, TG, AG, 16) \
                                ACF(LN, TH, AH, 17) ACF(LN, TI, AI, 18) \
                                  ACF(LN, TJ, AJ, 19) ACF(LN, TK, AK, 20) \
                                    ACF(LN, TL, AL, 21) ACF(LN, TM, AM, 22) \
                                      ACF(LN, TN, AN, 23) ACF(LN, TO, AO, 24) \
                                        ACF(LN, TP, AP, 25) \
                                          ACF(LN, TQ, AQ, 26) \
        ...
        WCF(T5, A5, 5) WCF(T6, A6, 6) WCF(T7, A7, 7) WCF(T8, A8, 8) \
          WCF(T9, A9, 9) WCF(TA, AA, 10) WCF(TB, AB, 11) WCF(TC, AC, 12) \
            WCF(TD, AD, 13) WCF(TE, AE, 14) WCF(TF, AF, 15) WCF(TG, AG, 16) \
              WCF(TH, AH, 17) WCF(TI, AI, 18) WCF(TJ, AJ, 19) WCF(TK, AK, 20) \
                WCF(TL, AL, 21) WCF(TM, AM, 22) WCF(TN, AN, 23) \
                  WCF(TO, AO, 24) WCF(TP, AP, 25) WCF(TQ, AQ, 26) \
                    WCF(TR, AR, 27) \
      } while (0)
  #endif
#endif /* MAX_PREPRO_ARGS */
...
/* HP/UX 9.01 cc requires the blank between '_Icf(3,G,T0,UN,LN) CCCF(T1,1,0)' */
 ...
 CFARGT14(CCCF,JCF,ABSOFT_cf1(T0),T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE)); \
      ...
      WCF(T4, A4, 4) \
      WCF(T5, A5, 5) WCF(T6, A6, 6) WCF(T7, A7, 7) WCF(T8, A8, 8) \
        WCF(T9, A9, 9) WCF(TA, A10, 10) WCF(TB, A11, 11) WCF(TC, A12, 12) \
          WCF(TD, A13, 13) WCF(TE, A14, 14) _(T0, _cfX) \
    }
#else
  #define PROTOCCALLSFFUN14( \
    T0, UN, LN, T1, T2, T3, T4, T5, T6, T7, T8, T9, TA, TB, TC, TD, TE) \
...
#ifdef vmsFortran
  #define STRING_cfT(M, I, A, B, D) \
    TTTTSTR(A->dsc$a_pointer, B, A->dsc$w_length)
  ...
  /* The void is req'd by the Apollo, to make this an ANSI function declaration.
    ...
    #define STRING_cfFZ(UN, LN) void  FCALLSC_QUALIFIER fcallsc(UN,LN)(fstring *AS
      ...
      #define STRING_cfFZ(UN, LN) void  FCALLSC_QUALIFIER fcallsc(UN,LN)(_fcd     AS
        ...
        defined(RETURNFLOAT))
    #if defined(f2cFortran) && !defined(gFortran)
      /* f2c/g77 return double from FORTRAN REAL functions. (KMCCARTY,
       * 2005/12/09) */
            ...
            TCF(LN, T7, 7, 1) TCF(LN, T8, 8, 1) TCF(LN, T9, 9, 1) \
              TCF(LN, TA, 10, 1) TCF(LN, TB, 11, 1) TCF(LN, TC, 12, 1) \
                TCF(LN, TD, 13, 1) TCF(LN, TE, 14, 1) TCF(LN, TF, 15, 1) \
                  TCF(LN, TG, 16, 1) TCF(LN, TH, 17, 1) TCF(LN, TI, 18, 1) \
                    TCF(LN, TJ, 19, 1) TCF(LN, TK, 20, 1) TCF(LN, TL, 21, 1) \
                      TCF(LN, TM, 22, 1) TCF(LN, TN, 23, 1) TCF(LN, TO, 24, 1) \
                        TCF(LN, TP, 25, 1) TCF(LN, TQ, 26, 1) \
                          TCF(LN, TR, 27, 1)); \
