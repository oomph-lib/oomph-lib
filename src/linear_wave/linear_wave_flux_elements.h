...
public:
 ...
 /// x is a Vector! 
 typedef void (*LinearWavePrescribedFluxFctPt)
 ...
 LinearWavePrescribedFluxFctPt& flux_fct_pt() {return Flux_fct_pt;}
 ...
 inline void fill_in_contribution_to_jacobian(Vector<double> &residuals,
                                          DenseMatrix<double> &jacobian)
  {
   ...
   fill_in_generic_residual_contribution_lin_wave_flux(residuals,jacobian,1);
  }
...
//===========================================================================
template<class ELEMENT>
LinearWaveFluxElement<ELEMENT>::LinearWaveFluxElement(FiniteElement *bulk_el_pt, 
    ...
    if(dynamic_cast<RefineableElement*>(elem_pt))
     {
      ...
      OomphLibWarning(
       ...
       "LinearWaveFluxElement::Constructor",
       OOMPH_EXCEPTION_LOCATION);
     }
   }
 }
