...
double GeneralisedAdvectionDiffusionEquations<DIM>::Default_peclet_number=0.0;
...
fill_in_generic_residual_contribution_cons_adv_diff(Vector<double> &residuals, 
 ...
 for(unsigned ipt=0;ipt<n_intpt;ipt++)
  {
   ...
   double J = 
    dshape_and_dtest_eulerian_at_knot_cons_adv_diff(ipt,psi,dpsidx,test,dtestdx);
...
const unsigned QGeneralisedAdvectionDiffusionElement<DIM,NNODE_1D>::Initial_Nvalue = 1;
