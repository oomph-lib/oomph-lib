...
check_include_files(fpu_control.h OOMPH_HAS_FPUCONTROLH)

# Add compiler flags
if(OOMPH_HAS_STACKTRACE)
  add_compile_definitions(OOMPH_HAS_STACKTRACE)
endif()
if(OOMPH_HAS_UNISTDH)
  add_compile_definitions(OOMPH_HAS_UNISTDH)
endif()
if(OOMPH_HAS_MALLOCH)
  add_compile_definitions(OOMPH_HAS_MALLOCH)
endif()
if(OOMPH_HAS_FPUCONTROLH)
  add_compile_definitions(OOMPH_HAS_FPUCONTROLH)
endif()
