...
foreach(C_COMPILE_FLAG IN LISTS OOMPH_C_FLAGS)
  check_compiler_flag(C ${C_COMPILE_FLAG} C_COMPILER_HAS_FLAG)
...
foreach(CXX_COMPILE_FLAG IN LISTS OOMPH_CXX_FLAGS)
  check_compiler_flag(CXX ${CXX_COMPILE_FLAG} CXX_COMPILER_HAS_FLAG)
...
foreach(FORTRAN_COMPILE_FLAG IN LISTS OOMPH_FORTRAN_FLAGS)
  check_compiler_flag(Fortran ${FORTRAN_COMPILE_FLAG} FORTRAN_COMPILER_HAS_FLAG)
