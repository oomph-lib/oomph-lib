...
# CMake Registry
#
# Export package to CMake registry such that it can be easily found by CMake
# even if it has not been installed to a standard directory.
#
...
if(NOT (DEFINED CMAKE_REGISTRY_FOLDER))
  set(CMAKE_REGISTRY_FOLDER "OFF" CACHE STRING "Choose CMake registry folder."
      FORCE)
endif()

# Set possible values for cmake-gui
set_property(CACHE CMAKE_REGISTRY_FOLDER PROPERTY STRINGS "BUILD_FOLDER"
                                                  "INSTALL_FOLDER" "OFF")
...
#
# This function adds an entry to the CMake registry for packages with the path
# of the directory where the package configuration file of the installed package
# is located in order to help CMake find the package in a custom installation
# prefix. This differs from CMake's export(PACKAGE) command which registers the
...
function(register_package PACKAGE_FOLDER)
  ...
  elseif(IS_DIRECTORY "$ENV{HOME}")
    file(WRITE "${PROJECT_BINARY_DIR}/${PROJECT_NAME}-registry-entry"
         "${PACKAGE_FOLDER}")
    install(
