...
if(NOT OOMPH_USE_GKLIB_FROM)
  ...
  ExternalProject_Add(
    ...
    CONFIGURE_COMMAND ${CMAKE_COMMAND} --install-prefix=<INSTALL_DIR> -G=${CMAKE_GENERATOR} -DNO_X86=${CONFIGURE_GKLIB_WITH_NO_X86} -DCMAKE_BUILD_TYPE=Release -B=build
...
set(METIS_LIBRARIES ${METIS_INSTALL_DIR}/lib/${METIS_LIBNAME} CACHE PATH "Path to GMP libraries")
set(METIS_INCLUDE_DIR ${METIS_INSTALL_DIR}/include CACHE PATH "Path to GMP include directory")
...
if (OOMPH_BUILD_SUPERLU)
  ...
  # Set the test command based on whether we want to disable third-party library tests
  ...
  ExternalProject_Add(
    ...
    CONFIGURE_COMMAND ${CMAKE_COMMAND} --install-prefix=<INSTALL_DIR> ${SUPERLU_CMAKE_BUILD_ARGS} -G=${CMAKE_GENERATOR} -B=build
...
if (OOMPH_ENABLE_MPI)
  ...
  set(PARMETIS_LIBRARIES ${PARMETIS_INSTALL_DIR}/lib/${PARMETIS_LIBNAME} CACHE PATH "Path to GMP libraries")
  set(PARMETIS_INCLUDE_DIR ${PARMETIS_INSTALL_DIR}/include CACHE PATH "Path to GMP include directory")
  ...
  # Build options
  set(SUPERLU_DIST_CMAKE_BUILD_ARGS
    -Denable_openmp=OFF
  ...
  ExternalProject_Add(
    ...
    CONFIGURE_HANDLED_BY_BUILD FALSE
    LIST_SEPARATOR | # Use the alternate list separator
    CONFIGURE_COMMAND ${CMAKE_COMMAND} --install-prefix=<INSTALL_DIR> ${SUPERLU_DIST_CMAKE_BUILD_ARGS} -G=${CMAKE_GENERATOR} -B=build
    BUILD_COMMAND ${CMAKE_COMMAND} --build build -j ${NUM_JOBS}
    INSTALL_COMMAND ${CMAKE_COMMAND} --install build
    TEST_COMMAND ${TEST_COMMAND}
  )
