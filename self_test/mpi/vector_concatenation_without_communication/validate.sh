...
# Validation for vector concatenation without communication test
#-----------------------------------------

echo "Running vector concatenation without communication test "

# one processor
MPI_RUN_ON_NP_COMMAND=`echo $MPI_VARIABLENP_RUN_COMMAND | sed -e "s/OOMPHNP/1/g"`
$MPI_RUN_ON_NP_COMMAND ../vector_concatenation_without_communication
...
echo "done"
echo " " >> validation.log
echo "Distributed vector concatenation without communication test" >> validation.log
echo "------------------------------------" >> validation.log
echo " " >> validation.log
...
cat out_NP1R0 out_NP2R0 out_NP2R1 out_NP3R0 out_NP3R1 out_NP3R2 out_NP4R0 out_NP4R1 out_NP4R2 out_NP4R3 > vector_concatenation_without_communication.dat
...
$OOMPH_ROOT_DIR/scripts/fpdiff.py ../validata/vector_concatenation_without_communication.dat.gz  \
         vector_concatenation_without_communication.dat >> validation.log
fi
