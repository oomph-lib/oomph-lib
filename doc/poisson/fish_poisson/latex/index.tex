...
\hypertarget{index}{}\label{index}\index{Demo problem: Adaptive solution of Poisson\textquotesingle{}s equation in a fish-\/shaped domain.@{Demo problem: Adaptive solution of Poisson\textquotesingle{}s equation in a fish-\/shaped domain.}}
...
The namespace {\ttfamily \doxylink{namespaceConstSourceForPoisson}{Const\+Source\+For\+Poisson}} only contains the constant source function $ f(x)=-1 $.
...
\end{DoxyCodeInclude}
 \DoxyHorRuler{0}
\hypertarget{index_black_box}{}\doxysubsection{\texorpdfstring{Black-\/box adaptation}{Black-box adaptation}}\label{index_black_box}
...
\DoxyCodeLine{\textcolor{comment}{///\ Demonstrate\ how\ to\ solve\ 2D\ Poisson\ problem\ in\ }\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{///\ fish-\/shaped\ domain\ with\ fully\ automatic\ mesh\ adaptation}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//========================================================================}}
...
\DoxyCodeLine{\ \ \textcolor{comment}{//-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{\ \ problem.\mbox{\hyperlink{classRefineableFishPoissonProblem_a6331b79c5c77d3f2fa7c37c3bb5308d9}{mesh\_pt}}()-\/>doc\_adaptivity\_targets(cout);}

\end{DoxyCodeInclude}
 These include
\begin{DoxyItemize}
\item {\bfseries{The target for the maximum error\+:}} Any elements whose error estimate exceed this value will be split into four "{}sons"{}.
\item {\bfseries{The target for the minimum error\+: }} Any elements whose error estimate lies below this value are deemed to be unnecessarily small and are scheduled for (possible) unrefinement. \mbox{[}Elements can only be unrefined (i.\+e. merged with their "{}brothers"{}) if their "{}brothers"{} are also scheduled for unrefinement.\mbox{]}
...
\end{DoxyItemize}
\end{DoxyItemize}These default parameters can be changed by the user; see \doxysectlink{index_comments}{Comments and Exercises}{1}.
...
\end{DoxyCodeInclude}
 \DoxyHorRuler{0}
\hypertarget{index_incremental}{}\doxysubsection{\texorpdfstring{Incremental adaptation}{Incremental adaptation}}\label{index_incremental}
...
\DoxyCodeLine{\textcolor{comment}{///\ Demonstrate\ how\ to\ solve\ 2D\ Poisson\ problem\ in\ }\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{///\ fish-\/shaped\ domain\ with\ mesh\ adaptation.\ First\ we\ solve\ on\ the\ original}}
\DoxyCodeLine{\textcolor{comment}{///\ coarse\ mesh.\ Next\ we\ do\ a\ few\ uniform\ refinement\ steps\ and\ re-\/solve.}}
\DoxyCodeLine{\textcolor{comment}{///\ Finally,\ we\ enter\ into\ an\ automatic\ adapation\ loop.}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//========================================================================}}
...
\end{DoxyCodeInclude}
 The solution looks much smoother but we suspect that the corner regions are still under-\/resolved. Therefore, we call the {\ttfamily Problem\+::adapt()} function which computes an error estimate for all elements and automatically performs a single mesh adaptation (refinement/unrefinement) step. If this adaptation changes the mesh, we recompute the solution, using the "{}normal"{} Newton solver without automatic adaptation. We document the solution and continue the adaptation cycle until {\ttfamily Problem\+::adapt()} ceases to change the mesh\+:
...
\DoxyCodeLine{\ \ \ \textcolor{keywordflow}{if}\ ((problem.\mbox{\hyperlink{classRefineableFishPoissonProblem_a6331b79c5c77d3f2fa7c37c3bb5308d9}{mesh\_pt}}()-\/>nrefined()\ \ !=0)||}
\DoxyCodeLine{\ \ \ \ \ \ \ (problem.\mbox{\hyperlink{classRefineableFishPoissonProblem_a6331b79c5c77d3f2fa7c37c3bb5308d9}{mesh\_pt}}()-\/>nunrefined()!=0))}
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ problem.newton\_solve();}
\DoxyCodeLine{\ \ \ \ \}}
...
\DoxyCodeLine{\textcolor{comment}{}\ RefineableFishMesh<ELEMENT>*\ \mbox{\hyperlink{classRefineableFishPoissonProblem_a6331b79c5c77d3f2fa7c37c3bb5308d9}{mesh\_pt}}()\ }
\DoxyCodeLine{\ \ \{}
...
\DoxyCodeLine{\textcolor{comment}{///\ Constructor\ for\ adaptive\ Poisson\ problem\ in\ fish-\/shaped}\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{///\ domain.}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//========================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class}\ ELEMENT>}
...
\item Impose a "{}user-\/defined"{} refinement pattern by calling the function {\ttfamily Problem\+::refine\+\_\+selected\+\_\+elements(...)}.
\end{DoxyEnumerate}
