...
\DoxyCodeLine{\textcolor{comment}{/// Demonstrate how to solve 2D Poisson problem with flux boundary }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// conditions}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//========================================================================}}
...
\DoxyCodeLine{  \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a4074baada03976c061d5672f4237cca5}{problem}}(\&\mbox{\hyperlink{namespaceTanhSolnForPoisson_a967bc28320e02534beb714846b63e251}{TanhSolnForPoisson::source\_function}});}
\DoxyCodeLine{ }
\DoxyCodeLine{}
...
\DoxyCodeLine{ \textcolor{keywordflow}{if} (\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.self\_test()==0) }
\DoxyCodeLine{  \{}
...
\DoxyCodeLine{   \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.newton\_solve();}
\DoxyCodeLine{}
\DoxyCodeLine{   \textcolor{comment}{//Output solution}}
\DoxyCodeLine{   \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.doc\_solution(doc\_info);}
\DoxyCodeLine{ }
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Create Poisson flux elements on the b-\/th boundary of the }}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Number of Poisson "bulk" elements (We're attaching the flux }}
...
\DoxyCodeLine{ \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{Problem::mesh\_pt}}()=\textcolor{keyword}{new} SimpleRectangularQuadMesh<ELEMENT>(n\_x,n\_y,l\_x,l\_y);}
...
\DoxyCodeLine{ Npoisson\_elements=\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>nelement();}
...
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} n\_bound = \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>nboundary();}
...
\DoxyCodeLine{    \{}
\DoxyCodeLine{     \textcolor{keywordtype}{unsigned} n\_node= \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>nboundary\_node(b);}
\DoxyCodeLine{     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} n=0;n<n\_node;n++)}
\DoxyCodeLine{      \{}
\DoxyCodeLine{       \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>boundary\_node\_pt(b,n)-\/>pin(0); }
\DoxyCodeLine{      \}}
\DoxyCodeLine{    \}}
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{   ELEMENT *el\_pt = \textcolor{keyword}{dynamic\_cast<}ELEMENT*\textcolor{keyword}{>}(\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>element\_pt(e));}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} n\_element=\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>nelement();}
\DoxyCodeLine{ }
...
\DoxyCodeLine{    \textcolor{keyword}{dynamic\_cast<}PoissonFluxElement<ELEMENT>*\textcolor{keyword}{>}(\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>element\_pt(e));}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} n\_element = \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>nboundary\_element(b);}
\DoxyCodeLine{}
...
\DoxyCodeLine{    \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>boundary\_element\_pt(b,e));}
\DoxyCodeLine{   }
\DoxyCodeLine{   \textcolor{comment}{// What is the index of the face of the bulk element at the boundary}}
\DoxyCodeLine{   \textcolor{keywordtype}{int} face\_index = \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>face\_index\_at\_boundary(b,e);}
\DoxyCodeLine{}
...
\DoxyCodeLine{   \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>add\_element\_pt(flux\_element\_pt);}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a0212ca86d5969b023039861ae8e472f8}{i}}=0;\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a0212ca86d5969b023039861ae8e472f8}{i}}<n\_bound;\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a0212ca86d5969b023039861ae8e472f8}{i}}++)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   \textcolor{comment}{// Only update Dirichlet nodes}}
\DoxyCodeLine{   \textcolor{keywordflow}{if} (\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a0212ca86d5969b023039861ae8e472f8}{i}}!=1)}
\DoxyCodeLine{    \{}
\DoxyCodeLine{     \textcolor{comment}{// How many nodes are there on this boundary?}}
\DoxyCodeLine{     \textcolor{keywordtype}{unsigned} n\_node = \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>nboundary\_node(\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a0212ca86d5969b023039861ae8e472f8}{i}});}
\DoxyCodeLine{     }
\DoxyCodeLine{     \textcolor{comment}{// Loop over the nodes on boundary}}
\DoxyCodeLine{     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} n=0;n<n\_node;n++)}
\DoxyCodeLine{      \{}
\DoxyCodeLine{       \textcolor{comment}{// Get pointer to node}}
\DoxyCodeLine{       Node* nod\_pt = \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>boundary\_node\_pt(\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a0212ca86d5969b023039861ae8e472f8}{i}},n);}
\DoxyCodeLine{       }
...
\DoxyCodeLine{ \textcolor{comment}{// Output solution }}
\DoxyCodeLine{ \textcolor{comment}{//-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{ \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a844fc4763d586f380d443a31d47359d9}{sprintf}}(filename,\textcolor{stringliteral}{"\%s/soln\%i.dat"},doc\_info.directory().c\_str(),}
\DoxyCodeLine{         doc\_info.number());}
\DoxyCodeLine{ some\_file.open(filename);}
\DoxyCodeLine{ \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>output(some\_file,npts);}
\DoxyCodeLine{ some\_file.close();}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Output exact solution }}
\DoxyCodeLine{ \textcolor{comment}{//-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{ \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a844fc4763d586f380d443a31d47359d9}{sprintf}}(filename,\textcolor{stringliteral}{"\%s/exact\_soln\%i.dat"},doc\_info.directory().c\_str(),}
\DoxyCodeLine{         doc\_info.number());}
\DoxyCodeLine{ some\_file.open(filename);}
\DoxyCodeLine{ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} e=0;e<Npoisson\_elements;e++)}
\DoxyCodeLine{  \{}
...
\DoxyCodeLine{\textcolor{comment}{//-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{\textcolor{keywordtype}{double} \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a6c0114d61baf5bb53ca063e763b7517a}{error}},\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a3bb09fda90c0006dbfa90d31248da3db}{norm}};}
\DoxyCodeLine{\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a844fc4763d586f380d443a31d47359d9}{sprintf}}(filename,\textcolor{stringliteral}{"\%s/error\%i.dat"},doc\_info.directory().c\_str(),}
\DoxyCodeLine{        doc\_info.number());}
\DoxyCodeLine{some\_file.open(filename);}
\DoxyCodeLine{\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a7c73c0d381a5a4a7df3d1c1e0e1e7d0c}{mesh\_pt}}()-\/>compute\_error(some\_file,\mbox{\hyperlink{namespaceTanhSolnForPoisson_af7896e9c18ce6438c73ae2a875e8b7de}{TanhSolnForPoisson::get\_exact\_u}},}
\DoxyCodeLine{                         \mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a6c0114d61baf5bb53ca063e763b7517a}{error}},\mbox{\hyperlink{two__d__poisson__flux__bc_8txt_a3bb09fda90c0006dbfa90d31248da3db}{norm}}); }
\DoxyCodeLine{some\_file.close();}
\end{DoxyCode}
