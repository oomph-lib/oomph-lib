...
the \c Mesh base class provides storage
to indicate if the boundary coordinates have been stored for
all \c Nodes on a specific mesh boundary. The storage 
...
boundary coordinates had been set up on boundary \c b.
