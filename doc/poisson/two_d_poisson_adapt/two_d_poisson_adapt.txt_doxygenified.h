...
\image html refineable_mesh_inheritance.gif "Typical inheritance structure for refineable meshes, illustrated for 2D quad meshes. " 
\image latex refineable_mesh_inheritance.eps "Typical inheritance structure for refineable meshes, illustrated for 2D quad meshes. " width=0.75\textwidth
...
\image html TanhPoissonAdaptive.gif "Plot of the solution with adaptive mesh refinement " 
\image latex TanhPoissonAdaptive.eps "Plot of the solution with adaptive mesh refinement " width=0.75\textwidth
