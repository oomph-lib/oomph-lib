...
\DoxyCodeLine{  \mbox{\hyperlink{two__d__poisson_8txt_a4074baada03976c061d5672f4237cca5}{problem}}(\&\mbox{\hyperlink{namespaceTanhSolnForPoisson_a967bc28320e02534beb714846b63e251}{TanhSolnForPoisson::source\_function}});}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \textcolor{keywordflow}{if} (\mbox{\hyperlink{two__d__poisson_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.self\_test()==0) }
\DoxyCodeLine{  \{}
...
\DoxyCodeLine{   \mbox{\hyperlink{two__d__poisson_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.newton\_solve();}
\DoxyCodeLine{}
\DoxyCodeLine{   \textcolor{comment}{//Output the solution}}
\DoxyCodeLine{   \mbox{\hyperlink{two__d__poisson_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.doc\_solution(doc\_info);}
\DoxyCodeLine{ }
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// 2D QPoisson elements. The specific type of element is}}
...
\DoxyCodeLine{ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{two__d__poisson_8txt_aa166dca8d99a7a36f016ae036351695c}{i}}=0;\mbox{\hyperlink{two__d__poisson_8txt_aa166dca8d99a7a36f016ae036351695c}{i}}<n\_bound;\mbox{\hyperlink{two__d__poisson_8txt_aa166dca8d99a7a36f016ae036351695c}{i}}++)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   \textcolor{keywordtype}{unsigned} n\_node = mesh\_pt()-\/>nboundary\_node(\mbox{\hyperlink{two__d__poisson_8txt_aa166dca8d99a7a36f016ae036351695c}{i}});}
\DoxyCodeLine{   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} n=0;n<n\_node;n++)}
\DoxyCodeLine{    \{}
\DoxyCodeLine{     mesh\_pt()-\/>boundary\_node\_pt(\mbox{\hyperlink{two__d__poisson_8txt_aa166dca8d99a7a36f016ae036351695c}{i}},n)-\/>pin(0); }
\DoxyCodeLine{    \}}
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{two__d__poisson_8txt_aa166dca8d99a7a36f016ae036351695c}{i}}=0;\mbox{\hyperlink{two__d__poisson_8txt_aa166dca8d99a7a36f016ae036351695c}{i}}<n\_element;\mbox{\hyperlink{two__d__poisson_8txt_aa166dca8d99a7a36f016ae036351695c}{i}}++)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   \textcolor{comment}{// Upcast from GeneralsedElement to the present element}}
\DoxyCodeLine{   ELEMENT *el\_pt = \textcolor{keyword}{dynamic\_cast<}ELEMENT*\textcolor{keyword}{>}(mesh\_pt()-\/>element\_pt(\mbox{\hyperlink{two__d__poisson_8txt_aa166dca8d99a7a36f016ae036351695c}{i}}));}
\DoxyCodeLine{}
...
\DoxyCodeLine{     Node* nod\_pt=mesh\_pt()-\/>boundary\_node\_pt(\mbox{\hyperlink{two__d__poisson_8txt_aa166dca8d99a7a36f016ae036351695c}{i}},n);}
\DoxyCodeLine{}
...
\begin{DoxyItemize}
\item {\ttfamily Super\+L\+U\+Solver\+:} An interface to Demmel, Eistenstat, Gilbert, Li \& Liu\textquotesingle{}s serial Super\+LU solver. See \href{http://crd.lbl.gov/~xiaoye/SuperLU/}{\texttt{ http\+://crd.\+lbl.\+gov/$\sim$xiaoye/\+Super\+L\+U/}} for details.
\item {\ttfamily H\+S\+L\+\_\+\+M\+A42\+:} An interface to the M\+A42 frontal solver from the H\+SL library. See \href{http://www.hsl.rl.ac.uk/}{\texttt{ http\+://www.\+hsl.\+rl.\+ac.\+uk}} for details.
...
\DoxyCodeLine{\textcolor{comment}{}Problem::linear\_solver\_pt() = \textcolor{keyword}{new} HSL\_MA42;}
\DoxyCodeLine{\textcolor{comment}{}}
...
{\ttfamily H\+S\+L\+\_\+\+M\+A42} can document various statistics such the memory usage etc. This is enabled with the second command. Other solvers have similar member functions. See the \href{../../../the_data_structure/html/index.html}{\texttt{ full documentation of all {\ttfamily oomph-\/lib} classes}} for details.
