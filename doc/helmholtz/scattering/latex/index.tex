...
\DoxyHorRuler{0}
\hypertarget{index_ABCs}{}\doxysubsection{Approximate/absorbing boundary conditions (\+A\+B\+Cs)}\label{index_ABCs}
...
edition)\char`\"{}, Wiley (2002) p. 501ff -- but note that Jin assumes that the potential varies like $ \exp(i\omega t)$ rather than $ \exp(-i\omega t)$ as assumed here) that the normal (radial) derivative, $ \partial u / \partial n = \partial u / \partial r, $ on the artificial boundary ~\newline
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{double} \mbox{\hyperlink{namespaceGlobalParameters_aae73cb63b27d51a87845c3392cd944eb}{K\_squared}}=10.0; }
\DoxyCodeLine{ \textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{unsigned} \mbox{\hyperlink{namespaceGlobalParameters_ae4df03bf0ffa55b741ac846ca7b6c155}{N\_fourier}}=10;}
\DoxyCodeLine{ \textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{bool} \mbox{\hyperlink{namespaceGlobalParameters_a6e2bba1769e86a5d3db88e2c7062bc63}{DtN\_BC}}=\textcolor{keyword}{false};}
\DoxyCodeLine{\textcolor{comment}{}}
...
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} \mbox{\hyperlink{namespaceGlobalParameters_a552eed3548a269715a95161ad3c4b96a}{ABC\_order}}=3;}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// Radius of outer boundary (must be a circle!)}}
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{double} \mbox{\hyperlink{namespaceGlobalParameters_a61b086072a6b8fd38af1a85f1dd1674a}{Outer\_radius}}=1.5;}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// Imaginary unit }}
\DoxyCodeLine{\textcolor{comment}{} std::complex<double> \mbox{\hyperlink{namespaceGlobalParameters_a7642bd7303d39de0d680340586b7df60}{I}}(0.0,1.0);}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Exact solution for scattered field }}
\DoxyCodeLine{\textcolor{comment}{ /// (vector returns real and impaginary parts).}}
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{void} \mbox{\hyperlink{namespaceGlobalParameters_ae2320da6053f5527b2af5ebb362a8a07}{get\_exact\_u}}(\textcolor{keyword}{const} Vector<double>\& x, Vector<double>\& \mbox{\hyperlink{scattering_8txt_a8c816198c8bd9c7829d875346c691800}{u}})}
\DoxyCodeLine{ \{}
...
\DoxyCodeLine{  \mbox{\hyperlink{scattering_8txt_a8c816198c8bd9c7829d875346c691800}{u}}[0]=real(u\_ex);}
\DoxyCodeLine{  \mbox{\hyperlink{scattering_8txt_a8c816198c8bd9c7829d875346c691800}{u}}[1]=imag(u\_ex);}
\DoxyCodeLine{  }
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Flux (normal derivative) on the unit disk}}
\DoxyCodeLine{\textcolor{comment}{ /// for a planar incoming wave}}
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{void} \mbox{\hyperlink{namespaceGlobalParameters_a5183de63b992338ee60bb4da78a45039}{prescribed\_incoming\_flux}}(\textcolor{keyword}{const} Vector<double>\& x, }
\DoxyCodeLine{                               complex<double>\& \mbox{\hyperlink{scattering_8txt_a6e2308ba2b055a80cdd4c2a0469b7d60}{flux}})}
\DoxyCodeLine{ \{}
\DoxyCodeLine{  \textcolor{comment}{// Switch to polar coordinates}}
\DoxyCodeLine{  \textcolor{keywordtype}{double} r;}
\DoxyCodeLine{  r=sqrt(x[0]*x[0]+x[1]*x[1]);}
...
\DoxyCodeLine{  \mbox{\hyperlink{scattering_8txt_a6e2308ba2b055a80cdd4c2a0469b7d60}{flux}}=std::complex<double>(0.0,0.0);}
\DoxyCodeLine{  \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} i=0;i<\mbox{\hyperlink{namespaceGlobalParameters_ae4df03bf0ffa55b741ac846ca7b6c155}{N\_fourier}};i++)}
\DoxyCodeLine{   \{}
\DoxyCodeLine{    \mbox{\hyperlink{scattering_8txt_a6e2308ba2b055a80cdd4c2a0469b7d60}{flux}}+=pow(\mbox{\hyperlink{namespaceGlobalParameters_a7642bd7303d39de0d680340586b7df60}{I}},i)*(sqrt(\mbox{\hyperlink{namespaceGlobalParameters_aae73cb63b27d51a87845c3392cd944eb}{K\_squared}}))*pow(exp(\mbox{\hyperlink{namespaceGlobalParameters_a7642bd7303d39de0d680340586b7df60}{I}}*theta),i)*jnp[i];}
\DoxyCodeLine{   \}}
\DoxyCodeLine{  \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} i=1;i<\mbox{\hyperlink{namespaceGlobalParameters_ae4df03bf0ffa55b741ac846ca7b6c155}{N\_fourier}};i++)}
\DoxyCodeLine{   \{}
\DoxyCodeLine{    \mbox{\hyperlink{scattering_8txt_a6e2308ba2b055a80cdd4c2a0469b7d60}{flux}}+=pow(\mbox{\hyperlink{namespaceGlobalParameters_a7642bd7303d39de0d680340586b7df60}{I}},i)*(sqrt(\mbox{\hyperlink{namespaceGlobalParameters_aae73cb63b27d51a87845c3392cd944eb}{K\_squared}}))*pow(exp(-\/\mbox{\hyperlink{namespaceGlobalParameters_a7642bd7303d39de0d680340586b7df60}{I}}*theta),i)*jnp[i];}
...
\DoxyCodeLine{\textcolor{comment}{/// Solve 2D Helmholtz problem for scattering of a planar wave from a }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// unit disk }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//========================================================================}}
...
\DoxyCodeLine{  \mbox{\hyperlink{scattering_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}};}
\DoxyCodeLine{ }
...
\DoxyCodeLine{   \mbox{\hyperlink{scattering_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}}.newton\_solve(max\_adapt);}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{preprocessor}{\#else}}
\DoxyCodeLine{}
\DoxyCodeLine{   \textcolor{comment}{// Solve the problem with Newton's method}}
\DoxyCodeLine{   \mbox{\hyperlink{scattering_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}}.newton\_solve();}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{//Output solution}}
\DoxyCodeLine{ \mbox{\hyperlink{scattering_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}}.doc\_solution(doc\_info);}
\DoxyCodeLine{    }
...
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Create BC elements on boundary b of the Mesh pointed}}
...
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Create Helmholtz flux elements on boundary b of the Mesh pointed}}
...
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Set pointer to prescribed-\/flux function for all}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Set up boundary condition elements on outer boundary}}
...
\DoxyCodeLine{\textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Pointer to mesh containing the DtN (or ABC) boundary}}
...
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Pointer to the mesh containing }}
...
and populate them using the functions {\ttfamily \mbox{\hyperlink{scattering_8txt_adf96798a41c029db39789a3f53d931b8}{create\+\_\+flux\+\_\+elements(...)}}} and {\ttfamily create\+\_\+outer\+\_\+bc\+\_\+elements(...)}.
...
\DoxyCodeLine{ \mbox{\hyperlink{scattering_8txt_adf96798a41c029db39789a3f53d931b8}{create\_flux\_elements}}(0,Bulk\_mesh\_pt,Helmholtz\_inner\_boundary\_mesh\_pt);}
\DoxyCodeLine{}
...
The mesh adaptation is driven by the error estimates for the bulk elements. The various {\ttfamily Face\+Elements} must therefore be removed from the global mesh before the adaptation takes place. We do this by calling the function {\ttfamily \mbox{\hyperlink{scattering_8txt_a7d4c3450d2e4709cd1f29e52b7e160f6}{delete\+\_\+flux\+\_\+elements(...)}}} for the two face meshes, before rebuilding the Problem\textquotesingle{}s global mesh.
...
After the (bulk-\/)mesh has been adapted, the flux elements must be re-\/attached. This is done by calling the functions {\ttfamily \mbox{\hyperlink{scattering_8txt_adf96798a41c029db39789a3f53d931b8}{create\+\_\+flux\+\_\+elements(...)}}} and {\ttfamily create\+\_\+outer\+\_\+bc\+\_\+elements}, followed by rebuilding the Problem\textquotesingle{}s global mesh. Finally, we complete the build of the {\ttfamily Face\+Elements} by calling the functions {\ttfamily setup\+\_\+outer\+\_\+boundary()} and {\ttfamily set\+\_\+prescribed\+\_\+incoming\+\_\+flux\+\_\+pt()}.
...
The functions {\ttfamily \mbox{\hyperlink{scattering_8txt_adf96798a41c029db39789a3f53d931b8}{create\+\_\+flux\+\_\+elements(...)}}} and {\ttfamily create\+\_\+outer\+\_\+bc\+\_\+elements(...)} create the {\ttfamily Face\+Elements} required to apply the boundary conditions on the inner and outer boundaries of the annular computational domain. They both loop over the bulk elements that are adjacent to the appropriate mesh boundary and attach the required {\ttfamily Face\+Elements} to their faces. The newly created {\ttfamily Face\+Elements} are then added to the appropriate mesh.

 
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{comment}{//============start\_of\_create\_outer\_bc\_elements==============================}}
\DoxyCodeLine{\textcolor{comment}{/// Create outer BC elements on the b-\/th boundary of }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// the Mesh object pointed to by bulk\_mesh\_pt and add the elements }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// to the Mesh object pointed to by helmholtz\_outer\_boundary\_mesh\_pt.}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//===========================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT>}
...
(We omit the listing of the function {\ttfamily \mbox{\hyperlink{scattering_8txt_adf96798a41c029db39789a3f53d931b8}{create\+\_\+flux\+\_\+elements(...)}}} because it is very similar. Feel free to inspect in the \href{../../../../demo_drivers/helmholtz/scattering/scattering.cc}{\texttt{ source code.}})
...
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{scattering_8txt_a649ec8dc57f56a2947bb323f273049ca}{power}}=0.0;}
...
\DoxyCodeLine{   \mbox{\hyperlink{scattering_8txt_a649ec8dc57f56a2947bb323f273049ca}{power}} += el\_pt-\/>global\_power\_contribution(some\_file);}
\DoxyCodeLine{  \}}
\DoxyCodeLine{ some\_file.close();}
\DoxyCodeLine{ oomph\_info << \textcolor{stringliteral}{"Total radiated power: "} << \mbox{\hyperlink{scattering_8txt_a649ec8dc57f56a2947bb323f273049ca}{power}} << std::endl; }
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Output solution }}
\DoxyCodeLine{ \textcolor{comment}{//-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
