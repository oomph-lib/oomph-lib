...
\begin{DoxyCode}{0}
\DoxyCodeLine{FiniteElement* \mbox{\hyperlink{coding__conventions_8txt_abdf54a843c828adc77dc76b43eed4a00}{surface\_element\_pt}}; }
\end{DoxyCode}
...
\DoxyCodeLine{\textcolor{comment}{} Node* \mbox{\hyperlink{coding__conventions_8txt_ae2354be5cf2b6fd97ded218f0282e485}{boundary\_node\_pt}}()\textcolor{keyword}{ const }\{\textcolor{keywordflow}{return} Boundary\_node\_pt;\}}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// Access to boundary node}}
\DoxyCodeLine{\textcolor{comment}{} Node*\& \mbox{\hyperlink{coding__conventions_8txt_ae2354be5cf2b6fd97ded218f0282e485}{boundary\_node\_pt}}() \{\textcolor{keywordflow}{return} Boundary\_node\_pt;\}}
\end{DoxyCode}
...
{\bfseries{Note\+:}} Do {\bfseries{not}} use public data -- ever! Make it private and and provide an access function -- even if it seems \char`\"{}perfectly
 obvious\char`\"{} at the time of writing the class that the internal storage for the data item is \char`\"{}never going to be changed\char`\"{}.\hypertarget{index_pointers}{}\doxysubsection{Pointers}\label{index_pointers}
...
\DoxyCodeLine{\textcolor{comment}{}FiniteElement* \mbox{\hyperlink{coding__conventions_8txt_ae11c23d019f158839e6002c47913bb4a}{element\_pt}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned}\& e);}
\end{DoxyCode}
 rather than {\ttfamily \mbox{\hyperlink{coding__conventions_8txt_ab59e60957ba7a4692ded05fe49a956d6}{elements\+\_\+pt(...)}}} 
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{coding__conventions_8txt_a7b8627ed669d599b2fcbf99832ef334f}{nelement}}();}
\end{DoxyCode}
...
\DoxyCodeLine{\textcolor{keyword}{class }\mbox{\hyperlink{classNavierStokesEquations}{NavierStokesEquations}}}
\DoxyCodeLine{\{}
\DoxyCodeLine{  \textcolor{keyword}{public}:}
\DoxyCodeLine{  [...]}
\DoxyCodeLine{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{preprocessor}{\#ifndef OOMPH\_SOME\_CLASS\_HEADER     // Assuming that the file is }}
\DoxyCodeLine{\textcolor{preprocessor}{\#define OOMPH\_SOME\_CLASS\_HEADER     // called some\_class.h}}
\DoxyCodeLine{}
...
\hypertarget{index_paranoia}{}\doxysubsection{The P\+A\+R\+A\+N\+O\+I\+D flag and error handling}\label{index_paranoia}
...
\DoxyCodeLine{\textcolor{comment}{}Mesh(\textcolor{keyword}{const} Mesh\& dummy) }
\DoxyCodeLine{ \{ }
\DoxyCodeLine{  BrokenCopy::broken\_copy(\textcolor{stringliteral}{"Mesh"});}
\DoxyCodeLine{ \} }
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{/// Broken assignment operator}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{keywordtype}{void} operator=(\textcolor{keyword}{const} Mesh\&) }
\DoxyCodeLine{ \{}
\DoxyCodeLine{  BrokenCopy::broken\_assign(\textcolor{stringliteral}{"Mesh"});}
\DoxyCodeLine{ \}}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Return FE interpolated coordinate x[i] at local coordinate s}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// at previous timestep t (t=0: present; t>0: previous timestep)}}
...
\DoxyCodeLine{\textcolor{comment}{}  \textcolor{keywordtype}{void} enable\_doc() \{Doc\_flag=\textcolor{keyword}{true};\}\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{  /// Disable documentation}}
\DoxyCodeLine{\textcolor{comment}{}  \textcolor{keywordtype}{void} disable\_doc() \{Doc\_flag=\textcolor{keyword}{false};\}\textcolor{comment}{}}
