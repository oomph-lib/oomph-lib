...
\item \href{\#multi_domain_boussinesq}{\texttt{ {\bfseries{Part I\+II}}}} discusses the driver code to solve the Boussinesq problem, using the elements developed in Part II. ~\newline
~\newline
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_implement_boussinesq}{}\doxysection{Part I\+I\+: Implementing multi-\/domain interaction elements for the Boussinesq convection problem}\label{index_implement_boussinesq}
...
\DoxyCodeLine{\textcolor{keyword}{class }RefineableNavierStokesBoussinesqElement : \textcolor{keyword}{public} \textcolor{keyword}{virtual} NST\_ELEMENT,}
...
\DoxyCodeLine{\textcolor{comment}{}  \textcolor{keyword}{const} \textcolor{keywordtype}{double} \&ra()\textcolor{keyword}{ const }\{\textcolor{keywordflow}{return} *Ra\_pt;\}}
\DoxyCodeLine{  \textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{  /// is passed to the sons. Also make sure that if the external geometric}}
\DoxyCodeLine{\textcolor{comment}{  /// Data was ignored in the father it's also ignored in the sons}}
\DoxyCodeLine{\textcolor{comment}{}  \textcolor{keywordtype}{void} further\_build()}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   NST\_ELEMENT::further\_build();}
\DoxyCodeLine{   }
...
\DoxyCodeLine{   RefineableNavierStokesBoussinesqElement<NST\_ELEMENT,AD\_ELEMENT>* }
\DoxyCodeLine{    cast\_father\_element\_pt}
\DoxyCodeLine{    = \textcolor{keyword}{dynamic\_cast<}RefineableNavierStokesBoussinesqElement}
\DoxyCodeLine{    <NST\_ELEMENT,AD\_ELEMENT\textcolor{keyword}{>}*>(}
...
\DoxyCodeLine{   }
\DoxyCodeLine{   \textcolor{comment}{// Retain ignorance about external geometric data...}}
\DoxyCodeLine{   \textcolor{keywordflow}{if} (!cast\_father\_element\_pt-\/>external\_geometric\_data\_is\_included())}
\DoxyCodeLine{    \{}
\DoxyCodeLine{     this-\/>ignore\_external\_geometric\_data();}
\DoxyCodeLine{    \}}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{  \textcolor{comment}{/// \(\backslash\)short Overload get\_body\_force\_nst() to return the temperature-\/dependent}}
...
\DoxyCodeLine{    \textcolor{keyword}{dynamic\_cast<}AD\_ELEMENT*\textcolor{keyword}{>}(}
\DoxyCodeLine{     external\_element\_pt(interaction,ipt));}
\DoxyCodeLine{   }
\DoxyCodeLine{   \textcolor{comment}{// Get the temperature interpolated from the external element}}
\DoxyCodeLine{   \textcolor{keyword}{const} \textcolor{keywordtype}{double} interpolated\_t =adv\_diff\_el\_pt-\/>}
\DoxyCodeLine{    interpolated\_u\_adv\_diff(external\_element\_local\_coord(interaction,ipt));}
\DoxyCodeLine{   }
...
Finally, we have to compute the element\textquotesingle{}s Jacobian matrix. The easiest (although potentially inefficient) way to do this is to recycle the analytical computation of the derivatives of the Navier-\/\+Stokes residuals with respect to the fluid degrees of freedom, as implemented in ~\newline
 {\ttfamily N\+S\+T\+\_\+\+E\+L\+E\+M\+E\+N\+T\+::fill\+\_\+in\+\_\+contribution\+\_\+to\+\_\+jacobian(...)},
...
\DoxyCodeLine{   this-\/>fill\_in\_jacobian\_from\_external\_interaction\_by\_fd(residuals,jacobian);}
\DoxyCodeLine{   }
...
\DoxyCodeLine{\textcolor{keyword}{public} \textcolor{keyword}{virtual} AD\_ELEMENT, \textcolor{keyword}{public} \textcolor{keyword}{virtual} ElementWithExternalElement}
\DoxyCodeLine{\{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{public}:}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Constructor: call the underlying constructors}}
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{void} get\_wind\_adv\_diff(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned}\& ipt, \textcolor{keyword}{const} Vector<double> \&s, }
\DoxyCodeLine{                        \textcolor{keyword}{const} Vector<double>\& x, Vector<double>\& wind)\textcolor{keyword}{ const}}
...
\DoxyCodeLine{  NST\_ELEMENT* nst\_el\_pt= \textcolor{keyword}{dynamic\_cast<}NST\_ELEMENT*\textcolor{keyword}{>}}
\DoxyCodeLine{   (external\_element\_pt(interaction,ipt));}
\DoxyCodeLine{  }
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_multi_domain_boussinesq}{}\doxysection{Part I\+I\+I\+: The driver code for the multi-\/domain Boussinesq problem}\label{index_multi_domain_boussinesq}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Access function to the NST mesh. }}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Access function to the AD mesh. }}
\DoxyCodeLine{\textcolor{comment}{ /// Casts the pointer to the base Mesh object to }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{ /// the actual mesh type.}}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Actions after adaptation, reset all sources, then}}
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_optimise}{}\doxysection{Part I\+V\+: Optimising multi-\/domain interactions}\label{index_optimise}
...
\DoxyCodeLine{      it != external\_elements\_pt[interaction].end(); it++)}
\DoxyCodeLine{   \{}
\DoxyCodeLine{    }
\DoxyCodeLine{    \textcolor{comment}{//Cast the external element to a fluid element}}
\DoxyCodeLine{    NST\_ELEMENT* external\_fluid\_el\_pt =}
\DoxyCodeLine{     \textcolor{keyword}{dynamic\_cast<}NST\_ELEMENT*\textcolor{keyword}{>}(*it);}
\DoxyCodeLine{   }
