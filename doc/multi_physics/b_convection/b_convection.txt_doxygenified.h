...
\image html symm_broken.gif "Steady Convection Rolls: contours of temperature and the vector velocity field for a two-dimensional domain heated from below at Ra = 1800 " 
\image latex symm_broken.eps "Steady Convection Rolls: contours of temperature and the vector velocity field for a two-dimensional domain heated from below at Ra = 1800 " width=0.75\textwidth
...
\image html base_flow.gif "The base flow: no flow and a linear temperature distribution " 
\image latex base_flow.eps "The base flow: no flow and a linear temperature distribution " width=0.75\textwidth
...
\image html multi_physics.gif "Sketch illustrating the construction of the BuoyantQCrouzeixRaviartElement by multiple inheritance. " 
\image latex multi_physics.eps "Sketch illustrating the construction of the BuoyantQCrouzeixRaviartElement by multiple inheritance. " width=0.75\textwidth
