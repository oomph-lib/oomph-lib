...
density in (1)!) is the Lagrange multiplier -- the
...
\image html lagr_distort.gif "Domain deformation in response to the prescribed boundary displacement. " 
\image latex lagr_distort.eps "Domain deformation in response to the prescribed boundary displacement. " width=0.75\textwidth
