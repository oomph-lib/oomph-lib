...
\DoxyCodeLine{  \}}
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Parametrised position on object: r(zeta). Evaluated at}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short How many items of Data does the shape of the object depend on?}}
...
\DoxyCodeLine{ \mbox{\hyperlink{classPrescribedBoundaryDisplacementProblem}{PrescribedBoundaryDisplacementProblem<RefineableQPVDElement<2,3>}} > \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_a4074baada03976c061d5672f4237cca5}{problem}};}
\DoxyCodeLine{ }
\DoxyCodeLine{ \textcolor{comment}{// Doc initial domain shape}}
\DoxyCodeLine{ \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.doc\_solution();}
...
\DoxyCodeLine{   \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.newton\_solve(max\_adapt);}
\DoxyCodeLine{   }
...
\DoxyCodeLine{   \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.solid\_mesh\_pt()-\/>set\_lagrangian\_nodal\_coordinates();}
\DoxyCodeLine{   }
\DoxyCodeLine{  \}}
\DoxyCodeLine{ }
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Update function (empty)}}
...
\DoxyCodeLine{\textcolor{keyword}{private}:}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Create elements that enforce prescribed boundary motion}}
...
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_a4594cc67d151c2f09d749a2d054e7f71}{l\_x}}=1.0;}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Domain length in y-\/direction}}
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_a70e156ba08d56ab9ab1360ed22c1e003}{l\_y}}=1.0;}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{//Now create the mesh }}
\DoxyCodeLine{ \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}() = \textcolor{keyword}{new} ElasticRefineableRectangularQuadMesh<ELEMENT>(}
\DoxyCodeLine{  n\_x,n\_y,\mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_a4594cc67d151c2f09d749a2d054e7f71}{l\_x}},\mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_a70e156ba08d56ab9ab1360ed22c1e003}{l\_y}});}
...
\DoxyCodeLine{ \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>spatial\_error\_estimator\_pt()=\textcolor{keyword}{new} Z2ErrorEstimator;}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} n\_element =\mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>nelement();}
...
\DoxyCodeLine{   ELEMENT *el\_pt = \textcolor{keyword}{dynamic\_cast<}ELEMENT*\textcolor{keyword}{>}(\mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>element\_pt(i));}
\DoxyCodeLine{   }
...
\DoxyCodeLine{ \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>refine\_uniformly();}
...
\DoxyCodeLine{ add\_sub\_mesh(\mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}());}
\DoxyCodeLine{}
...
\DoxyCodeLine{    \{}
\DoxyCodeLine{     \textcolor{keywordtype}{unsigned} n\_side = \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>nboundary\_node(b);}
\DoxyCodeLine{     }
...
\DoxyCodeLine{      \{}
\DoxyCodeLine{       \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>boundary\_node\_pt(b,i)-\/>pin\_position(0);}
\DoxyCodeLine{       \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>boundary\_node\_pt(b,i)-\/>pin\_position(1);}
\DoxyCodeLine{      \}}
\DoxyCodeLine{    \}}
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{  \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>element\_pt());}
...
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} n\_element = \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>nboundary\_element(b);}
\DoxyCodeLine{ }
...
\DoxyCodeLine{    \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>boundary\_element\_pt(b,e));}
\DoxyCodeLine{   }
\DoxyCodeLine{   \textcolor{comment}{//Find the index of the face of element e along boundary b}}
\DoxyCodeLine{   \textcolor{keywordtype}{int} face\_index = \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>face\_index\_at\_boundary(b,e);}
\DoxyCodeLine{      }
...
\DoxyCodeLine{ \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>output(some\_file,n\_plot);}
...
\DoxyCodeLine{   \textcolor{keywordtype}{unsigned} b=2;}
\DoxyCodeLine{   \textcolor{keywordtype}{unsigned} n\_nod = \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>nboundary\_node(b);}
\DoxyCodeLine{   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} i=0;i<n\_nod;i++)}
\DoxyCodeLine{    \{}
\DoxyCodeLine{     Node* nod\_pt= \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_ae8b0810a7b3e714302e99c81eb12136d}{solid\_mesh\_pt}}()-\/>boundary\_node\_pt(b,i);}
\DoxyCodeLine{}
