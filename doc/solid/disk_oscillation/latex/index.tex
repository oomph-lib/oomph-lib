...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Multiplier for inertia terms (needed for consistent assignment }}
...
\DoxyCodeLine{ \mbox{\hyperlink{classDiskOscillationProblem}{DiskOscillationProblem<RefineableQPVDElement<2,3>}} > \mbox{\hyperlink{disk__oscillation_8txt_a4074baada03976c061d5672f4237cca5}{problem}};}
\DoxyCodeLine{ }
\DoxyCodeLine{ \textcolor{comment}{//Run the simulation}}
\DoxyCodeLine{ \mbox{\hyperlink{disk__oscillation_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.run(nstep);}
\DoxyCodeLine{ }
...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Axisymmetrially oscillating disk with displacement}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Constructor: 2 Lagrangian coordinate, 2 Eulerian coords. Pass }}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Position vector at Lagrangian coordinate xi at present}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ ///\(\backslash\)short Parametrised velocity on object at current time: veloc = d r(xi)/dt.}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Parametrised acceleration on object at current time: }}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Parametrised j-\/th time-\/derivative on object at current time: }}
...
\DoxyCodeLine{}
\DoxyCodeLine{   \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Residual of dispersion relation for use in black-\/box Newton method}}
...
Here is the specification of the dispersion relation, in the form required by {\ttfamily oomph-\/lib\textquotesingle{}s} black-\/box Newton solver. The Bessel functions are computed by \href{http://www.crbond.com/}{\texttt{ C.\+R. Bond\textquotesingle{}s}} {\ttfamily bessjy01a(...)} function, available (with permission) via {\ttfamily oomph-\/lib\textquotesingle{}s} {\ttfamily C\+R\+Bond\+\_\+\+Bessel} namespace.
...
\DoxyCodeLine{   \textcolor{keywordtype}{double} \mbox{\hyperlink{disk__oscillation_8txt_a8788dde7ac2262ea5307475125f91fec}{u}}=\mbox{\hyperlink{classAxisymOscillatingDisk_a9b73de59d11877c96bc85ad52fe7c407}{Ampl}}*j1*sin(2.0*MathematicalConstants::Pi*time/\mbox{\hyperlink{classAxisymOscillatingDisk_a7789dcf51ef2e2eb6e5eaa826f404da1}{T}});}
\DoxyCodeLine{   }
\DoxyCodeLine{   \textcolor{comment}{// Position Vector}}
\DoxyCodeLine{   r[0]=(xi[0]+xi[0]/lagr\_radius*\mbox{\hyperlink{disk__oscillation_8txt_a8788dde7ac2262ea5307475125f91fec}{u}});}
\DoxyCodeLine{   r[1]=(xi[1]+xi[1]/lagr\_radius*\mbox{\hyperlink{disk__oscillation_8txt_a8788dde7ac2262ea5307475125f91fec}{u}});}
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{keyword}{public}:}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Constructor: Build mesh and copy Eulerian coords to Lagrangian}}
...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Problem class to simulate small-\/amplitude oscillations of }}
