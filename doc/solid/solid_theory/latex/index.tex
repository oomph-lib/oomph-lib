...
\end{DoxyItemize}
\end{DoxyEnumerate}The abstract base class {\ttfamily Constitutive\+Law} provides interfaces for the computation of the stress in all three forms.\hypertarget{index_strain-energy}{}\doxysubsubsection{Strain-\/energy functions}\label{index_strain-energy}
