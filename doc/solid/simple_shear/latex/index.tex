...
\hypertarget{index}{}\label{index}\index{Demo problem: Large-\/amplitude shear deformation of a 3D elastic solid@{Demo problem: Large-\/amplitude shear deformation of a 3D elastic solid}}
...
\DoxyCodeLine{\textcolor{preprocessor}{\#include\ "{}meshes/simple\_cubic\_mesh.h"{}}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{comment}{}\ \textcolor{keyword}{virtual}\ \mbox{\hyperlink{classElasticCubicMesh_a64cc078916561417462636f399a71e88}{\string~ElasticCubicMesh}}()\ \{\ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{}
...
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \textcolor{keywordtype}{double}\ \mbox{\hyperlink{classSimpleShearProblem_a3844145c334e84c6ed94d803aeb1a337}{Shear}};}
\DoxyCodeLine{}
\DoxyCodeLine{\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classSimpleShearProblem_a3e5d5f57fc041531ee683f50395536f0}{set\_incompressible}}(ELEMENT\ *el\_pt,\textcolor{keyword}{const}\ \textcolor{keywordtype}{bool}\ \&incompressible);}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{public}:}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{\ ///\ Constructor:}}
...
\DoxyCodeLine{\textcolor{comment}{}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classSimpleShearProblem_ac1746a2634e310571d40d70719d509c0}{run}}(\textcolor{keyword}{const}\ std::string\ \&dirname);}
\DoxyCodeLine{\ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{\ ///\ Access\ function\ for\ the\ mesh}}
\DoxyCodeLine{\textcolor{comment}{}\ \mbox{\hyperlink{classElasticCubicMesh}{ElasticCubicMesh<ELEMENT>}}*\ \mbox{\hyperlink{classSimpleShearProblem_a4939a469c0b494296c2d3adc21638fc3}{mesh\_pt}}()\ }
...
\DoxyCodeLine{\textcolor{comment}{}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classSimpleShearProblem_a24c087d9ea194229930bcf9f889a048e}{doc\_solution}}(DocInfo\&\ doc\_info);}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{\ ///\ Update\ function\ (empty)}}
\DoxyCodeLine{\textcolor{comment}{}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classSimpleShearProblem_ab476064967687537e335dfd40d770dbc}{actions\_after\_newton\_solve}}()\ \{\}}
\DoxyCodeLine{\textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classSimpleShearProblem_a2c63e1a6c120da147b0c4ec9764e1510}{actions\_before\_newton\_solve}}()}
\DoxyCodeLine{\ \ \{\ }
\DoxyCodeLine{\ \ \ \mbox{\hyperlink{classSimpleShearProblem_a1069985934b36d269b4bc8cb3ba00902}{apply\_boundary\_conditions}}();}
\DoxyCodeLine{\ \ \ \textcolor{keywordtype}{bool}\ update\_all\_solid\_nodes=\textcolor{keyword}{true};}
\DoxyCodeLine{\ \ \ \mbox{\hyperlink{classSimpleShearProblem_a4939a469c0b494296c2d3adc21638fc3}{mesh\_pt}}()-\/>node\_update(update\_all\_solid\_nodes);}
\DoxyCodeLine{\ \ \}\ \ \ }
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{\ ///\ Shear\ the\ top}}
\DoxyCodeLine{\textcolor{comment}{}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classSimpleShearProblem_a1069985934b36d269b4bc8cb3ba00902}{apply\_boundary\_conditions}}()}
\DoxyCodeLine{\ \ \{}
\DoxyCodeLine{\ \ \ \textcolor{keywordtype}{unsigned}\ ibound\ =\ 5;}
\DoxyCodeLine{\ \ \ \textcolor{keywordtype}{unsigned}\ num\_nod=\mbox{\hyperlink{classSimpleShearProblem_a4939a469c0b494296c2d3adc21638fc3}{mesh\_pt}}()-\/>nboundary\_node(ibound);}
...
\DoxyCodeLine{\ \ \ \ \ \mbox{\hyperlink{classSimpleShearProblem_a4939a469c0b494296c2d3adc21638fc3}{mesh\_pt}}()-\/>boundary\_node\_pt(ibound,inod));}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ solid\_nod\_pt-\/>x(0)\ =\ solid\_nod\_pt-\/>xi(0)\ +\ \mbox{\hyperlink{classSimpleShearProblem_a3844145c334e84c6ed94d803aeb1a337}{Shear}}*}
...
\DoxyCodeLine{\ }
\DoxyCodeLine{\ snprintf(filename,\ \textcolor{keyword}{sizeof}(filename),\ \textcolor{stringliteral}{"{}\%s/stress\%i.dat"{}},\ doc\_info.directory().c\_str(),}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ doc\_info.number());}
\DoxyCodeLine{\ some\_file.open(filename);}
