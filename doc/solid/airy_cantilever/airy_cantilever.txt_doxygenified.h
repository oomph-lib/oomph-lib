...
\image html airy_cantilever_sketch.gif "Sketch of the problem. " 
\image latex airy_cantilever_sketch.eps "Sketch of the problem. " width=0.75\textwidth
...
\image html beam_animation.gif "Animation of the beam's deformation with contours of its `horizontal' stress component. " 
\image latex beam_animation.eps "Animation of the beam's deformation with contours of its `horizontal' stress component. " width=0.75\textwidth
...
\image html stress_comparison.gif "Comparison of the computed distribution of the `horizontal' stress (in green) against the approximate analytical solution (in red). " 
\image latex stress_comparison.eps "Comparison of the computed distribution of the `horizontal' stress (in green) against the approximate analytical solution (in red). " width=0.75\textwidth
