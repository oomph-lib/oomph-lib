...
\DoxyCodeLine{       \mbox{\hyperlink{compressed__square_8txt_a4074baada03976c061d5672f4237cca5}{problem}}(incompress);}
\DoxyCodeLine{      }
\DoxyCodeLine{      \textcolor{comment}{// Run it}}
\DoxyCodeLine{      \mbox{\hyperlink{compressed__square_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.run\_it(case\_number,incompress);}
\DoxyCodeLine{     \}}
...
Next we consider the pressure/displacement formulation with continuous pressures (Taylor-\/\+Hood), using the ~\newline
 {\ttfamily Q\+P\+V\+D\+Element\+With\+Continuous\+Pressure} element.
...
\DoxyCodeLine{\textcolor{keyword}{public}:}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Constructor: Pass flag that determines if we want to use}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Doc the solution \& exact (linear) solution for compressible }}
...
\DoxyCodeLine{\textcolor{comment}{/// Constructor: Pass flag that determines if we want to enforce}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// incompressibility}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//====================================================================== }}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT>}
...
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{compressed__square_8txt_a5a6c39e643df898a41b2ff44e0453777}{nu}}=\mbox{\hyperlink{namespaceGlobal__Physical__Variables_a3962c36313826b19f216f6bbbdd6a477}{Global\_Physical\_Variables::Nu}};}
\DoxyCodeLine{ \textcolor{keywordflow}{if} (incompress) \mbox{\hyperlink{compressed__square_8txt_a5a6c39e643df898a41b2ff44e0453777}{nu}}=0.5;}
\DoxyCodeLine{}
...
\DoxyCodeLine{          (1.0+\mbox{\hyperlink{compressed__square_8txt_a5a6c39e643df898a41b2ff44e0453777}{nu}})*(1.0-\/2*\mbox{\hyperlink{compressed__square_8txt_a5a6c39e643df898a41b2ff44e0453777}{nu}})/(1.0-\/\mbox{\hyperlink{compressed__square_8txt_a5a6c39e643df898a41b2ff44e0453777}{nu}})*(0.5*x[1]*x[1]-\/x[1]);}
\DoxyCodeLine{         }
...
\DoxyCodeLine{         sigma(0,0)=\mbox{\hyperlink{compressed__square_8txt_a5a6c39e643df898a41b2ff44e0453777}{nu}}/(1.0-\/\mbox{\hyperlink{compressed__square_8txt_a5a6c39e643df898a41b2ff44e0453777}{nu}})*\mbox{\hyperlink{namespaceGlobal__Physical__Variables_a8b80d3e8d63b8d0a0ed435a2dd7fe2ad}{Global\_Physical\_Variables::Gravity}}*(x[1]-\/1.0);}
