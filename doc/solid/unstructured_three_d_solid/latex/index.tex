...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Constant pressure load. The arguments to this function are imposed}}
...
\DoxyCodeLine{ \mbox{\hyperlink{classUnstructuredSolidProblem}{UnstructuredSolidProblem<TPVDElement<3,3>}} > \mbox{\hyperlink{unstructured__three__d__solid_8txt_a4074baada03976c061d5672f4237cca5}{problem}};}
...
\DoxyCodeLine{ \mbox{\hyperlink{unstructured__three__d__solid_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.doc\_solution(doc\_info);}
...
\DoxyCodeLine{   \mbox{\hyperlink{unstructured__three__d__solid_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.newton\_solve();}
\DoxyCodeLine{   }
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//=====================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT>}
\DoxyCodeLine{\textcolor{keyword}{class }\mbox{\hyperlink{classUnstructuredSolidProblem}{UnstructuredSolidProblem}} : \textcolor{keyword}{public} \mbox{\hyperlink{unstructured__three__d__solid_8txt_a369f11bc5cf9fc0b3069a6f53624f7e2}{Problem}}}
\DoxyCodeLine{\{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{public}:}
\DoxyCodeLine{\textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short IDs of solid mesh boundaries which make up the traction interface}}
...
\DoxyCodeLine{ \mbox{\hyperlink{unstructured__three__d__solid_8txt_a99adc9b3c56170216a114b9b14978e9a}{create\_traction\_elements}}();}
...
The helper function {\ttfamily \mbox{\hyperlink{unstructured__three__d__solid_8txt_a99adc9b3c56170216a114b9b14978e9a}{create\+\_\+traction\+\_\+elements()}}} does exactly what it says\+: It loops over the bulk elements that are adjacent to the inner surface of the vessel, and attaches {\ttfamily Solid\+Traction\+Elements} to the appropriate faces. We store the pointers to the newly-\/created traction elements in separate meshes and specify the function pointer to the load function.
