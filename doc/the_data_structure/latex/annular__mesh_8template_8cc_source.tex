...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00006}00006 \textcolor{comment}{// LIC// Copyright (C) 2006-\/2021 Matthias Heil and Andrew Hazel}}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00044}00044     \mbox{\hyperlink{classoomph_1_1Ellipse}{Ellipse}} ellipse(a, a);}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00047}00047     \mbox{\hyperlink{classoomph_1_1Vector}{Vector<double>}} xi(1);}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00048}00048     \mbox{\hyperlink{classoomph_1_1Vector}{Vector<double>}} base(2);}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00049}00049     \mbox{\hyperlink{classoomph_1_1Vector}{Vector<double>}} \mbox{\hyperlink{namespaceoomph_1_1QuadTreeNames_a8954a5947b19986b8c4b755bc7639f7dabc60bec4cc294aa2adf92726c6d6823a}{N}}(2);}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00054}00054       \mbox{\hyperlink{classoomph_1_1Node}{Node}}* nod\_pt = this-\/>node\_pt(n);}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00059}00059       xi[0] = (1.0 -\/ 1.0e-\/10) * (-\/azimuthal\_fraction * nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_ab76b4773a65b349f143539e07b6e15e2}{x}}(0)) * 2.0 *}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00060}00060                 \mbox{\hyperlink{namespaceoomph_1_1MathematicalConstants_a61ae4ddbc59fbd0797ebb671e48c8d6d}{MathematicalConstants::Pi}} +}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00061}00061               \mbox{\hyperlink{namespaceoomph_1_1MathematicalConstants_a61ae4ddbc59fbd0797ebb671e48c8d6d}{MathematicalConstants::Pi}} -\/}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00062}00062               (1.0 -\/ azimuthal\_fraction) * 2.0 * \mbox{\hyperlink{namespaceoomph_1_1MathematicalConstants_a61ae4ddbc59fbd0797ebb671e48c8d6d}{MathematicalConstants::Pi}};}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00068}00068       \textcolor{keywordtype}{double} w = nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_ab76b4773a65b349f143539e07b6e15e2}{x}}(1);}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00071}00071       ellipse.\mbox{\hyperlink{classoomph_1_1Ellipse_abf6972409206084dd1f517a535fb1b52}{position}}(xi, base);}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00075}00075       \mbox{\hyperlink{namespaceoomph_1_1QuadTreeNames_a8954a5947b19986b8c4b755bc7639f7dabc60bec4cc294aa2adf92726c6d6823a}{N}}[0] = base[0] / norm;}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00076}00076       \mbox{\hyperlink{namespaceoomph_1_1QuadTreeNames_a8954a5947b19986b8c4b755bc7639f7dabc60bec4cc294aa2adf92726c6d6823a}{N}}[1] = base[1] / norm;}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00079}00079       nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_ab76b4773a65b349f143539e07b6e15e2}{x}}(0) = base[0] + w * (h + a -\/ norm) * \mbox{\hyperlink{namespaceoomph_1_1QuadTreeNames_a8954a5947b19986b8c4b755bc7639f7dabc60bec4cc294aa2adf92726c6d6823a}{N}}[0];}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00080}00080       nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_ab76b4773a65b349f143539e07b6e15e2}{x}}(1) = base[1] + w * (h + a -\/ norm) * \mbox{\hyperlink{namespaceoomph_1_1QuadTreeNames_a8954a5947b19986b8c4b755bc7639f7dabc60bec4cc294aa2adf92726c6d6823a}{N}}[1];}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00083}00083       \mbox{\hyperlink{classoomph_1_1Vector}{Vector<double>}} xi\_bound(1);}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00086}00086       \textcolor{keywordflow}{if} (nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_a2ca215e42116ee8a2acc7d6a35e37788}{is\_on\_boundary}}(0))}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00087}00087       \{}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00088}00088         xi\_bound[0] = atan2(nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_ab76b4773a65b349f143539e07b6e15e2}{x}}(1), nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_ab76b4773a65b349f143539e07b6e15e2}{x}}(0));}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00089}00089         nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_a94c19e165ab4e88aabbfa27443c530b7}{set\_coordinates\_on\_boundary}}(0, xi\_bound);}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00093}00093       \textcolor{keywordflow}{if} (nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_a2ca215e42116ee8a2acc7d6a35e37788}{is\_on\_boundary}}(1))}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00094}00094       \{}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00095}00095         xi\_bound[0] = sqrt(pow(nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_ab76b4773a65b349f143539e07b6e15e2}{x}}(0), 2) + pow(nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_ab76b4773a65b349f143539e07b6e15e2}{x}}(1), 2));}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00096}00096         nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_a94c19e165ab4e88aabbfa27443c530b7}{set\_coordinates\_on\_boundary}}(1, xi\_bound);}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00100}00100       \textcolor{keywordflow}{if} (nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_a2ca215e42116ee8a2acc7d6a35e37788}{is\_on\_boundary}}(2))}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00101}00101       \{}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00102}00102         xi\_bound[0] = atan2(nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_ab76b4773a65b349f143539e07b6e15e2}{x}}(1), nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_ab76b4773a65b349f143539e07b6e15e2}{x}}(0));}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00103}00103         nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_a94c19e165ab4e88aabbfa27443c530b7}{set\_coordinates\_on\_boundary}}(2, xi\_bound);}
...
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00107}00107       \textcolor{keywordflow}{if} (nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_a2ca215e42116ee8a2acc7d6a35e37788}{is\_on\_boundary}}(3))}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00108}00108       \{}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00109}00109         xi\_bound[0] = sqrt(pow(nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_ab76b4773a65b349f143539e07b6e15e2}{x}}(0), 2) + pow(nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_ab76b4773a65b349f143539e07b6e15e2}{x}}(1), 2));}
\DoxyCodeLine{\Hypertarget{annular__mesh_8template_8cc_source_l00110}00110         nod\_pt-\/>\mbox{\hyperlink{classoomph_1_1Node_a94c19e165ab4e88aabbfa27443c530b7}{set\_coordinates\_on\_boundary}}(3, xi\_bound);}
