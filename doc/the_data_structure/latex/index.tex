...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{the__data__structure_8txt_a3b0d20781021ec2f0e788713f8b0fec8}{Data::value}}(\mbox{\hyperlink{cfortran_8h_adb50e893b86b3e55e751a42eab3cba82}{i}})}
\end{DoxyCode}
 and its time-\/dependent counterpart 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{the__data__structure_8txt_a3b0d20781021ec2f0e788713f8b0fec8}{Data::value}}(\mbox{\hyperlink{cfortran_8h_af6f0bd3dc13317f895c91323c25c2b8f}{t}},\mbox{\hyperlink{cfortran_8h_adb50e893b86b3e55e751a42eab3cba82}{i}})}
\end{DoxyCode}
...
\end{DoxyCode}
 which returns the value of i-\/th nodal coordinate at the present (t=0) timestep or a history value, if (t$>$0); again, note that the history values are not necessarily positions at previous timesteps.\hypertarget{index_advanced_features_of_nodes}{}\doxysubsubsection{Advanced features\+:}\label{index_advanced_features_of_nodes}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{virtual} \textcolor{keywordtype}{void} \mbox{\hyperlink{the__data__structure_8txt_a80f7344c0300e389acecd2d048f2bb58}{GeneralisedElement::get\_residuals}}(...) }
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{class }\mbox{\hyperlink{classMultiPhysicsElement}{MultiPhysicsElement}} : \textcolor{keyword}{public} \textcolor{keyword}{virtual} SinglePhysicsOneElement,}
\DoxyCodeLine{                            \textcolor{keyword}{public} \textcolor{keyword}{virtual} SinglePhysicsTwoElement}
\DoxyCodeLine{ \{   }
\DoxyCodeLine{}
\DoxyCodeLine{  [...]}
\DoxyCodeLine{                     }
\DoxyCodeLine{  \textcolor{keywordtype}{void} \mbox{\hyperlink{classMultiPhysicsElement_a0d83f4f387363474e0912b4e892ad4f1}{get\_residuals}}(...) }
\DoxyCodeLine{   \{}
\DoxyCodeLine{    \mbox{\hyperlink{the__data__structure_8txt_a80f7344c0300e389acecd2d048f2bb58}{SinglePhysicsOneElement::get\_residuals}}(...);}
\DoxyCodeLine{    \mbox{\hyperlink{the__data__structure_8txt_a80f7344c0300e389acecd2d048f2bb58}{SinglePhysicsTwoElement::get\_residuals}}(...);}
\DoxyCodeLine{   \}}
\DoxyCodeLine{}
\DoxyCodeLine{  [...]}
\DoxyCodeLine{}
\DoxyCodeLine{ \};}
\end{DoxyCode}
 where the {\ttfamily \mbox{\hyperlink{classMultiPhysicsElement}{Multi\+Physics\+Element}}} inherits from {\ttfamily Single\+Physics\+One\+Element} and {\ttfamily Single\+Physics\+Two\+Element}.

A problem with this implementation arises when we consider where to initialise the residuals vector. If the second single-\/physics {\ttfamily \mbox{\hyperlink{the__data__structure_8txt_a80f7344c0300e389acecd2d048f2bb58}{get\+\_\+residuals(...)}}} function initialises the residuals vector, then the contribution of the first single-\/physics element will be negated. When writing a single-\/physics element, however, we cannot know whether it will ever be used as part of a multi-\/physics element and, if so, in which order the {\ttfamily \mbox{\hyperlink{the__data__structure_8txt_a80f7344c0300e389acecd2d048f2bb58}{get\+\_\+residuals(...)}}} functions will be called. The solution adopted in {\ttfamily oomph-\/lib} is to provide the two additional virtual functions 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{virtual} \textcolor{keywordtype}{void} \mbox{\hyperlink{the__data__structure_8txt_a74a99b2ddb5919974c6edd5550b6d953}{GeneralisedElement::fill\_in\_contribution\_to\_residuals}}(...)}
\end{DoxyCode}
 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{virtual} \textcolor{keywordtype}{void} \mbox{\hyperlink{the__data__structure_8txt_af81c63b6a6a317202ae084901ea01119}{GeneralisedElement::fill\_in\_contribution\_to\_jacobian}}(...)}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{virtual} \textcolor{keywordtype}{void} \mbox{\hyperlink{the__data__structure_8txt_a80f7344c0300e389acecd2d048f2bb58}{GeneralisedElement::get\_residuals}}(Vector<double> \&\mbox{\hyperlink{the__data__structure_8txt_a1400a973def57b85051cfe1070be1810}{residuals}}) }
\DoxyCodeLine{ \{}
\DoxyCodeLine{  \textcolor{comment}{//Zero the residuals vector}}
\DoxyCodeLine{  \mbox{\hyperlink{the__data__structure_8txt_a1400a973def57b85051cfe1070be1810}{residuals}}.initialise(0.0);}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{//Add the elemental contribution to the residuals vector}}
\DoxyCodeLine{  \mbox{\hyperlink{the__data__structure_8txt_a74a99b2ddb5919974c6edd5550b6d953}{fill\_in\_contribution\_to\_residuals}}(\mbox{\hyperlink{the__data__structure_8txt_a1400a973def57b85051cfe1070be1810}{residuals}});}
\DoxyCodeLine{  \}}
\end{DoxyCode}
...
\DoxyCodeLine{  [...]}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{keywordtype}{void} \mbox{\hyperlink{classMultiPhysicsElement_a0d83f4f387363474e0912b4e892ad4f1}{get\_residuals}}(Vector<double> \&\mbox{\hyperlink{the__data__structure_8txt_a1400a973def57b85051cfe1070be1810}{residuals}}) }
\DoxyCodeLine{  \{}
\DoxyCodeLine{   \textcolor{comment}{//Zero the residuals vector}}
\DoxyCodeLine{   \mbox{\hyperlink{the__data__structure_8txt_a1400a973def57b85051cfe1070be1810}{residuals}}.initialise(0.0);}
\DoxyCodeLine{}
\DoxyCodeLine{   \textcolor{comment}{//Add the first elemental contribution to the residuals vector}}
\DoxyCodeLine{   \mbox{\hyperlink{the__data__structure_8txt_a74a99b2ddb5919974c6edd5550b6d953}{SinglePhysicsOneElement::fill\_in\_contribution\_to\_residuals}}(\mbox{\hyperlink{the__data__structure_8txt_a1400a973def57b85051cfe1070be1810}{residuals}});}
\DoxyCodeLine{}
\DoxyCodeLine{   \textcolor{comment}{//Add the second elemental contribution to the residuals vector   }}
\DoxyCodeLine{   \mbox{\hyperlink{the__data__structure_8txt_a74a99b2ddb5919974c6edd5550b6d953}{SinglePhysicsTwoElement::fill\_in\_contribution\_to\_residuals}}(\mbox{\hyperlink{the__data__structure_8txt_a1400a973def57b85051cfe1070be1810}{residuals}}); }
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
\DoxyCodeLine{  [...]}
\DoxyCodeLine{}
...
The default implementation of {\ttfamily \mbox{\hyperlink{the__data__structure_8txt_af81c63b6a6a317202ae084901ea01119}{fill\+\_\+in\+\_\+contribution\+\_\+to\+\_\+jacobian(...)}}} uses finite differences to calculate the Jacobian matrix. Hence, the simplest possible implementation of a new element requires only the specification of {\ttfamily \mbox{\hyperlink{the__data__structure_8txt_a74a99b2ddb5919974c6edd5550b6d953}{fill\+\_\+in\+\_\+contribution\+\_\+to\+\_\+residuals(...)}}}.
...
\DoxyCodeLine{\mbox{\hyperlink{the__data__structure_8txt_a92944c1c6b9eca60b38b22831f47da95}{GeneralisedElement}} \mbox{\hyperlink{the__data__structure_8txt_af1ac6d88153e383bbb0a0d9f2dd78e60}{el}};}
\DoxyCodeLine{}
\DoxyCodeLine{[...]}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{the__data__structure_8txt_a0ca71de52c9f65466ea6eefc4f332736}{i\_global}}=\mbox{\hyperlink{the__data__structure_8txt_af1ac6d88153e383bbb0a0d9f2dd78e60}{el}}.eqn\_number(i\_local); }
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{FiniteElement::Node\_pt[\mbox{\hyperlink{the__data__structure_8txt_af88b2d950fae19ab641bd1690e08445c}{n}}] }
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{FiniteElement::Node\_pt[\mbox{\hyperlink{the__data__structure_8txt_af88b2d950fae19ab641bd1690e08445c}{n}}]-\/>x(\mbox{\hyperlink{cfortran_8h_adb50e893b86b3e55e751a42eab3cba82}{i}}) }
\end{DoxyCode}
 we can write 
\begin{DoxyCode}{0}
\DoxyCodeLine{FiniteElement::nodal\_position(\mbox{\hyperlink{the__data__structure_8txt_af88b2d950fae19ab641bd1690e08445c}{n}},\mbox{\hyperlink{cfortran_8h_adb50e893b86b3e55e751a42eab3cba82}{i}}) }
\end{DoxyCode}
...
At this level, we implement the equations that are represented by the specific element. We implement the \mbox{\hyperlink{the__data__structure_8txt_a0dbf3ebf11b527f1f8f1b9f494ba38e9}{interpolation(s)}} for the unknown function(s), employing either the geometric shape functions that already exist on level 2, or employing additional shape functions defined at this level. This allows us to write further member functions such as {\ttfamily \mbox{\hyperlink{the__data__structure_8txt_a5448c72da3359c7796cf0c5f800732a1}{interpolated\+\_\+u(...)}}}, say, which compute the i-\/th velocity component at the local coordinate {\ttfamily s} like this 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{comment}{// Create fluid element}}
\DoxyCodeLine{SomeFluidElement \mbox{\hyperlink{the__data__structure_8txt_a5a99a6499dd6ccc7755850eca7bb334b}{fluid\_element}};}
\DoxyCodeLine{}
\DoxyCodeLine{[...]}
\DoxyCodeLine{}
...
\DoxyCodeLine{Vector<double> \mbox{\hyperlink{the__data__structure_8txt_aaa5287b1cf3ca06b3f413cb95bd1ec60}{u}}(3);}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Compute the velocity at local coordinate s}}
\DoxyCodeLine{\mbox{\hyperlink{the__data__structure_8txt_a5a99a6499dd6ccc7755850eca7bb334b}{fluid\_element}}.interpolated\_u(\mbox{\hyperlink{cfortran_8h_ab7123126e4885ef647dd9c6e3807a21c}{s}},\mbox{\hyperlink{the__data__structure_8txt_aaa5287b1cf3ca06b3f413cb95bd1ec60}{u}});}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{the__data__structure_8txt_af88b2d950fae19ab641bd1690e08445c}{n}};}
\DoxyCodeLine{\textcolor{keywordtype}{double} \mbox{\hyperlink{the__data__structure_8txt_a15043ffc2013f4797ce93c4d1cc7a9ba}{press}} = Node\_pt[\mbox{\hyperlink{the__data__structure_8txt_af88b2d950fae19ab641bd1690e08445c}{n}}]-\/>value(3);}
\end{DoxyCode}
 (which forces us to remember that in this particular 3D fluid element, the pressure is stored as the fourth value at all nodes...), say, we provide an access function {\ttfamily \mbox{\hyperlink{the__data__structure_8txt_ac3335dcd8d8a94bd04fa5fcf4ca57d44}{p\+\_\+fluid(...)}}} which allows us to write 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{the__data__structure_8txt_af88b2d950fae19ab641bd1690e08445c}{n}};}
\DoxyCodeLine{\textcolor{keywordtype}{double} \mbox{\hyperlink{the__data__structure_8txt_a15043ffc2013f4797ce93c4d1cc7a9ba}{press}} = \mbox{\hyperlink{the__data__structure_8txt_a5a99a6499dd6ccc7755850eca7bb334b}{fluid\_element}}.p\_fluid(\mbox{\hyperlink{the__data__structure_8txt_af88b2d950fae19ab641bd1690e08445c}{n}});}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{double} \mbox{\hyperlink{the__data__structure_8txt_ac3335dcd8d8a94bd04fa5fcf4ca57d44}{SomeFluidElement::p\_fluid}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned}\& \mbox{\hyperlink{the__data__structure_8txt_af88b2d950fae19ab641bd1690e08445c}{n}})}
\DoxyCodeLine{ \{ \textcolor{keywordflow}{return} Node\_pt[\mbox{\hyperlink{the__data__structure_8txt_af88b2d950fae19ab641bd1690e08445c}{n}}]-\/>value(3);\}}
\end{DoxyCode}
 \mbox{[}See section \mbox{\hyperlink{index_Hanging_Nodes}{Hanging Nodes}} for a full description of hanging nodes.\mbox{]}

The functions 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{the__data__structure_8txt_a0da96ee19f5f052118b3538e2a5e043a}{FiniteElement::assign\_additional\_local\_eqn\_numbers}}()  }
\end{DoxyCode}
 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{the__data__structure_8txt_a80f7344c0300e389acecd2d048f2bb58}{FiniteElement::get\_residuals}}(...) }
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int} p\_local\_eqn(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&\mbox{\hyperlink{the__data__structure_8txt_af88b2d950fae19ab641bd1690e08445c}{n}}) }
\DoxyCodeLine{ \{}
\DoxyCodeLine{  \textcolor{keywordflow}{return} internal\_local\_eqn(0,\mbox{\hyperlink{the__data__structure_8txt_af88b2d950fae19ab641bd1690e08445c}{n}});}
\DoxyCodeLine{ \}}
\end{DoxyCode}
 Thus, in our standard equations the function {\ttfamily \mbox{\hyperlink{the__data__structure_8txt_a0da96ee19f5f052118b3538e2a5e043a}{assign\+\_\+additional\+\_\+local\+\_\+eqn\+\_\+numbers()}}} is not used.
...
\end{DoxyCode}
 The function 
\begin{DoxyCode}{0}
\DoxyCodeLine{Mesh::add\_boundary\_node(\mbox{\hyperlink{cfortran_8h_adb50e893b86b3e55e751a42eab3cba82}{i}},\&\mbox{\hyperlink{the__data__structure_8txt_ae56499a02d89f315ab025070e7a0058f}{node}}) }
\end{DoxyCode}
...
\end{DoxyEnumerate}\hypertarget{index_Node_DOF_numbering}{}\doxysubsubsection{Equation/\+D\+O\+F numbering at the mesh level}\label{index_Node_DOF_numbering}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{the__data__structure_8txt_a80f7344c0300e389acecd2d048f2bb58}{RefineableQElement<2>::get\_residuals}}() }
\end{DoxyCode}
 and 
\begin{DoxyCode}{0}
...
In practice, we again distinguish between the \char`\"{}geometry\char`\"{} and the \char`\"{}maths\char`\"{} by writing a general {\ttfamily Refineable\+Poisson\+Equations$<$\+D\+I\+M$>$} class that inherits from {\ttfamily Poisson\+Equations$<$\+D\+I\+M$>$} and re-\/implements the appropriate member functions.\hypertarget{index_RefineableQuadMesh_adaption_section}{}\doxysubsubsection{Mesh adaptation}\label{index_RefineableQuadMesh_adaption_section}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{the__data__structure_8txt_aecdcb19250d339765d0095e975875b2a}{GeomObject::position}}(xi,r)}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{the__data__structure_8txt_aecdcb19250d339765d0095e975875b2a}{GeomObject::position}}(xi,\mbox{\hyperlink{cfortran_8h_af6f0bd3dc13317f895c91323c25c2b8f}{t}},r)}
\end{DoxyCode}
...
\end{DoxyCode}
 The mapping needs to be chosen such that for $ S_1\in [-1..1]$ the position vector $ {\bf r}(S_0=-1,S_1) $ sweeps along the `southern' edge of the {\ttfamily Macro\+Element}, etc.; see Fig. (e). The form of the macro-\/element mapping is obviously not unique and it depends on the {\ttfamily Macro\+Element\textquotesingle{}s} topology. The class {\ttfamily Q\+Macro\+Element$<$2$>$} provides a mapping that is suitable for 2D quadrilateral elements and can therefore be used with {\ttfamily Refineable\+Q\+Element$<$2$>$} s.
...
With this additional information, we modify the ~\newline
 {\ttfamily Refineable\+Q\+Element$<$2$>$\+::build()} process as follows\+:
\begin{DoxyItemize}
