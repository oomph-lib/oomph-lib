...
\item We add dump and restart functions to the Problem class and call the dump function when post-\/processing the solution in {\ttfamily \mbox{\hyperlink{two__d__unsteady__heat2_8txt_a8c33f390f5dc2186b59cece9f9017efa}{doc\+\_\+solution(...)}}}.
\item We modify the Problem member function {\ttfamily \mbox{\hyperlink{two__d__unsteady__heat2_8txt_af39003811eefdbd2d5b4564c02a4decf}{set\+\_\+initial\+\_\+condition()}}} ~\newline
...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Driver code for unsteady heat equation with option for}}
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{void} \mbox{\hyperlink{two__d__unsteady__heat2_8txt_a7db09e50f04a54496d12ea041f5864b2}{restart}}(ifstream\& restart\_file);}
...
We start by checking the validity of the command line arguments, accessible via the namespace {\ttfamily Command\+Line\+Args}, as only a single command line argument is allowed. If a command line argument is provided, it is interpreted as the name of the restart file. We try to open the file and, if successful, pass the input stream to the {\ttfamily \mbox{\hyperlink{two__d__unsteady__heat2_8txt_a7db09e50f04a54496d12ea041f5864b2}{restart(...)}}} function, discussed below. If no command line arguments are specified, we generate the initial conditions, essentially as in the ~\newline
 \href{../../two_d_unsteady_heat/html/index.html}{\texttt{ previous example.}} The only difference is that in the current version of the code, we moved the specification and initialisation of the timestep from the {\ttfamily main} function into {\ttfamily \mbox{\hyperlink{two__d__unsteady__heat2_8txt_af39003811eefdbd2d5b4564c02a4decf}{set\+\_\+initial\+\_\+condition()}}}. This is because in a restarted simulation, the value of {\ttfamily dt} must be consistent with that used in the original simulation. If the simulation is restarted, the generic {\ttfamily Problem\+::read(...)} function, called by {\ttfamily \mbox{\hyperlink{two__d__unsteady__heat2_8txt_a7db09e50f04a54496d12ea041f5864b2}{restart(...)}}}, automatically initialises the previous timestep; otherwise we have to perform the initialisation ourselves.
...
\DoxyCodeLine{   \mbox{\hyperlink{two__d__unsteady__heat2_8txt_a7db09e50f04a54496d12ea041f5864b2}{restart}}(*restart\_file\_pt);}
\DoxyCodeLine{}
\DoxyCodeLine{  \}}
...
\DoxyCodeLine{   \textcolor{keywordtype}{double} \mbox{\hyperlink{two__d__unsteady__heat2_8txt_a8d9b1de956335a98b4b70f8c32b2c130}{dt}}=0.01;}
\DoxyCodeLine{   }
...
\DoxyCodeLine{   initialise\_dt(\mbox{\hyperlink{two__d__unsteady__heat2_8txt_a8d9b1de956335a98b4b70f8c32b2c130}{dt}});}
\DoxyCodeLine{   }
...
The Problem member function {\ttfamily \mbox{\hyperlink{two__d__unsteady__heat2_8txt_a8c33f390f5dc2186b59cece9f9017efa}{doc\+\_\+solution(...)}}} is identical to that in the \href{../../two_d_unsteady_heat/html/index.html}{\texttt{ previous example,}} apart from the addition of a call to the new {\ttfamily dump\+\_\+it(...)} function, discussed below.
...
\item Following this trivial change, the restarted simulation is terminated at the appropriate point but the numbering of the output files begins at 0, making it difficult to merge the results from the original and the restarted simulations. Modify the functions {\ttfamily dump\+\_\+it(...)} and {\ttfamily \mbox{\hyperlink{two__d__unsteady__heat2_8txt_a7db09e50f04a54496d12ea041f5864b2}{restart(...)}}} so that they write/read the current label for the output files to/from the restart file. ~\newline
~\newline
