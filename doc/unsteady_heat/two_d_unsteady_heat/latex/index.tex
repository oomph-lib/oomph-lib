...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Driver code for unsteady heat equation}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//========================================================================}}
...
\DoxyCodeLine{  \mbox{\hyperlink{two__d__unsteady__heat_8txt_aaff9a073880a8a1831a6f9563f872749}{problem}}(\&\mbox{\hyperlink{namespaceExactSolnForUnsteadyHeat_ab4e853d6368b1fcdbd6205079687455a}{ExactSolnForUnsteadyHeat::get\_source}});}
\DoxyCodeLine{ }
...
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{two__d__unsteady__heat_8txt_a86b85e72d6c63eeaa3e9ddd1be283f8e}{dt}}=0.01;}
...
\DoxyCodeLine{ \mbox{\hyperlink{two__d__unsteady__heat_8txt_aaff9a073880a8a1831a6f9563f872749}{problem}}.initialise\_dt(\mbox{\hyperlink{two__d__unsteady__heat_8txt_a86b85e72d6c63eeaa3e9ddd1be283f8e}{dt}});}
\DoxyCodeLine{ }
\DoxyCodeLine{ \textcolor{comment}{// Set IC}}
\DoxyCodeLine{ \mbox{\hyperlink{two__d__unsteady__heat_8txt_aaff9a073880a8a1831a6f9563f872749}{problem}}.set\_initial\_condition();}
\DoxyCodeLine{ }
\DoxyCodeLine{ \textcolor{comment}{//Output initial condition}}
\DoxyCodeLine{ \mbox{\hyperlink{two__d__unsteady__heat_8txt_aaff9a073880a8a1831a6f9563f872749}{problem}}.doc\_solution(doc\_info,trace\_file);}
\DoxyCodeLine{ }
...
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} nstep = unsigned(t\_max/\mbox{\hyperlink{two__d__unsteady__heat_8txt_a86b85e72d6c63eeaa3e9ddd1be283f8e}{dt}});}
\DoxyCodeLine{}
...
\DoxyCodeLine{   \mbox{\hyperlink{two__d__unsteady__heat_8txt_aaff9a073880a8a1831a6f9563f872749}{problem}}.unsteady\_newton\_solve(\mbox{\hyperlink{two__d__unsteady__heat_8txt_a86b85e72d6c63eeaa3e9ddd1be283f8e}{dt}});}
\DoxyCodeLine{   }
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Update the problem specs before solve (empty)}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Update the problem specs before next timestep: }}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Set initial condition (incl previous timesteps) according}}
...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Actions before timestep: update the domain, then reset the }}
...
{\bfseries{Important\+:}} {\ttfamily oomph-\/lib\textquotesingle{}s} {\ttfamily Unsteady\+Heat\+Equations} are based on the Arbitrary-\/\+Lagrangian-\/\+Eulerian (A\+LE) formulation of the unsteady heat equation to permit computations in moving domains; we will illustrate this capability in ~\newline
...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Set initial condition: Assign previous and current values}}
...
\DoxyCodeLine{ \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} \mbox{\hyperlink{two__d__unsteady__heat_8txt_ad5984e4c059a564ceba033747647feb1}{t}}=nprev\_steps;\mbox{\hyperlink{two__d__unsteady__heat_8txt_ad5984e4c059a564ceba033747647feb1}{t}}>=0;\mbox{\hyperlink{two__d__unsteady__heat_8txt_ad5984e4c059a564ceba033747647feb1}{t}}-\/-\/)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   prev\_time[\mbox{\hyperlink{two__d__unsteady__heat_8txt_ad5984e4c059a564ceba033747647feb1}{t}}]=time\_pt()-\/>time(\textcolor{keywordtype}{unsigned}(\mbox{\hyperlink{two__d__unsteady__heat_8txt_ad5984e4c059a564ceba033747647feb1}{t}}));}
\DoxyCodeLine{  \} }
\DoxyCodeLine{}
...
\DoxyCodeLine{   \textcolor{keywordtype}{double} time=prev\_time[\mbox{\hyperlink{two__d__unsteady__heat_8txt_ad5984e4c059a564ceba033747647feb1}{t}}];}
...
\DoxyCodeLine{     mesh\_pt()-\/>node\_pt(n)-\/>set\_value(\mbox{\hyperlink{two__d__unsteady__heat_8txt_ad5984e4c059a564ceba033747647feb1}{t}},0,soln[0]);}
\DoxyCodeLine{     }
...
\DoxyCodeLine{      \{}
\DoxyCodeLine{       mesh\_pt()-\/>node\_pt(n)-\/>x(\mbox{\hyperlink{two__d__unsteady__heat_8txt_ad5984e4c059a564ceba033747647feb1}{t}},i)=x[i];}
\DoxyCodeLine{      \}}
\DoxyCodeLine{    \} }
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
...
\item Confirm that the initialisation of the previous nodal positions is essential by commenting out this step -- see the ~\newline
 \href{../../two_d_unsteady_heat_ALE/html/index.html}{\texttt{ A\+LE example}} for further details on computations in moving domains.
