...
~\newline
 By default, {\ttfamily oomph-\/lib\textquotesingle{}s} installation is performed with the \href{http://gcc.gnu.org/}{\texttt{ gcc compiler suite}}, using full optimisation and warning ({\ttfamily -\/O6} {\ttfamily -\/Wall} ). ~\newline
~\newline
...
\item If you can\textquotesingle{}t fix the problem yourself, get in touch \href{../../contact/html/index.html}{\texttt{ either directly}}, or via our bugzilla-\/based bug-\/and-\/feature-\/tracking system, accessible online at ~\newline
~\newline
