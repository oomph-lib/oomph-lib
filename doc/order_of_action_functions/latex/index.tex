...
\DoxyCodeLine{if (\mbox{\hyperlink{order__of__action__functions_8txt_afeb93d7b09cde7e6a7eab7f9fba91cc3}{max\_res}}<Problem::Newton\_solver\_tolerance)}
\DoxyCodeLine{\{}
\DoxyCodeLine{   ...}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
...
\DoxyCodeLine{if ((\mbox{\hyperlink{order__of__action__functions_8txt_afeb93d7b09cde7e6a7eab7f9fba91cc3}{max\_res}}>Problem::Max\_residuals) ||}
\DoxyCodeLine{    (count == Problem::Max\_newton\_iterations))}
\DoxyCodeLine{\{}
\DoxyCodeLine{   ...}
\DoxyCodeLine{}
\DoxyCodeLine{   \textcolor{comment}{// Throw an error}}
\DoxyCodeLine{   \textcolor{keywordflow}{throw} NewtonSolverError(count,\mbox{\hyperlink{order__of__action__functions_8txt_afeb93d7b09cde7e6a7eab7f9fba91cc3}{max\_res}});}
\DoxyCodeLine{}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{... }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{order__of__action__functions_8txt_ace10831d73c381bdf9e042170367d445}{time\_pt}}()-\/>time()+=dt;}
\DoxyCodeLine{\mbox{\hyperlink{order__of__action__functions_8txt_ace10831d73c381bdf9e042170367d445}{time\_pt}}()-\/>dt()=dt;}
\end{DoxyCode}
   \\\cline{1-3}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{order__of__action__functions_8txt_a0fadd1160b1b37b723b5e9ad350097e6}{Problem::newton\_solve}}();}
\end{DoxyCode}
   \\\cline{1-3}
