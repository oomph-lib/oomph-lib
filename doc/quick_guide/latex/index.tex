...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{comment}{  /// Self test function: The sign in the source function should}}
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{keywordtype}{double} f(\textcolor{keyword}{const} \textcolor{keywordtype}{double}\& x)\textcolor{keyword}{ const}}
