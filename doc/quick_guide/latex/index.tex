...
\DoxyCodeLine{\textcolor{keyword}{class }SpecificMesh : \textcolor{keyword}{public} \mbox{\hyperlink{quick__guide_8txt_a87d98d9383cf4ede5d237d15f8b45b54}{Mesh}}}
\end{DoxyCode}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT>}
\DoxyCodeLine{\textcolor{keyword}{class }OneDimMesh : \textcolor{keyword}{public} \mbox{\hyperlink{quick__guide_8txt_a87d98d9383cf4ede5d237d15f8b45b54}{Mesh}}}
\DoxyCodeLine{\{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{public}:}
\DoxyCodeLine{\textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{} AnnularQuadMesh(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned}\& n\_r, \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned}\& \mbox{\hyperlink{quick__guide_8txt_a28c512be778574961174106e95825c6d}{n\_phi}},}
\DoxyCodeLine{                 \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& \mbox{\hyperlink{quick__guide_8txt_a78d8afa5582b00e09020ac467b127397}{r\_min}}, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& \mbox{\hyperlink{quick__guide_8txt_a9a75da5e2f56dd5571b8a556e1a6c500}{r\_max}},}
\DoxyCodeLine{                 \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& \mbox{\hyperlink{quick__guide_8txt_af10de6107417dc48a16cf00b58d00fc7}{phi\_min}}, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& \mbox{\hyperlink{quick__guide_8txt_ac839063c3988d3908e1455a2213bc073}{phi\_max}}) :}
\DoxyCodeLine{  SimpleRectangularQuadMesh<ELEMENT>(n\_r,\mbox{\hyperlink{quick__guide_8txt_a28c512be778574961174106e95825c6d}{n\_phi}},1.0,1.0)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{}
...
\DoxyCodeLine{   \textcolor{keyword}{const} \textcolor{keywordtype}{double} \mbox{\hyperlink{quick__guide_8txt_a4648272fb56eaaebdcdfc9f50f47daba}{pi}} = 4.0*atan(1.0);}
\DoxyCodeLine{}
\DoxyCodeLine{   \textcolor{comment}{// Loop over all nodes}}
...
\DoxyCodeLine{     \textcolor{keywordtype}{double} r=\mbox{\hyperlink{quick__guide_8txt_a78d8afa5582b00e09020ac467b127397}{r\_min}}+(\mbox{\hyperlink{quick__guide_8txt_a9a75da5e2f56dd5571b8a556e1a6c500}{r\_max}}-\/\mbox{\hyperlink{quick__guide_8txt_a78d8afa5582b00e09020ac467b127397}{r\_min}})*x\_old;}
\DoxyCodeLine{     \textcolor{keywordtype}{double} phi=(\mbox{\hyperlink{quick__guide_8txt_af10de6107417dc48a16cf00b58d00fc7}{phi\_min}}+(\mbox{\hyperlink{quick__guide_8txt_ac839063c3988d3908e1455a2213bc073}{phi\_max}}-\/\mbox{\hyperlink{quick__guide_8txt_af10de6107417dc48a16cf00b58d00fc7}{phi\_min}})*y\_old)*\mbox{\hyperlink{quick__guide_8txt_a4648272fb56eaaebdcdfc9f50f47daba}{pi}}/180.0;}
\DoxyCodeLine{}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{  \textcolor{keywordtype}{double} \mbox{\hyperlink{quick__guide_8txt_ac17939ce74bee1d9d5e41f861c653489}{f}}(\textcolor{keyword}{const} \textcolor{keywordtype}{double} \&x) \textcolor{keyword}{const} }
\DoxyCodeLine{   \{}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{comment}{  /// \(\backslash\)short Self test function: The sign in the source function should}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{  /// only have the values +/-\/ 1. Following the general oomph-\/lib convention,}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{  /// the self\_test() returns 0 for success, and 1 for failure:}}
...
\DoxyCodeLine{\textcolor{comment}{}  \textcolor{keywordtype}{unsigned} required\_nvalue(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&n)\textcolor{keyword}{ const }\{\textcolor{keywordflow}{return} 1;\}}
...
\DoxyCodeLine{      \textcolor{keywordtype}{double} source=\mbox{\hyperlink{quick__guide_8txt_ac17939ce74bee1d9d5e41f861c653489}{f}}(interpolated\_x);}
\DoxyCodeLine{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Calculate the elemental contributions to the residuals for }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// the weak form of the Poisson equation}}
...
\end{DoxyCode}
 and 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Calculate the elemental contribution to the Jacobian }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// matrix dR\_\{i\}/du\_\{j\} used in the Newton method}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Function pointer to source function: }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// The source function returns the value of the }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// source function at the global coordinate x.}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Function pointer to source function (initialised to}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// NULL in the constructor)}}
...
\DoxyCodeLine{\textcolor{comment}{}PoissonSourceFctPt\& source\_fct\_pt() \{\textcolor{keywordflow}{return} Source\_fct\_pt;\}}
\end{DoxyCode}
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{keywordtype}{double} \mbox{\hyperlink{quick__guide_8txt_ac17939ce74bee1d9d5e41f861c653489}{f}}(\textcolor{keyword}{const} \textcolor{keywordtype}{double}\& x)\textcolor{keyword}{ const}}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Integration scheme that will be used to integrate over the element.}}
\DoxyCodeLine{\textcolor{comment}{ /// Simple Gaussian quadrature in one dimension, with two Gauss points.}}
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keyword}{static} Gauss<1,2> Default\_spatial\_integration\_scheme;}
...
\item \mbox{\hyperlink{index_pre_compute_psi}{Using pre-\/computed shape functions and the Storable\+Shape\+Element$<$\+E\+L\+E\+M\+E\+N\+T$>$ class}}
...
\DoxyHorRuler{0}
\hypertarget{index_pre_compute_psi}{}\doxysubsection{Using pre-\/computed shape functions and the Storable\+Shape\+Element$<$\+E\+L\+E\+M\+E\+N\+T$>$ class}\label{index_pre_compute_psi}
...
\item \mbox{\hyperlink{index_mesh_movement}{Rule 4\+: Time derivatives should be implemented in the A\+LE formulation to allow for moving meshes.}}
\end{DoxyItemize}
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{keyword}{class }SomeMultiPhysicsElement : \textcolor{keyword}{public} \textcolor{keyword}{virtual} TwoNodePoissonElement,}
...
Specific examples that illustrate the creation of (non-\/trivial) multi-\/physics elements by multiple inheritance are provided in the \href{../../example_code_list/html/index.html\#multi}{\texttt{ list of example codes.}}\hypertarget{index_mesh_movement}{}\doxysubsubsection{Rule 4\+: Time derivatives should be implemented in the A\+L\+E formulation to allow for moving meshes.}\label{index_mesh_movement}
