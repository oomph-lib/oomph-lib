...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" >
  ...
  "https://www.matthias-heil.co.uk/new_webpage/index.html">Matthias Heil</a> and <a href=
  "https://personalpages.manchester.ac.uk/staff/Andrew.Hazel/">Andrew Hazel</a> of the
  ...
  <p> See the <a href="../change_log/html/index.html">change
  ...
  <h1>How do I get/install the code?</h1>
  <h2>Download/Installation</h2>
  <p><code>oomph-lib</code> is hosted on and distributed via GitHub at
  <center><a href="https://github.com/oomph-lib/oomph-lib">
  https://github.com/oomph-lib/oomph-lib</a></center><br>
  where we provide detailed build instructions.</p>
  ...
  the dependence on external libraries our CMake-based build machinery
  provides the option to automatically install all required
  external libraries (such as <a href=
  "http://www-users.cs.umn.edu/~karypis/metis/">METIS</a>, <a href=
  "http://crd.lbl.gov/~xiaoye/SuperLU">SuperLU</a>, ...). This avoids 
  the common and frustrating scenario where to install library A, you
  first need to install library B, which in turns requires library C etc.
  With <code>oomph-lib</code> you simply clone our GitHub reposiory and
  run our build script to produce the fully installed
...
apt-get install texlive texlive-latex-extra texlive-font-utils
  ...
  <br>
  <tt>
apt-get install git cmake ninja python3 doxygen gfortran g++ texlive texlive-latex-extra texlive-font-utils
  </tt>
  </article>
  ...
  newcomer to C++</b>
  <ul>
  <li>Buy <a href="https://yangdaoqi.info/">Daoqi Yang</a>
  brilliant book <a href="https://link.springer.com/book/10.1007/978-1-4613-0189-9">
