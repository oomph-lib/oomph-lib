...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" >
  ...
  "http://gcc.gnu.org/">GNU gcc compiler suite</a> version 9.3.0. or
  later is fine. [ <b>Note:</b> The Fortran77 and C compilers are
  only required to compile some external libraries --
  <code>oomph-lib</code> itself is written entirely in C++. We assume
  that your C++ compiler can handle the C++11 standard. If it doesn't
  you may have to add the <code>-std=c++11</code> option to the
  <code>CXXFLAGS</code> during the configure stage.]</li>
  </ul>
  ...
  <li><a href="http://www.python.org/download/">python3</a> is needed
  ...
  <ul>
  <li>Ubuntu (version 16.04) with gcc compilers (version 5.4.0). The
