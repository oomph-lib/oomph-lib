...
\DoxyCodeLine{ \mbox{\hyperlink{classRefineableYoungLaplaceProblem}{RefineableYoungLaplaceProblem<RefineableQYoungLaplaceElement<3>}} > \mbox{\hyperlink{contact__angle_8txt_a831d1ad5f0468950f29fbf410fa323b0}{problem}};}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Perform one uniform refinement}}
\DoxyCodeLine{ \mbox{\hyperlink{contact__angle_8txt_a831d1ad5f0468950f29fbf410fa323b0}{problem}}.refine\_uniformly();}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{//Output the solution}}
\DoxyCodeLine{ \mbox{\hyperlink{contact__angle_8txt_a831d1ad5f0468950f29fbf410fa323b0}{problem}}.doc\_solution(doc\_info,trace\_file);}
\DoxyCodeLine{}
...
\DoxyCodeLine{   \mbox{\hyperlink{contact__angle_8txt_a831d1ad5f0468950f29fbf410fa323b0}{problem}}.newton\_solve(max\_adapt);}
\DoxyCodeLine{ }
\DoxyCodeLine{   \textcolor{comment}{//Output the solution}}
\DoxyCodeLine{   \mbox{\hyperlink{contact__angle_8txt_a831d1ad5f0468950f29fbf410fa323b0}{problem}}.doc\_solution(doc\_info,trace\_file);}
\DoxyCodeLine{   }
...
The problem class contains the usual member functions. The functions {\ttfamily \mbox{\hyperlink{contact__angle_8txt_ad1c3b5a5aba86a7883b7915e8bdd7c21}{actions\+\_\+before\+\_\+adapt()}}} and {\ttfamily actions\+\_\+after\+\_\+adapt()} are used to detach and re-\/attach (and rebuild) the contact angle elements on the appropriate boundaries of the \char`\"{}bulk\char`\"{} mesh.

 
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{comment}{//====== start\_of\_problem\_class=======================================}}
\DoxyCodeLine{\textcolor{comment}{/// 2D RefineableYoungLaplace problem on rectangular domain, discretised with}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// 2D QRefineableYoungLaplace elements. The specific type of element is}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Create YoungLaplace contact angle elements on the }}
...
\DoxyCodeLine{ \mbox{\hyperlink{contact__angle_8txt_a770d352b78a60074a229f760bc2e0179}{build\_global\_mesh}}();}
...
\DoxyCodeLine{\textcolor{comment}{/// Create YoungLaplace contact angle elements on the b-\/th boundary of the }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// bulk mesh and add them to the contact angle mesh}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//=======================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT>}
