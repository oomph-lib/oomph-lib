This document discusses the finite-\/element-\/based solution of the \href{http://en.wikipedia.org/wiki/Young-Laplace_equation}{\texttt{ Young Laplace equation}}, a nonlinear P\+DE that determines the static equilibrium shapes of droplets or bubbles. We start by reviewing the relevant theory and then present the solution of a simple model problem.
...
The variational formulation of the problem is particularly convenient for a finite-\/element-\/based solution; see, e.\+g. the \href{../../../solid/solid_theory/html/index.html\#CartesianLagrangian}{\texttt{ Solid Mechanics Theory document}} for a discussion of how to discretise variational principles with finite elements. The variational and P\+D\+E-\/based formulations are, of course, related to each other\+: The Young-\/\+Laplace equation is the Euler-\/\+Lagrange equation of the variational principle.\hypertarget{index_intrinsic}{}\doxysubsection{Parametric representation}\label{index_intrinsic}
...
\DoxyCodeLine{ \textcolor{comment}{//-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Spine basis: The position vector to the basis of the spine}}
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{void} \mbox{\hyperlink{namespaceGlobalParameters_ac81daf87f8d3f075d9fd108427e70c4f}{spine\_base\_function}}(\textcolor{keyword}{const} Vector<double>\& \mbox{\hyperlink{young__laplace_8txt_a972796dc0dbb3f5b13cbc503572d2a26}{x}}, }
...
\DoxyCodeLine{  spine\_B[0]     = \mbox{\hyperlink{young__laplace_8txt_a972796dc0dbb3f5b13cbc503572d2a26}{x}}[0];}
\DoxyCodeLine{  spine\_B[1]     = \mbox{\hyperlink{young__laplace_8txt_a972796dc0dbb3f5b13cbc503572d2a26}{x}}[1];}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Spine: The spine vector field as a function of the two }}
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{void} \mbox{\hyperlink{namespaceGlobalParameters_a82df8c67f58e78a236fb6a0cc8bf8284}{spine\_function}}(\textcolor{keyword}{const} Vector<double>\& \mbox{\hyperlink{young__laplace_8txt_a972796dc0dbb3f5b13cbc503572d2a26}{x}}, }
...
\DoxyCodeLine{  }
\DoxyCodeLine{  spine[1]=cos(\mbox{\hyperlink{namespaceGlobalParameters_ae8fa7610a34b7a2a8223eade99a5c22f}{Alpha\_min}}+(\mbox{\hyperlink{namespaceGlobalParameters_a19d04a02b0b5ef5c72e9c30d822e4dc7}{Alpha\_max}}-\/\mbox{\hyperlink{namespaceGlobalParameters_ae8fa7610a34b7a2a8223eade99a5c22f}{Alpha\_min}})*\mbox{\hyperlink{young__laplace_8txt_a972796dc0dbb3f5b13cbc503572d2a26}{x}}[1]); }
\DoxyCodeLine{  dspine[0][1]=0.0;                                   }
\DoxyCodeLine{  dspine[1][1]=-\/sin(\mbox{\hyperlink{namespaceGlobalParameters_ae8fa7610a34b7a2a8223eade99a5c22f}{Alpha\_min}}+(\mbox{\hyperlink{namespaceGlobalParameters_a19d04a02b0b5ef5c72e9c30d822e4dc7}{Alpha\_max}}-\/\mbox{\hyperlink{namespaceGlobalParameters_ae8fa7610a34b7a2a8223eade99a5c22f}{Alpha\_min}})*\mbox{\hyperlink{young__laplace_8txt_a972796dc0dbb3f5b13cbc503572d2a26}{x}}[1])}
...
\DoxyCodeLine{  }
\DoxyCodeLine{  spine[2]=sin(\mbox{\hyperlink{namespaceGlobalParameters_ae8fa7610a34b7a2a8223eade99a5c22f}{Alpha\_min}}+(\mbox{\hyperlink{namespaceGlobalParameters_a19d04a02b0b5ef5c72e9c30d822e4dc7}{Alpha\_max}}-\/\mbox{\hyperlink{namespaceGlobalParameters_ae8fa7610a34b7a2a8223eade99a5c22f}{Alpha\_min}})*\mbox{\hyperlink{young__laplace_8txt_a972796dc0dbb3f5b13cbc503572d2a26}{x}}[1]);}
\DoxyCodeLine{  dspine[0][2]=0.0;                                  }
\DoxyCodeLine{  dspine[1][2]=cos(\mbox{\hyperlink{namespaceGlobalParameters_ae8fa7610a34b7a2a8223eade99a5c22f}{Alpha\_min}}+(\mbox{\hyperlink{namespaceGlobalParameters_a19d04a02b0b5ef5c72e9c30d822e4dc7}{Alpha\_max}}-\/\mbox{\hyperlink{namespaceGlobalParameters_ae8fa7610a34b7a2a8223eade99a5c22f}{Alpha\_min}})*\mbox{\hyperlink{young__laplace_8txt_a972796dc0dbb3f5b13cbc503572d2a26}{x}}[1]) }
\DoxyCodeLine{   *(\mbox{\hyperlink{namespaceGlobalParameters_a19d04a02b0b5ef5c72e9c30d822e4dc7}{Alpha\_max}}-\/\mbox{\hyperlink{namespaceGlobalParameters_ae8fa7610a34b7a2a8223eade99a5c22f}{Alpha\_min}});            }
\DoxyCodeLine{}
...
\DoxyCodeLine{ \mbox{\hyperlink{classYoungLaplaceProblem}{YoungLaplaceProblem<QYoungLaplaceElement<3>}} > \mbox{\hyperlink{young__laplace_8txt_a8044b62475f8b6be7b371532bab17017}{problem}};}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{//Output the solution}}
\DoxyCodeLine{ \mbox{\hyperlink{young__laplace_8txt_a8044b62475f8b6be7b371532bab17017}{problem}}.doc\_solution(doc\_info,trace\_file);}
\DoxyCodeLine{ }
...
\DoxyCodeLine{   \mbox{\hyperlink{young__laplace_8txt_a8044b62475f8b6be7b371532bab17017}{problem}}.newton\_solve();}
\DoxyCodeLine{   }
\DoxyCodeLine{   \textcolor{comment}{//Output the solution}}
\DoxyCodeLine{   \mbox{\hyperlink{young__laplace_8txt_a8044b62475f8b6be7b371532bab17017}{problem}}.doc\_solution(doc\_info,trace\_file);}
\DoxyCodeLine{   }
...
\DoxyCodeLine{\textcolor{comment}{/// 2D YoungLaplace problem on rectangular domain, discretised with}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// 2D QYoungLaplace elements. The specific type of element is}}
...
\DoxyCodeLine{ \mbox{\hyperlink{young__laplace_8txt_ad085028866de0dfb37173803eabff340}{Kappa\_pt}}=height\_control\_element\_pt-\/>kappa\_pt();}
...
\DoxyCodeLine{   el\_pt-\/>set\_kappa(\mbox{\hyperlink{young__laplace_8txt_ad085028866de0dfb37173803eabff340}{Kappa\_pt}}); }
\DoxyCodeLine{  \}}
...
\DoxyCodeLine{ \textcolor{comment}{//-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{ trace\_file << -\/1.0*\mbox{\hyperlink{young__laplace_8txt_ad085028866de0dfb37173803eabff340}{Kappa\_pt}}-\/>value(0) << \textcolor{stringliteral}{" "};}
