...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Ratio of viscosity in upper fluid to viscosity in lower}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Ratio of density in upper fluid to density in lower}}
...
Finally, we build the problem using the `pseudo-\/solid' version of {\ttfamily Refineable\+Q\+Crouzeix\+Raviart\+Elements} and the {\ttfamily B\+D\+F$<$2$>$} timestepper, before calling {\ttfamily unsteady\+\_\+run(...)}. This function solves the system at each timestep using the {\ttfamily Problem\+::unsteady\+\_\+newton\+\_\+solve(...)} function before documenting the result.
...
\DoxyCodeLine{  \mbox{\hyperlink{two__layer__interface_8txt_a4074baada03976c061d5672f4237cca5}{problem}};}
\DoxyCodeLine{ }
\DoxyCodeLine{ \textcolor{comment}{// Run the unsteady simulation}}
\DoxyCodeLine{ \mbox{\hyperlink{two__layer__interface_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.unsteady\_run(t\_max,dt);}
\DoxyCodeLine{ }
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Constructor: Pass number of elements in x-\/direction, number of}}
...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Create interface elements between the two fluids in the mesh}}
...
\DoxyCodeLine{    + (1.0-\/fabs(1.0-\/current\_y\_pos))*\mbox{\hyperlink{two__layer__interface_8txt_a12ad175f862d3fe119900bd546c618c2}{epsilon}}}
...
\DoxyCodeLine{ \textcolor{keyword}{const} \textcolor{keywordtype}{double} \mbox{\hyperlink{two__layer__interface_8txt_a12ad175f862d3fe119900bd546c618c2}{epsilon}} = 0.1;}
\DoxyCodeLine{}
...
\DoxyCodeLine{ deform\_free\_surface(\mbox{\hyperlink{two__layer__interface_8txt_a12ad175f862d3fe119900bd546c618c2}{epsilon}},n\_periods);}
