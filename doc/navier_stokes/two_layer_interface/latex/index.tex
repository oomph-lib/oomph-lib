...
\DoxyCodeLine{\ \mbox{\hyperlink{classElasticRefineableTwoLayerMesh}{snprintf}}(\mbox{\hyperlink{classElasticRefineableTwoLayerMesh}{filename}},\ \textcolor{keyword}{sizeof}(\mbox{\hyperlink{classElasticRefineableTwoLayerMesh}{filename}}),\ \textcolor{stringliteral}{"{}\%s/trace.dat"{}},\mbox{\hyperlink{classElasticRefineableTwoLayerMesh}{doc\_info}}.directory().c\_str());}
