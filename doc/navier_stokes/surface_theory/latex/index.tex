...
\item The function 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{double} \mbox{\hyperlink{surface__theory_8txt_aa6e311b025109a0aa3e5058952a5cd99}{FluidInterfaceElement::sigma}}(\textcolor{keyword}{const} Vector<double> \&s\_local) }
\end{DoxyCode}
...
\item The function 
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{virtual} \textcolor{keywordtype}{int} \mbox{\hyperlink{surface__theory_8txt_a3bad7200e996f3bbea6cbbce2e83e61a}{FluidInterfaceElement::kinematic\_local\_eqn}}(...)}
\end{DoxyCode}
...
\DoxyCodeLine{    SpineLineFluidInterfaceElement(}
...
\DoxyCodeLine{   SpineUpdateFluidInterfaceElement<FluidInterfaceElement,}
\DoxyCodeLine{    LineDerivatives,ELEMENT>(element\_pt,face\_index) \{\}}

\end{DoxyCodeInclude}


If a spine method is used to update the nodal positions then the spine height is the unknown associated with the kinematic condition. Thus, the function {\ttfamily \mbox{\hyperlink{surface__theory_8txt_a3bad7200e996f3bbea6cbbce2e83e61a}{kinematic\+\_\+local\+\_\+eqn(...)}}} is overloaded accordingly  
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{  \textcolor{keywordtype}{int} \mbox{\hyperlink{surface__theory_8txt_a3bad7200e996f3bbea6cbbce2e83e61a}{kinematic\_local\_eqn}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&n) }
...
The class \mbox{\hyperlink{classoomph_1_1ElasticLineFluidInterfaceElement}{oomph\+::\+Elastic\+Line\+Fluid\+Interface\+Element}} is templated by the bulk element type, {\ttfamily E\+L\+E\+M\+E\+NT}, and inherits from {\ttfamily Line\+Derivatives}, Fluid\+Interface\+Element and {\ttfamily Hijacked$<$Face\+Geometry$<$\+E\+L\+E\+M\+E\+N\+T$>$} $>$. The hijacking is again only required for imposition of contact angle boundary conditions.
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{    ElasticLineFluidInterfaceElement(}

\end{DoxyCodeInclude}


The kinematic boundary condition is associated with the Lagrange multiplier and {\ttfamily \mbox{\hyperlink{surface__theory_8txt_a3bad7200e996f3bbea6cbbce2e83e61a}{kinematic\+\_\+local\+\_\+eqn(...)}}} is overloaded accordingly  
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{  \textcolor{comment}{/// (This is the equation for the Lagrange multiplier) }}
\DoxyCodeLine{  \textcolor{keyword}{inline} \textcolor{keywordtype}{int} \mbox{\hyperlink{surface__theory_8txt_a3bad7200e996f3bbea6cbbce2e83e61a}{kinematic\_local\_eqn}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&n)}
\DoxyCodeLine{  \{}
...
\DoxyCodeLine{   EQUATION\_CLASS::fill\_in\_generic\_residual\_contribution\_interface(residuals,jacobian,1);}
\DoxyCodeLine{  }
