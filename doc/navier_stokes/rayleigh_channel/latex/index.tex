...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Flag for impulsive start: Default = start from exact}}
...
\DoxyCodeLine{   exp(complex<double>(0.0,omega*\mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}})) * }
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{void} \mbox{\hyperlink{namespaceExactSoln_a2598550281dd62f4160edb3d0b2e5432}{get\_exact\_u}}(\textcolor{keyword}{const} \textcolor{keywordtype}{double}\& \mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}}, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& y,\textcolor{keywordtype}{double}\& u)}
\DoxyCodeLine{ \{}
\DoxyCodeLine{  \textcolor{comment}{// I=sqrt(-\/1)}}
\DoxyCodeLine{  complex<double> I(0.0,1.0);}
\DoxyCodeLine{  \textcolor{comment}{// omega}}
...
\DoxyCodeLine{  \mbox{\hyperlink{classRayleighProblem}{RayleighProblem<QCrouzeixRaviartElement<2>}},BDF<2> > \mbox{\hyperlink{rayleigh__channel_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}}(nx,ny,lx,ly);}
\DoxyCodeLine{  }
\DoxyCodeLine{  \textcolor{comment}{// Run the unsteady simulation}}
\DoxyCodeLine{  \mbox{\hyperlink{rayleigh__channel_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}}.unsteady\_run(doc\_info);}
\DoxyCodeLine{ \}}
\DoxyCodeLine{}
\DoxyCodeLine{}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{//Set up problem}}
\DoxyCodeLine{  \mbox{\hyperlink{classRayleighProblem}{RayleighProblem<QTaylorHoodElement<2>}},BDF<2> > \mbox{\hyperlink{rayleigh__channel_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}}(nx,ny,lx,ly);}
\DoxyCodeLine{  }
\DoxyCodeLine{  \textcolor{comment}{// Run the unsteady simulation}}
\DoxyCodeLine{  \mbox{\hyperlink{rayleigh__channel_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}}.unsteady\_run(doc\_info);}
\DoxyCodeLine{ \}}
...
The problem class is very similar to that used in the \href{../../driven_cavity/html/index.html}{\texttt{ driven cavity example}}. We specify the type of the element and the type of the timestepper (assumed to be a member of the B\+DF family) as template parameters and pass the mesh parameters to the problem constructor.
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Update after solve is empty}}
...
The application of initial conditions for vector-\/valued problems is performed by the same procedure that we described for \href{../../../unsteady_heat/two_d_unsteady_heat/html/index.html\#IC}{\texttt{ scalar problems}}, except that we now have to assign \char`\"{}history
...
\DoxyCodeLine{ \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} \mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}}=nprev\_steps;\mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}}>=0;\mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}}-\/-\/)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   prev\_time[\mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}}]=time\_pt()-\/>time(\textcolor{keywordtype}{unsigned}(\mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}}));}
\DoxyCodeLine{  \} }
\DoxyCodeLine{}
...
\DoxyCodeLine{   \textcolor{keywordtype}{double} time=prev\_time[\mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}}];}
...
\DoxyCodeLine{     mesh\_pt()-\/>node\_pt(n)-\/>set\_value(\mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}},0,soln[0]);}
\DoxyCodeLine{     mesh\_pt()-\/>node\_pt(n)-\/>set\_value(\mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}},1,soln[1]);}
\DoxyCodeLine{     }
...
\DoxyCodeLine{      \{}
\DoxyCodeLine{       mesh\_pt()-\/>node\_pt(n)-\/>x(\mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}},i)=x[i];}
\DoxyCodeLine{      \}}
\DoxyCodeLine{    \} }
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}}=1;\mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}}<=ntsteps;\mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}}++)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   cout << \textcolor{stringliteral}{"TIMESTEP "} << \mbox{\hyperlink{rayleigh__channel_8txt_ab47f2ddbbb6e782aad3890ff929101a0}{t}} << std::endl;}
\DoxyCodeLine{   }
