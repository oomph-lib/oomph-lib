...
\image html rayleigh_channel.gif "Sketch of the problem. " 
\image latex rayleigh_channel.eps "Sketch of the problem. " width=0.75\textwidth
...
\image html velocity_vectors_CR.gif "Plot of the velocity field computed with 2D Crouzeix-Raviart elements, starting form the exact, time-periodic solution. " 
\image latex velocity_vectors_CR.eps "Plot of the velocity field computed with 2D Crouzeix-Raviart elements, starting form the exact, time-periodic solution. " width=0.75\textwidth

\image html velocity_vectors_TH.gif "Plot of the velocity field computed with 2D Taylor-Hood elements, starting form the exact, time-periodic solution. " 
\image latex velocity_vectors_TH.eps "Plot of the velocity field computed with 2D Taylor-Hood elements, starting form the exact, time-periodic solution. " width=0.75\textwidth
...
\image html error.gif "Plot of the L2-'errors' between the computed and time-periodic solution for two different initial conditions. " 
\image latex error.eps "Plot of the L2-'errors' between the computed and time-periodic solution for two different initial conditions. " width=0.75\textwidth
...
\image html periodic_mesh.gif "Figure of a mesh that is periodic in the horizontal direction. " 
\image latex periodic_mesh.eps "Figure of a mesh that is periodic in the horizontal direction. " width=0.75\textwidth
