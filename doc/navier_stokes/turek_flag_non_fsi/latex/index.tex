In this example we consider the flow in a 2D channel that contains a cylinder with a waving \char`\"{}flag\char`\"{}. This is a \char`\"{}warm-\/up problem\char`\"{} for the solution of Turek \& Hron\textquotesingle{}s F\+SI benchmark problem discussed in \href{../../../interaction/turek_flag/html/index.html}{\texttt{ another tutorial.}}
...
\DoxyCodeLine{  \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{  /// \(\backslash\)short Return the position along the top of the flag (xi[0] varies }}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Pointer to GeomObject of type Circle that defines the}}
...
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{turek__flag__non__fsi_8txt_a8c299f6b787f06fc249ea6eaba6cebd1}{height}}=4.1;}
...
\DoxyCodeLine{  \mbox{\hyperlink{turek__flag__non__fsi_8txt_a4074baada03976c061d5672f4237cca5}{problem}}(length, \mbox{\hyperlink{turek__flag__non__fsi_8txt_a8c299f6b787f06fc249ea6eaba6cebd1}{height}});}
...
\DoxyCodeLine{\textcolor{comment}{} \mbox{\hyperlink{turek__flag__non__fsi_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.initialise\_dt(dt);}
...
\DoxyCodeLine{\textcolor{comment}{} \mbox{\hyperlink{turek__flag__non__fsi_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.doc\_solution(doc\_info);}
...
\DoxyCodeLine{ \mbox{\hyperlink{turek__flag__non__fsi_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.steady\_newton\_solve(max\_adapt);}
\DoxyCodeLine{ \textcolor{comment}{}}
...
\DoxyCodeLine{   \mbox{\hyperlink{turek__flag__non__fsi_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.unsteady\_newton\_solve(dt,max\_adapt,first);}
\DoxyCodeLine{   }
\DoxyCodeLine{   \textcolor{comment}{// Output the solution}}
\DoxyCodeLine{   \mbox{\hyperlink{turek__flag__non__fsi_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.doc\_solution(doc\_info);}
\DoxyCodeLine{   }
...
\DoxyCodeLine{\textcolor{keyword}{class }\mbox{\hyperlink{classTurekNonFSIProblem}{TurekNonFSIProblem}} : \textcolor{keyword}{public} \mbox{\hyperlink{turek__flag__non__fsi_8txt_ade8e440eefd2b162768121af6ebed724}{Problem}}}
\DoxyCodeLine{\{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{public}:}
\DoxyCodeLine{\textcolor{comment}{}}
...
\DoxyCodeLine{                         \textcolor{keyword}{const} \textcolor{keywordtype}{double} \&\mbox{\hyperlink{turek__flag__non__fsi_8txt_a8c299f6b787f06fc249ea6eaba6cebd1}{height}});}
\DoxyCodeLine{ \textcolor{comment}{}}
...
\DoxyCodeLine{ \textcolor{keyword}{const} \textcolor{keywordtype}{double} \&length, \textcolor{keyword}{const} \textcolor{keywordtype}{double} \&\mbox{\hyperlink{turek__flag__non__fsi_8txt_a8c299f6b787f06fc249ea6eaba6cebd1}{height}}) : Height(\mbox{\hyperlink{turek__flag__non__fsi_8txt_a8c299f6b787f06fc249ea6eaba6cebd1}{height}})}
\DoxyCodeLine{\{ }
\DoxyCodeLine{}
...
\DoxyCodeLine{   length, \mbox{\hyperlink{turek__flag__non__fsi_8txt_a8c299f6b787f06fc249ea6eaba6cebd1}{height}}, }
...
The function \mbox{\hyperlink{turek__flag__non__fsi_8txt_ac032960b0e4ab209322f27e3de5dcffd}{doc\+\_\+solution(...)}} documents the results.
