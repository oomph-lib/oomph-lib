...
\end{DoxyEnumerate}\mbox{[}If the user \char`\"{}forgets\char`\"{} to call this function, a warning is issued if the library is compiled with the PARANOID flag.\mbox{]}
\end{DoxyItemize}The driver code discussed below illustrates the use of these functions. The section \mbox{\hyperlink{index_comments}{Comments and Exercises}} provides a more detailed discussion of the technical details involved in their implementation.
