...
$!VarSet |LFDSFN1| = '"RESLT_TH/soln|istep|.dat"'
$!VarSet |LFDSVL1| = '"V1" "V2" "V3" "V4" "V5"'
$!VarSet |LFDSFN2| = '"RESLT_TH/exact_soln|istep|.dat"'
...
$!IF |PNG|==1
        ...
        $!EXPORTSETUP EXPORTFNAME = 'velocity_vectors_TH|istep|.png'
        $!EXPORT
        ...
        $!EXPORTSETUP EXPORTFNAME = 'velocity_vectors_TH|istep|.eps'

        $!EXPORTSETUP PRINTRENDERTYPE = IMAGE
        $!EXPORTSETUP EXPORTFNAME = 'velocity_vectors_TH|istep|.img.eps'
        $!EXPORT
          EXPORTREGION = CURRENTFRAME
...
$!ELSE
        ...
        $!ELSE
                ...
                $!EXPORTSETUP
                 EXPORTFORMAT = AVI
                 EXPORTFNAME = "velocity_vectors_TH.avi"
