...
\DoxyCodeLine{  \textcolor{keywordtype}{double} \mbox{\hyperlink{rayleigh__traction__channel_8txt_ad37339aba2062c36c10b89b43966b78d}{omega}}=2.0*MathematicalConstants::Pi;}
\DoxyCodeLine{  \textcolor{comment}{// lambda}}
\DoxyCodeLine{  complex<double> lambda(0.0,\mbox{\hyperlink{rayleigh__traction__channel_8txt_ad37339aba2062c36c10b89b43966b78d}{omega}}*\mbox{\hyperlink{namespaceGlobal__Parameters_a7a59a32365e87566069e458dc83bd18a}{Global\_Parameters::ReSt}});}
\DoxyCodeLine{  lambda = I*sqrt(lambda);}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{// Solution}}
\DoxyCodeLine{  complex<double> sol(}
\DoxyCodeLine{   exp(complex<double>(0.0,\mbox{\hyperlink{rayleigh__traction__channel_8txt_ad37339aba2062c36c10b89b43966b78d}{omega}}*t)) * }
...
\DoxyCodeLine{   \mbox{\hyperlink{rayleigh__traction__channel_8txt_a2b46f734a1a4daa4920f680aefac42f2}{problem}}(nx,ny,lx,ly);}
\DoxyCodeLine{  }
\DoxyCodeLine{  \textcolor{comment}{// Run the unsteady simulation}}
\DoxyCodeLine{  \mbox{\hyperlink{rayleigh__traction__channel_8txt_a2b46f734a1a4daa4920f680aefac42f2}{problem}}.unsteady\_run(doc\_info);}
\DoxyCodeLine{ \}}
\DoxyCodeLine{}
\DoxyCodeLine{}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Create traction elements on boundary b of the Mesh pointed}}
...
\DoxyCodeLine{\textcolor{comment}{/// Create Navier-\/Stokes traction elements on the b-\/th boundary of the}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// Mesh object pointed to by bulk\_mesh\_pt and add the elements to the }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// Mesh object pointeed to by surface\_mesh\_pt.}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//=======================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT,\textcolor{keyword}{class} TIMESTEPPER>}
