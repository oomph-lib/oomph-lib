...
The Reynolds number, Strouhal number, inverse-\/\+Froude number, density ratio and viscosity ratio are assumed to be constant within each element. Their values are accessed via pointers which are accessible via the member functions {\ttfamily \mbox{\hyperlink{driven__cavity_8txt_a25257c692cb45036772f593eb0284b78}{re\+\_\+pt()}}} for $ Re, $ {\ttfamily \mbox{\hyperlink{driven__cavity_8txt_adc1a074e08505d277036878c9aedc811}{re\+\_\+st\+\_\+pt()}}} for $ Re \ St, $ {\ttfamily \mbox{\hyperlink{driven__cavity_8txt_ae99117aed97ea6b876d159aa1c14240b}{re\+\_\+invfr\+\_\+pt()}}} for $ Re/Fr, $ {\ttfamily \mbox{\hyperlink{driven__cavity_8txt_aab4f1d8c4747c7d7ff52692f739c7956}{density\+\_\+ratio\+\_\+pt()}}} for $ R_\rho $ and {\ttfamily viscosity\+\_\+ratio\+\_\+pt()} for $ R_\mu $.
...
\end{DoxyItemize}We use the same approach for the specification of the body force vector $ G_i $, accessible via the function {\ttfamily g\+\_\+pt} (), the variable body force $ B_i $, accessible via the function pointer {\ttfamily \mbox{\hyperlink{driven__cavity_8txt_a277632e2445c22857bf8d91868e029d9}{body\+\_\+force\+\_\+fct\+\_\+pt()}}}, and the volumetric source function $ Q $, accessible via the function pointer {\ttfamily \mbox{\hyperlink{driven__cavity_8txt_af9c2b28e5079228a74d221480c78b0b9}{source\+\_\+fct\+\_\+pt(time,x)}}}. By default the (function) pointers are set such that
\begin{DoxyItemize}
...
\DoxyCodeLine{\textcolor{comment}{/// Driver for RectangularDrivenCavity test problem -\/-\/ test drive}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// with two different types of element.}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//=====================================================================}}
...
\DoxyCodeLine{  \mbox{\hyperlink{classRectangularDrivenCavityProblem}{RectangularDrivenCavityProblem<QCrouzeixRaviartElement<2>}} > \mbox{\hyperlink{driven__cavity_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}};}
...
\DoxyCodeLine{  \mbox{\hyperlink{driven__cavity_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}}.newton\_solve();}
\DoxyCodeLine{  }
\DoxyCodeLine{  \textcolor{comment}{// Outpt the solution}}
\DoxyCodeLine{  \mbox{\hyperlink{driven__cavity_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}}.doc\_solution(doc\_info);}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{// Step number}}
...
\DoxyCodeLine{  \mbox{\hyperlink{classRectangularDrivenCavityProblem}{RectangularDrivenCavityProblem<QTaylorHoodElement<2>}} > \mbox{\hyperlink{driven__cavity_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}};}
...
\DoxyCodeLine{   \textcolor{keyword}{dynamic\_cast<}ELEMENT*\textcolor{keyword}{>}(\mbox{\hyperlink{classRectangularDrivenCavityProblem_a408035d1f224641db75a2f48074e9593}{mesh\_pt}}()-\/>element\_pt(e))-\/>}
...
\DoxyCodeLine{    \textcolor{keywordtype}{unsigned} \mbox{\hyperlink{driven__cavity_8txt_a3999228f16bf26800d15356372c52411}{i}}=0;}
\DoxyCodeLine{    mesh\_pt()-\/>boundary\_node\_pt(ibound,inod)-\/>set\_value(\mbox{\hyperlink{driven__cavity_8txt_a3999228f16bf26800d15356372c52411}{i}},1.0);}
\DoxyCodeLine{    \textcolor{comment}{// No penetration}}
\DoxyCodeLine{    \mbox{\hyperlink{driven__cavity_8txt_a3999228f16bf26800d15356372c52411}{i}}=1;}
\DoxyCodeLine{    mesh\_pt()-\/>boundary\_node\_pt(ibound,inod)-\/>set\_value(\mbox{\hyperlink{driven__cavity_8txt_a3999228f16bf26800d15356372c52411}{i}},0.0);}
\DoxyCodeLine{   \}}
\DoxyCodeLine{  }
...
\DoxyCodeLine{    \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} inod=0;inod<num\_nod;inod++)}
\DoxyCodeLine{     \{}
\DoxyCodeLine{      \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{driven__cavity_8txt_a3999228f16bf26800d15356372c52411}{i}}=0;\mbox{\hyperlink{driven__cavity_8txt_a3999228f16bf26800d15356372c52411}{i}}<2;\mbox{\hyperlink{driven__cavity_8txt_a3999228f16bf26800d15356372c52411}{i}}++)}
\DoxyCodeLine{       \{}
\DoxyCodeLine{        mesh\_pt()-\/>boundary\_node\_pt(ibound,inod)-\/>set\_value(\mbox{\hyperlink{driven__cavity_8txt_a3999228f16bf26800d15356372c52411}{i}},0.0);}
\DoxyCodeLine{       \}}
\DoxyCodeLine{     \}}
...
\DoxyCodeLine{     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{driven__cavity_8txt_a3999228f16bf26800d15356372c52411}{i}}=0;\mbox{\hyperlink{driven__cavity_8txt_a3999228f16bf26800d15356372c52411}{i}}<2;\mbox{\hyperlink{driven__cavity_8txt_a3999228f16bf26800d15356372c52411}{i}}++)}
\DoxyCodeLine{      \{}
\DoxyCodeLine{       mesh\_pt()-\/>boundary\_node\_pt(ibound,inod)-\/>pin(\mbox{\hyperlink{driven__cavity_8txt_a3999228f16bf26800d15356372c52411}{i}}); }
\DoxyCodeLine{      \}}
\DoxyCodeLine{    \}}
