...
\image html alg_node_update_sketch.gif "Sketch of the algebraic node-update procedure for the collapsible channel mesh. " 
\image latex alg_node_update_sketch.eps "Sketch of the algebraic node-update procedure for the collapsible channel mesh. " width=0.75\textwidth
