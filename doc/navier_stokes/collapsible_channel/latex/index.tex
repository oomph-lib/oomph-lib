...
\DoxyCodeLine{\textcolor{comment}{/// Straight, horizontal channel wall at \(\backslash\)f\$ y=H \(\backslash\)f\$ deforms into an }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// oscillating parabola. The amplitude of the oscillation }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)f\$ A \(\backslash\)f\$ and its period is \(\backslash\)f\$ T \(\backslash\)f\$.}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// The position vector to a point on the wall, parametrised by}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// the Lagrangian coordinate \(\backslash\)f\$ \(\backslash\)zeta \(\backslash\)in [0,L]\(\backslash\)f\$, is therefore given by}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)f[ \{\(\backslash\)bf R\}(\(\backslash\)zeta,t) = }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   \(\backslash\)left(}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   \(\backslash\)begin\{array\}\{c\}}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   L\_\{up\} + \(\backslash\)zeta  \(\backslash\)\(\backslash\)   1 }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   \(\backslash\)end\{array\}}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   \(\backslash\)right)}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   + A}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   \(\backslash\)left(}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   \(\backslash\)begin\{array\}\{l\}}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   -\/ B \(\backslash\)sin\(\backslash\)left(\(\backslash\)frac\{2\(\backslash\)pi\}\{L\_\{collapsible\}\}\(\backslash\)zeta\(\backslash\)right) \(\backslash\)\(\backslash\) \(\backslash\)left(}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   \(\backslash\)frac\{2\}\{L\_\{collapsible\}\}\(\backslash\)right)\string^2 \(\backslash\)zeta \(\backslash\) (L-\/\(\backslash\)zeta)}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   \(\backslash\)end\{array\}}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   \(\backslash\)right)   }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   \(\backslash\) \(\backslash\)sin\(\backslash\)left(\(\backslash\)frac\{2\(\backslash\)pi t\}\{T\}\(\backslash\)right)}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///   \(\backslash\) \{\(\backslash\)cal R\}(t)}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{///  \(\backslash\)f]}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// The parameter \(\backslash\)f\$ B \(\backslash\)f\$ is zero by default. If it is set to a nonzero}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// value, the material particles on the wall also perform some }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// horizontal motion. The "ramp" function }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)f[ }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \{\(\backslash\)cal R\}(t) =  \(\backslash\)left\(\backslash\)\{ }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)begin\{array\}\{ll\}  }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)frac\{1\}\{2\}(1-\/\(\backslash\)cos(\(\backslash\)pi t/T)) \& \(\backslash\)mbox\{for \$t<T\$\} \(\backslash\)\(\backslash\) 1 \& \(\backslash\)mbox\{for \$t \(\backslash\)ge T\$\}}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)end\{array\} }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)right.}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)f]}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// provides a "smooth" startup of the oscillation. }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//=========================================================================}}
\DoxyCodeLine{\textcolor{keyword}{class }\mbox{\hyperlink{classOscillatingWall}{OscillatingWall}} : \textcolor{keyword}{public} GeomObject}
\DoxyCodeLine{\{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{public}:}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Constructor : It's a 2D object, parametrised by }}
...
\DoxyCodeLine{\textcolor{comment}{} \mbox{\hyperlink{classOscillatingWall_a5ededc3d27eef5c4ef7e82ac5cdf6ff9}{OscillatingWall}}(\textcolor{keyword}{const} \textcolor{keywordtype}{double}\& h, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& x\_left, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& l, }
\DoxyCodeLine{                 \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& a, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& \mbox{\hyperlink{classOscillatingWall_ac3e0098c026e23dd8be8ea29f6a9c101}{period}}, Time* time\_pt) : }
\DoxyCodeLine{  GeomObject(1,2), \mbox{\hyperlink{classOscillatingWall_aa587e944cac9e501e6d3323731145b95}{H}}(h), \mbox{\hyperlink{classOscillatingWall_ac5e2ad6d5ef2992ba9295118787190e6}{Length}}(l), \mbox{\hyperlink{classOscillatingWall_a71a60ee3294746875a24aeeffb38f7ec}{X\_left}}(x\_left), \mbox{\hyperlink{classOscillatingWall_ac22b6ac70a42850ddbe2e9c4c16f4664}{A}}(a), \mbox{\hyperlink{classOscillatingWall_a9db810649987a2011c7fe14d10b98b9a}{B}}(0.0), \mbox{\hyperlink{classOscillatingWall_af33b31988c823d33a3b147281ec94599}{T}}(\mbox{\hyperlink{classOscillatingWall_ac3e0098c026e23dd8be8ea29f6a9c101}{period}}), }
\DoxyCodeLine{  \mbox{\hyperlink{classOscillatingWall_a9c4bea6ec6e80ba23139cd5a1d4d25d5}{Time\_pt}}(time\_pt) }
\DoxyCodeLine{  \{\}}
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// Destructor:  Empty}}
\DoxyCodeLine{\textcolor{comment}{} \mbox{\hyperlink{classOscillatingWall_adc35b40bdd733a244d6399d91fa20ade}{\string~OscillatingWall}}()\{\}}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{///Access function to the amplitude}}
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{double}\& \mbox{\hyperlink{classOscillatingWall_ae923c6a7abefe33efaf47a4b69d1b621}{amplitude}}()\{\textcolor{keywordflow}{return} \mbox{\hyperlink{classOscillatingWall_ac22b6ac70a42850ddbe2e9c4c16f4664}{A}};\}}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{///Access function to the period}}
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{double}\& \mbox{\hyperlink{classOscillatingWall_ac3e0098c026e23dd8be8ea29f6a9c101}{period}}()\{\textcolor{keywordflow}{return} \mbox{\hyperlink{classOscillatingWall_af33b31988c823d33a3b147281ec94599}{T}};\}}
...
\DoxyCodeLine{   \textcolor{keywordflow}{if} (Time\_pt-\/>time(t)<\mbox{\hyperlink{collapsible__channel_8txt_ac4952e657b7da1dbb7923ec12b675021}{T}})}
\DoxyCodeLine{    \{}
\DoxyCodeLine{     ramp=0.5*(1.0-\/cos(Pi*Time\_pt-\/>time(t)/\mbox{\hyperlink{collapsible__channel_8txt_ac4952e657b7da1dbb7923ec12b675021}{T}}));}
\DoxyCodeLine{    \}}
\DoxyCodeLine{   }
\DoxyCodeLine{   \textcolor{comment}{// Position vector}}
\DoxyCodeLine{   r[0] = zeta[0]+X\_left }
\DoxyCodeLine{    -\/B*\mbox{\hyperlink{collapsible__channel_8txt_a2915e1695d3a1b958511c874d728cec0}{A}}*sin(2.0*3.14159*zeta[0]/Length)*}
\DoxyCodeLine{    sin(2.0*Pi*(Time\_pt-\/>time(t))/\mbox{\hyperlink{collapsible__channel_8txt_ac4952e657b7da1dbb7923ec12b675021}{T}})*ramp;}
\DoxyCodeLine{}
\DoxyCodeLine{   r[1] = H+\mbox{\hyperlink{collapsible__channel_8txt_a2915e1695d3a1b958511c874d728cec0}{A}}*((Length-\/zeta[0])*zeta[0])/pow(0.5*Length,2)*}
\DoxyCodeLine{    sin(2.0*Pi*(Time\_pt-\/>time(t))/\mbox{\hyperlink{collapsible__channel_8txt_ac4952e657b7da1dbb7923ec12b675021}{T}})*ramp;}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short "Current" position vector at Lagrangian coordinate zeta }}
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{double} \mbox{\hyperlink{collapsible__channel_8txt_a2915e1695d3a1b958511c874d728cec0}{A}};}
\DoxyCodeLine{\textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{double} \mbox{\hyperlink{collapsible__channel_8txt_ac4952e657b7da1dbb7923ec12b675021}{T}};}
\DoxyCodeLine{\textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{/// Driver code for an unsteady adaptive collapsible channel problem}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// with prescribed wall motion. Presence of command line arguments}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// indicates validation run with coarse resolution and small number of}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// timesteps.}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//=============================================================================}}
\DoxyCodeLine{\textcolor{keywordtype}{int} \mbox{\hyperlink{collapsible__channel_8cc_a0ddf1224851353fc92bfbff6f499fa97}{main}}(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}* argv[])}
\DoxyCodeLine{\{}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \mbox{\hyperlink{classCollapsibleChannelProblem}{CollapsibleChannelProblem<RefineableQCrouzeixRaviartElement<2>}} > }
\DoxyCodeLine{  \mbox{\hyperlink{collapsible__channel_8txt_a4074baada03976c061d5672f4237cca5}{problem}}(nup, ncollapsible, ndown, ny, }
...
\DoxyCodeLine{ \mbox{\hyperlink{collapsible__channel_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.time\_pt()-\/>time()=t\_min;}
\DoxyCodeLine{ \mbox{\hyperlink{collapsible__channel_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.initialise\_dt(dt);}
\DoxyCodeLine{ \mbox{\hyperlink{collapsible__channel_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.set\_initial\_condition();}
\DoxyCodeLine{ }
\DoxyCodeLine{  \textcolor{comment}{// Output the initial solution}}
\DoxyCodeLine{ \mbox{\hyperlink{collapsible__channel_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.doc\_solution(doc\_info, trace\_file);}
\DoxyCodeLine{ }
...
\DoxyCodeLine{ \mbox{\hyperlink{collapsible__channel_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.bulk\_mesh\_pt()-\/>max\_permitted\_error()=1.0e-\/3;}
\DoxyCodeLine{ \mbox{\hyperlink{collapsible__channel_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.bulk\_mesh\_pt()-\/>min\_permitted\_error()=1.0e-\/5;}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \textcolor{keywordflow}{if} (CommandLineArgs::Argc>1)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   \mbox{\hyperlink{collapsible__channel_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.bulk\_mesh\_pt()-\/>max\_permitted\_error()=1.0e-\/4;}
\DoxyCodeLine{   \mbox{\hyperlink{collapsible__channel_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.bulk\_mesh\_pt()-\/>min\_permitted\_error()=1.0e-\/6;}
\DoxyCodeLine{  \}}
...
\DoxyCodeLine{   \mbox{\hyperlink{collapsible__channel_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.unsteady\_newton\_solve(dt, max\_adapt, first);}
\DoxyCodeLine{    }
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{keyword}{class }\mbox{\hyperlink{classCollapsibleChannelProblem}{CollapsibleChannelProblem}} : \textcolor{keyword}{public} Problem}
\DoxyCodeLine{\{}
\DoxyCodeLine{}
\DoxyCodeLine{ public :}
\DoxyCodeLine{\textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{} \mbox{\hyperlink{classCollapsibleChannelProblem_ab43fa30667f57e8019c8b30fd93156f8}{CollapsibleChannelProblem}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned}\& nup, }
...
\DoxyCodeLine{\textcolor{comment}{} \mbox{\hyperlink{classCollapsibleChannelProblem_a205e3e654d3205d1d55ac46e7b63ca9d}{\string~CollapsibleChannelProblem}}() \{\} }
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// Access function for the specific mesh}}
\DoxyCodeLine{\textcolor{comment}{} RefineableCollapsibleChannelMesh<ELEMENT>* \mbox{\hyperlink{classCollapsibleChannelProblem_a49a428b5f489d11b3fb92199b72f6dd7}{bulk\_mesh\_pt}}() }
\DoxyCodeLine{  \{}
\DoxyCodeLine{}
...
\DoxyCodeLine{    (\mbox{\hyperlink{classCollapsibleChannelProblem_acd96e5a1d72cc3a1aad196c97dcb3883}{Bulk\_mesh\_pt}});}
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Number of elements in the x direction in the "collapsible" }}
...
\DoxyCodeLine{\textcolor{comment}{} \mbox{\hyperlink{classOscillatingWall}{OscillatingWall}}* Wall\_pt;}
...
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Pointer to the "surface" mesh that contains the applied traction}}
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//===============================================================}}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{class} ELEMENT>}
\DoxyCodeLine{\mbox{\hyperlink{classCollapsibleChannelProblem_ab43fa30667f57e8019c8b30fd93156f8}{CollapsibleChannelProblem<ELEMENT>::CollapsibleChannelProblem}}(}
...
\DoxyCodeLine{ Wall\_pt=\textcolor{keyword}{new} \mbox{\hyperlink{classOscillatingWall}{OscillatingWall}}(height, x\_left, length, amplitude, period,}
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//============================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{class} ELEMENT>}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{classCollapsibleChannelProblem_afc4af9796c01d904d4074bd5bbfc5b9b}{CollapsibleChannelProblem<ELEMENT>:: doc\_solution}}(DocInfo\& doc\_info, }
\DoxyCodeLine{                                                       ofstream\& trace\_file)}
\DoxyCodeLine{\{ }
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//============================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{class} ELEMENT>}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{classCollapsibleChannelProblem_a70cfe97c12c0cb6a2a81266cdd4d6088}{CollapsibleChannelProblem<ELEMENT>::create\_traction\_elements}}(}
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//=======================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT>}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{classCollapsibleChannelProblem_a6a5324dd1efb8c517a7e4d431b10fca4}{CollapsibleChannelProblem<ELEMENT>::}}}
\DoxyCodeLine{\mbox{\hyperlink{classCollapsibleChannelProblem_a6a5324dd1efb8c517a7e4d431b10fca4}{delete\_traction\_elements}}(Mesh* \textcolor{keyword}{const} \&surface\_mesh\_pt)}
\DoxyCodeLine{\{}
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//============================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{class} ELEMENT>}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{classCollapsibleChannelProblem_a646147fb75669cfcc5bb56ee79d9b8da}{CollapsibleChannelProblem<ELEMENT>::set\_initial\_condition}}()}
\DoxyCodeLine{\{ }
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{comment}{/// Execute the actions before timestep: Update the velocity}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// boundary condition on the moving wall}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//============================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{class} ELEMENT>}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{classCollapsibleChannelProblem_a4c365050b11c184007b8e1cd6079147f}{CollapsibleChannelProblem<ELEMENT>::actions\_before\_implicit\_timestep}}()}
\DoxyCodeLine{\{}
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//========================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT>}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{classCollapsibleChannelProblem_a54abc5259d590154e5dfa458d885c16c}{CollapsibleChannelProblem<ELEMENT>::actions\_before\_adapt}}()}
\DoxyCodeLine{\{}
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//========================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT>}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{classCollapsibleChannelProblem_a3ea01d83f0256c588a652741c6c33e0e}{CollapsibleChannelProblem<ELEMENT>::actions\_after\_adapt}}()}
\DoxyCodeLine{\{}
...
\DoxyCodeLine{\textcolor{comment}{/// Namespace to define the mapping [0,1] -\/> [0,1] that re-\/distributes}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// nodal points across the channel width.}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//======================================================================}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Mapping [0,1] -\/> [0,1] that re-\/distributes}}
