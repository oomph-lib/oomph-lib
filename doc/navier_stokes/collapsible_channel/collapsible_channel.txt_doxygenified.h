...
\image html flow.gif "Snapshot from the animation of the flow field for Re = Re St = 50, T=0.45, A=0.01. " 
\image latex flow.eps "Snapshot from the animation of the flow field for Re = Re St = 50, T=0.45, A=0.01. " width=0.20\textwidth
...
\image html trace.gif "Time-trace of the axial velocities at two control points in the upstream and downstream cross-sections, and the vertical position of a control point on the wall. (Re = Re St = 50, T=0.45, A=0.01.) " 
\image latex trace.eps "Time-trace of the axial velocities at two control points in the upstream and downstream cross-sections, and the vertical position of a control point on the wall. (Re = Re St = 50, T=0.45, A=0.01.) " width=0.20\textwidth
...
\image html mesh.gif "Sketch of the CollapsibleChannelDomain/Mesh. " 
\image latex mesh.eps "Sketch of the CollapsibleChannelDomain/Mesh. " width=0.20\textwidth
...
required by (5). If the parameter
...
-# Check the non-dimensionalisation of the governing
   ...
   Poiseuille flow specified by (3) through the 
...
\image html bl_squashing.gif "Coarse initial meshes with and without the boundary-layer squash function. " 
\image latex bl_squashing.eps "Coarse initial meshes with and without the boundary-layer squash function. " width=0.75\textwidth
...
\image html large_amplitude_flow.gif "Flow field for a large-amplitude wall motion. Re=ReSt=50; A=B=0.5; T=0.45. " 
\image latex large_amplitude_flow.eps "Flow field for a large-amplitude wall motion. Re=ReSt=50; A=B=0.5; T=0.45. " width=0.75\textwidth
