...
\DoxyCodeLine{   \mbox{\hyperlink{spine__channel_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}};}
\DoxyCodeLine{  }
\DoxyCodeLine{  \textcolor{comment}{// Solve the problem with automatic adaptation}}
\DoxyCodeLine{  \mbox{\hyperlink{spine__channel_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}}.newton\_solve();}
\DoxyCodeLine{  }
\DoxyCodeLine{  \textcolor{comment}{//Output solution}}
\DoxyCodeLine{  \mbox{\hyperlink{spine__channel_8txt_a8d895bb93cd829890aa4c1a2d5682792}{problem}}.doc\_solution(doc\_info);}
...
\DoxyCodeLine{\textcolor{comment}{/// Channel flow through a non-\/uniform channel whose geometry is defined }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// by a spine mesh.}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//====================================================================}}
...
\DoxyCodeLine{   \mbox{\hyperlink{classChannelSpineFlowProblem_ab68c7ab5406b90a0ef56c39b67f83a09}{mesh\_pt}}()-\/>node\_update();}
\DoxyCodeLine{}
...
\DoxyCodeLine{  \textcolor{keyword}{new} \mbox{\hyperlink{classSinusoidalWall}{SinusoidalWall}}(Ly,amplitude\_upper,zeta\_min,zeta\_max);}
\DoxyCodeLine{ }
...
In the past when solving a problem in a domain with curved boundaries, we have made a specific Mesh for the domain, and use a geometric object to define its curved \mbox{\hyperlink{spine__channel_8txt_ab6c081592e5a43c3ddd306db5c520563}{wall(s)}}.
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT>}
\DoxyCodeLine{ChannelSpineMesh<ELEMENT>::ChannelSpineMesh(}
\DoxyCodeLine{ \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&nx0,}
...
\DoxyCodeLine{ RectangularQuadMesh<ELEMENT >(nx0+nx1+nx2,ny,0.0,lx0+lx1+lx2,}
\DoxyCodeLine{                               0.0,h,false,false,time\_stepper\_pt),}
\DoxyCodeLine{ Nx0(nx0), Nx1(nx1), Nx2(nx2), }
\DoxyCodeLine{ Lx0(lx0), Lx1(lx1), Lx2(lx2), }
\DoxyCodeLine{ Wall\_pt(wall\_pt)}

\end{DoxyCodeInclude}


We then assign all the parameters for the {\ttfamily Rectangular\+Quad\+Mesh$<$\+E\+L\+E\+M\+E\+N\+T$>$}, create the geometric object for the uniform wall and call the function {\ttfamily \mbox{\hyperlink{spine__channel_8txt_af6dd20913b6f4c7abd5a0823c3ad7134}{build\+\_\+channel\+\_\+spine\+\_\+mesh(...)}}} 
...
\DoxyCodeLine{ \mbox{\hyperlink{spine__channel_8txt_af6dd20913b6f4c7abd5a0823c3ad7134}{build\_channel\_spine\_mesh}}(time\_stepper\_pt);}
\DoxyCodeLine{}
\DoxyCodeLine{\}}
...
When we call the function {\ttfamily \mbox{\hyperlink{spine__channel_8txt_af6dd20913b6f4c7abd5a0823c3ad7134}{build\+\_\+channel\+\_\+spine\+\_\+mesh(...)}}}, it calls its counterpart in the {\ttfamily Rectangular\+Quad\+Mesh$<$\+E\+L\+E\+M\+E\+N\+T$>$}, then store the numbers of elements in each direction in each region (and all at once).

 
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{spine__channel_8txt_af6dd20913b6f4c7abd5a0823c3ad7134}{ChannelSpineMesh<ELEMENT>::build\_channel\_spine\_mesh}}(}
\DoxyCodeLine{ TimeStepper* time\_stepper\_pt) }
\DoxyCodeLine{\{}
...
\DoxyCodeLine{    \{}
\DoxyCodeLine{     Left\_element\_pt.push\_back(}
\DoxyCodeLine{      this-\/>finite\_element\_pt(irow*n\_x+e));}
\DoxyCodeLine{    \}}
...
\DoxyCodeLine{ \mbox{\hyperlink{spine__channel_8txt_a914410aeeaf61a0d6c75c43ec26ecbaa}{Spine}}* new\_spine\_pt=\textcolor{keyword}{new} \mbox{\hyperlink{spine__channel_8txt_a914410aeeaf61a0d6c75c43ec26ecbaa}{Spine}}(1.0);}
...
We then set the {\ttfamily spine\+\_\+pt()} of the first node to the Spine we just created, assign the nodes {\ttfamily \mbox{\hyperlink{spine__channel_8txt_aa65a3698923f42762308375c13258dd9}{fraction()}}} to zero and define the node as part of this mesh.
...
\DoxyCodeLine{     nod\_pt-\/>spine\_pt() = new\_spine\_pt;}
\DoxyCodeLine{     \textcolor{comment}{//Set the fraction}}
\DoxyCodeLine{     nod\_pt-\/>fraction()=(double(i)+double(l1)/double(n\_p-\/1))/\textcolor{keywordtype}{double}(n\_y);}
\DoxyCodeLine{     \textcolor{comment}{// Pointer to the mesh that implements the update fct}}
\DoxyCodeLine{     nod\_pt-\/>spine\_mesh\_pt() = \textcolor{keyword}{this}; }
\DoxyCodeLine{     \textcolor{comment}{// Set update fct id}}
\DoxyCodeLine{     nod\_pt-\/>node\_update\_fct\_id()=0;}
