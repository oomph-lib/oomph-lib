...
- <a href="../../../scripts/oomph-convert.py"><code>scripts/oomph-convert.py
  </code>:</a> The python conversion script itself.
  \n\n
- <a href="../../../scripts/oomph-convert"><code>scripts/oomph-convert
  </code>:</a> A shell script wrapper that allows the processing of
  multiple files.
  \n\n
- <a href="../../../scripts/makePvd"><code>scripts/makePvd</code>:</a>
...
-# Add \c oomph-lib's <code>scripts</code> directory to your path.
   \n
