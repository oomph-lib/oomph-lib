...
\begin{DoxyItemize}
\item \href{../../../scripts/oomph-convert.py}{\texttt{ {\ttfamily scripts/oomph-\/convert.\+py }\+:}} The python conversion script itself. ~\newline
~\newline

\item \href{../../../scripts/oomph-convert}{\texttt{ {\ttfamily scripts/oomph-\/convert }\+:}} A shell script wrapper that allows the processing of multiple files. ~\newline
~\newline

\item \href{../../../scripts/makePvd}{\texttt{ {\ttfamily scripts/make\+Pvd}\+:}} A shell script the creates the {\ttfamily \texorpdfstring{$\ast$}{*}} {\ttfamily }.pvd files required by paraview to produce animations.
...
\begin{DoxyEnumerate}
\item Add {\ttfamily oomph-\/lib\textquotesingle{}s} {\ttfamily scripts} directory to your path. ~\newline
