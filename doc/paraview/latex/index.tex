...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{    /// \(\backslash\)short Add name of output file and associated continuous time}}
