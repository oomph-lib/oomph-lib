...
\image html step_soln.gif "Animation of the adaptive solution for various values of the `steepness parameter'. " 
\image latex step_soln.eps "Animation of the adaptive solution for various values of the `steepness parameter'. " width=0.75\textwidth
...
\image html no_source.gif "Plot of the adaptive solution of the unforced problem. " 
\image latex no_source.eps "Plot of the adaptive solution of the unforced problem. " width=0.75\textwidth

Along \f$ \partial D_{Dirichlet}\f$, the value of \f$ u \f$ is enforced
by the Dirichlet boundary condition (2) and,
...
flux boundary condition  (3) imposes the normal
