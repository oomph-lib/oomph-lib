\chapter{Example problem\+: SUPG-\/stabilised solution of the 2D advection diffusion equation}
\hypertarget{index}{}\label{index}\index{Example problem: SUPG-\/stabilised solution of the 2D advection diffusion equation@{Example problem: SUPG-\/stabilised solution of the 2D advection diffusion equation}}
...
\ \ \ \ \ \ \ \ \  (3)
\] For large values of $ \alpha, $ this boundary data approaches a step, oriented at an angle $\Phi$ against the $x_1-$axis.
...
Overall, the structure of the driver code is very similar to that used for the \href{../../../advection_diffusion/two_d_adv_diff_adapt/html/index.html}{\texttt{ problem without stabilisation}}.\hypertarget{index_todo}{}\doxysubsection{\texorpdfstring{To be written\+:}{To be written:}}\label{index_todo}
...
\DoxyCodeLine{\textcolor{comment}{}\ \mbox{\hyperlink{classSUPGAdvectionDiffusionProblem}{SUPGAdvectionDiffusionProblem}}(}
