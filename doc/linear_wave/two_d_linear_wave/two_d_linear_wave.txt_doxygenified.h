...
\image html wave_sol.gif "Snapshot of the exact and computed solutions. " 
\image latex wave_sol.eps "Snapshot of the exact and computed solutions. " width=0.75\textwidth
...
correct results. This is because the travelling-wave solution (5)
