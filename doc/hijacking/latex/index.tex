...
\begin{DoxyCode}{0}
\DoxyCodeLine{Data* \mbox{\hyperlink{hijacking_8txt_a364e3cb53053754a4d7e8b138a16038e}{hijack\_internal\_value}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&n, \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&i)}
\DoxyCodeLine{Data* \mbox{\hyperlink{hijacking_8txt_a9d3dd9cee742150864622abdace064a9}{hijack\_external\_value}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&n, \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&i)}
\DoxyCodeLine{Data* \mbox{\hyperlink{hijacking_8txt_a03f884e3ddf315c7dff573ac40face8a}{hijack\_nodal\_value}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&n, \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&i)}
\DoxyCodeLine{Data* \mbox{\hyperlink{hijacking_8txt_a4db667df596f15537610995e5f6b763f}{hijack\_nodal\_position\_value}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&n, \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&i)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{Hijacked<QPoissonElement<1,2> > *\mbox{\hyperlink{hijacking_8txt_a6c19464a9b15972ff8a85d424bbcc737}{el\_pt}} = \textcolor{keyword}{new} Hijacked<QPoissonElement<1,3> >;}
\DoxyCodeLine{\mbox{\hyperlink{hijacking_8txt_a6c19464a9b15972ff8a85d424bbcc737}{el\_pt}}-\/>hijack\_nodal\_value(0,0);}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{delete} \mbox{\hyperlink{hijacking_8txt_a6c19464a9b15972ff8a85d424bbcc737}{el\_pt}}-\/>hijack\_internal\_value(0,0);}
\end{DoxyCode}
...
\item Hijacking will persist throughout adaptation, but only if the degree of freedom remains \char`\"{}active\char`\"{}. It is safest to {\ttfamily \mbox{\hyperlink{hijacking_8txt_a3cfa93c8a9d1db87b8bcf544e2fde3f7}{unhijack\+\_\+all\+\_\+data()}}} before adaptation and then hijack again in {\ttfamily actions\+\_\+after\+\_\+adapt()}.
