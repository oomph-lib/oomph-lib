...
\image html coated_sphere.gif "Sketch of the model problem: Forced oscillations of a sphere (black) deform an elastic coating layer (pink) which is surrounded by a compressible fluid. " 
\image latex coated_sphere.eps "Sketch of the model problem: Forced oscillations of a sphere (black) deform an elastic coating layer (pink) which is surrounded by a compressible fluid. " width=0.6\textwidth
...
Equations (5), (6) and 
(7) apply for each Fourier component
of the solution.
...
.
for the discretisation of the PDEs (1) and 
(2), respectively.
The displacement boundary condition (4) on the inner surface
...
Sommerfeld radiation condition (7) on the outer boundary
...
The boundary conditions (5) and 
(6) at the fluid-solid interface are 
...
\image html single_physics.gif "Sketch illustrating the imposition of flux and traction boundary conditions in single-physics problems. The continuous problems are shown on the left; the discretised ones on the right. " 
\image latex single_physics.eps "Sketch illustrating the imposition of flux and traction boundary conditions in single-physics problems. The continuous problems are shown on the left; the discretised ones on the right. " width=0.6\textwidth
...
(5), while the normal derivative of the
displacement potential is given in terms of the solid displacement via 
equation (6). Note that corresponding points on the
...
\image html multi_physics.gif "Sketch illustrating the imposition of flux and traction boundary conditions in the coupled multi-physics problem. The continuous problems are shown on the left; the discretised ones on the right. " 
\image latex multi_physics.eps "Sketch illustrating the imposition of flux and traction boundary conditions in the coupled multi-physics problem. The continuous problems are shown on the left; the discretised ones on the right. " width=0.6\textwidth
...
\image html anim.gif "Animation showing the time-harmonic oscillation of the elastic coating. (The pink region in the background shows the undeformed configuration.) " 
\image latex anim.eps "Animation showing the time-harmonic oscillation of the elastic coating. (The pink region in the background shows the undeformed configuration.) " width=0.6\textwidth

Here is a plot of the corresponding pressure field:

\image html potential.gif "Plot of the displacement potential (a measure of the fluid pressure). The elevation in the carpet plot indicates the real part; the colour contours represent the imaginary part. " 
\image latex potential.eps "Plot of the displacement potential (a measure of the fluid pressure). The elevation in the carpet plot indicates the real part; the colour contours represent the imaginary part. " width=0.6\textwidth
...
\image html trace.gif "Radiated power as function of the FSI parameter Q for a spherically-symmetrically oscillating coating. Markers: computed results; continuous line: analytical result. " 
\image latex trace.eps "Radiated power as function of the FSI parameter Q for a spherically-symmetrically oscillating coating. Markers: computed results; continuous line: analytical result. " width=0.6\textwidth



\image html comp_phi_re.gif "Real part of the fluid displacement potential (a measure of the fluid pressure) for Q=10. Shaded: computed; spheres: exact. " 
\image latex comp_phi_re.eps "Real part of the fluid displacement potential (a measure of the fluid pressure) for Q=10. Shaded: computed; spheres: exact. " width=0.6\textwidth

\image html comp_phi_im.gif "Imaginary part of the fluid displacement potential (a measure of the fluid pressure) for Q=10. Shaded: computed; spheres: exact. " 
\image latex comp_phi_im.eps "Imaginary part of the fluid displacement potential (a measure of the fluid pressure) for Q=10. Shaded: computed; spheres: exact. " width=0.6\textwidth

\image html comp_ur_re.gif "Real part of the radial solid displacement for Q=10. Shaded: computed; spheres: exact. " 
\image latex comp_ur_re.eps "Real part of the radial solid displacement for Q=10. Shaded: computed; spheres: exact. " width=0.6\textwidth

\image html comp_ur_im.gif "Imaginary part of the radial solid displacement for Q=10. Shaded: computed; spheres: exact. " 
\image latex comp_ur_im.eps "Imaginary part of the radial solid displacement for Q=10. Shaded: computed; spheres: exact. " width=0.6\textwidth

\image html comp_uz_re.gif "Real part of the axial solid displacement for Q=10. Shaded: computed; spheres: exact. " 
\image latex comp_uz_re.eps "Real part of the axial solid displacement for Q=10. Shaded: computed; spheres: exact. " width=0.6\textwidth

\image html comp_uz_im.gif "Imaginary part of the axial solid displacement for Q=10. Shaded: computed; spheres: exact. " 
\image latex comp_uz_im.eps "Imaginary part of the axial solid displacement for Q=10. Shaded: computed; spheres: exact. " width=0.6\textwidth
...
(5), the FSI flux boundary condition (6)
for the Helmholtz equation, and the Sommerfeld radiation condition 
(7), respectively, using helper functions discussed
below.
...
(5) on the outer boundary (boundary 2) of the solid
mesh:
...
(6) on the inner boundary (boundary 0),
and the Sommerfeld radiation condition (7) 
...
that impose the FSI traction boundary condition (5),
...
adjacent to (the Gauss points of) the \c FaceElements 
that impose the FSI flux boundary condition (6),
...
\bigg).
\f] 
Next we express the surface integral in (9) in
...
If we evaluate the surface integral in (9) 
