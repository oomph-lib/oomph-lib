...
\doxyfigcaption{Radiated power as function of the F\+SI parameter Q for a spherically-\/symmetrically oscillating coating. Markers\+: computed results; continuous line\+: analytical result. }
\end{DoxyImage}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Wavenumber "zenith"-\/variation of imposed displacement of coating}}
\DoxyCodeLine{\textcolor{comment}{ /// on inner boundary }}
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{unsigned} \mbox{\hyperlink{sphere_8txt_ab10469e7eba7097891e00152fcd01958}{M}}=4; }
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Displacement field on inner boundary of solid}}
...
\DoxyCodeLine{}
\DoxyCodeLine{  u[0]=complex<double>(normal[0]*cos(\textcolor{keywordtype}{double}(\mbox{\hyperlink{sphere_8txt_ab10469e7eba7097891e00152fcd01958}{M}})*theta),0.0);}
\DoxyCodeLine{  u[1]=complex<double>(normal[1]*cos(\textcolor{keywordtype}{double}(\mbox{\hyperlink{sphere_8txt_ab10469e7eba7097891e00152fcd01958}{M}})*theta),0.0);}
\DoxyCodeLine{ \}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Create DtN elements on outer boundary}}
...
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Pointer to mesh containing the DtN elements}}
...
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{sphere_8txt_a212de9f115b2f2901e4007e1f319fa28}{phi}}=0.5*MathematicalConstants::Pi;}
...
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{sphere_8txt_ab08834efd41ff8d453645c014df450bf}{a}}=1.0-\/\mbox{\hyperlink{namespaceGlobal__Parameters_ae3cf8878ede839bffda01f79bbe3e819}{Global\_Parameters::H\_coating}};}
\DoxyCodeLine{ }
...
\DoxyCodeLine{                                      ntheta\_solid,nr\_solid,\mbox{\hyperlink{sphere_8txt_ab08834efd41ff8d453645c014df450bf}{a}},}
\DoxyCodeLine{                                      \mbox{\hyperlink{namespaceGlobal__Parameters_ae3cf8878ede839bffda01f79bbe3e819}{Global\_Parameters::H\_coating}},\mbox{\hyperlink{sphere_8txt_a212de9f115b2f2901e4007e1f319fa28}{phi}});}
...
\DoxyCodeLine{ \mbox{\hyperlink{sphere_8txt_ab08834efd41ff8d453645c014df450bf}{a}}=1.0;}
\DoxyCodeLine{ }
\DoxyCodeLine{ \textcolor{comment}{// Thickness of Helmholtz mesh}}
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{sphere_8txt_a05fee6304cdd89e7b7155d220e5d5c4a}{h\_thick\_helmholtz}}=\mbox{\hyperlink{namespaceGlobal__Parameters_a88ded445ecd7bd89701409e68fd0b900}{Global\_Parameters::Outer\_radius}}-\/\mbox{\hyperlink{sphere_8txt_ab08834efd41ff8d453645c014df450bf}{a}};}
\DoxyCodeLine{}
...
\DoxyCodeLine{   ntheta\_helmholtz,nr\_helmholtz,\mbox{\hyperlink{sphere_8txt_ab08834efd41ff8d453645c014df450bf}{a}},\mbox{\hyperlink{sphere_8txt_a05fee6304cdd89e7b7155d220e5d5c4a}{h\_thick\_helmholtz}},\mbox{\hyperlink{sphere_8txt_a212de9f115b2f2901e4007e1f319fa28}{phi}});}
...
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} \mbox{\hyperlink{sphere_8txt_a558073be4eb9dfecd1a02957ab406727}{nfourier}}=20;}
...
\DoxyCodeLine{   \mbox{\hyperlink{namespaceGlobal__Parameters_a88ded445ecd7bd89701409e68fd0b900}{Global\_Parameters::Outer\_radius}},\mbox{\hyperlink{sphere_8txt_a558073be4eb9dfecd1a02957ab406727}{nfourier}});}
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_create_flux}{}\doxysubsection{Creating the F\+S\+I traction elements (and the F\+S\+I flux and Dt\+N elements)}\label{index_create_flux}
The function {\ttfamily create\+\_\+fsi\+\_\+traction\+\_\+elements()} creates the {\ttfamily Face\+Elements} required to apply the F\+SI traction boundary condition (5) on the outer boundary (boundary 2) of the solid mesh\+:
...
To function properly, the elements need to know the number of the bulk mesh boundary they are attached to (this allows them to determine the boundary coordinate $ \zeta $ required to set up the fluid-\/structure interaction; see \mbox{\hyperlink{index_impl}{Implementation}} ), and the F\+SI parameter $ Q $.
