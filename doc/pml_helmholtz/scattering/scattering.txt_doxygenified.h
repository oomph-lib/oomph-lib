...
\image html pml.gif "Sketch illustrating the idea behind perfectly matched layers. " 
\image latex pml.eps "Sketch illustrating the idea behind perfectly matched layers. " width=0.75\textwidth
...
\image html pml_meshes.gif "Sketch illustrating the geometry of the perfectly matched layers. " 
\image latex pml_meshes.eps "Sketch illustrating the geometry of the perfectly matched layers. " width=0.75\textwidth
...
The finite-element-discretised equations (2)
...
\image html Mesh.gif "The computational domain used in the example problem. " 
\image latex Mesh.eps "The computational domain used in the example problem. " width=0.75\textwidth
...
\image html Soln2D.gif "Sample solution with activated perfectly matched layers. " 
\image latex Soln2D.eps "Sample solution with activated perfectly matched layers. " width=0.6\textwidth

\image html SolnHeight.gif "Sample solution with activated perfectly matched layers -- height view. " 
\image latex SolnHeight.eps "Sample solution with activated perfectly matched layers -- height view. " width=0.6\textwidth
...
\image html ZeroFlux2D.gif "The solution with zero flux boundary conditions. " 
\image latex ZeroFlux2D.eps "The solution with zero flux boundary conditions. " width=0.6\textwidth

\image html ZeroFluxHeight.gif "The solution with zero flux boundary conditions -- height view. " 
\image latex ZeroFluxHeight.eps "The solution with zero flux boundary conditions -- height view. " width=0.6\textwidth
