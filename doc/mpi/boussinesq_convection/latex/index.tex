...
The problem class is identical to its serial counterpart, apart from the addition of the {\ttfamily \mbox{\hyperlink{boussinesq__convection_8txt_a472f479ab997a5a2d889405dce0b7c39}{actions\+\_\+after\+\_\+distribute()}}} function, discussed below.
...
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Actions after adaptation, re-\/set all interactions, then}}
...
\DoxyCodeLine{ \textcolor{keywordtype}{void} \mbox{\hyperlink{boussinesq__convection_8txt_a472f479ab997a5a2d889405dce0b7c39}{actions\_after\_distribute}}()}
\DoxyCodeLine{  \{}
...
As usual, the {\ttfamily \mbox{\hyperlink{boussinesq__convection_8txt_a8cb7bc96a2ec61fe51b7b81e7ca542df}{doc\+\_\+solution()}}} function is modified by adding the processor ID to each output file, ensuring that output from one processor does not overwrite that from another.
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_multi_domain}{}\doxysection{Part I\+I\+: Setting up multi-\/domain interactions}\label{index_multi_domain}
...
\DoxyCodeLine{                                       Mesh* \textcolor{keyword}{const} \&\mbox{\hyperlink{boussinesq__convection_8txt_a707b60a792e911d3fa7d844de3c21d8a}{first\_mesh\_pt}},}
\DoxyCodeLine{                                       Mesh* \textcolor{keyword}{const} \&\mbox{\hyperlink{boussinesq__convection_8txt_ae55dc27b6a9169b989fbdb65e21a2e98}{second\_mesh\_pt}});}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{boussinesq__convection_8txt_a15a095909692c48e1e31dac9df3387a3}{setup\_multi\_domain\_interaction<ELEMENT\_1>}}}
\DoxyCodeLine{     (problem\_pt,\mbox{\hyperlink{boussinesq__convection_8txt_a707b60a792e911d3fa7d844de3c21d8a}{first\_mesh\_pt}},\mbox{\hyperlink{boussinesq__convection_8txt_ae55dc27b6a9169b989fbdb65e21a2e98}{second\_mesh\_pt}});}
\DoxyCodeLine{\mbox{\hyperlink{boussinesq__convection_8txt_ad0de0d1da8264c20e566a642a54e36a5}{setup\_multi\_domain\_interaction<ELEMENT\_0>}}}
\DoxyCodeLine{     (problem\_pt,\mbox{\hyperlink{boussinesq__convection_8txt_ae55dc27b6a9169b989fbdb65e21a2e98}{second\_mesh\_pt}},\mbox{\hyperlink{boussinesq__convection_8txt_a707b60a792e911d3fa7d844de3c21d8a}{first\_mesh\_pt}});}
\end{DoxyCode}
...
\DoxyHorRuler{0}
\hypertarget{index_optim}{}\doxysubsection{Optimising the setup of multi-\/domain interactions}\label{index_optim}
