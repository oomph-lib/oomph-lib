...
\DoxyCodeLine{\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{adaptive__driven__cavity_8txt_aa4165c0479da2600f28861e56babbcc7}{max\_adapt}}=3;}
\DoxyCodeLine{}
...
\DoxyCodeLine{ problem.newton\_solve(\mbox{\hyperlink{adaptive__driven__cavity_8txt_aa4165c0479da2600f28861e56babbcc7}{max\_adapt}});}
\DoxyCodeLine{}
...
Finally, we must call {\ttfamily \mbox{\hyperlink{adaptive__driven__cavity_8txt_ab24ac0c852b9ce23e90f9bed9cab6a7c}{M\+P\+I\+\_\+finalize()}}} before the end of the main function  
\begin{DoxyCodeInclude}{0}
...
The {\ttfamily \mbox{\hyperlink{adaptive__driven__cavity_8txt_a72e73fc4b8becce181c42c7dff8c7aad}{doc\+\_\+solution()}}} routine requires a slight modification to ensure that the output from different processors can be distinguished; this is achieved by including the current processor number in the filename of the solution\+:
...
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{adaptive__driven__cavity_8txt_a72e73fc4b8becce181c42c7dff8c7aad}{RefineableDrivenCavityProblem<ELEMENT>::doc\_solution}}(DocInfo\& doc\_info)}
\DoxyCodeLine{\{ }
\DoxyCodeLine{}
...
The actual driver code demonstrates two of the different options available for the {\ttfamily Problem\+::distribute()} function, selected by the presence or absence of command line arguments.\hypertarget{index_no_disk}{}\doxysubsection{Option I\+: Distributing a problem using M\+E\+T\+I\+S and documenting its distribution}\label{index_no_disk}
...
\DoxyHorRuler{0}
\hypertarget{index_from_disk}{}\doxysubsection{Option I\+I\+: Using a pre-\/determined distribution}\label{index_from_disk}
...
For further examples of using the {\ttfamily \mbox{\hyperlink{adaptive__driven__cavity_8txt_a9c1ab6e1e8c4c9479be1d95df66f792b}{distribute()}}} function for both two-\/dimensional and three-\/dimensional single-\/domain problems, see the directory
