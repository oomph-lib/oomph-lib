...
\DoxyCodeLine{}
\DoxyCodeLine{\ \textcolor{comment}{//\ Output\ solution\ }}
\DoxyCodeLine{\ snprintf(filename,\ \textcolor{keyword}{sizeof}(filename),\ \textcolor{stringliteral}{"{}\%s/soln\%i\_on\_proc\%i.dat"{}},doc\_info.directory().c\_str(),}
...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{char}\ filename[100];}
\DoxyCodeLine{\ \ \ \ snprintf(filename,\ \textcolor{keyword}{sizeof}(filename),\ \textcolor{stringliteral}{"{}out\_adaptive\_cavity\_1\_partition.dat"{}});}
...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{char}\ filename[100];}
\DoxyCodeLine{\ \ \ \ snprintf(filename,\ \textcolor{keyword}{sizeof}(filename),\ \textcolor{stringliteral}{"{}adaptive\_cavity\_1\_partition.dat"{}});}
