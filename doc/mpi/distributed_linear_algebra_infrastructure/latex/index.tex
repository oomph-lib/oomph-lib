...
We begin by defining the {\ttfamily Oomph\+Communicator}, a class that is fundamental ~\newline
 to distributed computing in {\ttfamily oomph-\/lib}. Next we discuss the class {\ttfamily Linear\+Algebra\+Distribution} which specifies the distribution of the data and computations over the available processes. In Sections \mbox{\hyperlink{index_double_vector}{Double\+Vector}}, \mbox{\hyperlink{index_cr_double_matrix}{C\+R\+Double\+Matrix}} and \mbox{\hyperlink{index_distributed_linear_algebra_object}{Distributed\+Linear\+Algebra\+Object}} we discuss {\ttfamily oomph-\/lib\textquotesingle{}s} distributed linear algebra objects including the key containers (matrices and vectors) and operators (solvers and preconditioners). Finally, we demonstrate how the distributed linear algebra framework is typically used in practice.
...
{\ttfamily Oomph-\/lib} employs M\+PI for distributed memory parallelisation. Fundamental to M\+PI is the communicator ~\newline
 ( {\ttfamily M\+P\+I\+\_\+\+Comm} ) which determines which processes are involved in a parallel computation. Although {\ttfamily oomph-\/lib} is implemented in C++, the C M\+PI bindings are utilised. {\ttfamily Oomph-\/lib} provides the class {\ttfamily Oomph\+Communicator} as an object-\/oriented wrapper for a {\ttfamily M\+P\+I\+\_\+\+Comm}.
...
\DoxyCodeLine{  \textcolor{keywordtype}{bool} \mbox{\hyperlink{distributed__linear__algebra__infrastructure_8txt_a03654fcd0f1ae9cac59686ccb27bd720}{distributed}}=\textcolor{keyword}{false};}
\DoxyCodeLine{  locally\_replicated\_distribution.build(comm\_pt,nrow\_global,\mbox{\hyperlink{distributed__linear__algebra__infrastructure_8txt_a03654fcd0f1ae9cac59686ccb27bd720}{distributed}});}
\DoxyCodeLine{  }
\DoxyCodeLine{  \textcolor{comment}{// Show us how many rows this processor holds}}
...
\DoxyCodeLine{  \textcolor{keywordtype}{unsigned} \mbox{\hyperlink{distributed__linear__algebra__infrastructure_8txt_a735f6f26a559982261bb63ecfb78b016}{first\_row}} = distributed\_distribution.first\_row();}
\DoxyCodeLine{  }
...
\DoxyCodeLine{  \mbox{\hyperlink{distributed__linear__algebra__infrastructure_8txt_a03654fcd0f1ae9cac59686ccb27bd720}{distributed}} = distributed\_distribution.distributed();}
\DoxyCodeLine{  }
...
\DoxyCodeLine{  nrow\_local = my\_vector.distribution\_pt()-\/>nrow\_local();}
\DoxyCodeLine{  \mbox{\hyperlink{distributed__linear__algebra__infrastructure_8txt_a735f6f26a559982261bb63ecfb78b016}{first\_row}} = my\_vector.distribution\_pt()-\/>first\_row();}
\DoxyCodeLine{  \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} i = 0; i < nrow\_local; i++)}
\DoxyCodeLine{   \{}
\DoxyCodeLine{    oomph\_info << \textcolor{stringliteral}{"local row "} << i }
\DoxyCodeLine{               << \textcolor{stringliteral}{" is global row "} << \mbox{\hyperlink{distributed__linear__algebra__infrastructure_8txt_a735f6f26a559982261bb63ecfb78b016}{first\_row}}+i }
...
Again the {\ttfamily built()} method returns the state of the object and indicates if it contains any data.\hypertarget{index_cr_double_matrix}{}\doxysection{C\+R\+Double\+Matrix}\label{index_cr_double_matrix}
...
\DoxyCodeLine{  \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} i = 0; i < nrow\_local; ++i)}
\DoxyCodeLine{   \{}
\DoxyCodeLine{    column\_indices[i]=\mbox{\hyperlink{distributed__linear__algebra__infrastructure_8txt_a735f6f26a559982261bb63ecfb78b016}{first\_row}}+nrow\_local;}
...
\DoxyCodeLine{  \mbox{\hyperlink{distributed__linear__algebra__infrastructure_8txt_a735f6f26a559982261bb63ecfb78b016}{first\_row}} =  my\_matrix2.distribution\_pt()-\/>first\_row();}
...
\DoxyCodeLine{  }
\DoxyCodeLine{  \textcolor{comment}{// Get the first (global) row of my\_matrix on this process}}
\DoxyCodeLine{  \mbox{\hyperlink{distributed__linear__algebra__infrastructure_8txt_a735f6f26a559982261bb63ecfb78b016}{first\_row}} =  my\_matrix2.first\_row();}
...
\item {\ttfamily Trilinos\+Aztec\+O\+O\+Solver} is an {\ttfamily Iterative\+Linear\+Solver} wrapper to the \href{http://trilinos.sandia.gov/packages/aztecoo}{\texttt{ {\ttfamily Trilinos Aztec\+OO}}} package implementation of distributed Krylov methods including CG, G\+M\+R\+ES and Bi\+C\+G\+Stab.
\item {\ttfamily Trilinos\+M\+L\+Preconditioner} is a wrapper to the distributed \href{http://trilinos.sandia.gov/packages/ml}{\texttt{ Trilinos ML A\+MG preconditioners}}.
\item {\ttfamily Trilinos\+I\+F\+P\+A\+C\+K\+Preconditioner} is a wrapper to the distributed \href{http://trilinos.sandia.gov/packages/ifpack}{\texttt{ Trilinos I\+F\+P\+A\+CK preconditioners}}.
\item {\ttfamily Hypre\+Preconditioner} is a wrapper to the distributed \href{https://computation.llnl.gov/casc/linear_solvers/sls_hypre.html}{\texttt{ {\ttfamily Hypre Scalable Linear Solvers}}} package, of particular interest is the classical A\+MG implementation {\ttfamily Boomer\+A\+MG}.
...
\DoxyCodeLine{  \mbox{\hyperlink{distributed__linear__algebra__infrastructure_8txt_a03654fcd0f1ae9cac59686ccb27bd720}{distributed}}=\textcolor{keyword}{false};}
\DoxyCodeLine{  LinearAlgebraDistribution locally\_replicated\_distribution\_for\_jac(}
\DoxyCodeLine{   comm\_pt,problem.ndof(),\mbox{\hyperlink{distributed__linear__algebra__infrastructure_8txt_a03654fcd0f1ae9cac59686ccb27bd720}{distributed}});}
\DoxyCodeLine{  }
\DoxyCodeLine{  \textcolor{comment}{// Show us how many rows this processor holds}}
\DoxyCodeLine{  oomph\_info }
