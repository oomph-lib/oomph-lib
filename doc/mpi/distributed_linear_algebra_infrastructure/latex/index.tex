...
\begin{DoxyItemize}
\item A {\ttfamily CRDouble\+Matrix} can have no distribution or coefficients in which case {\ttfamily my\+\_\+matrix-\/$>$distribution\+\_\+built()} and {\ttfamily my\+\_\+matrix-\/$>$built()} are both {\ttfamily false}.
