...
\DoxyHorRuler{0}
\hypertarget{index_fsi_channel_with_leaflet}{}\doxysection{Revisiting the F\+S\+I channel with leaflet problem}\label{index_fsi_channel_with_leaflet}
...
\DoxyCodeLine{   \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_aceac2d137312489e7a8df95ead17ee0f}{problem}}.distribute(report\_stats);}
...
Similar examples of modified driver codes for F\+SI problems for a channel with a collapsible wall and an oscillating ring can be found in \begin{center} \href{../../../../demo_drivers/mpi/multi_domain/}{\texttt{ demo\+\_\+drivers/mpi/multi\+\_\+domain }} \end{center} 
