...
In the present problem we overload the functions {\ttfamily Problem\+::actions\+\_\+before\+\_\+distribute()} and {\ttfamily Problem\+::actions\+\_\+after\+\_\+distribute()} to perform the same functions as {\ttfamily actions\+\_\+before\+\_\+adapt()} (i.\+e. delete the flux elements) and {\ttfamily actions\+\_\+after\+\_\+adapt()} (i.\+e. re-\/attach the flux elements). ~\newline
 We note that any {\ttfamily Face\+Element} that is attached to a halo element in the bulk mesh becomes a halo element itself; see the \href{../../general_mpi/html/index.html\#face_elements}{\texttt{ general M\+PI tutorial}} for further details.
...
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Actions before distribute: Wipe the mesh of prescribed flux elements}}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Actions after distribute: Rebuild the mesh of prescribed flux }}
