...
For generality, we implement the mathematics to assemble contributions to the Jacobian and mass matrices defined above in the class {\ttfamily \doxylink{classComplexHarmonicEquations}{Complex\+Harmonic\+Equations}} that inherits from {\ttfamily Finite\+Element}.

 
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{comment}{///\ A\ class\ for\ all\ elements\ that\ solve\ the\ eigenvalue\ problem}}
\DoxyCodeLine{\textcolor{comment}{///\ \(\backslash\)f[\ \ \(\backslash\)frac\{\(\backslash\)partial\ w\}\{\(\backslash\)partial\ x\}\ \ =\ \(\backslash\)lambda\ u\ \(\backslash\)f]}\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{///\ \(\backslash\)f[\ \(\backslash\)frac\{\(\backslash\)partial\ u\}\{\(\backslash\)partial\ x\}\ =\ (\(\backslash\)lambda\ -\/\ \(\backslash\)mu)\ w\ \(\backslash\)f]}}
...
The shape functions are specified in the {\ttfamily \doxylink{classQComplexHarmonicElement}{QComplex\+Harmonic\+Element}} class that inherits from our standard one-\/dimensional Lagrange elements {\ttfamily QElement$<$1,\+NNODE\+\_\+1\+D$>$} as well as {\ttfamily \doxylink{classHarmonicEquations}{Harmonic\+Equations}}. The number of unknowns (two) is specified and the output functions and shape functions are overloaded as required\+: the output functions are specified in the {\ttfamily \doxylink{classComplexHarmonicEquations}{Complex\+Harmonic\+Equations}} class, whereas the shape functions are provided by the {\ttfamily QElement$<$1,\+NNODE\+\_\+1\+D$>$} class.
