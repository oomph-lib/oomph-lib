...
For generality, we implement the mathematics to assemble contributions to the Jacobian and mass matrices defined above in the class {\ttfamily \mbox{\hyperlink{classComplexHarmonicEquations}{Complex\+Harmonic\+Equations}}} that inherits from {\ttfamily Finite\+Element}.
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)frac\{\(\backslash\)partial w\}\{\(\backslash\)partial x\}  = \(\backslash\)lambda u}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)f] }}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)f[}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)frac\{\(\backslash\)partial u\}\{\(\backslash\)partial x\} = (\(\backslash\)lambda -\/ \(\backslash\)mu) w}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)f]}}
...
\DoxyCodeLine{\textcolor{keyword}{class }\mbox{\hyperlink{classComplexHarmonicEquations}{ComplexHarmonicEquations}} : \textcolor{keyword}{public} \textcolor{keyword}{virtual} FiniteElement}
\DoxyCodeLine{\{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{public}:\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// Empty Constructor}}
\DoxyCodeLine{\textcolor{comment}{} \mbox{\hyperlink{classComplexHarmonicEquations_aa93feb265f731b0d82c3c1c4c29f183d}{ComplexHarmonicEquations}}() \{\}}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Access function: First eigenfunction value at local node n}}
\DoxyCodeLine{\textcolor{comment}{ /// Note that solving the eigenproblem does not assign values}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{ /// to this storage space. It is used for output purposes only.}}
...
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Second eigenfunction value at local node n}}
...
The shape functions are specified in the {\ttfamily \mbox{\hyperlink{classQComplexHarmonicElement}{Q\+Complex\+Harmonic\+Element}}} class that inherits from our standard one-\/dimensional Lagrange elements {\ttfamily Q\+Element$<$1,\+N\+N\+O\+D\+E\+\_\+1\+D$>$} as well as {\ttfamily \mbox{\hyperlink{classHarmonicEquations}{Harmonic\+Equations}}}. The number of unknowns (two) is specified and the output functions and shape functions are overloaded as required\+: the output functions are specified in the {\ttfamily \mbox{\hyperlink{classComplexHarmonicEquations}{Complex\+Harmonic\+Equations}}} class, whereas the shape functions are provided by the {\ttfamily Q\+Element$<$1,\+N\+N\+O\+D\+E\+\_\+1\+D$>$} class.
...
\DoxyCodeLine{                         \textcolor{keyword}{public} \mbox{\hyperlink{classComplexHarmonicEquations}{ComplexHarmonicEquations}}}
\DoxyCodeLine{\{}
\DoxyCodeLine{ }
...
\DoxyCodeLine{                             \mbox{\hyperlink{classComplexHarmonicEquations}{ComplexHarmonicEquations}}() \{\}}
\DoxyCodeLine{\textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Output function overloaded from ComplexHarmonicEquations}}
...
\DoxyCodeLine{  \{\mbox{\hyperlink{classComplexHarmonicEquations_a9185e07b984e735c1c45b6f5a6c02b5f}{ComplexHarmonicEquations::output}}(outfile);\}}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ ///  \(\backslash\)short Output function overloaded from ComplexHarmonicEquations}}
...
\DoxyCodeLine{  \{\mbox{\hyperlink{classComplexHarmonicEquations_a9185e07b984e735c1c45b6f5a6c02b5f}{ComplexHarmonicEquations::output}}(outfile,Nplot);\}}
\DoxyCodeLine{}
\DoxyCodeLine{}
