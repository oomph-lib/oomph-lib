...
The test cases F\+S\+I2 and F\+S\+I3 are the most interesting because the system develops large-\/amplitude self-\/excited oscillations\hypertarget{index_fsi2_results}{}\doxysubsection{F\+S\+I2}\label{index_fsi2_results}
...
\end{DoxyImage}
\hypertarget{index_fsi3_results}{}\doxysubsection{F\+S\+I3}\label{index_fsi3_results}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Product of Reynolds and Strouhal numbers (default}}
...
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Density ratio (solid to fluid; default assignment for FSI1}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Timescale ratio for solid (dependent parameter}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Flux increases between Min\_flux and Max\_flux over }}
\DoxyCodeLine{\textcolor{comment}{ /// period Ramp\_period}}
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{double} \mbox{\hyperlink{namespaceGlobal__Parameters_a536aa5314a6cdb36af852e9513351d55}{flux}}(\textcolor{keyword}{const} \textcolor{keywordtype}{double}\& \mbox{\hyperlink{turek__flag_8txt_a0e13eaa7c5f7694e71118ba0687a09ec}{t}})}
\DoxyCodeLine{ \{    }
\DoxyCodeLine{  \textcolor{keywordflow}{if} (\mbox{\hyperlink{turek__flag_8txt_a0e13eaa7c5f7694e71118ba0687a09ec}{t}}<\mbox{\hyperlink{namespaceGlobal__Parameters_af6afcca0b1ffdf88144f99cdfed18d3b}{Ramp\_period}})}
\DoxyCodeLine{   \{}
...
\DoxyCodeLine{     0.5*(1.0-\/cos(MathematicalConstants::Pi*\mbox{\hyperlink{turek__flag_8txt_a0e13eaa7c5f7694e71118ba0687a09ec}{t}}/\mbox{\hyperlink{namespaceGlobal__Parameters_af6afcca0b1ffdf88144f99cdfed18d3b}{Ramp\_period}}));}
\DoxyCodeLine{   \}}
...
\DoxyCodeLine{  RefineableQPVDElement<2,3> > \mbox{\hyperlink{turek__flag_8txt_a8862c1c10f896d09569de1c3c2454432}{problem}}(length, height);}
...
\DoxyCodeLine{ \mbox{\hyperlink{turek__flag_8txt_a8862c1c10f896d09569de1c3c2454432}{problem}}.initialise\_dt(dt);}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Impulsive start}}
\DoxyCodeLine{ \mbox{\hyperlink{turek__flag_8txt_a8862c1c10f896d09569de1c3c2454432}{problem}}.assign\_initial\_values\_impulsive(dt);}
...
\DoxyCodeLine{ \mbox{\hyperlink{turek__flag_8txt_a8862c1c10f896d09569de1c3c2454432}{problem}}.doc\_solution(doc\_info,trace\_file);}
...
\DoxyCodeLine{  \mbox{\hyperlink{turek__flag_8txt_a8862c1c10f896d09569de1c3c2454432}{problem}}.unsteady\_newton\_solve(dt,max\_adapt,first); }
\DoxyCodeLine{  }
...
The {\ttfamily Problem} class contains the usual member functions, such as access functions to the various meshes. Because the nodal positions are updated by an algebraic node-\/update procedure, the function {\ttfamily \mbox{\hyperlink{turek__flag_8txt_a85a69cc532853b0453e0269031f79916}{actions\+\_\+before\+\_\+newton\+\_\+convergence\+\_\+check()}}} is employed to update the nodal positions in response to changes in the (solid) variables during the Newton iteration. The function {\ttfamily actions\+\_\+before\+\_\+implicit\+\_\+timestep()} is used to adjust the influx during the start-\/up period.
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Constructor: Pass length and height of domain}}
...
\DoxyCodeLine{\textcolor{comment}{} RefineableAlgebraicCylinderWithFlagMesh<FLUID\_ELEMENT>* \mbox{\hyperlink{classTurekProblem_a0fc23b86efec256cb7f4450a928f7999}{fluid\_mesh\_pt}}() }
...
\DoxyCodeLine{\textcolor{comment}{} ElasticRefineableRectangularQuadMesh<SOLID\_ELEMENT>*\& \mbox{\hyperlink{classTurekProblem_a89430ae6d87a85a83e23e14e0b0d72b7}{solid\_mesh\_pt}}() }
...
\DoxyCodeLine{\textcolor{comment}{} SolidMesh*\& \mbox{\hyperlink{classTurekProblem_a93a4b3d4e598a499631e00cfa701ee3c}{traction\_mesh\_pt}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned}\& i)}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Update the (dependent) fluid node positions following the}}
...
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} \mbox{\hyperlink{turek__flag_8txt_ab5a60b1de123a99846307cf3f4186828}{n\_x}}=20;}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// \# of elements in y-\/direction}}
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} \mbox{\hyperlink{turek__flag_8txt_a3d22db0f01d59531ccaa6b87399f0c4a}{n\_y}}=2;}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Domain length in y-\/direction }}
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{turek__flag_8txt_a8180485ff9e17af08ccc3181366d29de}{l\_y}}=\mbox{\hyperlink{namespaceGlobal__Parameters_ab360628e7830e43e355ce5768f6d6a6c}{Global\_Parameters::H}};}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Create the flag timestepper (consistent with BDF<2> for fluid)}}
\DoxyCodeLine{ Newmark<2>* \mbox{\hyperlink{turek__flag_8txt_a838b1a75bbaf13e686d961357717334e}{flag\_time\_stepper\_pt}}=\textcolor{keyword}{new} Newmark<2>;}
\DoxyCodeLine{ add\_time\_stepper\_pt(\mbox{\hyperlink{turek__flag_8txt_a838b1a75bbaf13e686d961357717334e}{flag\_time\_stepper\_pt}}); }
\DoxyCodeLine{\textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{} Vector<double> \mbox{\hyperlink{turek__flag_8txt_abe136565f9a9a75ef3a0b95f7d5aa38c}{origin}}(2);}
\DoxyCodeLine{ \mbox{\hyperlink{turek__flag_8txt_abe136565f9a9a75ef3a0b95f7d5aa38c}{origin}}[0]=\mbox{\hyperlink{namespaceGlobal__Parameters_a0f0247cc83ba202413b50e7b4b7fceb0}{Global\_Parameters::Centre\_x}}+}
...
\DoxyCodeLine{ \mbox{\hyperlink{turek__flag_8txt_abe136565f9a9a75ef3a0b95f7d5aa38c}{origin}}[1]=\mbox{\hyperlink{namespaceGlobal__Parameters_af41282d812fdff4867e3d8c825886290}{Global\_Parameters::Centre\_y}}-\/0.5*\mbox{\hyperlink{turek__flag_8txt_a8180485ff9e17af08ccc3181366d29de}{l\_y}};}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{turek__flag_8txt_a30dbfe80a1da9c57dc1989f42ca2a3a1}{l\_x}}=6.0-\/\mbox{\hyperlink{turek__flag_8txt_abe136565f9a9a75ef3a0b95f7d5aa38c}{origin}}[0];}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{//Now create the mesh}}
\DoxyCodeLine{ \mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}() = \textcolor{keyword}{new} ElasticRefineableRectangularQuadMesh<SOLID\_ELEMENT>(}
\DoxyCodeLine{  \mbox{\hyperlink{turek__flag_8txt_ab5a60b1de123a99846307cf3f4186828}{n\_x}},\mbox{\hyperlink{turek__flag_8txt_a3d22db0f01d59531ccaa6b87399f0c4a}{n\_y}},\mbox{\hyperlink{turek__flag_8txt_a30dbfe80a1da9c57dc1989f42ca2a3a1}{l\_x}},\mbox{\hyperlink{turek__flag_8txt_a8180485ff9e17af08ccc3181366d29de}{l\_y}},\mbox{\hyperlink{turek__flag_8txt_abe136565f9a9a75ef3a0b95f7d5aa38c}{origin}},\mbox{\hyperlink{turek__flag_8txt_a838b1a75bbaf13e686d961357717334e}{flag\_time\_stepper\_pt}});}
...
\DoxyCodeLine{ \mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>spatial\_error\_estimator\_pt()=solid\_error\_estimator\_pt;}
\DoxyCodeLine{}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Element that contains the control point}}
\DoxyCodeLine{ FiniteElement* el\_pt=\mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>finite\_element\_pt(\mbox{\hyperlink{turek__flag_8txt_ab5a60b1de123a99846307cf3f4186828}{n\_x}}*\mbox{\hyperlink{turek__flag_8txt_a3d22db0f01d59531ccaa6b87399f0c4a}{n\_y}}/2-\/1);}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>refine\_uniformly();}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{//Do not allow the solid mesh to be refined again}}
\DoxyCodeLine{ \mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>disable\_adaptation();}
...
\DoxyCodeLine{   \mbox{\hyperlink{turek__flag_8txt_a30dbfe80a1da9c57dc1989f42ca2a3a1}{l\_x}},\mbox{\hyperlink{namespaceGlobal__Parameters_ab360628e7830e43e355ce5768f6d6a6c}{Global\_Parameters::H}},}
...
\DoxyCodeLine{ add\_sub\_mesh(\mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}());}
\DoxyCodeLine{}
...
\DoxyCodeLine{ }
\DoxyCodeLine{ \textcolor{comment}{// Build combined "global" mesh}}
\DoxyCodeLine{ \mbox{\hyperlink{turek__flag_8txt_a1b26656bb9ec986a1e2e78eca382269a}{build\_global\_mesh}}();}
...
\DoxyCodeLine{  \{}
\DoxyCodeLine{   \mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>boundary\_node\_pt(3,i)-\/>pin\_position(0);}
\DoxyCodeLine{   \mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>boundary\_node\_pt(3,i)-\/>pin\_position(1);}
\DoxyCodeLine{  \}}
\DoxyCodeLine{ }
...
\DoxyCodeLine{  \mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>element\_pt());}
...
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{turek__flag_8txt_a0e13eaa7c5f7694e71118ba0687a09ec}{t}}=0.0;}
\DoxyCodeLine{ \textcolor{keywordtype}{double} ampl=\mbox{\hyperlink{namespaceGlobal__Parameters_a536aa5314a6cdb36af852e9513351d55}{Global\_Parameters::flux}}(\mbox{\hyperlink{turek__flag_8txt_a0e13eaa7c5f7694e71118ba0687a09ec}{t}});}
...
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned}  n\_element =\mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>nelement();}
...
\DoxyCodeLine{    \mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>element\_pt(i));}
\DoxyCodeLine{   }
...
\DoxyCodeLine{ FSI\_functions::Strouhal\_for\_no\_slip=\mbox{\hyperlink{namespaceGlobal__Parameters_af1af40a0df651e86bc1be273fafa98da}{Global\_Parameters::St}};}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \textcolor{keywordflow}{if} (!\mbox{\hyperlink{namespaceGlobal__Parameters_aac13d615d2acd78d22a3137ffd62f7aa}{Global\_Parameters::Ignore\_fluid\_loading}})}
\DoxyCodeLine{  \{}
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_set_traction}{}\doxysection{Create traction elements}\label{index_set_traction}
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//=======================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} FLUID\_ELEMENT,\textcolor{keyword}{class} SOLID\_ELEMENT >}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{classTurekProblem_ad460a2e860c9425297cf70ee125de10b}{TurekProblem<FLUID\_ELEMENT,SOLID\_ELEMENT>::create\_fsi\_traction\_elements}}()}
\DoxyCodeLine{\{}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Container to collect all nodes in the traction meshes}}
\DoxyCodeLine{ std::set<SolidNode*> all\_nodes;}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Traction elements are located on boundaries 0-\/2:}}
...
\DoxyCodeLine{   \textcolor{keywordtype}{unsigned} n\_element = \mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>nboundary\_element(b);}
\DoxyCodeLine{   }
...
\DoxyCodeLine{      \mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>boundary\_element\_pt(b,e));}
\DoxyCodeLine{     }
\DoxyCodeLine{     \textcolor{comment}{//What is the index of the face of the element e along boundary b}}
\DoxyCodeLine{     \textcolor{keywordtype}{int} face\_index = \mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>face\_index\_at\_boundary(b,e);}
\DoxyCodeLine{          }
\DoxyCodeLine{     \textcolor{comment}{// Create new element and add to mesh}}
\DoxyCodeLine{     Traction\_mesh\_pt[b]-\/>add\_element\_pt(}
...
\DoxyCodeLine{}
\DoxyCodeLine{   \textcolor{comment}{// Identify unique nodes}}
\DoxyCodeLine{   \textcolor{keywordtype}{unsigned} nnod=\mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>nboundary\_node(b);}
\DoxyCodeLine{   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} j=0;j<nnod;j++)}
\DoxyCodeLine{    \{}
\DoxyCodeLine{     all\_nodes.insert(\mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>boundary\_node\_pt(b,j));}
\DoxyCodeLine{    \}}
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Build combined mesh of fsi traction elements}}
\DoxyCodeLine{ Combined\_traction\_mesh\_pt=\textcolor{keyword}{new} SolidMesh(Traction\_mesh\_pt);}
\DoxyCodeLine{ }
\DoxyCodeLine{ \textcolor{comment}{// Stick nodes into combined traction mesh}}
\DoxyCodeLine{ \textcolor{keywordflow}{for} (std::set<SolidNode*>::iterator it=all\_nodes.begin();}
\DoxyCodeLine{      it!=all\_nodes.end();it++)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   Combined\_traction\_mesh\_pt-\/>add\_node\_pt(*it);}
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
 \hypertarget{index_check}{}\doxysection{Actions before Newton convergence check}\label{index_check}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{comment}{//====start\_of\_actions\_before\_newton\_convergence\_check===================}}
\DoxyCodeLine{\textcolor{comment}{/// Update the (dependent) fluid node positions following the}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// update of the solid variables}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//=======================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{class} FLUID\_ELEMENT,\textcolor{keyword}{class} SOLID\_ELEMENT> }
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{classTurekProblem_aa896171b1a817ca35cba9b723bb15ed2}{TurekProblem<FLUID\_ELEMENT,SOLID\_ELEMENT>}}}
\DoxyCodeLine{\mbox{\hyperlink{classTurekProblem_aa896171b1a817ca35cba9b723bb15ed2}{::actions\_before\_newton\_convergence\_check}} ()}
\DoxyCodeLine{\{}
...
\DoxyCodeLine{\textcolor{comment}{/// Actions before implicit timestep: Update inflow profile}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//========================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{class} FLUID\_ELEMENT,\textcolor{keyword}{class} SOLID\_ELEMENT> }
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{classTurekProblem_a4ad226ceec27cb3c3ea4d1ecfd4e573f}{TurekProblem<FLUID\_ELEMENT,SOLID\_ELEMENT>::}}}
\DoxyCodeLine{\mbox{\hyperlink{classTurekProblem_a4ad226ceec27cb3c3ea4d1ecfd4e573f}{actions\_before\_implicit\_timestep}}()}
\DoxyCodeLine{\{}
\DoxyCodeLine{ \textcolor{comment}{// Current time}}
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{turek__flag_8txt_a0e13eaa7c5f7694e71118ba0687a09ec}{t}}=time\_pt()-\/>time();}
\DoxyCodeLine{ }
...
After each adaptation, we unpin and re-\/pin all redundant pressures degrees of freedom. This is necessary because their \char`\"{}redundant-\/ness\char`\"{} may have been altered by changes in the refinement pattern; see \href{../../../navier_stokes/adaptive_driven_cavity/html/index.html}{\texttt{ another tutorial}} for details. We ensure the automatic application of the no-\/slip condition on fluid nodes that are located on the faces of the flag, and re-\/setup the F\+SI lookup scheme that tells {\ttfamily F\+S\+I\+Solid\+Traction\+Elements} which fluid elements are located next to their Gauss points.


\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{comment}{//=====================start\_of\_actions\_after\_adapt=======================}}
\DoxyCodeLine{\textcolor{comment}{///  Actions after adapt: Re-\/setup FSI}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//========================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} FLUID\_ELEMENT,\textcolor{keyword}{class} SOLID\_ELEMENT >}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{classTurekProblem_a39df0332d7606a5befe89bb0e581184b}{TurekProblem<FLUID\_ELEMENT,SOLID\_ELEMENT>::actions\_after\_adapt}}()}
\DoxyCodeLine{\{}
...
\DoxyCodeLine{  pin\_redundant\_nodal\_pressures(fluid\_mesh\_pt()-\/>element\_pt());}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Unpin all solid pressure dofs}}
\DoxyCodeLine{ PVDEquationsBase<2>::}
\DoxyCodeLine{  unpin\_all\_solid\_pressure\_dofs(\mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>element\_pt());}
\DoxyCodeLine{ }
\DoxyCodeLine{ \textcolor{comment}{// Pin the redundant solid pressures (if any)}}
\DoxyCodeLine{ PVDEquationsBase<2>::pin\_redundant\_nodal\_solid\_pressures(}
\DoxyCodeLine{  \mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>element\_pt());}
...
The function {\ttfamily \mbox{\hyperlink{turek__flag_8txt_a3e655f3477ba01c404fe8257d4d9d0bc}{doc\+\_\+solution(...)}}} produces the output for the fluid, solid and traction meshes and writes selected data to the trace file.
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//==================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} FLUID\_ELEMENT,\textcolor{keyword}{class} SOLID\_ELEMENT >}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{classTurekProblem_a2cf0eb1610b4c3a7cdbd3c7948cdd46e}{TurekProblem<FLUID\_ELEMENT,SOLID\_ELEMENT>::doc\_solution}}(}
\DoxyCodeLine{ DocInfo\& doc\_info, ofstream\& trace\_file)}
\DoxyCodeLine{\{}
\DoxyCodeLine{ }
\DoxyCodeLine{\textcolor{comment}{//  FSI\_functions::doc\_fsi<AlgebraicNode>(Fluid\_mesh\_pt,}}
\DoxyCodeLine{\textcolor{comment}{//                                        Combined\_traction\_mesh\_pt,}}
\DoxyCodeLine{\textcolor{comment}{//                                        doc\_info);}}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \mbox{\hyperlink{turek__flag_8txt_acdd098bc82b9d35854b3a4959e4291f9}{solid\_mesh\_pt}}()-\/>output(some\_file,n\_plot);}
...
\DoxyCodeLine{         doc\_info.number());}
\DoxyCodeLine{ some\_file.open(filename);}
\DoxyCodeLine{ fluid\_mesh\_pt()-\/>output(some\_file,n\_plot);}
\DoxyCodeLine{ some\_file.close();}
\DoxyCodeLine{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//Output the traction}}
\DoxyCodeLine{ sprintf(filename,\textcolor{stringliteral}{"\%s/traction\%i.dat"},doc\_info.directory().c\_str(),}
\DoxyCodeLine{         doc\_info.number());}
\DoxyCodeLine{ some\_file.open(filename);}
\DoxyCodeLine{\textcolor{comment}{// Loop over the traction meshes}}
\DoxyCodeLine{ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} i=0;i<3;i++)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   \textcolor{comment}{// Loop over the element in traction\_mesh\_pt}}
\DoxyCodeLine{   \textcolor{keywordtype}{unsigned} n\_element = Traction\_mesh\_pt[i]-\/>nelement();}
\DoxyCodeLine{   \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} e=0;e<n\_element;e++)}
\DoxyCodeLine{    \{}
\DoxyCodeLine{     FSISolidTractionElement<SOLID\_ELEMENT,2>* el\_pt = }
\DoxyCodeLine{      \textcolor{keyword}{dynamic\_cast<}FSISolidTractionElement<SOLID\_ELEMENT,2>* \textcolor{keyword}{>} (}
\DoxyCodeLine{       Traction\_mesh\_pt[i]-\/>element\_pt(e) );}
\DoxyCodeLine{     }
\DoxyCodeLine{     el\_pt-\/>output(some\_file,5);}
\DoxyCodeLine{    \}}
\DoxyCodeLine{  \}}
\DoxyCodeLine{ some\_file.close();  }
\DoxyCodeLine{}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Write trace (we're only using Taylor Hood elements so we know that}}
\DoxyCodeLine{ \textcolor{comment}{// the pressure is the third value at the fluid control node...}}
\DoxyCodeLine{ trace\_file << time\_pt()-\/>time() << \textcolor{stringliteral}{" "} }
\DoxyCodeLine{            << Solid\_control\_node\_pt-\/>x(0) << \textcolor{stringliteral}{" "} }
\DoxyCodeLine{            << Solid\_control\_node\_pt-\/>x(1) << \textcolor{stringliteral}{" "} }
\DoxyCodeLine{            << Fluid\_control\_node\_pt-\/>value(2) << \textcolor{stringliteral}{" "}}
\DoxyCodeLine{            << \mbox{\hyperlink{namespaceGlobal__Parameters_a536aa5314a6cdb36af852e9513351d55}{Global\_Parameters::flux}}(time\_pt()-\/>time()) << \textcolor{stringliteral}{" "} }
\DoxyCodeLine{            << std::endl;}
\DoxyCodeLine{ }
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_com_ex}{}\doxysection{Further comments and exercises}\label{index_com_ex}
...
~\newline
\begin{center} \href{../../../../demo_drivers/interaction/turek_flag/}{\texttt{ demo\+\_\+drivers/interaction/turek\+\_\+flag/ }} \end{center} ~\newline

\item The driver code is\+: ~\newline
~\newline
\begin{center} \href{../../../../demo_drivers/interaction/turek_flag/turek_flag.cc}{\texttt{ demo\+\_\+drivers/interaction/turek\+\_\+flag/turek\+\_\+flag.\+cc }} \end{center} 
\end{DoxyItemize}
