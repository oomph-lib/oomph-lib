...
\hypertarget{index_mesh}{}\doxysubsection{Macro\+Element-\/based (fluid-\/)node updates in F\+S\+I problems}\label{index_mesh}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{class }MeshAsGeomObject : \textcolor{keyword}{public} \mbox{\hyperlink{fsi__collapsible__channel_8txt_a95e2f1f681ceb4155d4f08b9da6c126b}{GeomObject}}}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{Vector<double> \mbox{\hyperlink{fsi__collapsible__channel_8txt_a1ba69e044238a99bd109e3158404a5bb}{xi}}(1);}
\DoxyCodeLine{\mbox{\hyperlink{fsi__collapsible__channel_8txt_a1ba69e044238a99bd109e3158404a5bb}{xi}}[0]=0.5;}
\DoxyCodeLine{Vector<double> \mbox{\hyperlink{fsi__collapsible__channel_8txt_a8e7e207ad7181df3307ddb31d62de767}{r}}(2);}
\DoxyCodeLine{wall\_geom\_object-\/>position(\mbox{\hyperlink{fsi__collapsible__channel_8txt_a1ba69e044238a99bd109e3158404a5bb}{xi}},\mbox{\hyperlink{fsi__collapsible__channel_8txt_a8e7e207ad7181df3307ddb31d62de767}{r}});}
\end{DoxyCode}
...
\DoxyHorRuler{0}
\hypertarget{index_fsi_wall_elements}{}\doxysubsection{Applying the fluid-\/traction to the wall elements\+: F\+S\+I\+Wall\+Elements}\label{index_fsi_wall_elements}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{class }FSIWallElement : \textcolor{keyword}{public} \textcolor{keyword}{virtual} \mbox{\hyperlink{fsi__collapsible__channel_8txt_af6d619a456e67f879350b1c9ca9c17b2}{SolidFiniteElement}}, }
...
The {\ttfamily Element\+With\+External\+Element} class provides the generic storage and helper functions required to keep track of the external elements that are adjacent to Gauss points in any {\ttfamily Finite\+Element}, see also the tutorial on \href{../../../multi_physics/multi_domain_ref_b_convect/html/index.html}{\texttt{ Boussinesq convection with a multi-\/domain approach. }} In the {\ttfamily F\+S\+I\+Wall\+Element}, it is the fluid elements that load the structure which are adjacent to the Gauss points. The various lookup schemes required to determine these fluid elements may be generated completely automatically by the helper function
...
\DoxyCodeLine{     \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&\mbox{\hyperlink{fsi__collapsible__channel_8txt_a3b46a8855e723be62480f97b105e8569}{boundary\_in\_fluid\_mesh}},}
...
\end{DoxyCode}
\hypertarget{index_fsi_fluid_elements}{}\doxysubsubsection{Obtaining the fluid traction from \char`\"{}adjacent\char`\"{} fluid elements\+: F\+S\+I\+Fluid\+Elements}\label{index_fsi_fluid_elements}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Load function: Apply a constant external pressure to the wall.}}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Fluid structure interaction parameter: Ratio of stresses used for}}
\DoxyCodeLine{\textcolor{comment}{ /// non-\/dimensionalisation of fluid to solid stresses. }}
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{double} \mbox{\hyperlink{fsi__collapsible__channel_8txt_ac2e59f25d9b074b519b847bd5d5aeede}{Q}}=1.0e-\/5;}
\DoxyCodeLine{}
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//=========================================================================}}
\DoxyCodeLine{\textcolor{keyword}{class }\mbox{\hyperlink{classUndeformedWall}{UndeformedWall}} : \textcolor{keyword}{public} \mbox{\hyperlink{fsi__collapsible__channel_8txt_a95e2f1f681ceb4155d4f08b9da6c126b}{GeomObject}}}
\DoxyCodeLine{\{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{public}:}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Constructor: arguments are the starting point and the height}}
\DoxyCodeLine{\textcolor{comment}{ /// above y=0.}}
\DoxyCodeLine{\textcolor{comment}{} \mbox{\hyperlink{classUndeformedWall_ad09cfdcd234be0ab47eb97a8a470602a}{UndeformedWall}}(\textcolor{keyword}{const} \textcolor{keywordtype}{double}\& x0, \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& h): \mbox{\hyperlink{fsi__collapsible__channel_8txt_a95e2f1f681ceb4155d4f08b9da6c126b}{GeomObject}}(1,2)}
\DoxyCodeLine{  \{}
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{void} \mbox{\hyperlink{fsi__collapsible__channel_8txt_a2cef67ccba3b1a5328862c09ef7c6cd8}{position}}(\textcolor{keyword}{const} Vector<double>\& zeta, Vector<double>\& \mbox{\hyperlink{fsi__collapsible__channel_8txt_a8e7e207ad7181df3307ddb31d62de767}{r}})\textcolor{keyword}{ const}}
\DoxyCodeLine{\textcolor{keyword}{  }\{}
\DoxyCodeLine{   \textcolor{comment}{// Position Vector}}
\DoxyCodeLine{   \mbox{\hyperlink{fsi__collapsible__channel_8txt_a8e7e207ad7181df3307ddb31d62de767}{r}}[0] = zeta[0]+X0;}
\DoxyCodeLine{   \mbox{\hyperlink{fsi__collapsible__channel_8txt_a8e7e207ad7181df3307ddb31d62de767}{r}}[1] = \mbox{\hyperlink{namespaceGlobal__Physical__Variables_af6e07423e22c0991084d9a2f43727805}{H}};}
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{void} \mbox{\hyperlink{fsi__collapsible__channel_8txt_a2cef67ccba3b1a5328862c09ef7c6cd8}{position}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned}\& t, \textcolor{keyword}{const} Vector<double>\& zeta,}
\DoxyCodeLine{               Vector<double>\& \mbox{\hyperlink{fsi__collapsible__channel_8txt_a8e7e207ad7181df3307ddb31d62de767}{r}})\textcolor{keyword}{ const}}
\DoxyCodeLine{\textcolor{keyword}{  }\{}
\DoxyCodeLine{   \textcolor{comment}{// Use the steady version}}
\DoxyCodeLine{   \mbox{\hyperlink{fsi__collapsible__channel_8txt_a2cef67ccba3b1a5328862c09ef7c6cd8}{position}}(zeta,\mbox{\hyperlink{fsi__collapsible__channel_8txt_a8e7e207ad7181df3307ddb31d62de767}{r}});}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Posn vector and its  1st \& 2nd derivatives}}
...
\DoxyCodeLine{                 Vector<double>\& \mbox{\hyperlink{fsi__collapsible__channel_8txt_a8e7e207ad7181df3307ddb31d62de767}{r}},}
...
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{fsi__collapsible__channel_8txt_a86c04ce7cdf31c01242f4278927def58}{ly}}=1.0;}
...
\DoxyCodeLine{  \mbox{\hyperlink{fsi__collapsible__channel_8txt_ad8007cc2dbef4f33f47302bac269c745}{problem}}(nup, ncollapsible, ndown, ny, }
\DoxyCodeLine{          lup, lcollapsible, ldown, \mbox{\hyperlink{fsi__collapsible__channel_8txt_a86c04ce7cdf31c01242f4278927def58}{ly}});}
...
\DoxyCodeLine{ \mbox{\hyperlink{fsi__collapsible__channel_8txt_ad8007cc2dbef4f33f47302bac269c745}{problem}}.time\_pt()-\/>time()=t\_min;}
\DoxyCodeLine{ \mbox{\hyperlink{fsi__collapsible__channel_8txt_ad8007cc2dbef4f33f47302bac269c745}{problem}}.initialise\_dt(dt);}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Apply initial condition}}
\DoxyCodeLine{ \mbox{\hyperlink{fsi__collapsible__channel_8txt_ad8007cc2dbef4f33f47302bac269c745}{problem}}.set\_initial\_condition();}
...
\DoxyCodeLine{ \mbox{\hyperlink{fsi__collapsible__channel_8txt_ad8007cc2dbef4f33f47302bac269c745}{problem}}.doc\_solution(doc\_info, trace\_file);}
\DoxyCodeLine{}
...
\DoxyCodeLine{   \mbox{\hyperlink{fsi__collapsible__channel_8txt_ad8007cc2dbef4f33f47302bac269c745}{problem}}.unsteady\_newton\_solve(dt);}
\DoxyCodeLine{   }
...
\DoxyCodeLine{ public :}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Constructor: The arguments are the number of elements and}}
...
\DoxyCodeLine{                       \textcolor{keyword}{const} \textcolor{keywordtype}{double}\& \mbox{\hyperlink{fsi__collapsible__channel_8txt_a86c04ce7cdf31c01242f4278927def58}{ly}});}
\DoxyCodeLine{ \textcolor{comment}{}}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{  \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Update before checking Newton convergence: Update the}}
...
The functions {\ttfamily \mbox{\hyperlink{fsi__collapsible__channel_8txt_a5bd739ada31f2426bbb015fb7fd4bcb1}{doc\+\_\+solution(...)}}} and {\ttfamily set\+\_\+initial\+\_\+condition()} do what they always do.


\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// Doc the solution}}
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{void} \mbox{\hyperlink{fsi__collapsible__channel_8txt_a5bd739ada31f2426bbb015fb7fd4bcb1}{doc\_solution}}(DocInfo\& doc\_info,ofstream\& trace\_file);}
\DoxyCodeLine{ \textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Number of elements in the x direction in the collapsible part of }}
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{double} \mbox{\hyperlink{fsi__collapsible__channel_8txt_a662e1bd37bd31188f0d8539376e0efa3}{Ly}};}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Pointer to the "surface" mesh that applies the traction at the}}
...
\DoxyCodeLine{ \mbox{\hyperlink{fsi__collapsible__channel_8txt_a662e1bd37bd31188f0d8539376e0efa3}{Ly}}=\mbox{\hyperlink{fsi__collapsible__channel_8txt_a86c04ce7cdf31c01242f4278927def58}{ly}};}
...
The wall mesh is built as in the corresponding \href{../../../beam/tensioned_string/html/index.html}{\texttt{ single-\/physics beam problem\+:}} We create the {\ttfamily Geom\+Object} that describes the undeformed wall shape and construct the wall mesh, this time with {\ttfamily F\+S\+I\+Hermite\+Beam\+Elements\+:} 
...
\DoxyCodeLine{ \mbox{\hyperlink{classUndeformedWall}{UndeformedWall}}* undeformed\_wall\_pt=\textcolor{keyword}{new} \mbox{\hyperlink{classUndeformedWall}{UndeformedWall}}(lup,\mbox{\hyperlink{fsi__collapsible__channel_8txt_a86c04ce7cdf31c01242f4278927def58}{ly}});}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \mbox{\hyperlink{fsi__collapsible__channel_8txt_afdb2b285ad5378948a0bde34c38e6466}{build\_global\_mesh}}();}
...
The function {\ttfamily \mbox{\hyperlink{fsi__collapsible__channel_8txt_a5bd739ada31f2426bbb015fb7fd4bcb1}{doc\+\_\+solution(...)}}} outputs the velocity and wall displacement fields and records the time-\/trace of the axial velocity at the control nodes and the position of the wall\textquotesingle{}s midpoint. The function {\ttfamily F\+S\+I\+\_\+functions\+::doc\+\_\+fsi(...)} is a helper function that can be used to document/validate the various F\+SI lookup schemes; see \mbox{\hyperlink{index_comments_and_ex}{Comments and Exercises}} for an illustration of their output.
...
\item In section \mbox{\hyperlink{index_fsi_wall_elements}{Applying the fluid-\/traction to the wall elements\+: F\+S\+I\+Wall\+Elements}} we mentioned that the function {\ttfamily F\+S\+I\+\_\+functions\+::setup\+\_\+fluid\+\_\+load\+\_\+info\+\_\+for\+\_\+solid\+\_\+elements(...)} assumes that the fluid nodes on the F\+SI boundary store the boundary coordinate. Investigate what happens if this step is omitted, e.\+g. by commenting out the assignment of boundary coordinates with {\ttfamily Node\+::set\+\_\+coordinates\+\_\+on\+\_\+boundary(...)} in \href{../../../../src/meshes/collapsible_channel_mesh.template.cc}{\texttt{ collapsible\+\_\+channel\+\_\+mesh.\+template.\+cc}}.
