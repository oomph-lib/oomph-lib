...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keywordtype}{double} \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a5b052db3a93fe3ee2945af0117375d3d}{Q}}=1.0e-\/6;}
...
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Flux: Pulsatile flow fluctuating between Min\_flux and Max\_flux }}
...
\DoxyCodeLine{  \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_abbb977d4712081610d3fbcc3962207ea}{problem}}(lleft,lright,hleaflet,}
...
\DoxyCodeLine{ \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_abbb977d4712081610d3fbcc3962207ea}{problem}}.initialise\_dt(dt);}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Doc initial guess for steady solve}}
\DoxyCodeLine{ \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_abbb977d4712081610d3fbcc3962207ea}{problem}}.doc\_solution(doc\_info,trace);}
...
\DoxyCodeLine{   \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_abbb977d4712081610d3fbcc3962207ea}{problem}}.steady\_newton\_solve(max\_adapt);}
\DoxyCodeLine{   \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_abbb977d4712081610d3fbcc3962207ea}{problem}}.doc\_solution(doc\_info,trace);}
\DoxyCodeLine{   doc\_info.number()++; }
...
\DoxyCodeLine{   \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_abbb977d4712081610d3fbcc3962207ea}{problem}}.unsteady\_newton\_solve(dt,max\_adapt,first);}
\DoxyCodeLine{   }
...
\DoxyCodeLine{\textcolor{keyword}{public}:}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Constructor: Pass the lenght of the domain at the left}}
...
\DoxyCodeLine{   \textcolor{keywordtype}{unsigned} num\_nod= \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>nboundary\_node(ibound);}
\DoxyCodeLine{   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} inod=0;inod<num\_nod;inod++)}
\DoxyCodeLine{   \{}
\DoxyCodeLine{    \textcolor{keywordtype}{double} ycoord = \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>boundary\_node\_pt(ibound,inod)-\/>x(1); }
\DoxyCodeLine{    \textcolor{keywordtype}{double} uy = ampl*6.0*ycoord/Htot*(1.0-\/ycoord/Htot);}
\DoxyCodeLine{    \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>boundary\_node\_pt(ibound,inod)-\/>set\_value(0,uy);}
\DoxyCodeLine{    \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>boundary\_node\_pt(ibound,inod)-\/>set\_value(1,0.0);    }
\DoxyCodeLine{   \}}
...
\DoxyCodeLine{  \{}
\DoxyCodeLine{   \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>node\_update();}
\DoxyCodeLine{  \}}
...
\DoxyCodeLine{\textcolor{comment}{} RefineableAlgebraicChannelWithLeafletMesh<ELEMENT>* \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}};}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// Pointer to the "wall" mesh}}
\DoxyCodeLine{\textcolor{comment}{} OneDLagrangianMesh<FSIHermiteBeamElement>* \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_adc77c86dbe31ae29b9c7082ea1fff7a4}{Wall\_mesh\_pt}};}
\DoxyCodeLine{\textcolor{comment}{}}
...
\DoxyCodeLine{ \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a2686101caa40fa891e30660e3dacd6c7}{add\_time\_stepper\_pt}}(fluid\_time\_stepper\_pt);}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Allocate the wall timestepper}}
\DoxyCodeLine{ Steady<2>* \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a554e2755ee0f2660c24d8053b1a26eba}{wall\_time\_stepper\_pt}}=\textcolor{keyword}{new} Steady<2>;}
\DoxyCodeLine{ \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a2686101caa40fa891e30660e3dacd6c7}{add\_time\_stepper\_pt}}(\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a554e2755ee0f2660c24d8053b1a26eba}{wall\_time\_stepper\_pt}});}
...
\DoxyCodeLine{ \mbox{\hyperlink{classUndeformedLeaflet}{UndeformedLeaflet}}* \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_aa9c84a4ff4c6e8e4df583cc7720541fb}{undeformed\_wall\_pt}}=\textcolor{keyword}{new} \mbox{\hyperlink{classUndeformedLeaflet}{UndeformedLeaflet}}(x\_0);}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_adc77c86dbe31ae29b9c7082ea1fff7a4}{Wall\_mesh\_pt}} = \textcolor{keyword}{new} OneDLagrangianMesh<FSIHermiteBeamElement>}
\DoxyCodeLine{  (n\_wall\_el,hleaflet,\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_aa9c84a4ff4c6e8e4df583cc7720541fb}{undeformed\_wall\_pt}},\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a554e2755ee0f2660c24d8053b1a26eba}{wall\_time\_stepper\_pt}});}
...
\DoxyCodeLine{  \textcolor{keyword}{new} MeshAsGeomObject(\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_adc77c86dbe31ae29b9c7082ea1fff7a4}{Wall\_mesh\_pt}}); }
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//Build the mesh}}
\DoxyCodeLine{ \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}} =\textcolor{keyword}{new} RefineableAlgebraicChannelWithLeafletMesh<ELEMENT>(}
...
\DoxyCodeLine{ \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>spatial\_error\_estimator\_pt()=error\_estimator\_pt;}
\DoxyCodeLine{}
\DoxyCodeLine{}
\DoxyCodeLine{}
...
\DoxyCodeLine{ add\_sub\_mesh(\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}});}
\DoxyCodeLine{ add\_sub\_mesh(\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_adc77c86dbe31ae29b9c7082ea1fff7a4}{Wall\_mesh\_pt}});}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Combine all submeshes into a single Mesh}}
\DoxyCodeLine{ \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a0ae549c3a1e99d9d4dd46a0443635590}{build\_global\_mesh}}();}
...
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} num\_bound = \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>nboundary();}
\DoxyCodeLine{ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} ibound=0;ibound<num\_bound;ibound++)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   \textcolor{keywordtype}{unsigned} num\_nod= \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>nboundary\_node(ibound);}
\DoxyCodeLine{   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} inod=0;inod<num\_nod;inod++)}
\DoxyCodeLine{    \{}
\DoxyCodeLine{      \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>boundary\_node\_pt(ibound,inod)-\/>pin(1);}
\DoxyCodeLine{     }
\DoxyCodeLine{      \textcolor{comment}{// Do not pin the x velocity of the outflow}}
\DoxyCodeLine{      \textcolor{keywordflow}{if}( ibound != 1)}
\DoxyCodeLine{      \{}
\DoxyCodeLine{       \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>boundary\_node\_pt(ibound,inod)-\/>pin(0); }
\DoxyCodeLine{      \}      }
\DoxyCodeLine{    \}}
\DoxyCodeLine{  \}}
...
\DoxyCodeLine{ \textcolor{comment}{//-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} n\_element = \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>nelement();}
\DoxyCodeLine{}
...
\DoxyCodeLine{   ELEMENT* el\_pt = \textcolor{keyword}{dynamic\_cast<}ELEMENT*\textcolor{keyword}{>}(\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>element\_pt(e));}
\DoxyCodeLine{}
...
\DoxyCodeLine{  pin\_redundant\_nodal\_pressures(\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>element\_pt());}

\end{DoxyCodeInclude}


When completing the build of the wall elements we use the function {\ttfamily \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a27035711492dba4208e7e70832c8a269}{enable\+\_\+fluid\+\_\+loading\+\_\+on\+\_\+both\+\_\+sides()}}} to indicate that the leaflet is completely immersed in the fluid so that fluid tractions act on both of its faces. When setting up the fluid-\/structure interaction below, one of the two faces will have to be identified as the \char`\"{}front\char`\"{} (face 0) and the other one as the \char`\"{}back\char`\"{} (face 1). The function {\ttfamily normal\+\_\+points\+\_\+into\+\_\+fluid()} allows us to indicate if the outer unit normal on the leaflet (as computed by {\ttfamily F\+S\+I\+Hermite\+Beam\+Element\+::get\+\_\+normal(...)} points into the fluid, when viewed from the \char`\"{}front\char`\"{} face. Here it does not -- see \mbox{\hyperlink{index_comm}{Further comments}} for more details on this slightly subtle point).
...
\DoxyCodeLine{   elem\_pt-\/>undeformed\_beam\_pt() = \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_aa9c84a4ff4c6e8e4df583cc7720541fb}{undeformed\_wall\_pt}};}
\DoxyCodeLine{}
...
\DoxyCodeLine{   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} inod=0;inod<num\_nod;inod++)}
\DoxyCodeLine{    \{   }
\DoxyCodeLine{     \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>boundary\_node\_pt(ibound, inod)-\/>}
...
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_aa82ca9f1c5efd140c153e31d5c906c15}{face}}=0; }
\DoxyCodeLine{ FSI\_functions::setup\_fluid\_load\_info\_for\_solid\_elements<ELEMENT,2>}
\DoxyCodeLine{  (\textcolor{keyword}{this},4,\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}},\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_adc77c86dbe31ae29b9c7082ea1fff7a4}{Wall\_mesh\_pt}},\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_aa82ca9f1c5efd140c153e31d5c906c15}{face}}); }
\DoxyCodeLine{ }
\DoxyCodeLine{ \textcolor{comment}{// Back of leaflet: face 1, needs to be specified explicitly}}
\DoxyCodeLine{ \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_aa82ca9f1c5efd140c153e31d5c906c15}{face}}=1; }
\DoxyCodeLine{ FSI\_functions::setup\_fluid\_load\_info\_for\_solid\_elements<ELEMENT,2>}
\DoxyCodeLine{  (\textcolor{keyword}{this},5,\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}},\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_adc77c86dbe31ae29b9c7082ea1fff7a4}{Wall\_mesh\_pt}},\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_aa82ca9f1c5efd140c153e31d5c906c15}{face}}); }
...
\DoxyCodeLine{ RefineableNavierStokesEquations<2>::}
\DoxyCodeLine{  unpin\_all\_pressure\_dofs(\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>element\_pt());}
\DoxyCodeLine{ }
...
\DoxyCodeLine{ \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>output(some\_file,npts);}
...
\DoxyCodeLine{         doc\_info.number());}
\DoxyCodeLine{ some\_file.open(filename);}
\DoxyCodeLine{ \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_adc77c86dbe31ae29b9c7082ea1fff7a4}{Wall\_mesh\_pt}}-\/>output(some\_file,npts);}
\DoxyCodeLine{ some\_file.close();}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Get node at tip of leaflet}}
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} n\_el\_wall=\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_adc77c86dbe31ae29b9c7082ea1fff7a4}{Wall\_mesh\_pt}}-\/>nelement();}
\DoxyCodeLine{ Node* tip\_node\_pt=\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_adc77c86dbe31ae29b9c7082ea1fff7a4}{Wall\_mesh\_pt}}-\/>finite\_element\_pt(n\_el\_wall-\/1)-\/>node\_pt(1);}
\DoxyCodeLine{}
...
\DoxyCodeLine{         doc\_info.number());}
\DoxyCodeLine{ some\_file.open(filename);}
\DoxyCodeLine{ \textcolor{keywordtype}{unsigned} nel= \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>nboundary\_element(bound);}
\DoxyCodeLine{ \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} e=0;e<nel;e++)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   \textcolor{keyword}{dynamic\_cast<}ELEMENT*\textcolor{keyword}{>}(\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>boundary\_element\_pt(bound,e))}
...
\DoxyCodeLine{         doc\_info.number());}
\DoxyCodeLine{ some\_file.open(filename);}
\DoxyCodeLine{ nel= \mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>nboundary\_element(bound);}
\DoxyCodeLine{ \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} e=0;e<nel;e++)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   \textcolor{keyword}{dynamic\_cast<}ELEMENT*\textcolor{keyword}{>}(\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}}-\/>boundary\_element\_pt(bound,e))}
\DoxyCodeLine{    -\/>output(some\_file,npts);}
...
\DoxyCodeLine{         doc\_info.number());}
\DoxyCodeLine{ some\_file.open(filename);}
\DoxyCodeLine{ nel=\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_adc77c86dbe31ae29b9c7082ea1fff7a4}{Wall\_mesh\_pt}}-\/>nelement();}
...
\DoxyCodeLine{    \textcolor{keyword}{dynamic\_cast<}FSIHermiteBeamElement*\textcolor{keyword}{>}(\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_adc77c86dbe31ae29b9c7082ea1fff7a4}{Wall\_mesh\_pt}}-\/>element\_pt(e));}
\DoxyCodeLine{}
...
\item Confirm that choosing the wrong value for the flag ~\newline
 {\ttfamily F\+S\+I\+Hermite\+Beam\+Element\+::normal\+\_\+points\+\_\+into\+\_\+fluid()} makes the leaflet move in the wrong direction as it perceives positive fluid tractions as negative ones and vice versa. Here is what you should get\+:  
\begin{DoxyImage}
...
\DoxyCodeLine{\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_aa82ca9f1c5efd140c153e31d5c906c15}{face}}=0; }
\DoxyCodeLine{FSI\_functions::setup\_fluid\_load\_info\_for\_solid\_elements<ELEMENT,2>}
\DoxyCodeLine{ (\textcolor{keyword}{this},5,\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_a10ce8f652e1f7e37624e9c8e5dde94d5}{Fluid\_mesh\_pt}},\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_adc77c86dbe31ae29b9c7082ea1fff7a4}{Wall\_mesh\_pt}},\mbox{\hyperlink{fsi__channel__with__leaflet_8txt_aa82ca9f1c5efd140c153e31d5c906c15}{face}}); }
\end{DoxyCode}
 ~\newline
