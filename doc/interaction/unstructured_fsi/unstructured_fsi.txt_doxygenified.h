...
\image html fsi_sketch.gif "Sketch of the problem and its two single-physics constituents. " 
\image latex fsi_sketch.eps "Sketch of the problem and its two single-physics constituents. " width=0.75\textwidth
...
\image html flow.gif "Animation of the flow field (streamlines and pressure contours) and the deformation of the elastic obstacle. " 
\image latex flow.eps "Animation of the flow field (streamlines and pressure contours) and the deformation of the elastic obstacle. " width=0.75\textwidth
...
\image html boundary_coordinate_check.gif "Plot of the boundary coordinates generated from the fluid and solid sides of the FSI interface. " 
\image latex boundary_coordinate_check.eps "Plot of the boundary coordinates generated from the fluid and solid sides of the FSI interface. " width=0.75\textwidth
...
\image html flow_fine.gif "Animation of the flow field (streamlines and pressure contours) and the deformation, computed on a refined fluid mesh. " 
\image latex flow_fine.eps "Animation of the flow field (streamlines and pressure contours) and the deformation, computed on a refined fluid mesh. " width=0.75\textwidth
...
- <b> The mesh is too coarse for the automatic generation of
  ...
  \n\n
\image html boundary_generation_test.gif "Correct FSI boundary. " 
\image latex boundary_generation_test.eps "Correct FSI boundary. " width=0.75\textwidth
  \n
  In the next figure, the fluid mesh is too coarse and the 
  boundary detection has failed spectacularly:
  \n\n
\image html boundary_generation_test_too_coarse.gif "Wrongly identified FSI boundary on a (too) coarse fluid mesh. " 
\image latex boundary_generation_test_too_coarse.eps "Wrongly identified FSI boundary on a (too) coarse fluid mesh. " width=0.75\textwidth
  \n\n
- <b> The boundary coordinates on the fluid and solid side
  ...
  \n\n
\image html boundaries.gif "Boundary nodes in the fluid (triangle) and solid (square) meshes. " 
\image latex boundaries.eps "Boundary nodes in the fluid (triangle) and solid (square) meshes. " width=0.75\textwidth
  \n
.
