...
We create boundary coordinates along the three newly-\/created mesh boundaries and document the process for the F\+SI boundary (boundary 3). See \mbox{\hyperlink{index_go_wrong}{What can go wrong?}} for a more detailed discussion of the output created here. ~\newline
...
\DoxyCodeLine{  TPVDElement<2,3> > \mbox{\hyperlink{unstructured__fsi_8txt_a559b24adf0c5fc11da2b7f8c4c406c08}{problem}};}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Output boundaries }}
\DoxyCodeLine{ \mbox{\hyperlink{unstructured__fsi_8txt_a559b24adf0c5fc11da2b7f8c4c406c08}{problem}}.fluid\_mesh\_pt()-\/>output\_boundaries(\textcolor{stringliteral}{"RESLT/fluid\_boundaries.dat"});}
\DoxyCodeLine{ \mbox{\hyperlink{unstructured__fsi_8txt_a559b24adf0c5fc11da2b7f8c4c406c08}{problem}}.solid\_mesh\_pt()-\/>output\_boundaries(\textcolor{stringliteral}{"RESLT/solid\_boundaries.dat"});}
\DoxyCodeLine{ }
\DoxyCodeLine{ \textcolor{comment}{// Output the initial guess for the solution}}
\DoxyCodeLine{ \mbox{\hyperlink{unstructured__fsi_8txt_a559b24adf0c5fc11da2b7f8c4c406c08}{problem}}.doc\_solution(doc\_info);}
...
\DoxyCodeLine{ \mbox{\hyperlink{unstructured__fsi_8txt_a559b24adf0c5fc11da2b7f8c4c406c08}{problem}}.newton\_solve();}
\DoxyCodeLine{ }
...
The function also writes the file {\ttfamily fsi\+\_\+geom\+\_\+object.\+dat}, which may be used to check the integrity of the compound {\ttfamily Geom\+Object} ~\newline
 that represents the F\+SI interface of the solid\+: As $ \zeta $ sweeps along the range used to parametrise the boundary, the position vector $ {\bf R}(\zeta) $, returned by {\ttfamily Geom\+Object\+::position(...)} should follow the F\+SI interface.
...
The use of pseudo-\/elasticity for the node update in the fluid mesh makes the solution of F\+SI problems extremely straightforward. They key ingredient that allows the \char`\"{}automatic\char`\"{} coupling between the unstructured fluid and solid meshes ~\newline
 is the (consistent!) generation of the boundary coordinate $ \zeta $ along the F\+SI interface. The function {\ttfamily Triangle\+Mesh\+::setup\+\_\+boundary\+\_\+coordinates(...)} achieves this automatically and exploits the facts that
\begin{DoxyEnumerate}
