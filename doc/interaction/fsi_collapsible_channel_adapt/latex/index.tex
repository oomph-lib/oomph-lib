...
For instance, the full interface to the constructor of the {\ttfamily One\+D\+Lagrangian\+Mesh}, defined in \href{../../../../src/meshes/one_d_lagrangian_mesh.template.h}{\texttt{ one\+\_\+d\+\_\+lagrangian\+\_\+mesh.\+template.\+h}} is given by

 
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Constructor: Pass number of elements, length,}}
...
\DoxyCodeLine{\textcolor{comment}{} \mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_a16c5b1918f8e50274913964a344d7f7c}{OneDLagrangianMesh}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \&n\_element, }
\DoxyCodeLine{                    \textcolor{keyword}{const} \textcolor{keywordtype}{double} \&length,}
\DoxyCodeLine{                    \mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_a9c6741891789e8156d85c39d4e3adaa7}{GeomObject}}* undef\_eulerian\_posn\_pt, }
\DoxyCodeLine{                    \mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_a76005d00b12acac8677ecc7c968ff865}{TimeStepper}}* time\_stepper\_pt=}
...
\DoxyCodeLine{\mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_abfb18846a4072af6d25a14fedc27e1e2}{Wall\_mesh\_pt}} = \textcolor{keyword}{new} OneDLagrangianMesh<FSIHermiteBeamElement>}
...
\DoxyCodeLine{\textcolor{keyword}{class }Steady : \textcolor{keyword}{public} \mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_a76005d00b12acac8677ecc7c968ff865}{TimeStepper}}}
\end{DoxyCode}
...
\DoxyCodeLine{ Steady<2>* \mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_adced636e1609d83cd4f8bac99930f86a}{wall\_time\_stepper\_pt}} = \textcolor{keyword}{new} Steady<2>;}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Add the wall timestepper to the Problem's collection of timesteppers.}}
\DoxyCodeLine{ add\_time\_stepper\_pt(\mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_adced636e1609d83cd4f8bac99930f86a}{wall\_time\_stepper\_pt}});}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_abfb18846a4072af6d25a14fedc27e1e2}{Wall\_mesh\_pt}} = \textcolor{keyword}{new} OneDLagrangianMesh<FSIHermiteBeamElement>}
\DoxyCodeLine{  (Ncollapsible,Lcollapsible,undeformed\_wall\_pt,\mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_adced636e1609d83cd4f8bac99930f86a}{wall\_time\_stepper\_pt}});}
...
When discussing \href{../../../navier_stokes/algebraic_collapsible_channel/html/index.html}{\texttt{ the non-\/\+F\+SI version of the collapsible channel problem}} we explained how {\ttfamily oomph-\/lib\textquotesingle{}s} mesh adaptation procedures assign the node-\/update data for newly-\/created {\ttfamily Algebraic\+Nodes}. Recall that the node-\/update data comprises\+:
\begin{DoxyItemize}
...
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Constructor: Pass number of elements in upstream/collapsible/}}
...
\DoxyCodeLine{\textcolor{comment}{} RefineableAlgebraicCollapsibleChannelMesh(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned}\& nup, }
...
\DoxyCodeLine{                                           \mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_a9c6741891789e8156d85c39d4e3adaa7}{GeomObject}}* wall\_pt,}
\DoxyCodeLine{                                           \mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_a76005d00b12acac8677ecc7c968ff865}{TimeStepper}}* time\_stepper\_pt=}
\DoxyCodeLine{                                           \&Mesh::Default\_TimeStepper) :}
...
\DoxyCodeLine{  AlgebraicCollapsibleChannelMesh<ELEMENT>(nup, ncollapsible, ndown, ny,}
\DoxyCodeLine{                                           lup, lcollapsible, ldown, ly,}
\DoxyCodeLine{                                           wall\_pt,}
\DoxyCodeLine{                                           time\_stepper\_pt)}
\DoxyCodeLine{  \{}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Update the node update data for specified node following }}
...
\DoxyCodeLine{ Vector<double> \mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_abe1a872647b7cfc1c732b57adef7d1b9}{s}}(1);}
\DoxyCodeLine{ \mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_a9c6741891789e8156d85c39d4e3adaa7}{GeomObject}}* geom\_obj\_pt;}
\DoxyCodeLine{ this-\/>Wall\_pt-\/>locate\_zeta(zeta\_wall,geom\_obj\_pt,\mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_abe1a872647b7cfc1c732b57adef7d1b9}{s}});}
...
\DoxyCodeLine{ ref\_value[2]=\mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_abe1a872647b7cfc1c732b57adef7d1b9}{s}}[0];}
...
\DoxyCodeLine{ node\_pt-\/>add\_node\_update\_info(}
...
As in the \href{../../../navier_stokes/collapsible_channel/html/index.html}{\texttt{ non-\/\+F\+SI problem}}, we use the function {\ttfamily Problem\+::actions\+\_\+before\+\_\+adapt()} to delete the applied traction elements before the mesh adaptation\+:
...
\DoxyCodeLine{  (\textcolor{keyword}{this},3,Bulk\_mesh\_pt,\mbox{\hyperlink{fsi__collapsible__channel__adapt_8txt_abfb18846a4072af6d25a14fedc27e1e2}{Wall\_mesh\_pt}});}
\DoxyCodeLine{}
\DoxyCodeLine{}
