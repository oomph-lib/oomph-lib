\chapter{Demo problem\+: 2D FSI on unstructured meshes with adaptivity}
\hypertarget{index}{}\label{index}\index{Demo problem: 2D FSI on unstructured meshes with adaptivity@{Demo problem: 2D FSI on unstructured meshes with adaptivity}}
...
\end{DoxyCodeInclude}
 \DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_actions_before}{}\doxysection{\texorpdfstring{Actions before adaptation}{Actions before adaptation}}\label{index_actions_before}
...
\end{DoxyCodeInclude}
 \DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_actions_after}{}\doxysection{\texorpdfstring{Actions after adaptation}{Actions after adaptation}}\label{index_actions_after}
...
\end{DoxyCodeInclude}
 \DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_fsi_traction}{}\doxysection{\texorpdfstring{Creating and destroying the FSI traction and Lagrange multiplier elements}{Creating and destroying the FSI traction and Lagrange multiplier elements}}\label{index_fsi_traction}
