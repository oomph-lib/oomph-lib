...
\image html fsi_sketch.gif "Sketch of the problem showing fluid and solid boundary " 
\image latex fsi_sketch.eps "Sketch of the problem showing fluid and solid boundary " width=0.75\textwidth
...
\image html res.gif "The flow field (streamlines and pressure contours) and the deformation of the elastic obstacle. " 
\image latex res.eps "The flow field (streamlines and pressure contours) and the deformation of the elastic obstacle. " width=0.75\textwidth
