...
\DoxyCodeLine{\textcolor{comment}{} \mbox{\hyperlink{fsi__chan__alg_8txt_a2eb1f6b91aaf3fcc2ea27a0b39ab52fe}{AlgebraicCollapsibleChannelMesh}}(\textcolor{keyword}{const} \textcolor{keywordtype}{unsigned}\& nup, }
...
\DoxyCodeLine{\textcolor{comment}{} \textcolor{keyword}{virtual} \string~\mbox{\hyperlink{fsi__chan__alg_8txt_a2eb1f6b91aaf3fcc2ea27a0b39ab52fe}{AlgebraicCollapsibleChannelMesh}}()\{\}}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Update nodal position at time level t (t=0: present; }}
...
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Update the node-\/udate data after mesh adaptation.}}
...
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// initially been set up with a flush upper wall}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{//=================================================================}}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT>}
...
\DoxyCodeLine{     \textcolor{keywordflow}{if} ((std::fabs(r\_wall[0]-\/x)>1.0e-\/15)\&\&(std::fabs(r\_wall[1]-\/y)>1.0e-\/15))}
\DoxyCodeLine{      \{}
...
\DoxyCodeLine{        << \textcolor{stringliteral}{"x-\/discrepancy: "} << std::fabs(r\_wall[0]-\/x) << std::endl}
\DoxyCodeLine{        << \textcolor{stringliteral}{"y-\/discrepancy: "} << std::fabs(r\_wall[1]-\/y) << std::endl;}
\DoxyCodeLine{       }
