...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Simple circle in 2D space.}}
...
\DoxyCodeLine{  \}}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Position Vector at Lagrangian coordinate zeta  at time level t}}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{\textcolor{comment}{//=========================================================================}}
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short GeneralCircle in 2D space.}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)f[ x = X\_c + R \(\backslash\)cos(\(\backslash\)zeta)  \(\backslash\)f]}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// \(\backslash\)f[ y = Y\_c + R \(\backslash\)sin(\(\backslash\)zeta)  \(\backslash\)f]}}
...
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Return pointer to the j-\/th Data item that the object's }}
...
\DoxyCodeLine{\textcolor{keyword}{protected}:}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Vector of pointers to Data items that affects the object's shape}}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Alternative constructor:  Pass x and y-\/coords of centre and radius}}
...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short GeneralCircle "upgraded" to a GeneralisedElement: Circular }}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Constructor: Build  ring from doubles that describe }}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Set pointer to Data object that specifies the "load"}}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{/// \(\backslash\)short Compute element residual Vector (only if flag=0) and also}}
...
\DoxyCodeLine{ \mbox{\hyperlink{classGeomObjectAsGeneralisedElementProblem}{GeomObjectAsGeneralisedElementProblem}} \mbox{\hyperlink{circle__as__element_8txt_a4074baada03976c061d5672f4237cca5}{problem}};}
\DoxyCodeLine{ }
\DoxyCodeLine{ \textcolor{comment}{// Initial value for the load }}
\DoxyCodeLine{ \mbox{\hyperlink{circle__as__element_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.load()=-\/0.3;}
\DoxyCodeLine{ }
...
\DoxyCodeLine{   \mbox{\hyperlink{circle__as__element_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.newton\_solve();}
\DoxyCodeLine{   \mbox{\hyperlink{circle__as__element_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.doc\_solution();}
\DoxyCodeLine{   }
\DoxyCodeLine{   \textcolor{comment}{//Increment counter for solutions }}
\DoxyCodeLine{   \mbox{\hyperlink{circle__as__element_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.doc\_info().number()++;    }
\DoxyCodeLine{   }
\DoxyCodeLine{   \textcolor{comment}{// Change load on ring}}
\DoxyCodeLine{   \mbox{\hyperlink{circle__as__element_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.load()+=dp;}
\DoxyCodeLine{  \} }
\DoxyCodeLine{ }
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Pointer to data item that stores the "load" on the ring}}
