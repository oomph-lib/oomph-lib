...
At this point it might appear that we have fatally weakened the concept of a solution. If we only require the P\+DE to be satisfied in an average sense, couldn\textquotesingle{}t any function ~\newline
...
The figure below shows the residual for a more sophisticated candidate solution which satisfies the P\+DE over most of the domain.  
\begin{DoxyImage}
...
\DoxyCodeLine{\textcolor{keywordtype}{unsigned} j;}
\DoxyCodeLine{Mesh mesh;}
\DoxyCodeLine{\textcolor{keywordtype}{double} \mbox{\hyperlink{intro_8txt_a2f9cf9d0788477757896c69e94741dbb}{x}}=mesh.node\_pt(j)-\/>x(0);}
\end{DoxyCode}
