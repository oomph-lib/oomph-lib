\chapter{Creation of internal boundaries for Triangle based meshes}
\hypertarget{index}{}\label{index}\index{Creation of internal boundaries for Triangle based meshes@{Creation of internal boundaries for Triangle based meshes}}
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_overview}{}\doxysection{\texorpdfstring{Adding internal boundaries}{Adding internal boundaries}}\label{index_overview}
\hypertarget{index_open_curve}{}\doxysubsection{\texorpdfstring{The Triangle\+Mesh\+Open\+Curve object}{The TriangleMeshOpenCurve object}}\label{index_open_curve}
...
\DoxyHorRuler{0}
\hypertarget{index_connections}{}\doxysection{\texorpdfstring{Creating connections among current boundaries in the domain and with internal boundaries}{Creating connections among current boundaries in the domain and with internal boundaries}}\label{index_connections}
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_example_poisson}{}\doxysection{\texorpdfstring{Example\+: A domain with multiple internal boundaries and connections}{Example: A domain with multiple internal boundaries and connections}}\label{index_example_poisson}
...
\DoxyHorRuler{0}
\hypertarget{index_def_domain}{}\doxysubsection{\texorpdfstring{Definition of the domain/mesh}{Definition of the domain/mesh}}\label{index_def_domain}
The following code is extracted from the Problem constructor and shows how to create the domain/mesh.\hypertarget{index_def_out}{}\doxysubsubsection{\texorpdfstring{Defining the outer boundaries}{Defining the outer boundaries}}\label{index_def_out}
...
\end{DoxyImage}
\hypertarget{index_def_inopen}{}\doxysubsubsection{\texorpdfstring{Defining internal boundaries}{Defining internal boundaries}}\label{index_def_inopen}
...
\end{DoxyCodeInclude}
 \hypertarget{index_create_mesh}{}\doxysubsubsection{\texorpdfstring{Build the mesh}{Build the mesh}}\label{index_create_mesh}
...
\end{DoxyCodeInclude}
 \hypertarget{index_def_extra_regions}{}\doxysubsubsection{\texorpdfstring{Defining regions}{Defining regions}}\label{index_def_extra_regions}
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_ex}{}\doxysection{\texorpdfstring{Comments and exercises}{Comments and exercises}}\label{index_ex}
