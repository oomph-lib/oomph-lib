...
For further information on V\+M\+TK, please refer to V\+M\+TK\textquotesingle{}s \href{http://www.vmtk.org}{\texttt{ home page}}.
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_vmtk}{}\doxysection{Using V\+M\+T\+K\+: From the M\+R/\+C\+T images to the fluid mesh}\label{index_vmtk}
...
V\+M\+TK is capable of generating an image based surface model from a {\ttfamily vti} file (obtained using the procedure explained in the section \mbox{\hyperlink{index_voi}{Volume of interest}} above), using the Level Set method and can then extract the surface model using a Marching Cubes algorithm.
...
Note that it is possible to clip the endcaps automatically with V\+M\+TK. For more information, please refer to V\+M\+TK\textquotesingle{}s own \href{http://www.vmtk.org}{\texttt{ tutorial pages}}.
...
\item {\ttfamily normalestimationratio\+:} We suggest setting this parameter to 1. For further information, please refer to V\+M\+TK\textquotesingle{}s \href{http://www.vmtk.org}{\texttt{ tutorial page}}.
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
 \hypertarget{index_oomph_mesh}{}\doxysection{Creating an oomph-\/lib mesh based on output files generated by V\+M\+TK}\label{index_oomph_mesh}
V\+M\+TK exports the mesh for different solvers. The one we chose is the \char`\"{}.\+xda\char`\"{} format (of \href{http://libmesh.sourceforge.net/}{\texttt{ Lib\+Mesh}}). To export the mesh in this format enter\+:
...
which uses the V\+M\+TK output mesh in \char`\"{}$\ast$.\+xda\char`\"{} format to generate a file \char`\"{}fluid\+\_\+$\ast$.\+poly\char`\"{} that can be used to generate the fluid mesh using the open-\/source mesh generator \href{http://wias-berlin.de/software/tetgen//}{\texttt{ Tet\+Gen}}.
