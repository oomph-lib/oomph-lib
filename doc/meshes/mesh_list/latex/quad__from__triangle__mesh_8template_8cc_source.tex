...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00072}00072     TriangleScaffoldMesh* tmp\_mesh\_pt,}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00073}00073     TimeStepper* time\_stepper\_pt,}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00077}00077     \textcolor{keywordtype}{unsigned} nelem = tmp\_mesh\_pt-\/>nelement();}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00083}00083     \textcolor{keywordtype}{unsigned} nbound = tmp\_mesh\_pt-\/>nboundary();}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00114}00114     QElement<2, 2> dummy\_element;}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00157}00157     Vector<double> centroid(2);}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00160}00160     Vector<Vector<double>> triangle\_vertex(3);}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00163}00163     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} e = 0; e < nelem; e++)}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00177}00177         \textcolor{keywordtype}{double} x = tmp\_mesh\_pt-\/>finite\_element\_pt(e)-\/>node\_pt(j)-\/>x(0);}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00178}00178         \textcolor{keywordtype}{double} y = tmp\_mesh\_pt-\/>finite\_element\_pt(e)-\/>node\_pt(j)-\/>x(1);}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00181}00181         centroid[0] += x;}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00185}00185         triangle\_vertex[j][0] = x;}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00201}00201       Vector<ELEMENT*> el\_vector\_pt(3, 0);}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00218}00218         Node* scaffold\_node\_pt = tmp\_mesh\_pt-\/>finite\_element\_pt(e)-\/>node\_pt(j);}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00282}00282       Edge edge0(tmp\_mesh\_pt-\/>finite\_element\_pt(e)-\/>node\_pt(0),}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00283}00283                  tmp\_mesh\_pt-\/>finite\_element\_pt(e)-\/>node\_pt(1));}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00284}00284       Edge edge1(tmp\_mesh\_pt-\/>finite\_element\_pt(e)-\/>node\_pt(1),}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00285}00285                  tmp\_mesh\_pt-\/>finite\_element\_pt(e)-\/>node\_pt(2));}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00286}00286       Edge edge2(tmp\_mesh\_pt-\/>finite\_element\_pt(e)-\/>node\_pt(2),}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00287}00287                  tmp\_mesh\_pt-\/>finite\_element\_pt(e)-\/>node\_pt(0));}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00291}00291       Vector<Node*> edge0\_vector\_pt = edge\_nodes\_map[edge0];}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00292}00292       Vector<Node*> edge1\_vector\_pt = edge\_nodes\_map[edge1];}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00293}00293       Vector<Node*> edge2\_vector\_pt = edge\_nodes\_map[edge2];}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00365}00365       q0\_lower\_boundary\_id = tmp\_mesh\_pt-\/>edge\_boundary(e, 0);}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00366}00366       q0\_left\_boundary\_id = tmp\_mesh\_pt-\/>edge\_boundary(e, 2);}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00371}00371       q1\_lower\_boundary\_id = tmp\_mesh\_pt-\/>edge\_boundary(e, 1);}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00372}00372       q1\_left\_boundary\_id = tmp\_mesh\_pt-\/>edge\_boundary(e, 0);}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00377}00377       q2\_lower\_boundary\_id = tmp\_mesh\_pt-\/>edge\_boundary(e, 2);}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00378}00378       q2\_left\_boundary\_id = tmp\_mesh\_pt-\/>edge\_boundary(e, 1);}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00381}00381       Vector<unsigned> boundary\_id\_vector(6, 0);}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00476}00476       Vector<double> s(2);}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00477}00477       Vector<double> x(2);}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00612}00612         el0\_pt-\/>local\_coordinate\_of\_node(j, s);}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00615}00615         dummy\_element.interpolated\_x(s, x);}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00616}00616         el0\_pt-\/>node\_pt(j)-\/>x(0) = x[0];}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00617}00617         el0\_pt-\/>node\_pt(j)-\/>x(1) = x[1];}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00782}00782         el1\_pt-\/>local\_coordinate\_of\_node(j, s);}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00785}00785         dummy\_element.interpolated\_x(s, x);}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00786}00786         el1\_pt-\/>node\_pt(j)-\/>x(0) = x[0];}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00787}00787         el1\_pt-\/>node\_pt(j)-\/>x(1) = x[1];}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00976}00976         el2\_pt-\/>local\_coordinate\_of\_node(j, s);}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00979}00979         dummy\_element.interpolated\_x(s, x);}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00980}00980         el2\_pt-\/>node\_pt(j)-\/>x(0) = x[0];}
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l00981}00981         el2\_pt-\/>node\_pt(j)-\/>x(1) = x[1];}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l01033}01033     \textcolor{keyword}{const} Vector<double>\& elem\_error)}
...
\DoxyCodeLine{\Hypertarget{quad__from__triangle__mesh_8template_8cc_source_l01036}01036     TreeBasedRefineableMeshBase::adapt(elem\_error);}
