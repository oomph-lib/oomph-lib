...
\end{DoxyItemize}The remainder of this document covers the following issues\+:


\begin{DoxyItemize}
\item \doxysectlink{index_interface_changes}{Policy on interface changes}{1}
\item \doxysectlink{index_two_point_zero_to_three_point_zero}{Changes between version 2.\+0 and 3.\+0.\texorpdfstring{$\ast$}{*}}{2}
\begin{DoxyItemize}
\item \doxysectlink{index_new_functionality_three_point_zero}{Major new functionality/changes}{3}
\end{DoxyItemize}
...
\DoxyHorRuler{0}
\hypertarget{index_two_point_zero_to_three_point_zero}{}\doxysubsection{\texorpdfstring{Changes between version 2.\+0 and 3.\+0.\texorpdfstring{$\ast$}{*}}{Changes between version 2.0 and 3.0.*}}\label{index_two_point_zero_to_three_point_zero}
\hypertarget{index_new_functionality_three_point_zero}{}\doxysubsubsection{\texorpdfstring{Major new functionality/changes}{Major new functionality/changes}}\label{index_new_functionality_three_point_zero}

\begin{DoxyItemize}
\item Moved to C++17 standard ~\newline
~\newline

\item Completely re-\/implemented the build machinery which is now based on CMake.
\begin{DoxyItemize}
\item the equivalent of the old {\ttfamily autogen.\+sh} script is {\ttfamily oomph\+\_\+build.\+py}
\item renamed the {\ttfamily bin} directory {\ttfamily scripts}
\item moved the {\ttfamily self\+\_\+test} directory into {\ttfamily demo\+\_\+drivers}
\item changed the way the template instantiation in the {\ttfamily meshes} directory is done\+: {\ttfamily \texorpdfstring{$\ast$}{*}.template.\+h} becomes {\ttfamily \texorpdfstring{$\ast$}{*}.h}.
\item third-\/party libraries are now pulled in from their Git\+Hub repositories.
\end{DoxyItemize}
\end{DoxyItemize}~\newline
~\newline
...
\begin{DoxyItemize}
\item How to use {\ttfamily oomph-\/lib} in parallel and how to (optionally) distribute problems over multiple processors and to perform load balancing when performing spatially-\/adaptive, distributed simulations. ~\newline
~\newline

\item How to use {\ttfamily oomph-\/lib\textquotesingle{}s} block preconditioning framework. ~\newline
~\newline
...
\item Significantly extended {\ttfamily oomph-\/lib\textquotesingle{}s} bifurcation tracking routines (no tutorials yet, though). ~\newline
~\newline
