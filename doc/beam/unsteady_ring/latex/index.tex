...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Square of timescale ratio (i.e. non-\/dimensional density)  }}
...
\DoxyCodeLine{ \mbox{\hyperlink{classElasticRingProblem}{ElasticRingProblem<HermiteBeamElement,Newmark<3>}} > \mbox{\hyperlink{unsteady__ring_8txt_a4074baada03976c061d5672f4237cca5}{problem}}(nelem);}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Do unsteady run}}
\DoxyCodeLine{ \mbox{\hyperlink{unsteady__ring_8txt_a4074baada03976c061d5672f4237cca5}{problem}}.unsteady\_run();}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Setup initial conditions}}
...
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Dump problem-\/specific parameter values, then dump}}
...
\DoxyCodeLine{ \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{unsteady__ring_8txt_a7a0eb570c0549e9c0d2d326ff26344f0}{t}}=0;\mbox{\hyperlink{unsteady__ring_8txt_a7a0eb570c0549e9c0d2d326ff26344f0}{t}}<=nsteps;\mbox{\hyperlink{unsteady__ring_8txt_a7a0eb570c0549e9c0d2d326ff26344f0}{t}}++)}
\DoxyCodeLine{  \{     }
\DoxyCodeLine{   sprintf(filename,\textcolor{stringliteral}{"\%s/ring\%i-\/\%i.dat"},doc\_info.directory().c\_str(),}
\DoxyCodeLine{           doc\_info.number(),\mbox{\hyperlink{unsteady__ring_8txt_a7a0eb570c0549e9c0d2d326ff26344f0}{t}});}
\DoxyCodeLine{   some\_file.open(filename);}
\DoxyCodeLine{   \textcolor{keywordtype}{unsigned} n\_elem=mesh\_pt()-\/>nelement();}
\DoxyCodeLine{   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} ielem=0;ielem<n\_elem;ielem++)}
\DoxyCodeLine{    \{}
\DoxyCodeLine{     \textcolor{keyword}{dynamic\_cast<}ELEMENT*\textcolor{keyword}{>}(mesh\_pt()-\/>element\_pt(ielem))-\/>}
\DoxyCodeLine{      output(\mbox{\hyperlink{unsteady__ring_8txt_a7a0eb570c0549e9c0d2d326ff26344f0}{t}},some\_file,npts);}
\DoxyCodeLine{    \}}
\DoxyCodeLine{   some\_file.close();}
