...
\end{longtabu}
\end{center}  \begin{center} {\bfseries{Table 1\+:}} Average G\+M\+R\+ES iteration counts as a function of the mesh refinement (indicated by the number of unknowns, {\ttfamily n\+\_\+dof}) for different implementations of the preconditioner. \end{center}  \DoxyHorRuler{0}
...
\end{longtabu}
\end{center}  \begin{center} {\bfseries{Table 2\+:}} Average G\+M\+R\+ES solve times \mbox{[}sec\mbox{]} as a function of the mesh refinement (indicated by the number of unknowns, {\ttfamily n\+\_\+dof}) for different implementations of the preconditioner. \end{center}  \DoxyHorRuler{0}
...
Most of the driver code is unchanged from the implementation discussed in the ~\newline
 \href{../../../solid/prescribed_displ_lagr_mult/html/index.html}{\texttt{ original tutorial.}} We therefore only discuss the modifications required to employ preconditioned G\+M\+R\+ES as the linear solver for the Newton method.
...
\DoxyCodeLine{\textcolor{comment}{/// Pseudo-\/Elastic Solid element class to overload the block preconditioner}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// methods ndof\_types() and get\_dof\_numbers\_for\_unknowns() to differentiate}}
\DoxyCodeLine{\textcolor{comment}{}\textcolor{comment}{/// between DOFs subject to Lagrange multiplier and those that are not.}}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Returns the number of DOF types associated with this element: Twice}}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Create a list of pairs for all unknowns in this element,}}
...
\DoxyCodeLine{  PseudoElasticBulkElement<RefineableQPVDElement<2,3> > > \mbox{\hyperlink{prescribed__displ__lagr__mult_8txt_a4074baada03976c061d5672f4237cca5}{problem}}(nel\_1d);}
