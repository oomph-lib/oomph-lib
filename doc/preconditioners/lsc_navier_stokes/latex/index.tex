...
~\newline
 Assuming that \href{https://computation.llnl.gov/casc/linear_solvers/sls_hypre.html}{\texttt{ {\ttfamily Hypre}}} is available, we therefore provide the option to use the {\ttfamily Hypre} A\+MG solver to solve the linear systems involving the $ {\bf P} $ matrix. ~\newline
~\newline
...
\hline
\cellcolor{\tableheadbgcolor}\textbf{ \# of dofs}&\cellcolor{\tableheadbgcolor}\textbf{ Super\+LU}&\cellcolor{\tableheadbgcolor}\textbf{ G\+M\+R\+ES \mbox{[}Super\+LU,Super\+LU\mbox{]}}&\cellcolor{\tableheadbgcolor}\textbf{ G\+M\+R\+ES \mbox{[}Super\+LU,A\+MG\mbox{]}}&\cellcolor{\tableheadbgcolor}\textbf{ G\+M\+R\+ES \mbox{[}A\+MG,Super\+LU\mbox{]}}&\cellcolor{\tableheadbgcolor}\textbf{ G\+M\+R\+ES \mbox{[}A\+MG,A\+MG\mbox{]} }\\\cline{1-6}
\endfirsthead
\hline
\endfoot
\hline
