...
\end{DoxyCodeInclude}
 ~\newline
 set the maximum number of iterations to 100, and increase the G\+M\+R\+ES convergence tolerance to $ 10^{-6} $ as experiments showed this to give the fastest overall solve times; see \mbox{\hyperlink{index_comm_ex}{Further comments and exercises}}. ~\newline
~\newline
...
\DoxyCodeLine{      FSIPreconditioner* \mbox{\hyperlink{fsi_8txt_a74da23730d99ddd48951640ea09874a6}{prec\_pt}}=\textcolor{keyword}{new} FSIPreconditioner(\textcolor{keyword}{this});}
...
\DoxyCodeLine{      \mbox{\hyperlink{fsi_8txt_a74da23730d99ddd48951640ea09874a6}{prec\_pt}}-\/>set\_navier\_stokes\_mesh(this-\/>bulk\_mesh\_pt());}
...
\DoxyCodeLine{      \mbox{\hyperlink{fsi_8txt_a74da23730d99ddd48951640ea09874a6}{prec\_pt}}-\/>set\_wall\_mesh(combined\_solid\_mesh\_pt,\textcolor{keyword}{true});}
...
\DoxyCodeLine{      iterative\_linear\_solver\_pt-\/>preconditioner\_pt()= \mbox{\hyperlink{fsi_8txt_a74da23730d99ddd48951640ea09874a6}{prec\_pt}};}
...
\DoxyCodeLine{        \mbox{\hyperlink{fsi_8txt_a74da23730d99ddd48951640ea09874a6}{prec\_pt}}-\/>use\_block\_triangular\_version\_with\_fluid\_on\_solid();}
...
\DoxyCodeLine{        \mbox{\hyperlink{fsi_8txt_a74da23730d99ddd48951640ea09874a6}{prec\_pt}}-\/>use\_block\_triangular\_version\_with\_solid\_on\_fluid();}
...
\DoxyCodeLine{        \mbox{\hyperlink{fsi_8txt_a74da23730d99ddd48951640ea09874a6}{prec\_pt}}-\/>use\_block\_diagonal\_version();}
...
\DoxyCodeLine{        \mbox{\hyperlink{fsi_8txt_a74da23730d99ddd48951640ea09874a6}{prec\_pt}}-\/>navier\_stokes\_preconditioner\_pt()-\/>}
...
\DoxyCodeLine{       \}}
\DoxyCodeLine{\textcolor{preprocessor}{\#endif // endif for we have hypre...}}
...
\begin{DoxyItemize}
\item \href{../../../interaction/turek_flag/html/index.html}{\texttt{ Hron \& Turek\textquotesingle{}s F\+SI benchmark of flow past a flag.}}~\newline
~\newline
