...
\item \href{\#pml_helmholtz}{\texttt{ The Helmholtz equation and perfectly matched layers (P\+M\+Ls)}}
\item \href{\#pml_fourier_decomposed_helmholtz}{\texttt{ The azimuthally Fourier-\/decomposed 3D Helmholtz equation and perfectly matched layers (P\+M\+Ls)}}
...
\item \href{\#gen_time_harmonic_lin_elas}{\texttt{ Generalised time-\/harmonic linear elasticity and perfectly matched layers (P\+M\+Ls)}}
...
We (re-\/)solve the problem considered in the \href{../../quick_guide/html/index.html}{\texttt{ Quick Guide}}, this time using existing {\ttfamily oomph-\/lib} objects\+: The {\ttfamily One\+D\+Mesh} and finite elements from the {\ttfamily Q\+Poisson} family.  &
\begin{DoxyItemize}
...
\\\cline{1-2}
\href{../../advection_diffusion/two_d_adv_diff_SUPG/html/index.html}{\texttt{ {\bfseries{The 2D advection diffusion equation revisited\+: Petrov-\/\+Galerkin methods and S\+U\+PG stabilisation. }} }}
...
\href{../../pml_helmholtz/scattering/html/index.html}{\texttt{ {\bfseries{The Helmholtz equation and perfectly matched layers (P\+M\+Ls). }} }} We demonstrate the imposition of the Sommerfeld radiation condition by perfectly matched layers (P\+M\+Ls) using the example of a radiating cylinder.  &
\begin{DoxyItemize}
...
\multicolumn{2}{|l|}{\label{_pml_fourier_decomposed_helmholtz}%
 \doxysubsection*{The azimuthally Fourier-\/decomposed 3D Helmholtz equation and perfectly matched layers (P\+M\+Ls)}

}\\\cline{1-2}
\href{../../pml_fourier_decomposed_helmholtz/oscillating_sphere/html/index.html}{\texttt{ {\bfseries{The azimuthally Fourier-\/decomposed 3D Helmholtz equation and perfectly matched layers (P\+M\+Ls). }} }}
...
This is a \char`\"{}warm-\/up\char`\"{} problem for \href{../../interaction/turek_flag/html/index.html}{\texttt{ Turek \& Hron\textquotesingle{}s F\+SI benchmark problem}} where the flag deforms in response to the fluid traction. Here we consider the case where the motion of the flag is prescribed.  &
\begin{DoxyItemize}
\item Another example illustrating the use of algebraic and {\ttfamily Macro\+Element/\+Domain-\/based} node update techniques. 
\end{DoxyItemize}
...
This is a \char`\"{}warm-\/up\char`\"{} problem for \href{../../interaction/unstructured_fsi/html/index.html}{\texttt{ another tutorial}} in which we demonstrate the use of unstructured meshes for F\+SI problems.  &
\begin{DoxyItemize}
...
This is a \char`\"{}warm-\/up\char`\"{} problem for \href{../../interaction/unstructured_three_d_fsi/html/index.html}{\texttt{ another tutorial}} in which we demonstrate the use of unstructured 3D meshes for F\+SI problems.  &
\begin{DoxyItemize}
...
We demonstrate how to use unstructured meshes to solve 3D solid mechanics problems. This is a \char`\"{}warm-\/up\char`\"{} problem for \href{../../interaction/unstructured_three_d_fsi/html/index.html}{\texttt{ another tutorial}} in which we demonstrate the use of unstructured 3D meshes for F\+SI problems.  &
\begin{DoxyItemize}
...
\doxysubsection*{Generalised time-\/harmonic linear elasticity and perfectly matched layers (P\+M\+Ls)}

}\\\cline{1-2}
\href{../../generalised_time_harmonic_linear_elasticity/html/index.html}{\texttt{ {\bfseries{The generalised equations of time-\/harmonic linear elasticity and perfectly matched layers (P\+M\+Ls). }} }}
...
We revisit the \href{../../interaction/fsi_collapsible_channel/html/index.html}{\texttt{ problem of flow in a collapsible channel}} yet again to demonstrate the use of {\ttfamily oomph-\/lib\textquotesingle{}s} F\+SI preconditioner for the monolithic solution of fluid-\/structure interaction problems in which the node update in the fluid mesh is performed by algebraic node updates.  &
\begin{DoxyItemize}
...
\\\cline{1-2}
\href{../../interaction/turek_flag/html/index.html}{\texttt{ {\bfseries{Turek \& Hron\textquotesingle{}s F\+SI benchmark\+: Flow past an elastic flag attached to a cylinder }} }}
...
\\\cline{1-2}
\href{../../interaction/unstructured_fsi/html/index.html}{\texttt{ {\bfseries{Using unstructured meshes for F\+SI problems. }} }}
...
\\\cline{1-2}
\href{../../interaction/unstructured_three_d_fsi/html/index.html}{\texttt{ {\bfseries{Using unstructured meshes for 3D F\+SI problems. }} }}
...
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\href{../../interaction/unstructured_adaptive_fsi/html/index.html}{\texttt{ {\bfseries{2D F\+SI on unstructured meshes with adaptivity }} }}
...
We show how to simulate physiological fluid-\/structure interaction problems, using the \href{http://www.vmtk.org}{\texttt{ Vascular Modeling Toolkit (V\+M\+TK).}}  &
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item \href{../../meshes/mesh_from_triangle/html/index.html}{\texttt{ {\bfseries{ Triangle\+Mesh$<$\+E\+L\+E\+M\+E\+N\+T$>$\+:}}}} A Mesh based on the output from \href{http://www.cs.cmu.edu/~jrs}{\texttt{ J.\+R.\+Shewchuk\textquotesingle{}s}} Delaunay mesh generator ~\newline
 \href{http://www.cs.cmu.edu/~quake/triangle.html}{\texttt{ {\ttfamily Triangle}}}
\item \href{../../meshes/mesh_from_tetgen/html/index.html}{\texttt{ {\bfseries{ Tetgen\+Mesh$<$\+E\+L\+E\+M\+E\+N\+T$>$\+:}}}} A Mesh based on the output from \href{http://www.wias-berlin.de/~si}{\texttt{ Hang Si\textquotesingle{}s}} unstructured tetrahedral mesh generator \href{http://wias-berlin.de/software/tetgen//index.html}{\texttt{ {\ttfamily Tet\+Gen.}}}
\item We provide a \href{../../meshes/mesh_from_vmtk/html/index.html}{\texttt{ separate tutorial}} that shows how to generate {\ttfamily oomph-\/lib} meshes from medical images, using the \href{http://www.vmtk.org}{\texttt{ Vascular Modeling Toolkit (V\+M\+TK).}}
...
{\ttfamily oomph-\/lib\textquotesingle{}s} one-\/and-\/only G\+UI\+: Generating unstructured triangular meshes using \href{http://en.wikipedia.org/wiki/Xfig}{\texttt{ xfig}} and \href{http://www.cs.cmu.edu/~quake/triangle.html}{\texttt{ Triangle}}  &
\begin{DoxyItemize}
...
\href{../../preconditioners/lsc_navier_stokes/html/index.html}{\texttt{ {\bfseries{ {\ttfamily oomph-\/lib}\textquotesingle{}s Least-\/\+Squares-\/\+Commutator (L\+SC) Navier-\/\+Stokes preconditioner}}}}
...
\\\cline{1-2}
\href{../../mpi/fsi_channel_with_leaflet/html/index.html}{\texttt{ {\bfseries{ Parallel solution of an F\+SI problem\+: Channel with an elastic leaflet}}}}
...
\\\cline{1-2}
\href{../../mpi/turek_flag/html/index.html}{\texttt{ {\bfseries{ Parallel solution of Turek and Hron\textquotesingle{}s F\+SI benchmark problem}}}}
...
\begin{DoxyItemize}
\item How to \char`\"{}upgrade\char`\"{} \href{../../interaction/turek_flag/html/index.html}{\texttt{ Turek \& Hron\textquotesingle{}s F\+SI benchmark problem}} to allow spatial adaptivity in the fluid and solid meshes.
