...
routines, activated with "<code>cd demo_drivers; cmake -G Ninja -B build;
cd build; ctest</code>" . 
</div>
</TD>
</TR>
...
-# <A HREF="#problems">Example codes for specific problem/equations</A>
  - Single-physics problems:
    ...
    - <A HREF="#axisym_solid">Nonlinear axisymmetric solid mechanics problems</A>
...
<TR>
<TD COLSPAN=2 class="header-cell">
<A NAME="axisym_solid"><H2 class="header">Axisymmetric nonlinear solid
mechanics problems</H2></A>
</TD>
</TR>
<TR>
<TD>
<A HREF="../../axisym_solid/spherical_shell_compression/html/index.html">
<B>Nonlinear axisymmetric solid mechanics: Theory, implementation and
a steady demo problem.
</B>
</A>

In this document we discuss the theoretical background and the
implementation of nonlinear solid mechanics problems, specialised
to axisymmetric settings
</TD>
<TD>
- Brief summary of governing equations and their implementation for
  compressible and incompressible constitutive behaviour.
- The solution of a model problem: the spherically symmetric
  compression of a spherical shell-like solid. This is a good test
  problem because its solution is determined by an easy-to-solve ODE
  in spherical coordinates but it provides a non-trivial test case for the
  formulation in cylindrical polars.
.
</TD>
...
<TR>
<TD>
<A HREF="../../axisym_solid/spherical_shell_unsteady/html/index.html">
<B>An unsteady, nonlinear axisymmetric solid mechanics problem
</B>
</A>

We demonstrate how to compute the time-dependent deformation of an
axisymmetric solid.
</TD>
<TD>
- As for the steady case, we consider the spherically symmetric
  compression of a spherical shell-like solid. The easy-to-solve ODE
  in spherical coordinates provides a solution against which we
  validate our formulation in cylindrical polars.
</TD>
