...
\DoxyCodeLine{ \}}
\DoxyCodeLine{ \textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short The body force function; returns vector of doubles}}
...
\DoxyCodeLine{ \textcolor{keywordtype}{double} \mbox{\hyperlink{cylinder_8txt_ac494e755f23b33df5d197ecb39ad1ca3}{u\_r}}(\textcolor{keyword}{const} \textcolor{keywordtype}{double} \&time, \textcolor{keyword}{const} Vector<double> \&x)}
\DoxyCodeLine{  \{}
...
\DoxyCodeLine{  <QAxisymmetricLinearElasticityElement<3>, Newmark<1> > \mbox{\hyperlink{cylinder_8txt_a19579a1133e22b1527426f9dbfdf7d3e}{problem}};}
...
\DoxyCodeLine{ \mbox{\hyperlink{cylinder_8txt_a19579a1133e22b1527426f9dbfdf7d3e}{problem}}.time\_pt()-\/>time()=0.0;}
\DoxyCodeLine{}
...
\DoxyCodeLine{  \}}
\DoxyCodeLine{ \mbox{\hyperlink{cylinder_8txt_a19579a1133e22b1527426f9dbfdf7d3e}{problem}}.time\_pt()-\/>initialise\_dt(dt);}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Set the initial conditions}}
\DoxyCodeLine{ \mbox{\hyperlink{cylinder_8txt_a19579a1133e22b1527426f9dbfdf7d3e}{problem}}.set\_initial\_conditions();}
\DoxyCodeLine{}
\DoxyCodeLine{ \textcolor{comment}{// Doc the initial conditions and increment the doc\_info number}}
\DoxyCodeLine{ \mbox{\hyperlink{cylinder_8txt_a19579a1133e22b1527426f9dbfdf7d3e}{problem}}.doc\_solution(doc\_info);}
...
\DoxyCodeLine{   \mbox{\hyperlink{cylinder_8txt_a19579a1133e22b1527426f9dbfdf7d3e}{problem}}.unsteady\_newton\_solve(dt);}
\DoxyCodeLine{}
...
The problem class is very simple, and similarly to other problems with Neumann conditions, there are separate meshes for the \char`\"{}bulk\char`\"{} elements and the \char`\"{}face\char`\"{} elements that apply the traction boundary conditions. The function {\ttfamily \mbox{\hyperlink{cylinder_8txt_a3f5b5e378483c5899ee892c73f08787e}{assign\+\_\+traction\+\_\+elements()}}} attaches the traction elements to the appropriate bulk elements.
...
\DoxyCodeLine{  \}}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{ /// \(\backslash\)short Set the initial conditions, either for an impulsive start or}}
...
\DoxyCodeLine{ \mbox{\hyperlink{cylinder_8txt_a3f5b5e378483c5899ee892c73f08787e}{assign\_traction\_elements}}();}
\DoxyCodeLine{ }
\DoxyCodeLine{ \textcolor{comment}{//Set the boundary conditions}}
\DoxyCodeLine{ \mbox{\hyperlink{cylinder_8txt_aba95f1accf0d9942d7c7f0c304db53de}{set\_boundary\_conditions}}();}
...
\DoxyCodeLine{ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{cylinder_8txt_a74dc2d1356729ecae4265c7721c19ba9}{e}}=0;\mbox{\hyperlink{cylinder_8txt_a74dc2d1356729ecae4265c7721c19ba9}{e}}<n\_el;\mbox{\hyperlink{cylinder_8txt_a74dc2d1356729ecae4265c7721c19ba9}{e}}++)}
\DoxyCodeLine{  \{}
\DoxyCodeLine{   \textcolor{comment}{// Cast to a bulk element}}
\DoxyCodeLine{   ELEMENT *el\_pt = \textcolor{keyword}{dynamic\_cast<}ELEMENT*\textcolor{keyword}{>}(Bulk\_mesh\_pt-\/>element\_pt(\mbox{\hyperlink{cylinder_8txt_a74dc2d1356729ecae4265c7721c19ba9}{e}}));}
\DoxyCodeLine{}
...
\DoxyCodeLine{ \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} \mbox{\hyperlink{cylinder_8txt_a74dc2d1356729ecae4265c7721c19ba9}{e}}=0;\mbox{\hyperlink{cylinder_8txt_a74dc2d1356729ecae4265c7721c19ba9}{e}}<n\_traction;\mbox{\hyperlink{cylinder_8txt_a74dc2d1356729ecae4265c7721c19ba9}{e}}++)}
\DoxyCodeLine{  \{}
...
\DoxyCodeLine{    <ELEMENT\textcolor{keyword}{>}* >(Surface\_mesh\_pt-\/>element\_pt(\mbox{\hyperlink{cylinder_8txt_a74dc2d1356729ecae4265c7721c19ba9}{e}}));}
\DoxyCodeLine{   }
...
\DoxyCodeLine{ cout << \mbox{\hyperlink{cylinder_8txt_a5697c5be964ff44aa97eedcdfbe3b8bc}{assign\_eqn\_numbers}}() << \textcolor{stringliteral}{" equations assigned"} << std::endl; }
