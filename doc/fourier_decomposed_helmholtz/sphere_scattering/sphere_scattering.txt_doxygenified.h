...
(2), such waves are represented by
...
(7) to obtain the normal derivative of the
...
Equation (8) provides a condition on the
...
radiation condition via (8) introduces a non-local coupling
...
\f$ \gamma \f$ values required for the imposition of equation (8).
The radius \f$ R \f$ of the artificial boundary and the (finite) upper limit
for the sum in (8) are specified
...
for which the exact solution of (5) is given by
\f[
...
\image html real.gif "Plot of the exact (green) and computed (red) real parts of the solution of the Fourier-decomposed Helmholtz equation for N=3 and a wavenumber of k^2 = 10. " 
\image latex real.eps "Plot of the exact (green) and computed (red) real parts of the solution of the Fourier-decomposed Helmholtz equation for N=3 and a wavenumber of k^2 = 10. " width=0.6\textwidth


\image html imag.gif "Plot of the exact (green) and computed (red) imaginary parts of the solution of the Fourier-decomposed Helmholtz equation for N=3 and a wavenumber of k^2 = 10. " 
\image latex imag.eps "Plot of the exact (green) and computed (red) imaginary parts of the solution of the Fourier-decomposed Helmholtz equation for N=3 and a wavenumber of k^2 = 10. " width=0.6\textwidth
...
Dirichlet-to-Neumann mapping (8); see \ref acc.
...
- The number of terms included in the sum  (8) --
...
- Explore the accuracy (and computational cost) of the application of
  ...
  in the sum  (8). Specifically, confirm that 
...
\image html compare_gamma.gif "Plot of the exact (dashed) and computed (solid) gamma integral for N=3 and a wavenumber of k^2 = 10. " 
\image latex compare_gamma.eps "Plot of the exact (dashed) and computed (solid) gamma integral for N=3 and a wavenumber of k^2 = 10. " width=0.6\textwidth
