...
def grey(text: str) -> str:
    return f"\x1b[38;20m{text}\x1b[0m"


def yellow(text: str) -> str:
    return f"\x1b[33;20m{text}\x1b[0m"
...
def red(text: str) -> str:
    return f"\x1b[31;20m{text}\x1b[0m"
...
def magenta(text: str) -> str:
    return f"\x1b[35;20m{text}\x1b[0m"
...
class MakefileToCMakeListsConverter:
    ...
    def _load(self, fpath: Path) -> str:
        ...
        with open(fpath, "r") as f:
            text = f.read()
        if not "SUBDIRS" in text:
            raise ValueError("Skipping leaf Makefiles for now.")
        return text
...
def main():
    ...
    for file in files:
        ...
        try:
            ...
            print()
            print(red("*" * BORDER_WIDTH))
            print(red(f"Failed to convert file:\n\t./{file.relative_to(Path.cwd())}"))
            print(red("-" * BORDER_WIDTH))
            logger.error(str(e))
            print(red("*" * BORDER_WIDTH))
            print()
