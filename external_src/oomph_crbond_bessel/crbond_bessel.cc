...
namespace CRBond_Bessel
{
                  ...
                  double &j0p, double &j1p, double &y0p, double &y1p)
    {
        ...
        else
        {
            ...
            p1 = ((((0.10632e-4 * t2 - 0.50363e-4) * t2 + 0.145575e-3) * t2 - 0.559487e-3) * t2 + 0.7323931e-2) * t2 + 1.000000004;
            q1 = t * (((((-0.9173e-5 * t2 + 0.40658e-4) * t2 - 0.99941e-4) * t2 + 0.266891e-3) * t2 - 0.1601836e-2) * t2 + 0.093749994);
            ta1 = x - 0.75 * M_PI;
